...
export function initSentry() {
  ...
  console.log('[Sentry] Inicializado com sucesso', { environment });
}
...
/**
 * Healthcare-specific breadcrumb for tracking exercise and health data
 */
export function addHealthcareBreadcrumb(
  type: 'exercise' | 'health_data' | 'appointment' | 'prescription',
  action: string,
