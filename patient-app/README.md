# FisioFlow - App do Paciente

App mobile para pacientes do FisioFlow, construido com Expo e React Native.
...
- [x] Autenticacao (Login/Logout)
- [x] Recuperar Senha
- [x] Tela Home com resumo
- [x] Lista de Exercicios
- [x] Marcar exercicios como concluidos
