...
(async () => {
  ...
  await page.goto(`${BASE_URL}/auth/login?nocache=${Date.now()}`, { waitUntil: "networkidle", timeout: 30000 });
  ...
  await page.goto(`${BASE_URL}/whatsapp/inbox?nocache=${Date.now()}`, { waitUntil: "networkidle", timeout: 30000 });
  await new Promise(r => setTimeout(r, 8000));
