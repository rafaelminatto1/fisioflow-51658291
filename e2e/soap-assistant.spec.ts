...
const MOCK_SOAP_RESPONSES = {
  lombalgia: {
    ...
    data: {
      soap: {
        subjective:
          "Paciente masculino, 45 anos, relata dor lombar há 2 meses com início pós-esforço (carregamento de móveis). Dor irradia para membro inferior direito em trajeto radicular (fisgada até pé). Piora significativa em posição sentada (postura no trabalho). Melhora parcial com deambulação. Limitação funcional para atividades ocupacionais.",
        objective: {
          inspection:
            "Postura antálgica com leve retificação da lordose lombar. Marcha preservada sem claudicação.",
          palpation:
            "Hipersensibilidade paravertebral bilateral L4-L5. Espasmo muscular paravertebral. Palpação de forames intervertebrais reproduz irradiação para MID direito.",
          movement_tests: {
        ...
        assessment:
          "Lombalgia mecânica com comprometimento radicular L4-L5 ou L5-S1 à direita. Hérnia de disco comprovada por RM há 3 semanas. Prognóstico favorável com tratamento conservador (fisioterapia). Ausência de bandeiras vermelhas (sem alteração de hábito intestinal/vesical, sem febre, sem perda de peso). Indicação de tratamento fisioterapêutico manual associado a exercícios de estabilização.",
        plan: {
          short_term_goals: [
    ...
    data: {
      soap: {
        ...
        objective: {
          ...
          posture_analysis:
            "Ombros anteriorizados, cifo-teorácica leve, protração escapular bilateral.",
          gait_analysis: "Não aplicável.",
        },
        assessment:
          "Síndrome do impacto subacromial do ombro direito com tendinopatia do manguito rotador (envolvimento de supraespinhoso). Arcus doloroso positivo entre 60-120° de abdução. Testes específicos positivos para impacto (Neer, Hawkins-Kennedy). Sem sinais de lesão completa do manguito (força preservada). Prognóstico favorável com tratamento conservador focado em fortalecimento de manguito rotador e estabilização escapular.",
        plan: {
          short_term_goals: [
