...
app.put('/:id', requireAuth, async (c) => {
  try {
    ...
    if (body.start_date !== undefined) { params.push(body.start_date || null); sets.push(`start_date = $${params.length}`); }
    if (body.end_date !== undefined) { params.push(body.end_date || null); sets.push(`end_date = $${params.length}`); }
    if (body.manager_id !== undefined) { params.push(body.manager_id || null); sets.push(`manager_id = $${params.length}`); }
