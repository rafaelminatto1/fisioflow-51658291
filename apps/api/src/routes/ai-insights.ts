...
aiInsightsRoutes.get("/widgets", async (c) => {
  ...
  const mockWidgets = {
    ...
    financialAlerts: [
      { id: "3", patientName: "Carlos Oliveira", pendingAmount: 450.00, daysOverdue: 35 },
      { id: "4", patientName: "Ana Costa", pendingAmount: 150.00, daysOverdue: 15 }
    ],
    dailyBriefing: "Hoje temos 15 consultas agendadas. A taxa de ocupação está em 85%. Há 2 pacientes em risco de abandono que precisam de atenção."
  };
