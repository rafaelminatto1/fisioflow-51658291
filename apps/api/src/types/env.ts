...
export interface Env {
  ...
  FLOWS_PUBLIC_KEY?: string; // Chave pública RSA (PEM) — usada na rota de setup one-time
  FLOWS_SETUP_KEY?: string; // Guarda a rota one-time de upload da chave pública; deletar após uso
