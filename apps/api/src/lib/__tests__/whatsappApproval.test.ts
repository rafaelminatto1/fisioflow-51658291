...
describe("needsHumanApproval", () => {
  ...
  it("informação com conteúdo clínico exige aprovação", () => {
    expect(needsHumanApproval("information", "estou com dor no joelho depois da cirurgia")).toBe(true);
    ...
    expect(needsHumanApproval("information", "estou dormente e com sangramento no curativo")).toBe(true);
  });
