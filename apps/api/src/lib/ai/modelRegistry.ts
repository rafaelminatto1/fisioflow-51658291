...
const MODEL_DEFINITIONS: AIModelDefinition[] = [
  ...
  },
  {
    id: "workers-whisper",
    provider: "workers-ai",
    displayName: "Whisper Large V3 Turbo (Edge)",
    description: "Transcrição de áudio na edge. Formato: base64 string.",
    capabilities: ["audio", "transcription"],
    inputCostPer1m: 0,
    outputCostPer1m: 0,
    cachedCostPer1m: 0,
  ...
  {
    id: "workers-whisper-legacy",
    provider: "workers-ai",
    displayName: "Whisper Original (Edge)",
    description: "Transcrição de áudio na edge (fallback). Formato: array de bytes.",
    capabilities: ["audio", "transcription"],
    inputCostPer1m: 0,
    outputCostPer1m: 0,
    cachedCostPer1m: 0,
