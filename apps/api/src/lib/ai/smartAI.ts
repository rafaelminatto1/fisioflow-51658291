...
import { callAI, callAIStructured, type AITask, type CallAIOptions, type CallAIResult } from './callAI';
import { z } from 'zod';
...
export async function smartChat(env: Env, opts: UnifiedAIOptions): Promise<{ text: string; thoughts?: string; usage: CallAIResult['usage'] }> {
