...
| `0166_lgpd_export_requests.sql` | Registro de pedidos de portabilidade/acesso de dados (LGPD art. 18 V e VI) | ✅ 06/08/2026 | ✅ | Espelha `lgpd_deletion_requests` |
| `0167_partnerships.sql` | Tabela `partnerships` + colunas `partnership_id` e `partnership_role` em `patients` | ✅ 07/08/2026 | ✅ | Aplicada com sucesso no Neon PostgreSQL (purple-union-72678311). Tabela e colunas confirmadas via information_schema. |
