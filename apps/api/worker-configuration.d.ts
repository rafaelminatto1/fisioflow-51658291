...
interface __BaseEnv_Env {
  ...
  MONITOR_HEALTH_URL:
    ...
    | "https://fisioflow-api-staging.rafalegollas.workers.dev/api/health";
  ...
  R2_PUBLIC_URL:
    ...
    | "https://pub-7d7f6b6af4684fb3a18be682c4b610d9.r2.dev";
  GOOGLE_MAPS_API_KEY: "";
  NEON_AUTH_URL:
    | "https://ep-wandering-bonus-acj4zwvo.neonauth.sa-east-1.aws.neon.tech/neondb/auth"
    | "https://ep-withered-glade-acrv7il7.neonauth.sa-east-1.aws.neon.tech/neondb/auth";
  NEON_AUTH_AUDIENCE:
    | "https://ep-wandering-bonus-acj4zwvo.neonauth.sa-east-1.aws.neon.tech"
    | "https://ep-withered-glade-acrv7il7.neonauth.sa-east-1.aws.neon.tech";
  ...
  FISIOFLOW_AI_GATEWAY_URL:
    | "https://gateway.ai.cloudflare.com/v1/32156f9a72a32d1ece28ab74bcd398fb/fisioflow-gateway"
    | "https://gateway.ai.cloudflare.com/v1/32156f9a72a32d1ece28ab74bcd398fb/fisioflow-gateway-staging";
  ...
  WORKFLOW_APPOINTMENT_REMINDER: Workflow<
    Parameters<import("./src/index").AppointmentReminderWorkflow["run"]>[0]["payload"]
  >;
  WORKFLOW_PATIENT_ONBOARDING: Workflow<
    Parameters<import("./src/index").PatientOnboardingWorkflow["run"]>[0]["payload"]
  >;
  WORKFLOW_NFSE: Workflow<Parameters<import("./src/index").NFSeWorkflow["run"]>[0]["payload"]>;
  WORKFLOW_HEP_COMPLIANCE: Workflow<
    Parameters<import("./src/index").HEPComplianceWorkflow["run"]>[0]["payload"]
  >;
  WORKFLOW_DISCHARGE: Workflow<
    Parameters<import("./src/index").PatientDischargeWorkflow["run"]>[0]["payload"]
  >;
  WORKFLOW_REENGAGEMENT: Workflow<
    Parameters<import("./src/index").PatientReengagementWorkflow["run"]>[0]["payload"]
  >;
  WORKFLOW_DIGITAL_TWIN: Workflow<
    Parameters<import("./src/index").PatientDigitalTwinWorkflow["run"]>[0]["payload"]
  >;
  WORKFLOW_WIKI_SYNC: Workflow<
    Parameters<import("./src/index").WikiSyncWorkflow["run"]>[0]["payload"]
  >;
  WORKFLOW_KNOWLEDGE_SYNC: Workflow<
    Parameters<import("./src/index").KnowledgeSyncWorkflow["run"]>[0]["payload"]
  >;
  WORKFLOW_SESSION_SUMMARY: Workflow<
    Parameters<import("./src/index").SessionSummaryWorkflow["run"]>[0]["payload"]
  >;
  EVENTS_PIPELINE:
    | import("cloudflare:pipelines").Pipeline<Cloudflare.FisioflowEventsStreamRecord>
    | import("cloudflare:pipelines").Pipeline<Cloudflare.FisioflowEventsStagingStreamRecord>;
}
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<
      ...
      | "MONITOR_HEALTH_URL"
      | "MONITOR_NTFY_TOPIC"
      | "MONITOR_AI_GATEWAY_URL"
      | "IMAGE_TRANSFORMATIONS"
      | "GOOGLE_AI_PREMIUM_ENABLED"
      | "R2_PUBLIC_URL"
      | "GOOGLE_MAPS_API_KEY"
      | "NEON_AUTH_URL"
      | "NEON_AUTH_AUDIENCE"
