/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 060270202a527eab9b3583934d6f824a)
// Runtime types generated with workerd@1.20260515.1 2026-05-14 nodejs_compat
interface __BaseEnv_Env {
	FISIOFLOW_CONFIG: KVNamespace;
	MEDIA_BUCKET: R2Bucket;
	EXAMS_BUCKET: R2Bucket;
	CLINICAL_DOCS_BUCKET: R2Bucket;
	DB: D1Database;
	EDGE_CACHE: D1Database;
	HYPERDRIVE: Hyperdrive;
	ANALYTICS: AnalyticsEngineDataset;
	NFSE_SP_CERT?: Fetcher;
	...
	MONITOR_HEALTH_URL: "https://api-pro.moocafisio.com.br/api/health" | "https://fisioflow-api-staging.rafalegollas.workers.dev/api/health";
	MONITOR_NTFY_TOPIC: "fisioflow-mon-rafael-prod" | "fisioflow-mon-rafael-staging";
	MONITOR_AI_GATEWAY_URL?: "https://fisioflow-ai-gateway.rafalegollas.workers.dev/health";
	IMAGE_TRANSFORMATIONS: "enabled";
	GOOGLE_AI_PREMIUM_ENABLED: "false";
	R2_PUBLIC_URL: "https://media.moocafisio.com.br" | "https://pub-7d7f6b6af4684fb3a18be682c4b610d9.r2.dev";
	GOOGLE_MAPS_API_KEY: "";
	NEON_AUTH_URL: "https://ep-wandering-bonus-acj4zwvo.neonauth.sa-east-1.aws.neon.tech/neondb/auth" | "https://ep-withered-glade-acrv7il7.neonauth.sa-east-1.aws.neon.tech/neondb/auth";
	NEON_AUTH_AUDIENCE: "https://ep-wandering-bonus-acj4zwvo.neonauth.sa-east-1.aws.neon.tech" | "https://ep-withered-glade-acrv7il7.neonauth.sa-east-1.aws.neon.tech";
	NEON_DATA_API_URL?: "https://ep-wandering-bonus-acj4zwvo.apirest.sa-east-1.aws.neon.tech/neondb/rest/v1";
	AXIOM_ORG_ID: "activity-dbyc";
	AXIOM_DATASET: "fisioflow-logs" | "fisioflow-logs-staging";
	PAGES_URL: "https://moocafisio.com.br" | "https://fisioflow-web-staging.rafalegollas.workers.dev";
	FISIOFLOW_AI_GATEWAY_URL: "https://gateway.ai.cloudflare.com/v1/32156f9a72a32d1ece28ab74bcd398fb/fisioflow-gateway" | "https://gateway.ai.cloudflare.com/v1/32156f9a72a32d1ece28ab74bcd398fb/fisioflow-gateway-staging";
	...
	ORGANIZATION_STATE: DurableObjectNamespace<import("./src/index").OrganizationState>;
	PATIENT_AGENT: DurableObjectNamespace<import("./src/index").PatientAgent>;
	ASSESSMENT_LIVE_SESSION: DurableObjectNamespace<import("./src/index").AssessmentLiveSession>;
	CLINIC_AGENT: DurableObjectNamespace<import("./src/index").ClinicAgent>;
	VOICE_SCRIBE_AGENT: DurableObjectNamespace<import("./src/index").VoiceScribeAgent>;
	WORKFLOW_APPOINTMENT_REMINDER: Workflow<Parameters<import("./src/index").AppointmentReminderWorkflow['run']>[0]['payload']>;
	WORKFLOW_PATIENT_ONBOARDING: Workflow<Parameters<import("./src/index").PatientOnboardingWorkflow['run']>[0]['payload']>;
	WORKFLOW_NFSE: Workflow<Parameters<import("./src/index").NFSeWorkflow['run']>[0]['payload']>;
	WORKFLOW_HEP_COMPLIANCE: Workflow<Parameters<import("./src/index").HEPComplianceWorkflow['run']>[0]['payload']>;
	WORKFLOW_DISCHARGE: Workflow<Parameters<import("./src/index").PatientDischargeWorkflow['run']>[0]['payload']>;
	WORKFLOW_REENGAGEMENT: Workflow<Parameters<import("./src/index").PatientReengagementWorkflow['run']>[0]['payload']>;
	WORKFLOW_DIGITAL_TWIN: Workflow<Parameters<import("./src/index").PatientDigitalTwinWorkflow['run']>[0]['payload']>;
	WORKFLOW_WIKI_SYNC: Workflow<Parameters<import("./src/index").WikiSyncWorkflow['run']>[0]['payload']>;
	WORKFLOW_KNOWLEDGE_SYNC: Workflow<Parameters<import("./src/index").KnowledgeSyncWorkflow['run']>[0]['payload']>;
	WORKFLOW_SESSION_SUMMARY: Workflow<Parameters<import("./src/index").SessionSummaryWorkflow['run']>[0]['payload']>;
	EVENTS_PIPELINE: import("cloudflare:pipelines").Pipeline<Cloudflare.FisioflowEventsStreamRecord> | import("cloudflare:pipelines").Pipeline<Cloudflare.FisioflowEventsStagingStreamRecord>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "PatientAgent" | "AssessmentLiveSession" | "ClinicAgent" | "VoiceScribeAgent";
	}
	type FisioflowEventsStreamRecord = { value: Record<string, unknown> };
	type FisioflowEventsStagingStreamRecord = { value: Record<string, unknown> };
	interface ProductionEnv {
		...
		MONITOR_HEALTH_URL: "https://api-pro.moocafisio.com.br/api/health";
		...
		WORKFLOW_KNOWLEDGE_SYNC: Workflow<Parameters<import("./src/index").KnowledgeSyncWorkflow['run']>[0]['payload']>;
		WORKFLOW_SESSION_SUMMARY: Workflow<Parameters<import("./src/index").SessionSummaryWorkflow['run']>[0]['payload']>;
		EVENTS_PIPELINE: import("cloudflare:pipelines").Pipeline<Cloudflare.FisioflowEventsStreamRecord>;
	}
	interface StagingEnv {
		...
		AI_SEARCH: AiSearchInstance;
		ENVIRONMENT: "staging";
		MONITOR_HEALTH_URL: "https://fisioflow-api-staging.rafalegollas.workers.dev/api/health";
		MONITOR_NTFY_TOPIC: "fisioflow-mon-rafael-staging";
		IMAGE_TRANSFORMATIONS: "enabled";
		GOOGLE_AI_PREMIUM_ENABLED: "false";
		R2_PUBLIC_URL: "https://pub-7d7f6b6af4684fb3a18be682c4b610d9.r2.dev";
		PAGES_URL: "https://fisioflow-web-staging.rafalegollas.workers.dev";
		GOOGLE_MAPS_API_KEY: "";
		NEON_AUTH_URL: "https://ep-withered-glade-acrv7il7.neonauth.sa-east-1.aws.neon.tech/neondb/auth";
		NEON_AUTH_AUDIENCE: "https://ep-withered-glade-acrv7il7.neonauth.sa-east-1.aws.neon.tech";
		FISIOFLOW_AI_GATEWAY_URL: "https://gateway.ai.cloudflare.com/v1/32156f9a72a32d1ece28ab74bcd398fb/fisioflow-gateway-staging";
		TURNSTILE_SITE_KEY: "0x4AAAAAAC813j31sbl6IHX3";
		AXIOM_ORG_ID: "activity-dbyc";
		AXIOM_DATASET: "fisioflow-logs-staging";
		WRANGLER_HYPERDRIVE_LOCAL_CONNECTION_STRING_HYPERDRIVE: string;
		NEON_AUTH_JWKS_URL: string;
		NEON_AUTH_ISSUER: string;
		ALLOWED_ORIGINS: string;
		...
		WORKFLOW_KNOWLEDGE_SYNC: Workflow<Parameters<import("./src/index").KnowledgeSyncWorkflow['run']>[0]['payload']>;
		WORKFLOW_SESSION_SUMMARY: Workflow<Parameters<import("./src/index").SessionSummaryWorkflow['run']>[0]['payload']>;
		EVENTS_PIPELINE: import("cloudflare:pipelines").Pipeline<Cloudflare.FisioflowEventsStagingStreamRecord>;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "MONITOR_HEALTH_URL" | "MONITOR_NTFY_TOPIC" | "MONITOR_AI_GATEWAY_URL" | "IMAGE_TRANSFORMATIONS" | "GOOGLE_AI_PREMIUM_ENABLED" | "R2_PUBLIC_URL" | "GOOGLE_MAPS_API_KEY" | "NEON_AUTH_URL" | "NEON_AUTH_AUDIENCE" | "NEON_DATA_API_URL" | "AXIOM_ORG_ID" | "AXIOM_DATASET" | "PAGES_URL" | "FISIOFLOW_AI_GATEWAY_URL" | "TURNSTILE_SITE_KEY" | "WRANGLER_HYPERDRIVE_LOCAL_CONNECTION_STRING_HYPERDRIVE" | "NEON_AUTH_JWKS_URL" | "NEON_AUTH_ISSUER" | "ALLOWED_ORIGINS" | "GOOGLE_AI_API_KEY" | "LIVEKIT_URL" | "LIVEKIT_API_KEY" | "LIVEKIT_API_SECRET">> {}
}
