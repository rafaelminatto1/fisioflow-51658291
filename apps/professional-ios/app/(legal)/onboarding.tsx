...
import { doc, setDoc, serverTimestamp, getDoc } from '@/lib/data-store';
...
export default function OnboardingScreen() {
  ...
  const setupBiometric = () => {
    ...
    router.push('/(auth)/biometric-setup?mode=onboarding');
  };
  ...
  const renderPrivacy = () => (
    <View style={styles.stepContainer}>
      ...
      <TouchableOpacity
        style={styles.primaryButton}
        onPress={() => router.push('/(legal)/privacy-policy?mode=onboarding')}
      >
  ...
  const renderTerms = () => (
    <View style={styles.stepContainer}>
      ...
      <TouchableOpacity
        style={styles.primaryButton}
        onPress={() => router.push('/(legal)/terms-of-service?mode=onboarding')}
      >
