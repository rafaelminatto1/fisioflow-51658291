...
export default function TermsOfServiceScreen() {
  ...
  const { mode: modeParam } = router.params || {};
  const mode: 'onboarding' | 'view' = (modeParam as 'onboarding' | 'view') || 'view';
  ...
  const handleContinue = async () => {
    ...
    try {
      ...
      if (mode === 'onboarding') {
        ...
        console.log('Terms of service accepted in onboarding mode');
        router.back();
      } else {
