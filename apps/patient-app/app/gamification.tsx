        ...
        <Card style={styles.profileCard}>
          <View style={styles.profileInfo}>
            ...
            <View style={styles.streakInfo}>
              ...
              <Text style={[styles.streakValue, { color: colors.text }]}>{profile?.streak || 0}</Text>
            </View>
          </View>
          ...
          {activeTab === 'quests' && (
            <View>
              {quests.length > 0 ? quests.map((quest) => (
                <Card key={quest.id} style={styles.itemCard}>
                  <View style={styles.questHeader}>
                    <View style={styles.questText}>
                      <Text style={[styles.itemTitle, { color: colors.text }]}>{quest.title}</Text>
                      <Text style={[styles.itemDescription, { color: colors.textSecondary }]}>{quest.description}</Text>
                    </View>
                ...
                <Text style={[styles.emptyText, { color: colors.textMuted }]}>Nenhuma missão disponível no momento.</Text>
              )}
            </View>
          )}
              ...
              {achievements.map((achievement) => (
                <View key={achievement.id} style={styles.achievementItem}>
                  <View style={[
                    ...
                    { 
                      backgroundColor: achievement.unlockedAt ? colors.primary + '20' : colors.surfaceHover,
                  ...
                  <Text style={[styles.achievementTitle, { color: achievement.unlockedAt ? colors.text : colors.textMuted }]} numberOfLines={1}>
                    {achievement.title}
                  </Text>
                </View>
              ))}
            ...
            <View style={styles.shopGrid}>
              {shopItems.map((item) => (
                <Card key={item.id} style={styles.shopCard}>
                  <View style={[styles.shopIconContainer, { backgroundColor: colors.surfaceHover }]}>
                    <Ionicons name={item.icon as any || 'gift'} size={40} color={colors.primary} />
                  </View>
