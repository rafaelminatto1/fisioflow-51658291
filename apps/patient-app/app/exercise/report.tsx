...
export default function ExerciseReportScreen() {
  const { id: exerciseId, reps, rom } = useLocalSearchParams<{ id: string; reps: string; rom: string }>();
      ...
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <Card style={styles.insightCard}>
          ...
          <Text style={[styles.insightText, { color: colors.text }]}>
            Excelente controle motor nas primeiras 8 repetições. Detectamos uma leve inclinação do tronco para a esquerda nas últimas 2 repetições, possivelmente devido à fadiga.
          </Text>
        ...
        <View style={styles.actions}>
          <Button 
            ...
            onPress={handleShare}
            loading={sharing}
            icon={<Ionicons name="share-social" size={20} color="#fff" style={{ marginRight: 8 }} />}
          />
          <TouchableOpacity 
            onPress={() => router.back()} 
...
const styles = StyleSheet.create({
  ...
  tipContainer: { flexDirection: "row", alignItems: "center", gap: 8, backgroundColor: "rgba(245, 158, 11, 0.1)", padding: 10, borderRadius: 8 },
