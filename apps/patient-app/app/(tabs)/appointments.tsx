			...
			<Card key={appointment.id} style={styles.appointmentCard}>
				<View style={styles.appointmentHeader}>
					...
					<View style={styles.appointmentInfo}>
						<Text
							style={[styles.appointmentType, { color: colors.text }]}
							numberOfLines={1}
						>
							{appointment.type}
						</Text>
				...
				<View
					style={[styles.appointmentDetails, { borderTopColor: colors.border }]}
				>
				...
				>
					<Text
						style={[
							...
							{
								color:
									selectedTab === "upcoming" ? "#FFFFFF" : colors.textSecondary,
							},
						]}
					>
				...
				>
					<Text
						style={[
							...
							{
								color:
									selectedTab === "past" ? "#FFFFFF" : colors.textSecondary,
							},
						]}
					>
