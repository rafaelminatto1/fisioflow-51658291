...
export default function AppointmentsScreen() {
          ...
          {appointment.isGroup && (
            <View style={styles.detailRow}>
              ...
              <Text style={[styles.detailText, { color: colors.primary, fontWeight: "600" }]}>
                Sessão de Grupo{" "}
                {appointment.additionalNames ? `(${appointment.additionalNames})` : ""}
              </Text>
            </View>
          )}
        </View>
  ...
  return (
    ...
    >
      ...
      >
        <TouchableOpacity
          style={[styles.tab, selectedTab === "upcoming" && { backgroundColor: colors.primary }]}
        ...
        <TouchableOpacity
          style={[styles.tab, selectedTab === "past" && { backgroundColor: colors.primary }]}
      ...
      >
        {displayAppointments.length === 0 ? (
          <View style={styles.emptyState}>
            ...
            <Text style={[styles.emptyTitle, { color: colors.text }]}>Nenhuma consulta</Text>
