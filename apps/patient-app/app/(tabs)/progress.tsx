...
export default function ProgressScreen() {
  ...
  const evolutions = useMemo(() => progressData?.evolutions || [], [progressData]);
  ...
  const stats = useMemo(() => {
    ...
    const dates = evolutions.map((e) => new Date(e.date)).sort((a, b) => a.getTime() - b.getTime());
  ...
  return (
    ...
    >
      ...
      <View style={styles.pageHeader}>
        <Text style={[styles.pageTitle, { color: colors.text }]}>Progresso</Text>
      </View>
      ...
      >
        ...
        {filteredEvolutions.length === 0 ? (
          <Card style={styles.emptyCard}>
            ...
            <Text style={[styles.emptyTitle, { color: colors.text }]}>Nenhuma evolução ainda</Text>
            ...
            {reports.map((report) => (
              <Card key={report.id} style={styles.evolutionCard}>
                <TouchableOpacity
                  ...
                  onPress={() =>
                    Alert.alert("Documento", "Em breve: visualização de PDF direto no app.")
                  }
                >
                  ...
                  <View style={{ flex: 1 }}>
                    ...
                    <Text
                      style={[styles.evolutionProfessional, { color: colors.textSecondary }]}
                      numberOfLines={1}
                    >
                      Emitido em{" "}
