                ...
                >
                  ...
                  <View style={{ flex: 1 }}>
                    ...
                    <Text style={[styles.evolutionProfessional, { color: colors.textSecondary }]} numberOfLines={1}>
                      Emitido em {format(new Date(report.date), "dd/MM/yyyy", { locale: ptBR })}
                    </Text>
                  </View>
    ...
    <Card style={styles.evolutionCard}>
      <TouchableOpacity onPress={() => setExpanded(!expanded)}>
        <View style={styles.evolutionHeader}>
          ...
          <View style={[styles.painIndicator, { backgroundColor: getPainColor(evolution.painLevel || 0, colors) + '20' }]}>
            <Text style={[styles.painIndicatorText, { color: getPainColor(evolution.painLevel || 0, colors) }]}>
