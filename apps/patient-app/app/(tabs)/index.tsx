...
export default function DashboardScreen() {
	...
	const isLoading =
		gamificationLoading || exercisesLoading || appointmentsLoading;
			...
			>
				{activeRoom && (
					<TouchableOpacity
						activeOpacity={0.8}
						onPress={() =>
							activeRoom.meeting_url && Linking.openURL(activeRoom.meeting_url)
						}
						...
						>
							<View style={styles.telemedicineContent}>
								...
								<View style={styles.telemedicineText}>
									<Text style={styles.telemedicineTitle}>
										Consulta Online Ativa
									</Text>
									<Text style={styles.telemedicineSub}>
									...
									{exercises.slice(0, 3).map((exercise, index) => (
										...
										>
											...
											<Ionicons
												...
												size={24}
												color={
													exercise.completed ? colors.success : colors.textMuted
												}
											/>
										</View>
									))}
