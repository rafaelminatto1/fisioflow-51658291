...
export default function WellnessScreen() {
	...
	const getConnectionStatus = () => {
		...
		if (isAndroid && healthConnectAuthorized)
			return "Conectado ao Health Connect";
				...
				<Card style={styles.stepsCard}>
					<View style={styles.stepsHeader}>
						...
						<View style={styles.stepsInfo}>
							<Text
								style={[styles.stepsLabel, { color: colors.textSecondary }]}
							>
								Passos Hoje
							</Text>
					...
					<Card style={{ padding: 16 }}>
						...
						>
							...
							<View style={{ flex: 1 }}>
								...
								>
									Ative o acesso aos dados de saúde nas configurações do
									dispositivo.
								</Text>
							</View>
						</View>
