 ...
 */
export function PainMap({ value = [], onChange, readOnly = false, size = "medium" }: PainMapProps) {
    ...
    <>
      <View style={[styles.container, { width: mapWidth }]}>
        ...
        <View style={[styles.bodyContainer, { height: mapHeight }]}>
          ...
          >
            <View
              style={[styles.regionShape, { backgroundColor: getRegionColor("leftShoulder") }]}
            />
          </TouchableOpacity>
          <TouchableOpacity
          ...
          >
            <View
              style={[styles.regionShape, { backgroundColor: getRegionColor("rightShoulder") }]}
            />
          </TouchableOpacity>
          ...
          >
            <View
              style={[styles.regionShape, { backgroundColor: getRegionColor("leftForearm") }]}
            />
          </TouchableOpacity>
          <TouchableOpacity
          ...
          >
            <View
              style={[styles.regionShape, { backgroundColor: getRegionColor("rightForearm") }]}
            />
          </TouchableOpacity>
      ...
      <View style={styles.modalOverlay}>
        <Card style={styles.modalContent}>
          ...
          {currentValue?.level && currentValue.level > 0 && (
            <>
              <Text
                style={[styles.modalSubtitle, { color: colors.textSecondary }, { marginTop: 20 }]}
              >
        ...
        <View style={styles.summaryContent}>
          ...
          <View style={styles.summaryText}>
            ...
            <Text style={[styles.summarySubtitle, { color: colors.textSecondary }]}>
              {regionCount} região{regionCount !== 1 ? "s" : ""} afetada
              {regionCount !== 1 ? "s" : ""}
            </Text>
          </View>
          {maxPainLevel > 0 && (
            <View
              style={[styles.summaryBadge, { backgroundColor: getPainColor(maxPainLevel, colors) }]}
            >
