...
export function Divider({
  ...
  return (
    <View style={[styles.horizontalContainer, style]}>
      <View
        style={[styles.horizontalLine, { backgroundColor: colors.border, height: thickness }]}
      />
      {text && (
        <>
          <Text
            style={[
              ...
              { color: colors.textSecondary, marginHorizontal: 12 },
              textStyle,
            ]}
          >
            {text}
...
export function ListDivider({ inset = 16, style }: ListDividerProps) {
  ...
  return (
    <View
      style={[styles.listDivider, { backgroundColor: colors.border, marginLeft: inset }, style]}
    />
  );
}
