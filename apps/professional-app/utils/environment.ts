...
export function getBuildEnvironment(): BuildEnvironment {
  ...
  return {
    ...
    isDevelopmentBuild: executionEnvironment === ExecutionEnvironment.StoreClient ? false : __DEV__,
    isProductionBuild: executionEnvironment === ExecutionEnvironment.Standalone && !__DEV__,
...
export function isFeatureAvailable(
  feature: "liveCamera" | "poseDetection" | "charts" | "notifications" | "biometrics",
): boolean {
