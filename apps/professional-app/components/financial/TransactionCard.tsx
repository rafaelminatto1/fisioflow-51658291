...
const PAYMENT_METHOD_ICONS: Record<string, keyof typeof Ionicons.prototype.props.name> = {
        ...
        <View style={styles.cardContent}>
          <View style={styles.topRow}>
            ...
            <View style={styles.statusContainer}>
              <Badge
                ...
                icon={
                  <Ionicons name={statusConfig.icon as any} size={12} color={getStatusColor()} />
                }
              >
                {statusConfig.label}
              </Badge>
          ...
          <View style={styles.middleRow}>
            <View style={styles.methodContainer}>
              <Ionicons name={methodIcon as any} size={14} color={colors.textSecondary} />
