    ...
    <>
      <Card style={styles.container} padding="md">
            ...
            {DATE_PERIODS.map((period) => (
              <TouchableOpacity
                ...
                style={[
                  ...
                  {
                    backgroundColor:
                      filters.datePeriod === period.value ? colors.primary + "20" : colors.surface,
                    borderColor:
                      filters.datePeriod === period.value ? colors.primary : colors.border,
                  },
                ]}
              ...
              >
                <Ionicons
                  ...
                  size={16}
                  color={
                    filters.datePeriod === period.value ? colors.primary : colors.textSecondary
                  }
                />
                <Text
                  style={[
                    styles.chipText,
                    {
                      color: filters.datePeriod === period.value ? colors.primary : colors.text,
                    },
                  ]}
                >
                  {period.label}
        ...
        {filters.customDateRange && (
          <View style={[styles.customDateDisplay, { backgroundColor: colors.primaryLight + "40" }]}>
                    ...
                    styles.smallChip,
                    {
                      backgroundColor:
                        filters.paymentMethod === method.value
                          ...
                          : "transparent",
                      borderColor:
                        filters.paymentMethod === method.value ? colors.primary : colors.border,
                    },
                  ]}
                  onPress={() =>
                    onFiltersChange({
                ...
                >
                  <Text
                    style={[
                      ...
                      {
                        color:
                          filters.paymentMethod === method.value ? colors.primary : colors.text,
                      },
                    ]}
                  >
                    {method.label}
        ...
        <SafeAreaView style={styles.modalOverlay}>
          <View style={[styles.modalContent, { backgroundColor: colors.background }]}>
            <View style={[styles.modalHeader, { borderBottomColor: colors.border }]}>
              <Text style={[styles.modalTitle, { color: colors.text }]}>Selecione o Período</Text>
            ...
            <View style={styles.modalBody}>
              ...
              >
                <Text style={[styles.applyButtonText, { color: "#fff" }]}>Aplicar Período</Text>
              </TouchableOpacity>
            </View>
          </View>
        </SafeAreaView>
