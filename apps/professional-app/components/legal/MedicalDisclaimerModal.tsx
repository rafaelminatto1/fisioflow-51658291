    ...
    >
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerSubtitle}>Leia atentamente antes de continuar</Text>
        </View>
        ...
        <View style={styles.checkboxContainer}>
          ...
          >
            ...
            >
              Li e compreendi este aviso. Reconheço que sou totalmente responsável por todas as
              decisões clínicas.
            </Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.footer}>
          <TouchableOpacity
            style={[
              styles.button,
              (!hasScrolledToBottom || !hasAccepted || isLoading) && styles.buttonDisabled,
            ]}
