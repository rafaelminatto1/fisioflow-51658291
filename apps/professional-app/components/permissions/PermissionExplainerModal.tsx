...
> = {
  camera: {
    ...
    description:
      "O FisioFlow Pro precisa acessar sua câmera para facilitar seu atendimento clínico.",
    icon: "camera-outline",
    benefits: [
  ...
  photos: {
    ...
    description:
      "O acesso à sua galeria permite gerenciar arquivos importantes do seu histórico clínico.",
    icon: "images-outline",
    benefits: [
  ...
  location: {
    title: "Localização",
    description:
      "Sua localização é utilizada para otimizar a gestão da sua agenda e presença clínica.",
          ...
          <SafeAreaView>
            <View style={styles.content}>
              ...
              <View style={styles.footer}>
                <Button title="Permitir Acesso" onPress={onRequest} style={styles.actionButton} />
              ...
              <Text style={[styles.privacyNote, { color: colors.textMuted }]}>
                Seus dados são criptografados e nunca compartilhados com terceiros para fins de
                marketing.
              </Text>
            </View>
          </SafeAreaView>
