...
export function ExerciseTimer({
  ...
  const totalDuration =
    state === "exercising" ? holdSeconds || 0 : state === "resting" ? restSeconds : 0;
  const progress =
    totalDuration > 0 ? ((totalDuration - timeLeft) / totalDuration) * CIRCUMFERENCE : 0;
    ...
    >
      ...
      <View style={styles.ringContainer}>
        ...
        <View style={styles.ringContent}>
          <Text style={[styles.timerLabel, { color: stateColor }]}>{stateLabels[state]}</Text>
      ...
      <View style={styles.controls}>
        ...
        {(state === "exercising" || state === "resting") && (
          <>
            ...
            >
              ...
              <Text style={[styles.controlText, { color: colors.text }]}>Resetar</Text>
            </TouchableOpacity>
          </>
        )}
        ...
        {state === "complete" && (
          <TouchableOpacity
            style={[styles.controlBtn, { backgroundColor: STATE_COLORS.complete }]}
            onPress={handleReset}
