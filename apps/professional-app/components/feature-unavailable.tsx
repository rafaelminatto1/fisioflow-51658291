...
export function FeatureUnavailable({
  ...
  return (
    ...
    >
      ...
      <Text style={[styles.title, { color: colors.text }]}>Recurso Indisponível no Expo Go</Text>

      <Text style={[styles.featureName, { color: colors.primary }]}>{featureName}</Text>
      ...
      <View
        style={[styles.msgBox, { backgroundColor: colors.surface, borderColor: colors.border }]}
      >
        <Text style={[styles.msgText, { color: colors.text }]}>{defaultMessage}</Text>
      </View>
