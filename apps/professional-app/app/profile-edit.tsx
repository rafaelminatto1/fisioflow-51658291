...
export default function ProfileEditScreen() {
  ...
  const [activeSection, setActiveSection] = useState<"personal" | "clinic" | "schedule">(
    "personal",
  );
  ...
  const updateMutation = useMutation({
    mutationFn: (data: Partial<FormData>) => updateProfessionalProfile(user!.id, data),
        ...
        <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
              ...
              <View style={styles.inputGroup}>
                ...
                <TextInput
                  style={[
                    styles.input,
                    {
                      borderColor: errors.crefito ? colors.error : colors.border,
                      backgroundColor: colors.surface,
                    },
                  ]}
                ...
                />
                {errors.crefito && (
                  <Text style={[styles.errorText, { color: colors.error }]}>{errors.crefito}</Text>
                )}
              </View>
          ...
          <Card style={styles.dangerCard} padding="sm">
            ...
            >
              ...
              <Text style={[styles.dangerButtonText, { color: colors.error }]}>Alterar Senha</Text>
            </TouchableOpacity>
          </Card>
        </ScrollView>
      </KeyboardAvoidingView>
