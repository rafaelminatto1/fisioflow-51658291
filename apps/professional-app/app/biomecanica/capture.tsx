          ...
          {VIEWS.map((v) => {
            ...
            return (
              <Pressable
                key={v}
                onPress={() => setView(v)}
                style={[styles.vt, sel && styles.vtSel]}
              >
          ...
          <Pressable onPress={toggle}>
            ...
            <View style={styles.sheetHead}>
              ...
              <View style={styles.selNow}>
                ...
                {open ? (
                  <ChevronDown size={16} color={bio.primary} strokeWidth={2.4} />
                ) : (
                  <ChevronUp size={16} color={bio.primary} strokeWidth={2.4} />
                )}
              </View>
            </View>
          </Pressable>
          ...
          <View style={{ gap: 9 }}>
            {PROTOCOLS.map((p) => {
              ...
              return (
                <Pressable
                  key={p.name}
                  onPress={() => setProtocol(p.name)}
                  style={[styles.testOpt, sel && styles.testOptSel]}
                >
...
const styles = StyleSheet.create({
  ...
  plumb: {
    ...
    left: "50%",
    width: 1,
    backgroundColor: "hsla(45,93%,55%,0.45)",
  },
  joint: {
    position: "absolute",
    width: 11,
  ...
  calibChip: {
    ...
    paddingVertical: 8,
    borderRadius: 999,
    backgroundColor: "hsl(142,60%,16%)",
    borderWidth: 1,
    borderColor: "hsl(142,50%,32%)",
  },
  ...
  patientPa: {
    ...
    height: 36,
    borderRadius: 12,
    backgroundColor: bio.avatarBlue,
    alignItems: "center",
    justifyContent: "center",
  },
