        ...
        <GestureDetector gesture={pan}>
          <Pressable onPress={toggle}>
            ...
            <View style={styles.sheetHead}>
              ...
              {open ? (
                <ChevronDown size={18} color={bio.muted} />
              ) : (
                <ChevronUp size={18} color={bio.muted} />
              )}
            </View>
          </Pressable>
        </GestureDetector>
            ...
            <View style={styles.protocolResult}>
              ...
              <View style={{ flex: 1 }}>
                ...
                <Text style={styles.resultDesc}>
                  Aguardando finalização para processar diagnóstico completo do Brain.
                </Text>
              </View>
            </View>
          </View>
              ...
              >
                {saving ? (
                  ...
                  <>
                    ...
                    <Text style={styles.saveText}>Finalizar e Prescrever</Text>
                  </>
                )}
              </Pressable>
            </View>
        ...
        <View style={styles.modalRoot}>
          <Animated.View entering={SlideInDown} style={styles.modalCard}>
            ...
            <Text style={styles.modalIntro}>
              Com base na análise de {protocol.toLowerCase()}, sugiro atualizar o plano:
            </Text>
