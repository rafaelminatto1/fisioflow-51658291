  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Text style={[styles.headerTitle, { color: colors.text }]}>Comunicações</Text>
      </View>
        ...
        {TABS.map((tab) => {
          ...
          return (
            ...
            >
              ...
              />
              <Text
                style={[styles.segmentLabel, { color: isActive ? "#fff" : colors.textSecondary }]}
              >
                {tab.label}
              </Text>
            </TouchableOpacity>
...
function WhatsAppPlaceholder({ colors }: { colors: any }) {
  return (
    <View style={styles.placeholder}>
      ...
      <Text style={[styles.placeholderTitle, { color: colors.text }]}>WhatsApp Business</Text>
...
function MessagesPlaceholder({ colors }: { colors: any }) {
  return (
    <View style={styles.placeholder}>
      ...
      <Text style={[styles.placeholderTitle, { color: colors.text }]}>Mensagens Internas</Text>
      <Text style={[styles.placeholderDesc, { color: colors.textSecondary }]}>
