    ...
    return (
      ...
      >
        <View style={styles.errorContainer}>
          ...
          <Text style={[styles.errorTitle, { color: colors.text }]}>Não foi possível carregar</Text>
      ...
      >
        ...
        {isLoading && !refreshing ? (
          ...
          <>
            ...
            {upcomingAppointments.length === 0 ? (
              ...
              >
                {upcomingAppointments.map((apt) => (
                  <TouchableOpacity
                    key={apt.id}
                    onPress={() => router.push(`/appointment-form?id=${apt.id}`)}
                    activeOpacity={0.7}
                  >
                    <Card
                      style={[styles.appointmentCard, { backgroundColor: colors.surface }] as any}
                    >
                      ...
                      >
                        <Text
                          style={[styles.appointmentType, { color: colors.primary }]}
                          numberOfLines={1}
                        >
                          {apt.type}
                        </Text>
                    ...
                    >
                      <View style={styles.exerciseCardHeader}>
                        {ex.imageUrl ? (
                          ...
                          <View
                            style={[
                              styles.exerciseMiniPlaceholder,
                        ...
                        >
                          ...
                          <Text style={styles.miniDifficultyText}>
                            {ex.difficulty === "easy" || ex.difficulty === "iniciante"
                              ? "FÁCIL"
                              : ex.difficulty === "medium" || ex.difficulty === "intermediario"
                                ? "MÉDIO"
                                : "DIFÍCIL"}
                          </Text>
                        </View>
            ...
            <View style={styles.sectionHeader}>
              <Text style={[styles.sectionTitle, { color: colors.text }]}>Protocolos Recentes</Text>
              <TouchableOpacity onPress={() => router.push("/protocols")} style={styles.seeAllBtn}>
                  ...
                  >
                    ...
                    >
                      ...
                      <View style={styles.protocolMeta}>
                        <Text
                          style={[styles.protocolCategory, { color: colors.primary }]}
                          numberOfLines={1}
                        >
                          {p.category}
                        </Text>
                        ...
                        <Text
                          style={[styles.protocolCondition, { color: colors.textSecondary }]}
                          numberOfLines={1}
                        >
                          {p.condition || "Geral"}
                        </Text>
            ...
            {recentPatients.length === 0 ? (
              ...
              <View style={styles.patientListContainer}>
                {recentPatients.map((p) => (
                  ...
                  >
                    <Card
                      style={[styles.patientListItem, { backgroundColor: colors.surface }] as any}
                    >
                      <View
                        style={[
                      ...
                      <View style={styles.patientInfo}>
                        <Text
                          style={[styles.patientNameList, { color: colors.text }]}
                          numberOfLines={1}
                        >
                          {p.name}
                        </Text>
