      ...
      >
        <Card style={styles.leadCard}>
          <View style={styles.leadHeader}>
            <View
              style={[styles.leadAvatar, { backgroundColor: STATUS_COLORS[lead.estagio] + "18" }]}
            >
              <Ionicons name="person-outline" size={20} color={STATUS_COLORS[lead.estagio]} />
            </View>
          ...
          {lead.interesse && (
            <Text style={[styles.interestText, { color: colors.textSecondary }]} numberOfLines={2}>
              {lead.interesse}
            </Text>
          )}
      ...
      <View style={styles.skeletonStatsRow}>
        {[1, 2, 3].map((i) => (
          <View key={i} style={styles.skeletonStat}>
            ...
            <Skeleton width={40} height={20} variant="text" style={{ marginTop: 6 }} />
      ...
      <View style={[styles.searchContainer, { borderBottomColor: colors.border }]}>
        ...
        >
          {statusOptions.map((status) => {
            ...
            const stageColor = status !== "todos" ? STATUS_COLORS[stageKey] : colors.primary;
            return (
              <TouchableOpacity
                key={status}
                onPress={() => {
