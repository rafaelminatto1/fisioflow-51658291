      ...
      <View style={styles.searchContainer}>
        <View style={[styles.searchBar, { backgroundColor: colors.surface, borderColor: colors.border }]}>
          ...
          {searchQuery.length > 0 && (
            <TouchableOpacity onPress={() => { light(); setSearchQuery(''); }}>
        ...
        <TouchableOpacity
          ...
          onPress={() => { light(); router.push('/patient-form'); }}
          ...
          <View style={styles.listContainer}>
            {filteredPatients.map((patient) => (
              <TouchableOpacity
                key={patient.id}
                activeOpacity={0.7}
                onPress={() => { light(); router.push(`/patient/${patient.id}`); }}
              >
...
const styles = StyleSheet.create({
  ...
  conditionBadge: { alignSelf: 'flex-start', paddingHorizontal: 8, paddingVertical: 2, borderRadius: 6 },
  ...
  emptyBtn: {
    marginTop: 12, paddingHorizontal: 24, paddingVertical: 10, borderRadius: 10,
  },
