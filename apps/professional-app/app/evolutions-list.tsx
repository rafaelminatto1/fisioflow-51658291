        ...
        >
          {isDuplicating ? (
            ...
            <>
              ...
              <Text style={[styles.footerBtnText, { color: colors.textSecondary }]}>Duplicar</Text>
            </>
          )}
        </TouchableOpacity>
...
function PaginationBar({
  ...
  return (
    <View
      style={[styles.pagination, { backgroundColor: colors.surface, borderColor: colors.border }]}
    >
      <TouchableOpacity
        onPress={() => {
          medium();
      ...
      >
        ...
        />
        <Text
          style={[styles.pageBtnText, { color: hasPrevPage ? colors.primary : colors.textMuted }]}
        >
          Anterior
        </Text>
      </TouchableOpacity>
      ...
      >
        <Text
          style={[styles.pageBtnText, { color: hasNextPage ? colors.primary : colors.textMuted }]}
        >
          Próxima
        </Text>
        <Ionicons
