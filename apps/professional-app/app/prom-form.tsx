...
const SCALE_QUESTIONS: Record<string, ScaleQuestion[]> = {
  ...
  DASH: [{ id: "score", label: "Pontuação total DASH (0–100)", type: "slider", min: 0, max: 100 }],
  OSWESTRY: [
    { id: "score", label: "Pontuação Oswestry (0–100%)", type: "slider", min: 0, max: 100 },
  ],
  NDI: [{ id: "score", label: "Pontuação NDI (0–100%)", type: "slider", min: 0, max: 100 }],
  LEFS: [{ id: "score", label: "Pontuação LEFS (0–80)", type: "slider", min: 0, max: 80 }],
  BERG: [{ id: "score", label: "Pontuação Berg Balance (0–56)", type: "slider", min: 0, max: 56 }],
};
      ...
      >
        <ScrollView contentContainerStyle={styles.content}>
          ...
          >
            ...
            {patientName && (
              <Text style={[styles.infoPatient, { color: colors.primary }]}>
                ...
                >
                  {q.options.map((opt) => {
                    ...
                    return (
                      ...
                      >
                        <Text
                          style={[styles.optionText, { color: selected ? "#fff" : colors.text }]}
                        >
                          {opt.label}
                        </Text>
                      </TouchableOpacity>
          ...
          {allAnswered && (
            ...
            >
              <Text style={[styles.scorePreviewLabel, { color: colors.textSecondary }]}>
                Score calculado
              </Text>
