          ...
          <View style={styles.dateRow}>
            ...
            <View style={styles.dateItem}>
              ...
              <Text style={[styles.dateValue, { color: overdue ? "#dc2626" : colors.text }]}>
                {overdue ? "⚠ " : ""}
                {formatDateFull(tarefa.data_vencimento ?? undefined)}
              </Text>
            </View>
            {tarefa.completed_at && (
              <View style={styles.dateItem}>
                  ...
                  <View key={cl.id} style={[styles.checklist, { borderColor: colors.border }]}>
                    <View style={[styles.checklistHeader, { backgroundColor: colors.surface }]}>
                      ...
                      <Text
                        style={[
                          ...
                          {
                            color:
                              done === cl.items.length && cl.items.length > 0
                                ? "#16a34a"
                                : colors.textMuted,
                          },
                        ]}
                    ...
                    <View style={[styles.addItemRow, { borderColor: colors.border }]}>
                      <TextInput
                        ...
                        onChangeText={(v) => setNewItemText((prev) => ({ ...prev, [cl.id]: v }))}
                      ...
                      {isAddingHere ? (
                        ...
                        <TouchableOpacity
                          ...
                          style={{
                            opacity: (newItemText[cl.id] ?? "").trim() ? 1 : 0.3,
                            padding: 4,
                          }}
                        >
