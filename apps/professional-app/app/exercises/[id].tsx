...
export default function ExerciseDetailScreen() {
  ...
  const scientificReferences: ScientificReference[] = Array.isArray(exercise.scientific_references)
      ...
      <ScrollView>
        ...
        <View style={styles.content}>
          ...
          {exercise.indicated_pathologies && exercise.indicated_pathologies.length > 0 && (
            <View style={styles.section}>
              <Text style={[styles.sectionTitle, { color: colors.text }]}>Indicações</Text>
              <View style={styles.pathologyContainer}>
                {exercise.indicated_pathologies.map((path, idx) => (
                  <View
                    key={idx}
                    style={[styles.pathologyTag, { backgroundColor: colors.surface }]}
                  >
          ...
          {scientificReferences.length > 0 && (
            <View style={styles.section}>
              <Text style={[styles.sectionTitle, { color: colors.text }]}>Base Científica</Text>
              {scientificReferences.map((ref, idx) => (
                ...
                >
                  ...
                  <View style={{ flex: 1 }}>
                    ...
                    {ref.url && (
                      <Text style={{ color: colors.primary, fontSize: 12 }}>Ver Evidência</Text>
                    )}
                  </View>
                </TouchableOpacity>
              ))}
