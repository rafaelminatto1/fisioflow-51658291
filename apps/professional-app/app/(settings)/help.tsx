...
const FAQS = [
  {
    ...
    answer:
      "O FisioFlow utiliza criptografia AES-256 para dados em repouso e TLS 1.3 para dados em trânsito. Suas evoluções SOAP possuem criptografia de ponta a ponta, garantindo que apenas você tenha acesso ao conteúdo clínico.",
  },
  {
    question: "O app está em conformidade com a LGPD?",
    answer:
      "Sim, o FisioFlow Professional foi desenvolvido seguindo todos os princípios da Lei Geral de Proteção de Dados (LGPD), incluindo o direito à portabilidade (exportação) e ao esquecimento (exclusão de conta).",
  },
  {
    question: "Como exportar os prontuários dos meus pacientes?",
    answer:
      "Acesse Configurações > Exportar Meus Dados. Você pode escolher o formato JSON ou PDF. O processamento é assíncrono e você receberá um aviso quando estiver pronto.",
  },
  {
    question: "Por que preciso de autenticação biométrica?",
    answer:
      "A biometria (Face ID ou Touch ID) adiciona uma camada extra de segurança necessária para o manuseio de dados sensíveis de saúde (PHI), impedindo acessos não autorizados mesmo se o celular estiver desbloqueado.",
  },
  {
    question: "Como faço para excluir minha conta?",
    answer:
      "Vá em Configurações > Excluir Minha Conta. Seguindo a LGPD, seus dados entrarão em um período de carência de 30 dias antes da remoção permanente.",
  },
];
