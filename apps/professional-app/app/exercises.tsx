				...
				<View style={styles.cardImageContainer}>
					...
					<View
						style={[
							...
							{
								backgroundColor:
									getDifficultyColor(exercise.difficulty || "") + "DD",
							},
						]}
					>
							...
							>
								...
								>
									{exercise.bodyParts && exercise.bodyParts.length > 0
										? exercise.bodyParts[0].charAt(0).toUpperCase() +
											exercise.bodyParts[0].slice(1)
										: "Geral"}
								</Text>
							</View>
						</View>
				...
				{selectedExercise && (
					<View style={styles.assignModalContent}>
						<View style={styles.modalHeaderInfo}>
							...
							<Text
								style={[styles.modalExerciseCat, { color: colors.primary }]}
							>
