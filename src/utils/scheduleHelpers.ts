...
export function generateTimeSlots(
	...
	while (
		isBeforeOrEqual(addMinutes(currentSlot, slotDuration), endDateTime) ||
		(isBeforeOrEqual(currentSlot, endDateTime) &&
			isEqual(currentSlot, endDateTime) === false &&
			isStoreOpenForSlot(currentSlot, slotDuration, endDateTime))
	) {
