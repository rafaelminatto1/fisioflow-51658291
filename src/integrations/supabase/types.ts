  ...
  public: {
    Tables: {
      ...
      google_sync_logs: {
        ...
        Relationships: [
          {
            foreignKeyName: "google_sync_logs_appointment_id_fkey"
            columns: ["appointment_id"]
            isOneToOne: false
            referencedRelation: "appointments"
            referencedColumns: ["id"]
      ...
      ml_training_data: {
        Row: {
          ...
          baseline_functional_score: number | null
          baseline_pain_level: number | null
          chronic_condition: boolean | null
          created_at: string
          data_collection_period_end: string | null
          data_collection_period_start: string | null
          functional_improvement_percentage: number | null
          gender: string | null
          home_exercise_compliance: number | null
          id: string
          outcome_category: string | null
          pain_reduction_percentage: number | null
          patient_hash: string
          patient_satisfaction_score: number | null
          portal_login_frequency: number | null
          primary_pathology: string | null
          session_frequency_weekly: number | null
          sessions_to_discharge: number | null
          total_sessions: number | null
      ...
      patient_challenges: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "patient_challenges_patient_id_fkey"
            columns: ["patient_id"]
            isOneToOne: false
            referencedRelation: "aniversariantes_mes"
            referencedColumns: ["id"]
      ...
      patient_goal_tracking: {
        Row: {
          achieved_at: string | null
          achievement_milestone: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "patient_goal_tracking_patient_id_fkey"
            columns: ["patient_id"]
            isOneToOne: false
            referencedRelation: "aniversariantes_mes"
            referencedColumns: ["id"]
      ...
      patient_insights: {
        Row: {
          ...
          comparison_benchmark_id: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "patient_insights_comparison_benchmark_id_fkey"
            columns: ["comparison_benchmark_id"]
            isOneToOne: false
            referencedRelation: "clinical_benchmarks"
            referencedColumns: ["id"]
          },
          {
      ...
      patient_lifecycle_events: {
        ...
        Relationships: [
          {
            foreignKeyName: "patient_lifecycle_events_patient_id_fkey"
            columns: ["patient_id"]
            isOneToOne: false
            referencedRelation: "aniversariantes_mes"
            referencedColumns: ["id"]
      ...
      patient_outcome_measures: {
        ...
        Relationships: [
          {
            foreignKeyName: "patient_outcome_measures_patient_id_fkey"
            columns: ["patient_id"]
            isOneToOne: false
            referencedRelation: "aniversariantes_mes"
            referencedColumns: ["id"]
      ...
      patient_predictions: {
        ...
        Relationships: [
          {
            foreignKeyName: "patient_predictions_patient_id_fkey"
            columns: ["patient_id"]
            isOneToOne: false
            referencedRelation: "aniversariantes_mes"
            referencedColumns: ["id"]
      ...
      patient_risk_scores: {
        Row: {
          ...
          patient_id: string
          poor_outcome_risk_score: number | null
      ...
      patient_session_metrics: {
        ...
        Relationships: [
          {
            foreignKeyName: "patient_session_metrics_patient_id_fkey"
            columns: ["patient_id"]
            isOneToOne: false
            referencedRelation: "aniversariantes_mes"
            referencedColumns: ["id"]
      ...
      recurring_appointment_occurrences: {
        Row: {
          appointment_id: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "recurring_appointment_occurrences_appointment_id_fkey"
            columns: ["appointment_id"]
            isOneToOne: false
            referencedRelation: "appointments"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "recurring_appointment_occurrences_canceled_by_fkey"
            columns: ["canceled_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "recurring_appointment_occurrences_series_id_fkey"
            columns: ["series_id"]
            isOneToOne: false
            referencedRelation: "active_recurring_series"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "recurring_appointment_occurrences_series_id_fkey"
            columns: ["series_id"]
            isOneToOne: false
            referencedRelation: "recurring_appointment_series"
            referencedColumns: ["id"]
          },
        ]
      }
      recurring_appointment_series: {
        ...
        Relationships: [
          {
            foreignKeyName: "recurring_appointment_series_canceled_by_fkey"
            columns: ["canceled_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "recurring_appointment_series_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "recurring_appointment_series_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "recurring_appointment_series_patient_id_fkey"
            columns: ["patient_id"]
            isOneToOne: false
            referencedRelation: "aniversariantes_mes"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "recurring_appointment_series_therapist_id_fkey"
            columns: ["therapist_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
      ...
      reward_redemptions: {
        ...
        Relationships: [
          {
            foreignKeyName: "reward_redemptions_patient_id_fkey"
            columns: ["patient_id"]
            isOneToOne: false
            referencedRelation: "aniversariantes_mes"
            referencedColumns: ["id"]
      ...
      session_attachments: {
        ...
        Relationships: [
          {
            foreignKeyName: "session_attachments_patient_id_fkey"
            columns: ["patient_id"]
            isOneToOne: false
            referencedRelation: "aniversariantes_mes"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "session_attachments_soap_record_id_fkey"
            columns: ["soap_record_id"]
            isOneToOne: false
            referencedRelation: "soap_records"
            referencedColumns: ["id"]
      ...
      soap_records: {
        Row: {
          ...
          status: Database["public"]["Enums"]["soap_status_enum"]
          subjective: string | null
          updated_at: string | null
        }
        Insert: {
    ...
    Functions: {
      analyze_performance_tables: { Args: never; Returns: undefined }
      calcular_lead_score: {
      ...
      generate_patient_report: {
        Args: { patient_id: string; report_type?: string }
        Returns: Json
      }
      ...
      get_active_sessions_for_patient: {
      ...
      get_patient_clinical_tests: {
        Args: { include_historical?: boolean; patient_id: string }
        Returns: {
          is_abnormal: boolean
          notes: string
          result_value: Json
      ...
      get_slow_queries: {
        Args: { min_calls?: number; min_ms?: number }
        Returns: {
          calls: number
          max_time: number
          mean_time: number
      ...
      meets_recurrence_criteria: {
        Args: {
          series: Database["public"]["Tables"]["recurring_appointment_series"]["Row"]
          target_date: string
        }
        Returns: boolean
      }
      ...
      warm_query_cache: { Args: never; Returns: undefined }
    }
    Enums: {
