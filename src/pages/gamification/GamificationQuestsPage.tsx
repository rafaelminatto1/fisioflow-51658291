...
export default function GamificationQuestsPage() {
  const { user } = useAuth();
  const { profile, dailyQuests, completeQuest, xpPerLevel } = useGamification(user?.id || "");
  ...
  const _totalXp = safeDailyQuests.reduce((sum, q) => sum + (q.completed ? q.xp : 0), 0);
    ...
    <PageLayout>
      <PageContainer>
        <PageHeader
          ...
          subtitle="Complete missões para ganhar XP e subir de nível"
        />
        <div className="min-h-screen bg-gray-50/50 pb-20">
          <div className="max-w-4xl mx-auto p-4 md:p-6 space-y-6">
            ...
            <Card
              className={
                allCompleted ? "bg-gradient-to-br from-green-50 to-emerald-50 border-green-200" : ""
              }
            >
              <div className="p-6">
                ...
                {allCompleted && (
                  ...
                  >
                    <p className="font-semibold">
                      🎉 Parabéns! Todas as missões diárias concluídas!
                    </p>
                  </motion.div>
                )}
              </div>
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            {quest.expires_at && (
                              <div className="flex items-center gap-1 mt-1 text-xs text-muted-foreground">
                                ...
                                Expira às{" "}
                                {new Date(quest.expires_at).toLocaleTimeString("pt-BR", {
                                  hour: "2-digit",
                                  minute: "2-digit",
                                })}
                              </div>
            ...
            <Card className="bg-gradient-to-br from-blue-50 to-indigo-50 border-blue-200">
              <div className="p-6">
                ...
                <p className="text-sm text-muted-foreground">
                  Complete as missões diárias todos os dias para manter sua sequência ativa e ganhar
                  bônus de XP a cada 3, 7 e 30 dias consecutivos!
                </p>
              </div>
            </Card>
          </div>
