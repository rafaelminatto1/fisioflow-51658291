...
export default function GamificationQuestsPage() {
	const { user } = useAuth();
	const { profile, dailyQuests, completeQuest, xpPerLevel } = useGamification(
		user?.id || "",
	);
                      ...
                      `}
													...
													<div className="flex-1 min-w-0">
														...
														{quest.expires_at && (
															<div className="flex items-center gap-1 mt-1 text-xs text-muted-foreground">
																...
																Expira às{" "}
																{new Date(quest.expires_at).toLocaleTimeString(
																	"pt-BR",
																	{
																		hour: "2-digit",
																		minute: "2-digit",
										...
										<Card className="p-8">
											<div className="flex flex-col items-center justify-center text-center text-muted-foreground">
												...
												<p className="text-sm mt-1">
													Volte mais tarde para novas missões diárias
												</p>
											</div>
										</Card>
									)}
						...
						<Card className="bg-gradient-to-br from-blue-50 to-indigo-50 border-blue-200">
							<div className="p-6">
								...
								<p className="text-sm text-muted-foreground">
									Complete as missões diárias todos os dias para manter sua
									sequência ativa e ganhar bônus de XP a cada 3, 7 e 30 dias
									consecutivos!
								</p>
							</div>
						</Card>
