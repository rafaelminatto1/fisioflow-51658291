...
import { Award, Search, Lock, CheckCircle2, Sparkles } from "lucide-react";
...
export default function GamificationAchievementsPage() {
  ...
  const [filterCategory, setFilterCategory] = useState<
    "all" | "sessions" | "exercises" | "streaks" | "social"
  >("all");
        ...
        <div className="max-w-6xl mx-auto p-4 md:p-6 space-y-6">
          ...
          <Card className="p-4">
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <Tabs
                value={filterStatus}
                onValueChange={(v) => setFilterStatus(v as "all" | "unlocked" | "locked")}
                className="w-auto"
              >
                <TabsList>
              ...
              <Tabs
                ...
                onValueChange={(v) =>
                  setFilterCategory(v as "all" | "sessions" | "exercises" | "streaks" | "social")
                }
                className="w-auto"
              >
                <TabsList>
          ...
          {filteredAchievements.length === 0 && (
            <div className="text-center py-16">
              ...
              <p className="text-muted-foreground text-lg">Nenhuma conquista encontrada</p>
