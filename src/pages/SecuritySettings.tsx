		...
		<PageLayout>
			<PageContainer>
				<PageHeader
					...
					subtitle="Gerencie configurações de segurança, privacidade e conformidade LGPD"
				/>
						...
						<TabsContent value="lgpd" className="space-y-4">
							<Card>
								<CardHeader>
									...
									<CardDescription>
										Gerencie suas autorizações conforme a Lei Geral de Proteção
										de Dados
									</CardDescription>
								</CardHeader>
								<CardContent>
							...
							<Card>
								...
								<CardContent>
									<div className="text-center text-muted-foreground py-8">
										...
										<p>
											Nenhum evento de segurança registrado nos últimos 7 dias
										</p>
									</div>
								</CardContent>
							</Card>
