		...
		<PageLayout>
			<PageContainer>
				<PageHeader
					...
					subtitle="Acesse o prontuário completo de cada paciente. Evoluções, anamnese e dados clínicos
                  ficam no perfil do paciente."
				/>
							...
							<div className="flex items-center justify-between">
								<div>
									...
									<CardDescription className="mt-1">
										Busque pelo nome e clique em &quot;Ver prontuário&quot; para
										abrir evoluções e dados clínicos.
									</CardDescription>
								</div>
								{patients.length > 0 && (
									<Button
