						...
						<Card className="bg-gradient-card border-border shadow-card">
							...
							<CardContent className="space-y-6">
								<div className="space-y-4">
									<div className="flex items-start gap-4 p-4 rounded-lg bg-muted/50">
										...
										<div className="space-y-2">
											...
											<p className="text-sm text-muted-foreground">
												Vá para o Google Cloud Console e crie um novo projeto ou
									...
									<div className="flex items-start gap-4 p-4 rounded-lg bg-muted/50">
										...
										<div className="space-y-2">
											...
											<p className="text-sm text-muted-foreground">
												Em "APIs & Services" → "Credentials", clique em "Create
												Credentials" → "OAuth client ID". Selecione "Web
												application" e adicione as URLs autorizadas.
											</p>
										</div>
									</div>
									...
									<div className="flex items-start gap-4 p-4 rounded-lg bg-muted/50">
										...
										<div className="space-y-2">
											...
											<p className="text-sm text-muted-foreground">
												...
												stack atual, isso deve ficar alinhado com Neon Auth e as
								...
								<div className="space-y-4">
									...
									<p className="text-sm text-muted-foreground">
										Adicione estas URLs nas "Authorized redirect URIs" no Google
										Cloud Console:
									</p>
