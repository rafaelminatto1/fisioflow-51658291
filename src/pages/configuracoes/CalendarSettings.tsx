  ...
  const handleImportFromGoogle = async () => {
    if (!isConnected) {
      toast.error("Google Calendar não conectado", {
        description: "Conecte sua conta nas configurações primeiro.",
      });
      return;
    }
    ...
    <PageLayout>
      <PageContainer>
        <PageHeader
          ...
          subtitle="Sincronize seus agendamentos automaticamente com o Google Calendar"
        />
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              ...
              <div className="grid gap-6 md:grid-cols-2">
                ...
                <Card className="bg-gradient-card border-border shadow-card">
                  <CardHeader>
                    ...
                    <CardDescription>Visualize o status atual da integração</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="flex items-center justify-between p-4 rounded-lg bg-muted/50">
                      <div className="flex items-center gap-3">
                        <div
                          className={`p-2 rounded-full ${isConnected ? "bg-success/20" : "bg-muted"}`}
                        >
                          {isConnected ? (
                        ...
                        <div className="space-y-3">
                          <div className="flex items-center gap-2 text-sm">
                            ...
                            <span className="font-medium">
                              {integration.calendar_email || "N/A"}
                            </span>
                          </div>
                ...
                <Card className="bg-gradient-card border-border shadow-card">
                  <CardHeader>
                    ...
                    <CardDescription>Gerencie a conexão com seu Google Calendar</CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    {!isConnected ? (
                      <>
                        <Alert>
                          ...
                          <AlertDescription>
                            Conecte seu Google Calendar para sincronizar automaticamente suas
                            consultas.
                          </AlertDescription>
                        </Alert>
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <p className="text-2xl font-bold">
                            {integration?.events_synced_count || 0}
                          </p>
            ...
            <TabsContent value="config" className="space-y-6 mt-6">
              <Card className="bg-gradient-card border-border shadow-card">
                <CardHeader>
                  ...
                  <CardDescription>Configure como os eventos são sincronizados</CardDescription>
                </CardHeader>
                    ...
                    <div className="flex items-start gap-3 p-4 rounded-lg bg-muted/30">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-muted-foreground mb-3">
                          Busque eventos do seu Google Calendar no período desejado e visualize a
                          lista.
                        </p>
                        <Button
                          variant="outline"
                        ...
                        {!isConnected && (
                          <p className="text-xs text-muted-foreground mt-2">
                            Conecte o Google Calendar na aba &quot;Configuração&quot; primeiro.
                          </p>
                        )}
                      </div>
                    </div>
                          ...
                          {importEvents.length > 0 && (
                            <ScrollArea className="h-[200px] rounded-md border p-3">
                              <p className="text-sm font-medium mb-2">
                                {importEvents.length} evento(s) encontrado(s)
                              </p>
                                ...
                                {importEvents.slice(0, 20).map((ev) => (
                                  <li key={ev.id} className="flex justify-between gap-2">
                                    ...
                                    <span className="shrink-0">
                                      {ev.start
                                        ? format(new Date(ev.start), "dd/MM HH:mm", {
                                            locale: ptBR,
                                          })
                                        : "—"}
                                    </span>
                              ...
                              {importEvents.length > 20 && (
                                <p className="text-xs text-muted-foreground mt-2">
                                  e mais {importEvents.length - 20} evento(s)
                                </p>
                              )}
                            </ScrollArea>
                          )}
            ...
            <TabsContent value="logs" className="space-y-6 mt-6">
              <Card className="bg-gradient-card border-border shadow-card">
                <CardHeader>
                  ...
                  <CardDescription>Acompanhe as últimas ações de sincronização</CardDescription>
                </CardHeader>
                <CardContent>
                  {isLoadingLogs ? (
            ...
            <TabsContent value="setup" className="space-y-6 mt-6">
              <Alert>
                ...
                <AlertDescription>
                  Esta seção é destinada à configuração inicial do sistema. A integração já está
                  pré-configurada para uso.
                </AlertDescription>
              </Alert>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-4 p-4 rounded-lg bg-muted/50">
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Vá para o Google Cloud Console e crie um novo projeto ou selecione um
                          existente.
                        </p>
                    ...
                    <div className="flex items-start gap-4 p-4 rounded-lg bg-muted/50">
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-muted-foreground">
                          No menu "APIs & Services" → "Library", busque por "Google Calendar API" e
                          habilite.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4 p-4 rounded-lg bg-muted/50">
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Vá em "APIs & Services" → "OAuth consent screen" e configure o tipo de
                          usuário como "Externo".
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4 p-4 rounded-lg bg-muted/50">
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Em "APIs & Services" → "Credentials", clique em "Create Credentials" →
                          "OAuth client ID". Selecione "Web application" e adicione as URLs
                          autorizadas.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-4 p-4 rounded-lg bg-muted/50">
                      ...
                      <div className="space-y-2">
                        <h4 className="font-medium">Configure no provedor de autenticação</h4>
                        <p className="text-sm text-muted-foreground">
                          Copie o CLIENT_ID e CLIENT_SECRET e configure no provedor
                          OAuth/autenticação usado pelo ambiente. No stack atual, isso deve ficar
                          alinhado com Neon Auth e as credenciais do Google Cloud.
                        </p>
                        <Button variant="outline" size="sm" asChild>
                          <a
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2 p-3 rounded-lg bg-muted/50 font-mono text-sm">
                        ...
                        <Button
                          ...
                          size="icon"
                          onClick={() =>
                            handleCopyToClipboard(`${window.location.origin}/__/auth/handler`)
                          }
                        >
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center gap-2 p-2 rounded bg-muted/50 font-mono text-xs">
                        ...
                        <Button
                          ...
                          className="h-6 w-6"
                          onClick={() =>
                            handleCopyToClipboard("https://www.googleapis.com/auth/calendar")
                          }
                        >
                      ...
                      <div className="flex items-center gap-2 p-2 rounded bg-muted/50 font-mono text-xs">
                        ...
                        <Button
                          ...
                          className="h-6 w-6"
                          onClick={() =>
                            handleCopyToClipboard("https://www.googleapis.com/auth/calendar.events")
                          }
                        >
                          <Copy className="h-3 w-3" />
                        </Button>
