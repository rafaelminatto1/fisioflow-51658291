					...
					>
											...
											<>
												...
												<div className="space-y-3">
													...
													<div className="flex items-center gap-2 text-sm">
														...
														<span className="font-medium">
															{integration.events_synced_count}
														</span>
													</div>
												</div>
											</>
										...
										{!isConnected ? (
											<>
												<Alert>
													...
													<AlertDescription>
														Conecte seu Google Calendar para sincronizar
														automaticamente suas consultas.
													</AlertDescription>
												</Alert>
								...
								<CardContent className="space-y-6">
									<div className="flex items-center justify-between">
										<div className="space-y-0.5">
											...
											<p className="text-sm text-muted-foreground">
												Sincronizar automaticamente quando um agendamento for
												criado ou alterado
											</p>
										</div>
										<Switch
									...
									<div className="flex items-center justify-between">
										<div className="space-y-0.5">
											<Label className="text-base">
												Enviar Eventos Automaticamente
											</Label>
											<p className="text-sm text-muted-foreground">
												Criar eventos no Google Calendar automaticamente ao
												agendar consultas
											</p>
										</div>
										<Switch
											...
											onCheckedChange={(checked) =>
												updateSettings({ autoSendEvents: checked })
											}
											disabled={isUpdating || !isConnected}
										/>
									</div>
									...
									<div className="space-y-2">
										...
										<Select
											...
											onValueChange={(value) =>
												updateSettings({ defaultCalendarId: value })
											}
											disabled={isUpdating || !isConnected}
										>
											<SelectTrigger>
											...
											<SelectContent>
												...
												<SelectItem value="fisioflow">
													FisioFlow - Agendamentos
												</SelectItem>
									...
									{!isConnected && (
										<Alert>
											...
											<AlertDescription>
												Conecte seu Google Calendar para ativar estas
												configurações.
											</AlertDescription>
										</Alert>
									)}
									...
									<div className="grid gap-4 md:grid-cols-2">
										<div className="flex items-start gap-3 p-4 rounded-lg bg-muted/50">
											...
											<div>
												...
												<p className="text-sm text-muted-foreground">
													Todos os agendamentos são enviados para o Google
													Calendar
												</p>
											</div>
										</div>
										...
										<div className="flex items-start gap-3 p-4 rounded-lg bg-muted/50">
											...
											<div>
												...
												<p className="text-sm text-muted-foreground">
													Alterações são refletidas automaticamente no
													calendário
												</p>
											</div>
										</div>
										...
										<div className="flex items-start gap-3 p-4 rounded-lg bg-muted/30">
											...
											<div className="flex-1">
												...
												<p className="text-sm text-muted-foreground mb-3">
													Busque eventos do seu Google Calendar no período
													desejado e visualize a lista.
												</p>
												<Button
													variant="outline"
													size="sm"
												...
												{!isConnected && (
													<p className="text-xs text-muted-foreground mt-2">
														Conecte o Google Calendar na aba
										...
										>
											<DialogContent className="max-w-lg">
												<DialogHeader>
													...
													<DialogDescription>
														Escolha o período e busque os eventos do seu Google
														Calendar.
													</DialogDescription>
												</DialogHeader>
									...
									{isLoadingLogs ? (
										...
										<div className="text-center py-8 text-muted-foreground">
											...
											<p className="text-sm mt-1">
												Conecte seu Google Calendar para começar
											</p>
										</div>
									) : (
						...
						<TabsContent value="setup" className="space-y-6 mt-6">
							<Alert>
								...
								<AlertDescription>
									Esta seção é destinada à configuração inicial do sistema. A
									integração já está pré-configurada para uso.
								</AlertDescription>
							</Alert>
							...
							<Card className="bg-gradient-card border-border shadow-card">
								...
								<CardContent className="space-y-6">
									<div className="space-y-4">
										<div className="flex items-start gap-4 p-4 rounded-lg bg-muted/50">
											...
											<div className="space-y-2">
												...
												<p className="text-sm text-muted-foreground">
													Vá para o Google Cloud Console e crie um novo projeto
										...
										<div className="flex items-start gap-4 p-4 rounded-lg bg-muted/50">
											...
											<div className="space-y-2">
												...
												<p className="text-sm text-muted-foreground">
													No menu "APIs & Services" → "Library", busque por
													"Google Calendar API" e habilite.
												</p>
											</div>
										</div>
										...
										<div className="flex items-start gap-4 p-4 rounded-lg bg-muted/50">
											...
											<div className="space-y-2">
												...
												<p className="text-sm text-muted-foreground">
													Vá em "APIs & Services" → "OAuth consent screen" e
										...
										<div className="flex items-start gap-4 p-4 rounded-lg bg-muted/50">
											...
											<div className="space-y-2">
												...
												<p className="text-sm text-muted-foreground">
													Em "APIs & Services" → "Credentials", clique em
													"Create Credentials" → "OAuth client ID". Selecione
													"Web application" e adicione as URLs autorizadas.
												</p>
											</div>
										</div>
										...
										<div className="flex items-start gap-4 p-4 rounded-lg bg-muted/50">
											...
											<div className="space-y-2">
												<h4 className="font-medium">
													Configure no provedor de autenticação
												</h4>
												<p className="text-sm text-muted-foreground">
													Copie o CLIENT_ID e CLIENT_SECRET e configure no
													provedor OAuth/autenticação usado pelo ambiente. No
													stack atual, isso deve ficar alinhado com Neon Auth e
													as credenciais do Google Cloud.
												</p>
												<Button variant="outline" size="sm" asChild>
													<a
									...
									<div className="space-y-4">
										...
										<p className="text-sm text-muted-foreground">
											Adicione estas URLs nas "Authorized redirect URIs" no
