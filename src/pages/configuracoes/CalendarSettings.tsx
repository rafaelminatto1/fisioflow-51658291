                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center gap-2 p-3 rounded-lg bg-muted/50 font-mono text-sm">
                      <span className="flex-1 truncate">https://ycvbtjfrchcyvmkvuocu.supabase.co/auth/v1/callback</span>
                      <Button 
                        variant="ghost" 
                        size="icon"
                        onClick={() => handleCopyToClipboard('https://ycvbtjfrchcyvmkvuocu.supabase.co/auth/v1/callback')}
                      >
