                          ...
                          <div className="flex items-center gap-3">
                            <div className="text-right">
                              <p className="font-bold text-green-600">
                                R${" "}
                                {(receita.valor * receita.quantidade).toLocaleString("pt-BR", {
                                  minimumFractionDigits: 2,
                                })}
                              </p>
            ...
            <div className="space-y-6">
                  ...
                  <div className="p-3 bg-green-50 dark:bg-green-950/30 rounded-lg">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <Badge className="bg-green-500">
                        +
                        {(((lucroOtimista - lucroAtual) / Math.abs(lucroAtual || 1)) * 100).toFixed(
                          0,
                        )}
                        %
                      </Badge>
                  ...
                  <div className="p-3 bg-red-50 dark:bg-red-950/30 rounded-lg">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <Badge variant="destructive">
                        {(
                          ((lucroPessimista - lucroAtual) / Math.abs(lucroAtual || 1)) *
                          100
                        ).toFixed(0)}
                        %
                      </Badge>
              ...
              <Card className="bg-blue-50 dark:bg-blue-950/30 border-blue-200 dark:border-blue-800">
                ...
                <CardContent className="text-sm text-blue-700 dark:text-blue-400 space-y-2">
                  {margemLucro < 30 && (
                    <p>
                      • Sua margem de lucro está baixa. Considere revisar preços ou reduzir custos.
                    </p>
                  )}
                  {taxaOcupacao > 80 && (
