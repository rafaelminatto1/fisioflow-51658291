      ...
      <div className="flex items-center justify-between">
                    ...
                    <Table>
                      <TableHeader className="bg-slate-50/50 dark:bg-slate-800/20">
                        <TableRow className="border-none">
                          <TableHead className="px-6 py-4 font-black text-[10px] uppercase tracking-widest">Nº Recibo</TableHead>
                          <TableHead className="px-6 py-4 font-black text-[10px] uppercase tracking-widest">Emissão</TableHead>
                          <TableHead className="px-6 py-4 font-black text-[10px] uppercase tracking-widest">Referência</TableHead>
                      ...
                      <TableBody>
                        {filteredRecibos.map((recibo) => {
                          ...
                          return (
                            <TableRow key={recibo.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-800/30 border-slate-50 dark:border-slate-800/50">
                              ...
                              <TableCell className="px-6 py-4 max-w-xs truncate font-bold text-slate-700 dark:text-slate-300">{recibo.referente}</TableCell>
              ...
              <CardContent className="p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <Label className="text-[10px] font-black uppercase text-slate-400 tracking-widest">CPF/CNPJ do Pagador</Label>
                      <Input
                  ...
                  <div className="space-y-2">
                    <Label className="text-[10px] font-black uppercase text-slate-400 tracking-widest">Referente a *</Label>
                    <Textarea
                  ...
                  <div className="flex items-center gap-4 p-4 rounded-2xl bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-800">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2">
                        ...
                        />
                        <Label htmlFor="usar-clinica" className="text-sm font-bold text-slate-700 dark:text-slate-300 cursor-pointer">
                  ...
                  <div className="flex gap-3 pt-4">
                    <Button type="submit" disabled={createRecibo.isPending} className="flex-1 rounded-xl h-12 bg-slate-900 text-white hover:bg-slate-800 dark:bg-white dark:text-slate-900 shadow-xl font-bold uppercase tracking-wider gap-2">
              ...
              <CardContent className="p-8 space-y-8">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                  <div className="space-y-1">
                    ...
                    <p className="font-bold text-slate-700 dark:text-slate-300">{clinicaConfig?.org?.name || 'Não configurado'}</p>
                  </div>
                  <div className="space-y-1">
                    <Label className="text-[10px] font-black uppercase text-slate-400 tracking-widest">Profissional Responsável</Label>
                    <p className="font-bold text-slate-700 dark:text-slate-300">{clinicaConfig?.profile?.full_name || 'Não configurado'}</p>
                  </div>
                </div>
              </CardContent>
            </Card>
        ...
        >
          <CustomModalHeader onClose={() => setPreviewRecibo(null)}>
            <div className="flex flex-col gap-1">
              <Badge className="w-fit rounded-lg bg-emerald-500/10 text-emerald-600 border-none uppercase text-[10px] font-black tracking-widest">Documento Digital</Badge>
          ...
          <CustomModalFooter isMobile={isMobile} className="bg-white dark:bg-slate-900 border-t border-slate-100 dark:border-slate-800">
            <Button variant="ghost" onClick={() => setPreviewRecibo(null)} className="rounded-xl h-11 px-6 font-bold text-slate-500 uppercase text-xs tracking-wider">
              Fechar
            </Button>
            <div className="flex-1" />
            {previewRecibo && (
        ...
        >
          ...
          <CustomModalBody className="p-6">
              <form id="quick-recibo-form" onSubmit={handleSubmit} className="space-y-6">
                <div className="space-y-2">
                  <Label className="text-[10px] font-black uppercase text-slate-400 tracking-widest">Valor Recebido (R$)*</Label>
                  <div className="relative">
                    <span className="absolute left-3 top-3 text-slate-400 font-black text-sm">R$</span>
                    <Input
                      type="number"
