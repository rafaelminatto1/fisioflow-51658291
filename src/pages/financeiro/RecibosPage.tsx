              ...
              <div className="grid grid-cols-1 gap-6">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setReceiptConfig({ ...receiptConfig, custom_issuer_name: e.target.value })
                    }
                    placeholder="Nome que aparecerá como emitente"
                    className="rounded-xl border-slate-200 dark:border-slate-800 h-11"
                  />
                  <p className="text-[10px] text-muted-foreground">
                    Padrão: {currentOrganization?.name}
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-[10px] text-muted-foreground">
                    Padrão: {clinicaConfig?.profile?.full_name}
                  </p>
                </div>
                ...
                <div className="space-y-4 pt-4 border-t border-slate-100 dark:border-slate-800">
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-xs text-muted-foreground">
                        Incluir selo de documento assinado digitalmente
                      </p>
                    </div>
                    <Switch
                      checked={receiptConfig.assinado_padrao}
                      onCheckedChange={(v) =>
                        setReceiptConfig({ ...receiptConfig, assinado_padrao: v })
                      }
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-xs text-muted-foreground">
                        Mostrar o texto informativo no rodapé do recibo
                      </p>
                    </div>
                    <Switch
                      checked={receiptConfig.show_disclaimer}
                      onCheckedChange={(v) =>
                        setReceiptConfig({ ...receiptConfig, show_disclaimer: v })
                      }
                    />
                  </div>
                </div>
                ...
                {receiptConfig.show_disclaimer && (
                  <div className="space-y-2 animate-in fade-in slide-in-from-top-2">
                    ...
                    <Textarea
                      ...
                      onChange={(e) =>
                        setReceiptConfig({ ...receiptConfig, disclaimer_text: e.target.value })
                      }
                      rows={3}
                      className="rounded-xl border-slate-200 dark:border-slate-800 resize-none bg-slate-50/50"
                    />
                    <p className="text-[10px] text-muted-foreground">
                      A Lei nº 14.063/2020 dispõe sobre o uso de assinaturas eletrônicas em
                      interações com entes públicos e em questões de saúde.
                    </p>
                  </div>
                )}
              </div>
