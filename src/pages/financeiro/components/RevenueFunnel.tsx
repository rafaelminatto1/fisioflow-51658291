    ...
    <Card>
      ...
      <CardContent>
        <div className="space-y-3">
          {funnelItems.map(({ label, value, color, deduct, highlight }) => (
            ...
            >
              ...
              <span
                className={`font-mono text-sm ${deduct ? "text-red-600" : highlight ? "text-primary" : "text-green-600"}`}
              >
                {deduct ? "- " : ""}R${" "}
        ...
        <p className="text-xs text-muted-foreground mt-3">
          * Impostos baseados em estimativa do Simples Nacional. Consulte seu contador.
        </p>
      </CardContent>
    </Card>
  );
