...
import { ReciboPreview, ReciboPDF, type ReciboData } from "@/components/financial/ReciboPDF";
...
export function ReciboDetailsModal({ previewRecibo, onClose, isMobile }: ReciboDetailsModalProps) {
  return (
    <CustomModal
      open={!!previewRecibo}
