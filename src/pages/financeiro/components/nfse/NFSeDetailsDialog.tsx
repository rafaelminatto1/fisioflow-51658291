          ...
          <div className="flex flex-col h-full bg-white dark:bg-slate-900">
              ...
              <div className="grid grid-cols-2 gap-10">
                <div className="space-y-1">
                  ...
                  <p className="font-bold text-slate-700 dark:text-slate-200">
                    {new Date(selectedNFSe.data_emissao).toLocaleString("pt-BR")}
                  </p>
                </div>
                  ...
                  <div className="space-y-4 relative z-10">
                    <div className="flex justify-between items-center text-xs font-black uppercase tracking-widest text-slate-400">
                      ...
                      <span className="text-white">
                        R${" "}
                        {selectedNFSe.valor.toLocaleString("pt-BR", { minimumFractionDigits: 2 })}
                      </span>
                    </div>
                    <div className="flex justify-between items-center text-xs font-black uppercase tracking-widest text-slate-400">
            ...
            <div className="p-10 pt-0 grid grid-cols-2 gap-4">
              <Button
                ...
                onClick={() =>
                  selectedNFSe.link_nfse && window.open(selectedNFSe.link_nfse, "_blank")
                }
              >
              ...
              selectedNFSe.status !== "falhou" ? (
                ...
                <Button
                  ...
                  onClick={() =>
                    selectedNFSe.link_danfse && window.open(selectedNFSe.link_danfse, "_blank")
                  }
