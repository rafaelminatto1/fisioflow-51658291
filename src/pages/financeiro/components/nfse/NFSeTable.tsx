				...
				<Table>
					...
					<TableBody>
						{isLoading ? (
							...
							nfses.map((nfse, idx) => {
								const status =
									statusConfig[nfse.status] || statusConfig.rascunho;
										...
										<TableCell className="px-10 py-8">
											<div className="flex flex-col gap-1">
												...
												<span className="text-[10px] font-black text-slate-400 uppercase tracking-widest">
													{new Date(nfse.data_emissao).toLocaleDateString(
														"pt-BR",
														{
															day: "2-digit",
															month: "short",
										...
										<TableCell className="px-8 py-8">
											...
											>
												<StatusIcon
													className={cn(
														"h-3.5 w-3.5",
														nfse.status === "aguardando_prefeitura"
															? "animate-spin"
															: "",
													)}
												/>
											...
											<div className="flex justify-end gap-2">
												{nfse.link_nfse && (
													<Button
														...
														onClick={() =>
															window.open(nfse.link_nfse, "_blank")
														}
													>
