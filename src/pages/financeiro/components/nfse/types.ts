...
export function normalizeNFSe(row: any): NFSe {
	return {
		...
		destinatario: {
			...
			cnpj_cpf: String(
				row.tomador_cpf_cnpj || row.destinatario?.cnpj_cpf || "",
			),
