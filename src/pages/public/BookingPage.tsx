				...
				toast({
					...
					description:
						error instanceof Error
							? error.message
							: "Não foi possível encontrar o profissional solicitado.",
					variant: "destructive",
				});
			} finally {
				setLoading(false);
		...
		try {
			...
			toast({
				...
				description:
					error instanceof Error
						? error.message
						: "Não foi possível realizar o agendamento. Tente novamente ou entre em contato.",
				variant: "destructive",
			});
		} finally {
			...
			<div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
				<Card className="w-full max-w-md text-center p-6">
					...
					<p className="text-muted-foreground">
						O link que você acessou parece estar incorreto ou expirado.
					</p>
				</Card>
			</div>
		);
				...
				<Card className="md:col-span-1 h-fit">
					<CardContent className="pt-6 flex flex-col items-center text-center">
						...
						<p className="text-sm text-muted-foreground mt-4 text-left w-full">
							{profile.bio ||
								"Bem-vindo ao meu agendamento online. Escolha um horário para sua consulta."}
						</p>
					</CardContent>
				</Card>
					...
					{step === 2 && (
						<>
							<CardHeader>
								...
								<CardDescription>
									Informe seus dados para finalizar o agendamento em{" "}
									{selectedDate &&
							...
							<CardContent className="space-y-4">
								...
								<div className="flex justify-between pt-4">
									...
									<Button
										...
										disabled={
											!formData.name || !formData.phone || bookingLoading
										}
									>
										{bookingLoading && (
					...
					{step === 3 && (
						<div className="p-8 flex flex-col items-center text-center space-y-4">
							...
							<p className="text-muted-foreground max-w-md">
								...
								<br />
								<br />
								Entraremos em contato pelo WhatsApp/Email para confirmar sua
								consulta em breve.
							</p>
