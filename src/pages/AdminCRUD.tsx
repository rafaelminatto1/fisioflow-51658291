		...
		<PageLayout>
			<PageContainer>
				<PageHeader
					...
					subtitle="Gerencie todas as entidades do sistema em um só lugar"
				/>
				<div className="container mx-auto p-6 space-y-6">
					...
					>
						...
						<TabsContent value="agendamentos" className="space-y-4">
							<Card className="p-6">
								<p className="text-muted-foreground text-center py-8">
									Use a página de{" "}
									<a href="/agenda" className="text-primary hover:underline">
										Agenda
									</a>{" "}
						...
						<TabsContent value="prontuarios" className="space-y-4">
							<Card className="p-6">
								<p className="text-muted-foreground text-center py-8">
									Acesse os prontuários através da página de{" "}
