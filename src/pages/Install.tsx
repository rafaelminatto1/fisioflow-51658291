...
export default function Install() {
	...
	return (
		<PageLayout>
			<PageContainer>
				<PageHeader
					title="Instale o FisioFlow"
					subtitle="Tenha acesso rápido e trabalhe offline"
				/>
									...
									<div className="space-y-4 p-4 border rounded-lg">
										...
										<ol className="space-y-3 text-sm">
											...
											<li className="flex gap-3">
												...
												<span>
													Role para baixo e toque em "Adicionar à Tela de
													Início"
												</span>
											</li>
											<li className="flex gap-3">
									...
									<div className="space-y-4 p-4 border rounded-lg">
										...
										<ol className="space-y-3 text-sm">
											<li className="flex gap-3">
												...
												<span>
													Toque no menu{" "}
													<MoreVertical className="inline h-4 w-4 mx-1" /> no
													navegador
												</span>
											</li>
											<li className="flex gap-3">
						...
						<CardContent className="space-y-3">
							<div className="flex items-start gap-3">
								...
								<div>
									...
									<p className="text-sm text-muted-foreground">
										O app se comporta como um aplicativo nativo, sem bordas do
										navegador
									</p>
								</div>
							</div>
							...
							<div className="flex items-start gap-3">
								...
								<div>
									...
									<p className="text-sm text-muted-foreground">
										Sempre tenha a versão mais recente sem precisar atualizar
										manualmente
									</p>
								</div>
							</div>
