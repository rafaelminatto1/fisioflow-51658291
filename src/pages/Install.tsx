...
import { Download, Smartphone, Wifi, Zap, Shield, Check, Share2, MoreVertical } from "lucide-react";
    ...
    <MainLayout>
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-xl text-muted-foreground">Tenha acesso rápido e trabalhe offline</p>
        </div>
                ...
                <div className="space-y-4 p-4 border rounded-lg">
                  ...
                  <ol className="space-y-3 text-sm">
                    <li className="flex gap-3">
                      ...
                      <span>
                        Toque no botão <Share2 className="inline h-4 w-4 mx-1" /> (compartilhar) na
