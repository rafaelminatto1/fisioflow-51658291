		...
		<PageLayout>
			<PageContainer>
				<PageHeader
					...
					subtitle="Envie WhatsApp para pacientes inativos e recupere atendimentos"
				/>
											...
											>
												<CardContent className="p-3 flex items-center gap-3">
													<Checkbox
														...
														disabled={isSent}
														onCheckedChange={() =>
															!isSent && handleToggle(patient.id)
														}
								...
								<CardContent className="px-4 pb-4 space-y-3">
									<div className="space-y-1.5">
										...
										<p className="text-[10px] text-muted-foreground">
											...
											para inserir o nome do paciente
										</p>
									</div>
									...
									<Button
										...
										disabled={
											unsentSelected.length === 0 || sendMutation.isPending
										}
									...
									<CardContent className="px-4 pb-4 space-y-2">
										{campaigns.slice(0, 5).map((c: Record<string, unknown>) => (
											<button
												...
												onClick={() =>
													setTemplate(
														(c.message_template as string) ?? template,
													)
												}
											>
