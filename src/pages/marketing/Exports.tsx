              ...
              <div className="flex flex-col md:flex-row gap-4">
                ...
                <div className="flex gap-2">
                  <Select
                    ...
                    onValueChange={(v: typeof filterAnonymized) => setFilterAnonymized(v)}
                  >
                        ...
                        <AlertDialog>
                          ...
                          <AlertDialogContent>
                            <AlertDialogHeader>
                              ...
                              <AlertDialogDescription>
                                Esta ação não pode ser desfeita. O arquivo será removido do
                                armazenamento e o registro será excluído permanentemente.
                              </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="text-sm">
                  ...
                  <p className="text-amber-800 dark:text-amber-200 mt-1">
                    Todas as exportações são armazenadas com registro de consentimento. Use apenas
                    conteúdo de pacientes que assinaram o Termo de Consentimento para Uso de Imagem
                    em Marketing. Anonimize sempre que possível.
                  </p>
                </div>
              </div>
            </CardContent>
