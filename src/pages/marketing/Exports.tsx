...
export default function MarketingExportsPage() {
	...
	const [filterAnonymized, setFilterAnonymized] = useState<
		"all" | "yes" | "no"
	>("all");
	const [filterType, setFilterType] = useState<"all" | "video_comparison">(
		"all",
	);
		...
		<PageLayout>
			<PageContainer>
				<PageHeader
					...
					subtitle="Histórico de conteúdos gerados para marketing"
					actions={
						<>
							<Button asChild>
						...
						<Card>
							...
							<CardContent>
								<div className="text-2xl font-bold">
									{
										exports.filter((e) => e.export_type === "video_comparison")
											.length
									}
								</div>
							</CardContent>
						...
						<CardContent className="p-4">
							<div className="flex flex-col md:flex-row gap-4">
								...
								<div className="flex gap-2">
									<Select
										value={filterAnonymized}
										onValueChange={(v: typeof filterAnonymized) =>
											setFilterAnonymized(v)
										}
									>
									...
									<Select
										value={filterType}
										onValueChange={(v: typeof filterType) => setFilterType(v)}
									>
										...
										<SelectContent>
											...
											<SelectItem value="video_comparison">
												Vídeo Comparativo
											</SelectItem>
										</SelectContent>
									</Select>
										...
										<div className="flex items-start justify-between gap-4">
											<div className="flex items-start gap-4 flex-1">
												...
												<div className="flex-1 min-w-0">
													...
													{exportItem.metrics_overlay &&
														exportItem.metrics_overlay.length > 0 && (
												...
												<AlertDialog>
													...
													<AlertDialogContent>
														<AlertDialogHeader>
															...
															<AlertDialogDescription>
																Esta ação não pode ser desfeita. O arquivo será
																removido do armazenamento e o registro será
							...
							<div className="flex items-start gap-3">
								...
								<div className="text-sm">
									...
									<p className="text-amber-800 dark:text-amber-200 mt-1">
										Todas as exportações são armazenadas com registro de
										consentimento. Use apenas conteúdo de pacientes que
										assinaram o Termo de Consentimento para Uso de Imagem em
										Marketing. Anonimize sempre que possível.
									</p>
								</div>
							</div>
						</CardContent>
