                ...
                {reviewConfig.enabled && (
                  <>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {["alta", "concluido", "melhorado"].map((status) => (
                          <Badge
                            key={status}
                            variant={
                              reviewConfig.trigger_status?.includes(status) ? "default" : "outline"
                            }
                    ...
                    <div className="space-y-2">
                      ...
                      />
                      <p className="text-xs text-muted-foreground">
                        O ID do local da sua clínica no Google Maps. Necessário para exibir reviews
                        no site.
                      </p>
                    </div>
                      ...
                      <div className="flex flex-wrap gap-2 mt-2">
                        {availableVariables.map((v) => (
                          <Badge
                            ...
                            onClick={() =>
                              setReviewConfig({
                                ...reviewConfig,
                                message_template: reviewConfig.message_template + v.variable,
                              })
                            }
                          >
                            + {v.variable}
                        ...
                        <Badge
                          ...
                          onClick={() =>
                            setReviewConfig({
                              ...reviewConfig,
                              message_template: reviewConfig.message_template + "{review_link}",
                            })
                          }
                        >
                          + {"{review_link}"}
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="text-sm">
                    ...
                    <p className="text-blue-800 dark:text-blue-200 mt-1">
                      O momento ideal para solicitar uma avaliação é quando o paciente relata
                      melhora significativa ou completa o tratamento. Personalize a mensagem para
                      soar genuína e não automatizada.
                    </p>
                  </div>
                </div>
              </CardContent>
          ...
          <TabsContent value="recall" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Reative pacientes que não retornam há muito tempo</CardDescription>
              </CardHeader>
              <CardContent className="space-y-6">
                {/* Existing Campaigns */}
                        ...
                        {availableVariables.map((v) => (
                          <Badge
                            ...
                            onClick={() =>
                              setBirthdayConfig({
                                ...birthdayConfig,
                                message_template: birthdayConfig.message_template + v.variable,
                              })
                            }
                          >
                            + {v.variable}
              ...
              <CardContent className="space-y-4">
                <div className="text-center py-8 border rounded-lg border-dashed">
                  ...
                  <p className="text-sm text-muted-foreground mb-4">
                    Crie uma página personalizada com seus links importantes para usar no Instagram
