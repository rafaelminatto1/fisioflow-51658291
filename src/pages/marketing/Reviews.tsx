...
import { Star, Search, ExternalLink, AlertCircle, Sparkles, Loader2 } from "lucide-react";
  ...
  const filteredReviews = useMemo(() => {
    ...
    if (searchTerm) {
      filtered = filtered.filter(
        (r) => accentIncludes(r.author, searchTerm) || accentIncludes(r.comment, searchTerm),
      );
    }
            ...
            <Card className="md:col-span-1">
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center gap-4">
                  <div className="text-4xl font-bold">{metrics.averageRating.toFixed(1)}</div>
            ...
            <Card className="md:col-span-2">
              ...
              <CardContent>
                <div className="space-y-2">
                  {[5, 4, 3, 2, 1].map((star) => {
                    const count =
                      metrics.ratingDistribution[star as keyof typeof metrics.ratingDistribution];
                    const percentage =
                      metrics.totalReviews > 0 ? (count / metrics.totalReviews) * 100 : 0;
                    return (
              ...
              <div className="flex flex-col md:flex-row gap-4">
                ...
                <div className="flex gap-2">
                  <Select
                    ...
                    onValueChange={(v) => setFilterRating(v === "all" ? "all" : (Number(v) as any))}
                  >
                    ...
                    <div className="flex items-start gap-4 flex-1">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <Badge
                            variant="outline"
                            className={cn("text-[10px] h-5", getRatingColor(review.rating))}
                          >
                            {review.rating}/5
                          </Badge>
                        </div>
