		...
		<div className="space-y-10 py-6">
						...
						<div className="flex flex-col md:flex-row items-center justify-between gap-8">
							<div className="space-y-4 text-center md:text-left">
								<div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 text-primary border border-primary/20">
									...
									<span className="text-[10px] font-black uppercase tracking-[0.2em]">Celebração de Hoje</span>
								</div>
								...
								<p className="text-slate-500 font-medium max-w-md">
									Hoje é um dia especial para seus pacientes. Aproveite para fortalecer o vínculo clínico com uma mensagem especial.
								</p>
							</div>
							...
							<div className="flex flex-wrap justify-center gap-4">
								{aniversariantesHoje.map((a) => (
									...
									>
										...
										<div className="pr-4">
											<p className="font-black text-slate-800 dark:text-white text-lg tracking-tight">{a.name}</p>
			...
			<div className="space-y-4">
				<div className="flex items-center justify-between px-2">
					<h3 className="text-[10px] font-black uppercase tracking-[0.3em] text-slate-400">Filtrar por Mês</h3>
					...
					<div className="p-4">
						{isLoading ? (
							<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 p-4">
								{[1, 2, 3, 4, 5, 6].map((i) => (
									<div key={i} className="h-32 w-full bg-slate-100 dark:bg-slate-800 rounded-3xl animate-pulse" />
								))}
							</div>
