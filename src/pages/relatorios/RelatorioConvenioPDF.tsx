...
export function RelatorioConvenioPDF({ data }: { data: RelatorioConvenioData }) {
  return (
    <Document>
      <Page size="A4" style={styles.page}>
        <View style={styles.header}>
          <Text style={styles.title}>RELATÓRIO DE ATENDIMENTO FISIOTERAPÊUTICO</Text>
          <Text style={styles.subtitle}>Para fins de reembolso junto a convênios médicos</Text>
