			...
			<div
				className={cn(
					...
					position === 1
						...
						: position === 2
							? "from-gray-400/10 to-gray-400/5 border-gray-400/30"
		...
		<PageLayout>
			<PageContainer>
				<PageHeader
					...
					subtitle="Análise de produtividade e resultados dos fisioterapeutas"
					actions={
						<>
							<Button
								variant="outline"
				...
				<div className="space-y-6">
					...
					<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
						<StatCard
							...
							changePositive={
								(data?.previousPeriodComparison.revenueChange || 0) > 0
							}
						...
						<StatCard
							...
							changePositive={
								(data?.previousPeriodComparison.retentionChange || 0) > 0
							}
					...
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Top performers do período selecionado
							</CardDescription>
						</CardHeader>
						<CardContent>
							{isLoading ? (
					...
					<div className="grid lg:grid-cols-2 gap-6">
						...
						<Card>
							<CardHeader>
								...
								<CardDescription>
									Comparativo de receita no período
								</CardDescription>
							</CardHeader>
							<CardContent>
								{isLoading ? (
					...
					<div className="grid lg:grid-cols-2 gap-6">
						...
						<Card>
							<CardHeader>
								...
								<CardDescription>
									Sessões, receita, retenção e satisfação
								</CardDescription>
							</CardHeader>
							<CardContent>
								{isLoading ? (
						...
						<Card>
							<CardHeader>
								...
								<CardDescription>
									Análise por tipo de tratamento
								</CardDescription>
							</CardHeader>
							<CardContent>
								{isLoading ? (
												...
												>
													...
													<td className="py-3 px-2">
														<div className="flex items-center justify-center gap-2">
															<Progress
																value={therapist.retentionRate}
																className="w-16 h-2"
															/>
															<span className="text-sm w-10">
																{therapist.retentionRate}%
															</span>
														</div>
													</td>
