...
const getStatusBadge = (status: string) => {
	...
	switch (s) {
		...
		case "cancelado":
			return (
				<Badge className="bg-slate-500/20 text-slate-700 border-slate-500/30">
					Cancelado
				</Badge>
			);
		case "agendado":
		...
		case "presenca_confirmada":
			return (
				<Badge className="bg-blue-900/20 text-blue-900 border-blue-900/30">
					Confirmado
				</Badge>
			);
		case "remarcar":
		...
		<PageLayout>
			<PageContainer>
				<PageHeader
					...
					subtitle="Análise detalhada de comparecimentos e faltas"
					actions={
						<>
							<Button
								variant="outline"
							...
							>
								<Download
									className={cn("h-4 w-4 mr-2", isExporting && "animate-pulse")}
								/>
								Exportar Excel
							</Button>
							<Button
				...
				<div className="space-y-6">
								...
								<div className="flex-1 min-w-[150px]">
									...
									>
										...
										<SelectContent>
											...
											<SelectItem value="presenca_confirmada">
												Confirmado
											</SelectItem>
										</SelectContent>
									</Select>
					...
					<div className="grid lg:grid-cols-3 gap-6">
						...
						<Card>
							<CardHeader>
								...
								<CardDescription>
									Realizado vs Faltou vs Cancelado
								</CardDescription>
							</CardHeader>
							<CardContent>
								{isLoading ? (
						...
						<Card className="lg:col-span-2">
							<CardHeader>
								...
								<CardDescription>
									Comparecimento e faltas por dia
								</CardDescription>
							</CardHeader>
							<CardContent>
								{isLoading ? (
					...
					<div className="grid lg:grid-cols-2 gap-6">
						...
						<Card>
							<CardHeader>
								...
								<CardDescription>
									Taxa de comparecimento nos últimos 6 meses
								</CardDescription>
							</CardHeader>
							<CardContent>
								{isLoading ? (
										...
										<tbody>
											{data?.therapistData.map((therapist) => (
												...
												>
													...
													<td className="text-center py-3 px-2 text-sm text-green-600">
														{therapist.attended}
													</td>
													<td className="text-center py-3 px-2 text-sm text-red-600">
														{therapist.noShow}
													</td>
													<td className="text-center py-3 px-2 text-sm text-yellow-600">
														{therapist.cancelled}
													</td>
					...
					<Card>
						<CardHeader>
							...
							<CardDescription>
								Clique em uma linha para ver mais detalhes
							</CardDescription>
						</CardHeader>
						<CardContent>
							{isLoading ? (
