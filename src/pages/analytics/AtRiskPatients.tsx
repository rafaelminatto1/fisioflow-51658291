      ...
      <div className="container max-w-7xl mx-auto py-6 md:py-10 space-y-8 px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
          ...
          <Card className={cn("rounded-xl border", riskConfig.critical.border)}>
            ...
            <CardContent>
              <p className={cn("text-3xl font-bold", riskConfig.critical.color)}>
                {stats.critical}
              </p>
          ...
          <Card className={cn("rounded-xl border", riskConfig.high.border)}>
            <CardHeader className="pb-2">
              <CardTitle
                className={cn("text-sm font-medium flex items-center gap-2", riskConfig.high.color)}
              >
          ...
          <Card className={cn("rounded-xl border", riskConfig.low.border)}>
            <CardHeader className="pb-2">
              <CardTitle
                className={cn("text-sm font-medium flex items-center gap-2", riskConfig.low.color)}
              >
