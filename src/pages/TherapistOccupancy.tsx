...
export default function TherapistOccupancyPage() {
	...
	const { data, isLoading, refetch, isFetching } = useTherapistOccupancy({
		period,
	});
	...
	return (
		<PageLayout>
			<PageContainer>
				<PageHeader
					title="Ocupação dos Fisioterapeutas"
					subtitle="Acompanhe a taxa de ocupação e produtividade da equipe"
					actions={
						<>
							<Select
								value={period}
							...
							>
								<SelectTrigger
									className="w-[180px]"
									data-testid="occupancy-period-select"
								>
					...
					<div className="grid lg:grid-cols-2 gap-6">
						...
						<Card>
							<CardHeader>
								...
								<CardDescription>
									Comparativo entre fisioterapeutas
								</CardDescription>
							</CardHeader>
							<CardContent>
								{isLoading ? (
						...
						<Card>
							<CardHeader>
								...
								<CardDescription>
									Distribuição de consultas ao longo do dia
								</CardDescription>
							</CardHeader>
							<CardContent>
								{isLoading ? (
					...
					<div className="grid lg:grid-cols-3 gap-6">
											...
											<tbody>
												{data?.therapists.map((therapist) => (
													<tr
														...
														data-testid="therapist-occupancy-row"
													>
														...
														<td className="text-center py-3 px-2 text-sm">
															{therapist.consultasHoje}
														</td>
														<td className="text-center py-3 px-2 text-sm">
															{therapist.horasTrabalhadas}h
														</td>
														<td className="text-center py-3 px-2 text-sm">
															{therapist.capacidadeHoras}h
														</td>
														<td className="py-3 px-2">
						...
						<Card>
							<CardHeader>
								...
								<CardDescription>
									Insights automáticos para melhorar a produtividade
								</CardDescription>
							</CardHeader>
							<CardContent>
								{isLoading ? (
