          ...
          <AlertDialogContent className="rounded-3xl">
            <AlertDialogHeader>
              ...
              <AlertDialogDescription className="font-medium">
                Tem certeza que deseja excluir este evento? Esta ação não pode ser desfeita e todos
                os dados relacionados (prestadores, participantes, checklist) serão removidos
                permanentemente.
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
