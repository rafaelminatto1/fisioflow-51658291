        ...
        <AlertDialogContent className="rounded-3xl">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="font-medium">
              Tem certeza que deseja excluir este evento? Esta ação não pode ser desfeita e todos os
              dados relacionados (prestadores, participantes, checklist) serão removidos
              permanentemente.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
      ...
      <div className="space-y-4 animate-fade-in pb-20 md:pb-0">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div className="flex items-center gap-3 min-w-0">
            ...
            <h1 className="text-base sm:text-lg font-semibold leading-tight">Eventos</h1>
          </div>
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            {canWrite("eventos") && (
              <Button size="sm" className="gap-1.5" onClick={() => setNewEventoOpen(true)}>
                      ...
                      <div className="flex items-center gap-2">
                        <Badge
                          className={cn(
                            ...
                            !evento.minimo_colaboradores || evento.minimo_colaboradores === 0
