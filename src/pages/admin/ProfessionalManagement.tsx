                          ...
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end" className="rounded-xl">
                              ...
                              {member.active ? (
                                ...
                                >
                                  <XCircle className="h-3.5 w-3.5" /> Desativar Acesso
                                </DropdownMenuItem>
                              ) : (
                                <DropdownMenuItem
                                  onClick={() =>
                                ...
                                >
                                  <CheckCircle2 className="h-3.5 w-3.5" /> Reativar Acesso
                                </DropdownMenuItem>
                              )}
                            </DropdownMenuContent>
                          </DropdownMenu>
              ...
              {selectedMember?.role === "fisioterapeuta" && !selectedMember?.user?.crefito && (
                <div className="p-3 rounded-lg bg-amber-50 text-amber-700 border border-amber-100 flex gap-2 items-start">
                  ...
                  <p className="text-[10px] font-bold leading-tight">
                    Este profissional ainda não preencheu o número do CREFITO no perfil dele. Peça
                    para que ele atualize os dados cadastrais.
                  </p>
                </div>
              )}
            </div>
