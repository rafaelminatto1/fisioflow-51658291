								...
								<DialogContent className="max-w-2xl">
									<DialogHeader>
										...
										<DialogDescription className="text-base">
											Templates permitem padronizar o acompanhamento de metas
											SMART para seus pacientes.
										</DialogDescription>
									</DialogHeader>
										...
										<div className="bg-slate-50 p-5 rounded-xl border border-slate-100 space-y-4">
											...
											<ul className="text-xs space-y-3 text-slate-600">
												...
												<li className="flex gap-2">
													...
													<span>
														<strong>Mensurável:</strong> Como mediremos o
														sucesso (métrica)?
													</span>
												</li>
												<li className="flex gap-2">
													...
													<span>
														<strong>Alcançável:</strong> A meta é realista para
														o paciente?
													</span>
												</li>
												<li className="flex gap-2">
						...
						<div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
							<div className="space-y-4 max-w-xl">
								...
								<p className="text-blue-100 opacity-90 leading-relaxed">
									...
									que cada plano de evolução seja específico, mensurável e
									...
									<div className="grid grid-cols-1 md:grid-cols-5 gap-8">
										<div className="space-y-3">
											...
											<p className="text-sm text-slate-500 leading-relaxed">
												...
												joelho para 120° visando independência em subir
												escadas".
											</p>
										</div>
										<div className="space-y-3">
										...
										<div className="space-y-3">
											...
											<p className="text-sm text-slate-500 leading-relaxed">
												A meta deve importar para o paciente. Deve estar
												conectada ao desejo de retorno funcional ou esportivo.
											</p>
										</div>
										<div className="space-y-3">
											...
											<p className="text-sm text-slate-500 leading-relaxed">
												Toda meta precisa de um prazo. "Em 4 semanas", "Até a
												12ª sessão". Isso cria senso de urgência e foco.
											</p>
										</div>
									</div>
											...
											<div className="space-y-1">
												...
												<p className="text-emerald-800 text-sm opacity-90 leading-relaxed">
													...
													**Biometria de Vídeo** (Análise Objetiva). Quando o
													paciente vê a evolução nos números e na tela, a
													retenção e o valor percebido do seu tratamento
