                ...
                <DialogContent className="max-w-2xl">
                  <DialogHeader>
                    ...
                    <DialogDescription className="text-base">
                      Templates permitem padronizar o acompanhamento de metas SMART para seus
                      pacientes.
                    </DialogDescription>
                  </DialogHeader>
            ...
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
              <div className="space-y-4 max-w-xl">
                ...
                <p className="text-blue-100 opacity-90 leading-relaxed">
                  Pacientes com metas bem definidas apresentam 40% mais engajamento no tratamento.
                  Use nossos templates para garantir que cada plano de evolução seja específico,
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-emerald-800 text-sm opacity-90 leading-relaxed">
                          ...
                          (Análise Objetiva). Quando o paciente vê a evolução nos números e na tela,
                          a retenção e o valor percebido do seu tratamento aumentam drasticamente.
                        </p>
                      </div>
                    </div>
                  </div>
