...
export default function GoalProfileListPage() {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case "PUBLISHED":
        return (
          <Badge className="bg-emerald-100 text-emerald-800 border-emerald-200">Publicado</Badge>
        );
      case "DRAFT":
        return (
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
          <div className="space-y-2">
            ...
            <p className="text-lg text-slate-500 max-w-2xl">
              Crie e gerencie templates de metas baseados em evidência científica (SMART) para
              elevar o padrão da sua análise clínica.
            </p>
          </div>
                ...
                <div className="bg-slate-50 p-5 rounded-xl border border-slate-100 space-y-4">
                  ...
                  <ul className="text-xs space-y-3 text-slate-600">
                    <li className="flex gap-2">
                      ...
                      <span>
                        <strong>Específica:</strong> O que exatamente será alcançado?
                      </span>
                    </li>
                    <li className="flex gap-2">
                      <span className="font-bold text-blue-600 min-w-[15px]">M</span>
                      <span>
                        <strong>Mensurável:</strong> Como mediremos o sucesso (métrica)?
                      </span>
                    </li>
                    <li className="flex gap-2">
                      <span className="font-bold text-blue-600 min-w-[15px]">A</span>
                      <span>
                        <strong>Alcançável:</strong> A meta é realista para o paciente?
                      </span>
                    </li>
                    <li className="flex gap-2">
                      <span className="font-bold text-blue-600 min-w-[15px]">R</span>
                      <span>
                        <strong>Relevante:</strong> Faz sentido para a patologia?
                      </span>
                    </li>
                    <li className="flex gap-2">
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="space-y-4 max-w-xl">
              ...
              <p className="text-blue-100 opacity-90 leading-relaxed">
                Pacientes com metas bem definidas apresentam 40% mais engajamento no tratamento. Use
                nossos templates para garantir que cada plano de evolução seja específico,
                mensurável e baseado em evidência.
              </p>
              <Button
                variant="outline"
                ...
                <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
                  <div className="space-y-3">
                    ...
                    <p className="text-sm text-slate-500 leading-relaxed">
                      Evite "melhorar força". Use: "Aumentar flexão ativa de joelho para 120°
                      visando independência em subir escadas".
                    </p>
                  </div>
                  <div className="space-y-3">
                    ...
                    <p className="text-sm text-slate-500 leading-relaxed">
                      Utilize métricas objetivas como ADM, Força (kg), Escalas (EVA/PROM) ou
                      indicadores de vídeo (valgo em graus).
                    </p>
                  </div>
                  <div className="space-y-3">
                    ...
                    <p className="text-sm text-slate-500 leading-relaxed">
                      A meta deve desafiar o paciente mas ser realisticamente possível dentro do
                      quadro clínico e biologia tecidual.
                    </p>
                  </div>
                  <div className="space-y-3">
                    ...
                    <p className="text-sm text-slate-500 leading-relaxed">
                      A meta deve importar para o paciente. Deve estar conectada ao desejo de
                      retorno funcional ou esportivo.
                    </p>
                  </div>
                  <div className="space-y-3">
                    ...
                    <p className="text-sm text-slate-500 leading-relaxed">
                      Toda meta precisa de um prazo. "Em 4 semanas", "Até a 12ª sessão". Isso cria
                      senso de urgência e foco.
                    </p>
                  </div>
                </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-emerald-800 text-sm opacity-90 leading-relaxed">
                        Combine **PROMs** (Percepção do Paciente) com **Biometria de Vídeo**
                        (Análise Objetiva). Quando o paciente vê a evolução nos números e na tela, a
                        retenção e o valor percebido do seu tratamento aumentam drasticamente.
                      </p>
                    </div>
                  </div>
                </div>
