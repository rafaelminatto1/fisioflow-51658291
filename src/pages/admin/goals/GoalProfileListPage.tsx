				...
				<div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
					<div className="space-y-2">
						...
						<p className="text-lg text-slate-500 max-w-2xl">
							Crie e gerencie templates de metas baseados em evidência
							científica (SMART) para elevar o padrão da sua análise clínica.
						</p>
					</div>
					...
					>
						<DialogTrigger asChild>
							<Button
								size="lg"
								className="bg-blue-600 hover:bg-blue-700 text-white shadow-lg shadow-blue-200 gap-2 h-12 px-6 rounded-xl transition-all hover:scale-[1.02]"
							>
						...
						<DialogContent className="max-w-2xl">
							<DialogHeader>
								<DialogTitle className="text-2xl">
									Criar Novo Template de Metas
								</DialogTitle>
								<DialogDescription className="text-base">
									Templates permitem padronizar o acompanhamento de metas SMART
									para seus pacientes.
								</DialogDescription>
							</DialogHeader>
								...
								<div className="space-y-4">
									<div className="grid gap-2">
										...
										<p className="text-[10px] text-muted-foreground uppercase tracking-tight">
											Identificador técnico sem espaços
										</p>
									</div>
									<div className="grid gap-2">
								...
								<div className="bg-slate-50 p-5 rounded-xl border border-slate-100 space-y-4">
									...
									<ul className="text-xs space-y-3 text-slate-600">
										<li className="flex gap-2">
											<span className="font-bold text-blue-600 min-w-[15px]">
												S
											</span>
											<span>
												<strong>Específica:</strong> O que exatamente será
												alcançado?
											</span>
										</li>
										<li className="flex gap-2">
											...
											<span>
												<strong>Mensurável:</strong> Como mediremos o sucesso
												(métrica)?
											</span>
										</li>
										<li className="flex gap-2">
											...
											<span>
												<strong>Alcançável:</strong> A meta é realista para o
												paciente?
											</span>
										</li>
										<li className="flex gap-2">
											...
											<span>
												<strong>Relevante:</strong> Faz sentido para a
												patologia?
											</span>
										</li>
										<li className="flex gap-2">
											...
											<span>
												<strong>Temporal:</strong> Qual o prazo esperado?
											</span>
										</li>
									</ul>
								</div>
						...
						{GOAL_PROFILES_SEED.slice(0, 4).map((seed) => (
							...
							>
								<CardHeader className="p-4 pb-2">
									...
									<CardTitle className="text-sm font-bold group-hover:text-blue-700 transition-colors">
										{seed.name}
									</CardTitle>
								</CardHeader>
					...
					{isLoading ? (
						<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
							{[1, 2, 3].map((i) => (
								<Card
									key={i}
									className="h-48 animate-pulse bg-slate-100 border-none"
								/>
							))}
						</div>
									...
									<CardContent className="flex-grow pt-0 pb-6">
										<div className="flex items-center gap-4 text-xs text-slate-400 border-t border-slate-50 pt-4">
											...
											<div className="flex items-center gap-1.5">
												...
												<span>
													{format(new Date(p.updated_at), "dd MMM yy")}
												</span>
											</div>
										</div>
									</CardContent>
					...
					<div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
						<div className="space-y-4 max-w-xl">
							<h3 className="text-2xl font-bold flex items-center gap-2">
								<Info className="w-6 h-6" />O Poder das Metas SMART
							</h3>
							<p className="text-blue-100 opacity-90 leading-relaxed">
								Pacientes com metas bem definidas apresentam 40% mais
								engajamento no tratamento. Use nossos templates para garantir
								que cada plano de evolução seja específico, mensurável e baseado
								em evidência.
							</p>
							<Button
								variant="outline"
							...
							<div className="space-y-4 relative z-20">
								<div className="flex items-center gap-3">
									<div className="w-10 h-10 rounded-full bg-emerald-400/20 flex items-center justify-center">
										<Badge className="bg-emerald-400 text-slate-900 border-none">
											95%
										</Badge>
									</div>
								...
								<div className="flex items-center gap-3">
									<div className="w-10 h-10 rounded-full bg-amber-400/20 flex items-center justify-center">
										<Badge className="bg-amber-400 text-slate-900 border-none">
						...
						<Card className="border-none shadow-xl bg-white overflow-hidden">
							<CardHeader className="bg-slate-50/50 border-b border-slate-100">
								...
								<CardDescription className="text-base">
									Aprenda a estruturar objetivos clínicos que transformam a
									adesão do paciente.
								</CardDescription>
							</CardHeader>
							<CardContent className="p-8">
								<div className="grid grid-cols-1 md:grid-cols-5 gap-8">
									<div className="space-y-3">
										<div className="w-12 h-12 rounded-2xl bg-blue-600 text-white flex items-center justify-center text-xl font-bold shadow-lg shadow-blue-200">
											S
										</div>
										<h4 className="font-bold text-slate-800">Específica</h4>
										<p className="text-sm text-slate-500 leading-relaxed">
											Evite "melhorar força". Use: "Aumentar flexão ativa de
											joelho para 120° visando independência em subir escadas".
										</p>
									</div>
									<div className="space-y-3">
										<div className="w-12 h-12 rounded-2xl bg-blue-500 text-white flex items-center justify-center text-xl font-bold shadow-lg shadow-blue-200">
											M
										</div>
										<h4 className="font-bold text-slate-800">Mensurável</h4>
										<p className="text-sm text-slate-500 leading-relaxed">
											Utilize métricas objetivas como ADM, Força (kg), Escalas
											(EVA/PROM) ou indicadores de vídeo (valgo em graus).
										</p>
									</div>
									<div className="space-y-3">
										<div className="w-12 h-12 rounded-2xl bg-blue-400 text-white flex items-center justify-center text-xl font-bold shadow-lg shadow-blue-100">
											A
										</div>
										<h4 className="font-bold text-slate-800">Alcançável</h4>
										<p className="text-sm text-slate-500 leading-relaxed">
											A meta deve desafiar o paciente mas ser realisticamente
											possível dentro do quadro clínico e biologia tecidual.
										</p>
									</div>
									<div className="space-y-3">
										<div className="w-12 h-12 rounded-2xl bg-blue-300 text-white flex items-center justify-center text-xl font-bold shadow-lg shadow-blue-50">
											R
										</div>
										<h4 className="font-bold text-slate-800">Relevante</h4>
										<p className="text-sm text-slate-500 leading-relaxed">
											A meta deve importar para o paciente. Deve estar conectada
											ao desejo de retorno funcional ou esportivo.
										</p>
									</div>
									<div className="space-y-3">
										<div className="w-12 h-12 rounded-2xl bg-slate-800 text-white flex items-center justify-center text-xl font-bold shadow-lg shadow-slate-200">
											T
										</div>
										<h4 className="font-bold text-slate-800">Temporal</h4>
										<p className="text-sm text-slate-500 leading-relaxed">
											Toda meta precisa de um prazo. "Em 4 semanas", "Até a 12ª
											sessão". Isso cria senso de urgência e foco.
										</p>
									</div>
								</div>
									...
									<div className="flex items-start gap-4">
										...
										<div className="space-y-1">
											...
											<p className="text-emerald-800 text-sm opacity-90 leading-relaxed">
												Combine **PROMs** (Percepção do Paciente) com
												**Biometria de Vídeo** (Análise Objetiva). Quando o
												paciente vê a evolução nos números e na tela, a retenção
												e o valor percebido do seu tratamento aumentam
												drasticamente.
											</p>
										</div>
									</div>
