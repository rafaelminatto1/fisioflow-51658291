          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white p-6 rounded-2xl border border-slate-100 shadow-sm space-y-4">
              ...
              <p className="text-xs text-slate-500 leading-relaxed">
                Para metas de retorno ao esporte (RTS), combine sempre métricas de{" "}
                <strong>percepção subjetiva</strong> (PROMs) com <strong>biomecânica</strong>.
              </p>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-slate-500">
                      Defina quais métricas o sistema deve monitorar para este template.
                    </p>
                  </div>
                  <Button
                    variant="outline"
                    ...
                    <div className="flex flex-col items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-slate-500 max-w-xs mx-auto">
                          Adicione métricas para que o sistema possa analisar automaticamente o
                              ...
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 flex-1 mr-4">
                                ...
                                <div className="space-y-1.5">
                                  ...
                                  <Select
                                    value={target.mode}
                                    onValueChange={(val) =>
                                      updateTarget(index, "mode", val as TargetMode)
                                    }
                                  >
                                    <SelectTrigger className="rounded-lg h-10 border-slate-200 focus:ring-blue-100">
                                      <SelectValue />
            ...
            {activeTab === "metadata" && (
              <Card className="border-slate-100 shadow-sm rounded-2xl overflow-hidden bg-white">
                <CardHeader className="bg-slate-50/50 border-b border-slate-100 p-6">
                  ...
                  <CardDescription>
                    Estes detalhes ajudam a identificar e selecionar o template no prontuário.
                  </CardDescription>
                </CardHeader>
