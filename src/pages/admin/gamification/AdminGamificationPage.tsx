		...
		<PageLayout>
			<PageContainer>
				<PageHeader
					...
					subtitle="Configure missões, conquistas, recompensas e desafios para engajar seus pacientes."
				/>
				<div className="p-6 max-w-7xl mx-auto space-y-8">
					...
					>
						<TabsList className="grid w-full grid-cols-3 lg:grid-cols-9 h-auto gap-1">
							<TabsTrigger
								value="dashboard"
								className="gap-2 flex-col h-auto py-3 data-[state=active]:bg-primary/10"
							>
