            ...
            <div className="space-y-6">
              ...
              <div className="grid gap-3 sm:grid-cols-4">
                ...
                <div className="rounded-2xl border border-white/12 bg-white/10 p-4 backdrop-blur-sm">
                  ...
                  <div className="mt-2 text-3xl font-semibold">{recentBoards.length}</div>
                </div>
              </div>
            </div>
        ...
        {allBoards.length === 0 ? (
          ...
          <div className="grid gap-6 xl:grid-cols-[280px_minmax(0,1fr)]">
            <aside className="space-y-4">
              ...
              <Card className="rounded-[28px] border-border/60 shadow-sm">
                <CardHeader className="pb-3">
                  <CardTitle className="text-sm font-semibold">Atualizados recentemente</CardTitle>
                </CardHeader>
              ...
              <Card className="rounded-[28px] border-border/60 shadow-sm">
                <CardHeader className="pb-3">
                  <CardTitle className="text-sm font-semibold">Templates prontos</CardTitle>
                </CardHeader>
                <CardContent className="space-y-2">
                  <button
                    type="button"
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="text-xs text-muted-foreground">
                        Cobranças, inadimplência e fluxo
                      </div>
                    </div>
                  </button>
                  <button
                  ...
                  >
                    ...
                    <div className="min-w-0">
                      ...
                      <div className="text-xs text-muted-foreground">
                        Metas funcionais e reabilitação
                      </div>
                    </div>
                  </button>
                </CardContent>
            ...
            <div className="space-y-6">
              {starredBoards.length > 0 && collection === "all" && !search && (
                <section className="space-y-3">
                  <div className="flex items-center justify-between">
                    <div>
                      <h2 className="text-lg font-semibold tracking-tight">Favoritos</h2>
                  ...
                  <Card className="rounded-[28px] border-dashed border-border/70 shadow-sm">
                    <CardContent className="flex flex-col items-center justify-center gap-3 py-16 text-center">
                      ...
                      <div className="space-y-1">
                        <div className="text-lg font-medium">Nenhum board encontrado</div>
