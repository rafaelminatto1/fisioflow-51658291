					...
					<Card className="w-full max-w-md text-center py-8">
						<CardContent className="space-y-4">
							...
							<p className="text-muted-foreground">
								Sua opinião é fundamental para continuarmos melhorando o
								FisioFlow.
							</p>
						</CardContent>
					</Card>
		...
		<PageLayout>
			<PageContainer>
				<PageHeader
					...
					subtitle="Gerencie e analise as pesquisas de satisfação dos pacientes"
				/>
				<div className="space-y-6">
					{/* Header */}
				...
				<AlertDialog
					open={!!deleteSurveyId}
					onOpenChange={() => setDeleteSurveyId(null)}
				>
					<AlertDialogContent>
						<AlertDialogHeader>
							<AlertDialogTitle>Excluir Pesquisa</AlertDialogTitle>
							<AlertDialogDescription>
								Tem certeza que deseja excluir esta pesquisa de satisfação? Esta
