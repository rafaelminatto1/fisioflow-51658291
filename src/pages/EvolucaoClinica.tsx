...
const TIMELINE: TimelineEntry[] = [
  {
    ...
    body: (
      <>
        ...
        Reavaliação biomecânica do agachamento mostra ganho de ROM (78°→118° em 8 semanas) e
        redução da inclinação de tronco. Persiste valgo dinâmico moderado à direita (+14°) — mantida
        ênfase em fortalecimento de glúteo médio e controle excêntrico.
      </>
    ),
    metrics: [
  ...
  },
  {
    ...
    body: (
      <>
        ...
        quadríceps e glúteo médio. Sem queixa álgica durante a execução; leve desconforto ao final da
        série de step-down.
      </>
    ),
    metrics: [
  ...
  },
  {
    ...
    body: (
      <>
        Contato por vídeo. Paciente relatou pico de dor (5/10) após caminhada longa no fim de semana.
        Orientado gelo e ajuste de volume nos exercícios domiciliares. Mantida conduta; reforçada
        importância de respeitar a progressão.
      </>
    ),
    metrics: [
...
const TABS = ["Resumo", "Evolução clínica", "Agendamentos", "Protocolo", "Avaliações", "Documentos"];
          ...
          <div className="flex flex-col gap-[18px] overflow-y-auto border-l border-border bg-muted/30 p-[18px]">
            ...
            <Widget title="Indicadores">
              <div className="grid grid-cols-2 gap-2.5">
                ...
                <div>
                  <div className="text-[26px] font-extrabold tabular-nums tracking-[-0.02em]">
                    12<span className="text-[15px] text-muted-foreground">/20</span>
                  </div>
                ...
                <div>
                  ...
                  <div className="text-[11px] font-semibold text-muted-foreground">Simetria L/R</div>
                  <div className="mt-0.5 flex items-center gap-0.5 text-[11px] font-bold text-[hsl(158_64%_35%)]">
