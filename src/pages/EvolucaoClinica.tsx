...
const ic = (Icon: typeof Activity, size = 13) => (
...
const TIMELINE: TimelineEntry[] = [
	{
		...
		body: (
			<>
				...
				Reavaliação biomecânica do agachamento mostra ganho de ROM (78°→118° em
				8 semanas) e redução da inclinação de tronco. Persiste valgo dinâmico
				moderado à direita (+14°) — mantida ênfase em fortalecimento de glúteo
				médio e controle excêntrico.
			</>
		),
		metrics: [
	...
	},
	{
		...
		body: (
			<>
				Progredida carga do leg press (10→12kg) e agachamento isométrico
				(30s→45s). Boa ativação de quadríceps e glúteo médio. Sem queixa álgica
				durante a execução; leve desconforto ao final da série de step-down.
			</>
		),
		metrics: [
			{ label: "Dor pico", value: "3/10", pain: "low" },
	...
	},
	{
		...
		body: (
			<>
				Contato por vídeo. Paciente relatou pico de dor (5/10) após caminhada
				longa no fim de semana. Orientado gelo e ajuste de volume nos exercícios
				domiciliares. Mantida conduta; reforçada importância de respeitar a
				progressão.
			</>
		),
		metrics: [
	...
	},
	{
		...
		body: (
			<>
				Quadro de dor anterior no joelho direito há ~4 meses, agravada por
				agachar e descer escadas. Exame: teste de compressão patelar positivo,
				ADM ativa limitada por dor a 78° de flexão sob carga, valgo dinâmico
				acentuado no agachamento. Definido protocolo de reabilitação de 20
