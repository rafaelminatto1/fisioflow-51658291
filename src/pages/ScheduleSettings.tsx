		...
		<MainLayout>
			<div className="space-y-6">
				...
				<div className="flex items-start gap-3 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30 rounded-xl border border-blue-200 dark:border-blue-800">
					...
					<div className="flex-1">
						...
						<p className="text-xs text-blue-700 dark:text-blue-300 mt-1 leading-relaxed">
							Global: capacidade, horários e bloqueios. Local: cores, aparência
							e presets (por usuário/dispositivo). Automação: cancelamento e
							notificações (persistidas para fluxos automáticos).
						</p>
					</div>
				</div>
				...
				>
					...
					<div className="space-y-4">
						...
						<div
							className={cn(
								...
								currentTab.color
									.replace("to-", "from-50 dark:to-950/30 ")
									.replace("from-", "to-50 dark:from-950/30 "),
							)}
						>
							<div
								className={cn(
					...
					<TabsContent
						value="capacity"
						className="focus-visible:outline-none focus-visible:ring-0 animate-in fade-in slide-in-from-bottom-2 duration-300"
					>
