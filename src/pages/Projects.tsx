    ...
    <PageLayout>
      <PageContainer>
        <PageHeader
          ...
          subtitle="Gerencie seus projetos e acompanhe o progresso da equipe"
          actions={
            <>
          ...
          <AlertDialog open={!!projectToDelete} onOpenChange={() => setProjectToDelete(null)}>
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  Tem certeza que deseja excluir o projeto "{projectToDelete?.title}"? Todas as
                  tarefas associadas serão mantidas, mas perderão a associação com o projeto. Esta
