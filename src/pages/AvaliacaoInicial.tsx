...
const ic = (Icon: typeof Check, size = 13) => (
				...
				<div className="flex h-[calc(100dvh-3rem)] min-h-[600px] flex-col bg-background font-sans text-foreground">
					...
					<div className="flex items-center gap-3.5 border-b border-border px-6 py-3.5">
						<div className="flex items-center gap-1.5 text-[13px] font-semibold text-muted-foreground">
							Pacientes {ic(ChevronRight, 14)} Marina Alves{" "}
							{ic(ChevronRight, 14)}{" "}
						...
						<div className="overflow-y-auto px-[26px] py-[22px]">
							<section className="mb-[26px]">
								...
								<p className="mb-3.5 ml-[33px] text-xs font-medium text-muted-foreground">
									História da moléstia atual — em primeira pessoa sempre que
									possível.
								</p>
								...
								<div className="grid grid-cols-3 gap-3.5">
									...
									<div>
										...
										<input
											className={INPUT}
											placeholder="Progressiva / estável…"
										/>
									</div>
									<div>
							...
							<section className="mb-[26px]">
								<SectionHeading n="5">
									ADM &amp; força (goniometria / MMT)
								</SectionHeading>
								<p className="mb-3.5 ml-[33px] text-xs font-medium text-muted-foreground">
									Amplitude de movimento ativa e força muscular manual —
									comparativo D/E.
								</p>
								<table className="w-full border-collapse text-xs">
									...
									<tbody>
										{GONIO_ROWS.map((r) => (
											<tr key={r.move}>
												<td className="border-b border-border/60 px-2.5 py-1.5 font-bold">
													{r.move}
												</td>
