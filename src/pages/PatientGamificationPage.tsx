				...
				<div className="min-h-screen bg-gray-50/50 pb-20">
					<div className="max-w-md mx-auto md:max-w-6xl p-4 md:p-6 space-y-6">
						...
						<GamificationHeader
							...
							currentXp={
								profile?.total_points ? profile.total_points % 1000 : 0
							}
								...
								<div className="flex items-center justify-between">
									<div className="space-y-1">
										...
										<p className="text-blue-100 text-sm">
											Use seus pontos para não perder dias se esquecer de
											treinar.
										</p>
									</div>
									<Button
								...
								>
									<div className="flex items-center justify-between">
										...
										>
											...
											{dailyQuests?.length || 0} Completas
										</Badge>
									</div>
									...
									<div className="p-4 border-b space-y-4">
										<div className="flex items-center justify-between">
											...
											<Tabs
												value={rankingPeriod}
												onValueChange={(v) =>
													setRankingPeriod(v as "weekly" | "monthly" | "all")
												}
												className="w-auto"
											>
