              ...
              <div className="flex items-center justify-between">
                <div className="space-y-1">
                  ...
                  <p className="text-blue-100 text-sm">
                    Use seus pontos para não perder dias se esquecer de treinar.
                  </p>
                </div>
                <Button
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
            ...
            <div className="md:col-span-7 space-y-6">
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  >
                    {dailyQuests?.filter((q) => q.completed).length}/{dailyQuests?.length || 0}{" "}
                    Completas
                  </Badge>
                </div>
                  ...
                  {dailyQuests?.map((quest) => (
                    <motion.div
                      ...
                      className={`
                            ...
                            `}
                      onClick={() =>
                        !quest.completed && completeQuest.mutate({ questId: quest.id })
                      }
                    >
                      {quest.completed && (
                        <motion.div
                      ...
                      <div className="relative flex items-center gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                          <h4
                            className={`font-semibold truncate ${quest.completed && "text-muted-foreground line-through"}`}
                          >
                            {quest.title}
                          </h4>
            ...
            <div className="md:col-span-5 space-y-6">
              ...
              <Card className="overflow-hidden border border-border/50 shadow-sm bg-gradient-to-br from-slate-50 to-white">
                ...
                <Button
                  variant="ghost"
                  className="w-full text-xs text-muted-foreground hover:bg-slate-50 border-t rounded-none h-10"
                >
                  Ver todas
                </Button>
              </Card>
              ...
              {/* 5.5 Rewards Shop */}
              <RewardsShop patientId={user?.uid || ""} />
              ...
              <Card className="border-border/50 shadow-sm h-fit">
                <div className="p-4 border-b space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Tabs
                      value={rankingPeriod}
                      onValueChange={(v) => setRankingPeriod(v as "weekly" | "monthly" | "all")}
                      className="w-auto"
                    >
                    ...
                    filteredLeaderboard.map((entry, index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="flex-1 min-w-0">
                            <p
                              className={`font-medium text-sm truncate ${isCurrentUser && "text-primary font-bold"}`}
                            >
                              {entry.patient_name}
                              {isCurrentUser && (
                                <span className="ml-2 text-[10px] bg-primary text-white py-0.5 px-1.5 rounded-full uppercase tracking-tighter">
                                  Você
                                </span>
                              )}
                            </p>
                          ...
                          <div className="text-right">
                            <span
                              className={`text-xs font-bold ${isCurrentUser ? "text-primary" : "text-slate-600"}`}
                            >
                              {entry.total_xp} XP
                            </span>
                          </div>
