...
const MOCK_TAREFAS: Tarefa[] = [
  ...
  },
  {
    ...
    assignees: [],
    checklists: [],
    attachments: [{ id: 'att-1', name: 'exame-raio-x.jpg', url: '/mock/files/exame.jpg', size: 1024000, type: 'image', created_at: new Date().toISOString() }],
    references: [{ id: 'ref-1', title: 'Protocolo de Avaliação Lumbar', url: 'https://example.com', type: 'website', created_at: new Date().toISOString() }],
    comments: [{ id: 'comm-1', content: 'Lembre de atualizar os exercícios prescritos', author_id: 'user-1', author_name: 'Rafael Minatto', created_at: new Date().toISOString() }],
    dependencies: [],
    blocks: [],
    color: '#3b82f6',
    cover_image: undefined,
  ...
  },
  {
    ...
    attachments: [],
    references: [
      { id: 'ref-1', title: 'Journal of Orthopedic & Sports Physical Therapy', url: 'https://example.com', type: 'website', created_at: new Date().toISOString() },
      { id: 'ref-2', title: 'Physical Therapy in Sport', url: 'https://example.com', type: 'website', created_at: new Date().toISOString() }
    ],
    comments: [],
    dependencies: [],
    blocks: [],
