...
export default function TarefasV2() {
  ...
  const stats = useMemo((): TaskStats | null => {
    ...
    const completionRate =
      effectiveTarefas.length > 0 ? (completedTotal / effectiveTarefas.length) * 100 : 0;
    ...
    return (
      <MainLayout>
        <div className="space-y-6">
          ...
          <LazyTaskQuickCreateModal open={quickCreateOpen} onOpenChange={setQuickCreateOpen} />
        </div>
      </MainLayout>
    );
  }
        ...
        <div className="flex flex-col gap-6 mb-8">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              >
                <RefreshCw
                  className={cn("h-5 w-5 text-slate-400", isRefetching && "animate-spin")}
                />
              </Button>
              <Button
                onClick={() => setQuickCreateOpen(true)}
          ...
          {stats && (
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
                ...
                <CardContent className="pt-4">
                  <div className="flex items-center justify-between">
                    ...
                    <AlertCircle
                      className={cn(
                        "h-8 w-8",
                        stats.overdue > 0 ? "text-red-500/20" : "text-muted-foreground/20",
                      )}
                    />
                  </div>
                </CardContent>
              ...
              <Card
                className={cn(
                  stats.pending_acknowledgments > 0 && "border-orange-500/50 bg-orange-50/10",
                )}
              >
                <CardContent className="pt-4">
                  <div className="flex items-center justify-between">
          ...
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              >
                <ShieldAlert
                  className={cn("h-4 w-4", filterPendingAck ? "text-orange-600" : "text-slate-400")}
                />
            ...
            <Card>
              <CardHeader className="pb-2">
                <div className="flex items-center justify-between">
                  ...
                  <Select
                    value={timelineRange}
                    onValueChange={(v) => setTimelineRange(v as "week" | "month")}
                  >
                        ...
                        <div
                          ...
                          className={cn(
                            ...
                            safeFormat(day, "yyyy-MM-dd") ===
                              safeFormat(new Date(), "yyyy-MM-dd") && "bg-primary/10",
                          )}
                        >
                      ...
                      >
                        <div className="w-64 p-2 border-r shrink-0">
                          <div className="flex items-center gap-2">
                            <div
                              className={cn("h-2 w-2 rounded-full shrink-0", statusConfig.dot)}
                            />
                        ...
                        <div className="flex flex-1 relative">
                          {timelineData.days.map((day, i) => {
                            ...
                            const isStart =
                              isStartValid && dayStr === safeFormat(startDate, "yyyy-MM-dd");
                            const isEnd =
                              isEndValid && dayStr === safeFormat(endDate, "yyyy-MM-dd");
                            ...
                            return (
                              <div
                                ...
                                className={cn(
                                  ...
                                  safeFormat(day, "yyyy-MM-dd") ===
                                    safeFormat(new Date(), "yyyy-MM-dd") && "bg-primary/5",
                                )}
                              >
                                {isInRange && (
                                  <div
