...
export default function AutomationPage() {
  ...
  const { data: automationLogs = [], isLoading: logsLoading } = useAutomationLogs(organizationId, {
    limitCount: 50,
  });
    ...
    <PageLayout>
      <PageContainer>
        <PageHeader
          ...
          subtitle="Histórico operacional disponível; editor completo em implantação"
          actions={
            <>
              <Button disabled>
              ...
              <TabsContent value="history">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Acompanhe a execução das suas automações</CardDescription>
                  </CardHeader>
                  <CardContent>
                    {logsLoading ? (
                      ...
                      <div className="text-center py-8 text-muted-foreground">
                        ...
                        <p className="text-sm mt-1">
                          As execuções aparecem aqui quando suas automações forem disparadas.
                        </p>
                      </div>
                    ) : (
