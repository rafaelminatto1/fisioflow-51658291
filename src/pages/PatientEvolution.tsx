...
const PatientEvolution = () => {
  ...
  const handleEvolutionV2Change = useCallback(
    (next: EvolutionV2Data) => {
      ...
      // Persiste o rascunho local somente se houver conteúdo real.
      // Evita que renders iniciais com state vazio sobrescrevam o draft
      // antes da hidratação do servidor concluir.
