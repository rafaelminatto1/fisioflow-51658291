...
export default function ContratadosPage() {
	...
	const [editingContratado, setEditingContratado] = useState<Contratado | null>(
		null,
	);
	...
	const especialidades = Array.from(
		new Set(
			safeContratados.map((c) => c.especialidade).filter(Boolean) as string[],
		),
		...
		<PageLayout>
			<PageContainer>
				<PageHeader
					...
					subtitle="Cadastro global de prestadores contratados para eventos"
					actions={
						<>
				...
				<div className="p-6 space-y-6">
							...
							<div className="flex flex-col lg:flex-row lg:items-center gap-4">
								...
								<div className="flex flex-wrap items-center gap-3">
									<Select
										...
										onValueChange={setEspecialidadeFiltro}
									>
									...
									<div className="flex items-center gap-2">
										<Switch
											checked={comDocumento}
											onCheckedChange={setComDocumento}
										/>
												...
												<TableCell>
													<div className="flex items-center gap-1">
														<Button
															variant="ghost"
															size="icon"
															onClick={() => openEditModal(contratado)}
														>
														...
														<Button
															variant="ghost"
															size="icon"
															onClick={() => handleDelete(contratado.id)}
														>
					...
					<Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
						<DialogContent className="sm:max-w-2xl max-h-[90vh] overflow-y-auto">
							<DialogHeader>
								<DialogTitle>
									{editingContratado ? "Editar Contratado" : "Novo Contratado"}
								</DialogTitle>
							</DialogHeader>
							<form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
								<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
									...
									<div className="space-y-2 sm:col-span-2">
										...
										<Input
											...
											placeholder="Ex: Fisioterapeuta, Massoterapeuta"
										/>
									</div>
								...
								<DialogFooter>
									...
									<Button
										type="submit"
										disabled={
											createContratado.isPending || updateContratado.isPending
										}
									>
