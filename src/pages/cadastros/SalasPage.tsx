    ...
    <MainLayout>
      <div className="space-y-4 p-4 md:p-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground">Configure as salas e espaços da clínica</p>
          </div>
        ...
        <Card>
          ...
          <CardContent>
            {isLoading ? (
              ...
              <div className="text-center py-8 text-muted-foreground">Nenhuma sala encontrada</div>
            ) : (
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="max-w-lg max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>{editingItem ? "Editar Sala" : "Nova Sala"}</DialogTitle>
            <DialogDescription>Configure os detalhes da sala de atendimento</DialogDescription>
          </DialogHeader>
