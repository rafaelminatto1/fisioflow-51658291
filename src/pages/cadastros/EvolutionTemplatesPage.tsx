...
export default function EvolutionTemplatesPage() {
  ...
  const filteredTemplates = templates.filter((t) => accentIncludes(t.nome, search));
    ...
    <PageLayout>
      <PageContainer>
        <PageHeader
          ...
          subtitle="Crie modelos de evolução para agilizar a documentação clínica"
          actions={
            <>
            ...
            <CardHeader>
              <div className="flex items-center gap-4">
                ...
                <Select
                  ...
                  onValueChange={(value) => setSelectedTipo(value === "all" ? "" : value)}
                >
                      ...
                      <TableRow key={template.id}>
                        ...
                        <TableCell>
                          <Badge variant="secondary">
                            {TIPOS_EVOLUCAO.find((t) => t.value === template.tipo)?.label ||
                              template.tipo}
                          </Badge>
                        </TableCell>
