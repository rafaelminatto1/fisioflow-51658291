...
export default function StaffSchedulesPage() {
	...
	const addBlock = useMutation({
		mutationFn: (block: any) =>
			request("/api/staff-schedules/blocks", {
				method: "POST",
	...
	const deleteBlock = useMutation({
		mutationFn: (id: string) =>
			request(`/api/staff-schedules/blocks/${id}`, { method: "DELETE" }),
		...
		<PageLayout>
			<PageContainer>
				<PageHeader
					...
					subtitle="Horários semanais e bloqueios de agenda da equipe"
					actions={
						<>
							<Button
