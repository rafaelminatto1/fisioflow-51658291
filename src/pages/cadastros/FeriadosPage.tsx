									...
									<TableBody>
										{filteredFeriados.map((feriado) => (
											<TableRow key={feriado.id}>
												...
												<TableCell>
													<Badge
														className={`${tipoColors[feriado.tipo]} text-white`}
													>
												...
												<TableCell>
													<Badge
														variant={
															feriado.recorrente ? "default" : "secondary"
														}
													>
							...
							<form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
									...
									<div className="space-y-2">
										...
										>
											...
											<SelectContent>
												...
												<SelectItem value="ponto_facultativo">
													Ponto Facultativo
												</SelectItem>
											</SelectContent>
										</Select>
								...
								<DialogFooter>
									...
									<Button
										type="submit"
										disabled={
											createFeriado.isPending || updateFeriado.isPending
										}
									>
