...
import { Plus, Search, Edit, Trash2, CalendarDays, CalendarIcon } from "lucide-react";
import {
  useFeriados,
  useCreateFeriado,
  useUpdateFeriado,
    ...
    <PageLayout>
      <PageContainer>
        <PageHeader
          ...
          subtitle="Configure os feriados e bloqueios de agenda"
          actions={
            <>
          ...
          <Card>
            <CardHeader className="pb-3">
              <div className="flex items-center gap-4 flex-wrap">
                ...
                <Badge variant="secondary">{filteredFeriados.length} feriado(s)</Badge>
              </div>
            </CardHeader>
            <CardContent>
              {isLoading ? (
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(v) =>
                        setValue(
                          "tipo",
                          v as "nacional" | "estadual" | "municipal" | "ponto_facultativo",
                        )
                      }
                    >
                      <SelectTrigger>
