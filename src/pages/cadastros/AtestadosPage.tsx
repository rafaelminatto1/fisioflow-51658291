...
export default function AtestadosPage() {
  ...
  const [selectedTemplateForPDF, setSelectedTemplateForPDF] = useState<AtestadoTemplate | null>(
    null,
  );
                ...
                <Card key={template.id} className={!template.ativo ? "opacity-60" : ""}>
                  ...
                  <CardContent>
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      <Button variant="default" size="sm" onClick={() => openPDFDialog(template)}>
              ...
              <div className="space-y-4 py-4">
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => setPdfForm((p) => ({ ...p, patientId: value }))}
                  >
