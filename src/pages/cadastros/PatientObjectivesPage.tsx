    ...
    <PageLayout>
      <PageContainer>
        <PageHeader
          ...
          subtitle="Gerencie objetivos que podem ser atribuídos aos pacientes"
          actions={
            <>
            ...
            <CardHeader>
              <div className="flex items-center gap-4">
                ...
                <Select
                  ...
                  onValueChange={(value) => setSelectedCategoria(value === "all" ? "" : value)}
                >
          ...
          <AlertDialog open={!!deleteId} onOpenChange={() => setDeleteId(null)}>
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  Tem certeza que deseja excluir este objetivo? As atribuições existentes serão
                  mantidas.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
