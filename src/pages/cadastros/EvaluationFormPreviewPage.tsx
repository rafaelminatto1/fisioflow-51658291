        ...
        return (
          <div className="space-y-3">
            ...
            <input
              ...
              className="w-full"
            />
            <div className="text-center font-semibold text-lg">{value || 0}</div>
          </div>
        );
      ...
      case "body_map":
        return (
          <div className="p-4 bg-muted/50 rounded-lg text-center">
            <div className="text-muted-foreground mb-2">Mapa corporal interativo</div>
            {readonly ? (
  ...
  return (
    <div className="space-y-2">
      <div className="flex items-start gap-2">
        {field.obrigatorio && <span className="text-destructive mt-0.5">*</span>}
...
export default function EvaluationFormPreviewPage() {
        ...
        <PageContainer>
          <div className="text-center py-12">
            ...
            <p className="text-muted-foreground mb-4">
              A ficha solicitada não existe ou foi excluída.
            </p>
  ...
  const groupedFields =
    formData.fields?.reduce(
      (acc: Record<string, Array<Record<string, unknown>>>, field: Record<string, unknown>) => {
...
${Object.entries(groupedFields)
  .map(
    ([section, fields]: [string, Array<Record<string, unknown>>]) => `
${section}
${"-".repeat(30)}
...
Gerado em: ${new Date().toLocaleString("pt-BR")}
  ...
  return (
    <PageLayout>
      <PageContainer>
        <PageHeader title={<>{formData.nome}</>} />
        <div className="space-y-6 max-w-4xl mx-auto">
          {/* Header */}
