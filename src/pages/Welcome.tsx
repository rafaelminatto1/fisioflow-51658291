          ...
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="flex-1 text-center lg:text-left">
              ...
              <h1 className="text-5xl md:text-7xl font-bold tracking-tight text-slate-900 mb-8 leading-[1.1]">
                A Evolução da <span className="text-primary">Gestão Clínica</span> para
                Fisioterapia.
              </h1>
              <p className="text-lg md:text-xl text-slate-600 mb-10 max-w-2xl leading-relaxed">
                O FisioFlow combina a robustez da infraestrutura Edge da Cloudflare com a
                Inteligência Clínica mais avançada do mercado. Projetado para quem busca exatidão
                diagnóstica e eficiência operacional 10x maior.
              </p>
