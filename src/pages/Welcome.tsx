	...
	const features = [
		{
			...
			description:
				"Cadastro completo, histórico médico e evolução detalhada de cada paciente",
			status: "Ativo",
		},
		{
			...
			description:
				"Sistema de agendamento com lembretes automáticos e gestão de horários",
			status: "Ativo",
		},
		{
			...
			description:
				"Biblioteca de exercícios com prescrições personalizadas e acompanhamento",
			status: "Ativo",
		},
		{
			...
			description:
				"Assistente de IA treinado em fisioterapia para suporte clínico",
			status: "Novo",
		},
		{
			...
			description:
				"Relatórios detalhados de progresso e estatísticas da clínica",
			status: "Ativo",
		},
		{
				...
				<div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
					<div className="text-center">
						...
						<p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto">
							Sistema completo de gestão clínica com inteligência artificial
							para fisioterapeutas modernos
						</p>
						...
						>
							<CardHeader className="pb-4">
								<div className="flex items-center justify-between">
									...
									<Badge
										variant={
											feature.status === "Novo" ? "default" : "secondary"
										}
										className={
											feature.status === "Novo" ? "bg-green-500 text-white" : ""
										}
									>
										{feature.status}
									</Badge>
