					...
					<div className="flex flex-col lg:flex-row items-center gap-16">
						<div className="flex-1 text-center lg:text-left">
							...
							<h1 className="text-5xl md:text-7xl font-bold tracking-tight text-slate-900 mb-8 leading-[1.1]">
								A Evolução da{" "}
								<span className="text-primary">Gestão Clínica</span> para
								Fisioterapia.
							</h1>
							<p className="text-lg md:text-xl text-slate-600 mb-10 max-w-2xl leading-relaxed">
								O FisioFlow combina a robustez da infraestrutura Edge da
								Cloudflare com a Inteligência Clínica mais avançada do mercado.
								Projetado para quem busca exatidão diagnóstica e eficiência
								operacional 10x maior.
							</p>
				...
				<div className="max-w-7xl mx-auto px-4 text-center">
					...
					<div className="grid grid-cols-2 md:grid-cols-4 gap-8 grayscale opacity-60">
						<div className="flex items-center justify-center gap-2">
							...
							<span className="font-bold">Neon Auth</span>
						</div>
						<div className="flex items-center justify-center gap-2">
							<Activity className="h-6 w-6" />{" "}
							<span className="font-bold">Workers Edge</span>
						</div>
						<div className="flex items-center justify-center gap-2">
							<Zap className="h-6 w-6" />{" "}
							<span className="font-bold">Neon Database</span>
						</div>
						<div className="flex items-center justify-center gap-2">
							<Brain className="h-6 w-6" />{" "}
							<span className="font-bold">Cloudflare AI</span>
						</div>
					</div>
				</div>
			</section>
					...
					<div className="flex flex-col md:flex-row justify-between items-center gap-10">
						<div>
							...
							<p className="text-slate-400 max-w-xs">
								A plataforma que está redefinindo o futuro da fisioterapia
								baseada em evidências.
							</p>
						</div>
						<div className="text-center md:text-right">
							<p className="text-slate-500 text-sm mb-2">
								© 2026 FisioFlow Corporation
							</p>
							<div className="flex gap-4">
								<span className="text-slate-400 hover:text-white cursor-pointer px-1">
									Privacidade
								</span>
								<span className="text-slate-400 hover:text-white cursor-pointer px-1">
									Termos
