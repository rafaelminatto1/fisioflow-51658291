...
import type { ActivityLabPatient, ActivityLabSession } from "@/types/activityLab";
...
export default function ActivityLabPage() {
  ...
  const { data: sessions = [], isLoading: loadingSessions } = useActivityLabSessions(
    selectedPatient?.id,
  );
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex items-center space-x-4">
            ...
            <div>
              ...
              <p className="text-gray-500">Integração de testes de força e biomecânica</p>
            </div>
          </div>
                          ...
                          {loadingLabPatients ? (
                            ...
                            <>
                              ...
                              <p className="text-xs mt-1">
                                Use a busca acima para encontrar qualquer paciente.
                              </p>
                            </>
                          )}
                        </div>
                  ...
                  <Card className="h-full border-none shadow-md overflow-hidden">
                    <CardHeader className="bg-slate-50/50 border-b border-slate-100">
                      <div className="flex items-center justify-between">
                        ...
                        <Badge
                          className={selectedPatient.is_active ? "bg-green-500" : "bg-slate-400"}
                        >
                    ...
                    <CardContent className="pt-8 space-y-8">
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                        ...
                        <div>
                          ...
                          <p className="text-sm font-bold text-slate-700">
                            {format(new Date(selectedPatient.created_at), "dd/MM/yyyy")}
                          </p>
                        </div>
                      </div>
                  ...
                  <Card className="h-full flex items-center justify-center border-dashed border-2 bg-slate-50/30">
                    <div className="text-center p-12">
                      ...
                      <p className="text-slate-500 max-w-xs mx-auto">
                        Selecione um paciente na lista ao lado para visualizar seu perfil e
                        histórico de força.
                      </p>
                    </div>
                  </Card>
                ...
                {selectedSession && compareSession && comparisonMode ? (
                  ...
                  <Card className="h-full flex items-center justify-center border-dashed border-2 bg-slate-50/30">
                    <div className="text-center p-12">
                      ...
                      <p className="text-slate-500 max-w-xs mx-auto">
                        Escolha um teste no histórico ao lado para analisar a curva de força e
