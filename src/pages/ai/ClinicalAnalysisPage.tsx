        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2 px-3 py-2 bg-gray-100 rounded-lg">
              ...
              <Switch checked={useRAG} onCheckedChange={setUseRAG} id="rag-toggle" />
            ...
            <div className="flex items-center gap-2 px-3 py-2 bg-gray-100 rounded-lg">
              ...
              <Switch checked={useMedLM} onCheckedChange={setUseMedLM} id="medlm-toggle" />
            ...
            <div className="flex items-center gap-2 px-3 py-2 bg-gray-100 rounded-lg">
              ...
              <Switch checked={voiceEnabled} onCheckedChange={setVoiceEnabled} id="voice-toggle" />
                        ...
                        {analysisHistory.map((entry) => (
                          <Card key={entry.id} className="p-4">
                            <div className="flex items-center justify-between mb-2">
                              ...
                              {entry.score && <Badge variant="outline">Score: {entry.score}</Badge>}
                              {entry.improvement !== undefined && (
                                <Badge
                                  variant={entry.improvement >= 0 ? "default" : "destructive"}
                                  className={entry.improvement >= 0 ? "bg-green-600" : "bg-red-600"}
                                >
                                  {entry.improvement >= 0 ? "+" : ""}
              ...
              <TabsContent value="comparison">
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Compare o progresso ao longo do tempo</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-6">
                        ...
                        <>
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="p-4 bg-gray-50 rounded-lg border">
                              ...
                              <p className="text-sm">{analysisHistory[0]?.summary}</p>
                            </div>
                          </div>
                      ...
                      {analysisHistory.length < 2 && (
                        <div className="text-center py-12 text-gray-500">
                          ...
                          <p className="text-sm mt-1">Mínimo 2 análises são necessárias</p>
                        </div>
                      )}
                    </div>
                  </CardContent>
