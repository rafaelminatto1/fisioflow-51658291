        ...
        <Card className="max-w-2xl mx-auto">
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground">
              A busca semântica requer índices vetoriais configurados no banco principal. Entre em
              contato com o administrador do sistema para ativar esta funcionalidade.
            </p>
    ...
    <div className="container mx-auto py-8 max-w-5xl">
      ...
      <Card className="mb-6 bg-blue-50 dark:bg-blue-950/20 border-blue-200 dark:border-blue-900">
        ...
        <CardContent className="text-sm text-muted-foreground space-y-2">
          <p>
            A busca semântica usa <strong>embeddings vetoriais</strong> para encontrar evoluções
            clinicamente similares, não apenas correspondências exatas de texto.
          </p>

          <ul className="list-disc list-inside space-y-1 ml-2">
            <li>
              Busque em português natural: <em>"pacientes com dor lombar que melhoraram"</em>
            </li>
        ...
        <div className="lg:col-span-2 space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Digite sua consulta em linguagem natural</CardDescription>
            </CardHeader>
