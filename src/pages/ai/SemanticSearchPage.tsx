...
} from "@/components/ai/SemanticSearch";
import {
	Card,
	CardContent,
	CardDescription,
...
export function SemanticSearchPage() {
	...
	const [, setSelectedEvolution] = useState<string | null>(null);
				...
				<Card className="max-w-2xl mx-auto">
					...
					<CardContent>
						<p className="text-sm text-muted-foreground">
							A busca semântica requer índices vetoriais configurados no banco
							principal. Entre em contato com o administrador do sistema para
		...
		<div className="container mx-auto py-8 max-w-5xl">
			...
			<Card className="mb-6 bg-blue-50 dark:bg-blue-950/20 border-blue-200 dark:border-blue-900">
				...
				<CardContent className="text-sm text-muted-foreground space-y-2">
					<p>
						A busca semântica usa <strong>embeddings vetoriais</strong> para
						encontrar evoluções clinicamente similares, não apenas
						correspondências exatas de texto.
					</p>

					<ul className="list-disc list-inside space-y-1 ml-2">
						<li>
							Busque em português natural:{" "}
							<em>"pacientes com dor lombar que melhoraram"</em>
						</li>
			...
			<div className="grid gap-6 lg:grid-cols-3">
				...
				<div className="lg:col-span-2 space-y-6">
					<Card>
						...
						<CardContent>
							<SemanticSearch onSelectEvolution={handleSelectEvolution} />
						</CardContent>
					</Card>
				</div>
						...
						<CardContent className="text-sm space-y-3">
							<div>
								...
								<p className="text-muted-foreground">
									"Dor lombar aguda após levantamento de peso" funciona melhor
									que "dor nas costas"
								</p>
							</div>
							...
							<div>
								...
								<p className="text-muted-foreground">
									"Limitação de movimento no ombro direito com teste de Neer
									positivo"
								</p>
							</div>
						</CardContent>
