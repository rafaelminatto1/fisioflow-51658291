		...
		<PageLayout>
			<PageContainer>
				<PageHeader
					...
					subtitle="Gerencie seus templates de fichas de avaliação"
					actions={
						<>
						...
						>
							<DialogContent className="max-w-4xl max-h-[80vh] overflow-y-auto">
								...
								<div className="space-y-4">
									<div>
										<Badge variant="secondary">
											{CATEGORY_LABELS[previewTemplate.tipo] ||
										...
										previewTemplate.fields.length > 0 && (
											<div>
												<h4 className="font-semibold mb-2">
													Campos ({previewTemplate.fields.length})
												</h4>
									...
									<div className="flex justify-end gap-2">
										...
										<Button onClick={() => handleUse(previewTemplate.id)}>
											Usar Template
										</Button>
									</div>
								</div>
