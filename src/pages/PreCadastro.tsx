...
const PreCadastro = () => {
  ...
  if (submitted) {
    const successMsg =
      tokenData?.ui_style?.successMessage ||
      ...
      <div className="max-w-xl mx-auto space-y-8">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-slate-500 font-medium">
            {tokenData?.descricao || "Preencha sua ficha clínica para agilizar seu atendimento."}
          </p>
        </div>
                ...
                <div className="p-6 rounded-[2rem] bg-slate-50 border border-slate-100 space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <p className="text-[11px] leading-relaxed text-slate-600 font-medium text-justify">
                      Seus dados serão utilizados exclusivamente para fins de atendimento clínico e
                      administrativo, em conformidade com a{" "}
                      <strong>Lei Geral de Proteção de Dados (LGPD)</strong>. Garantimos o sigilo
                      médico e a segurança das suas informações em nossos servidores criptografados.
                    </p>
                  </div>
