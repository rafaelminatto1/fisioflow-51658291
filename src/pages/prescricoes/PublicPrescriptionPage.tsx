...
export default function PublicPrescriptionPage() {
	...
	const { prescription, loading, error, markExerciseComplete, isMarking } =
		usePublicPrescription(qrCode || "");
	...
	const isExpired =
		...
		isAfter(new Date(), parseISO(prescription.valid_until));
						...
						<div className="flex flex-wrap gap-4 justify-between items-center">
							<div className="flex items-center gap-2">
								...
								<span className="font-medium">
									{prescription.patient?.name || "Paciente"}
								</span>
							</div>
