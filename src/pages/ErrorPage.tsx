...
export default function ErrorPage() {
  ...
  const message =
    state.message ?? "Ocorreu um erro inesperado. Tente novamente ou volte ao início.";
    ...
    >
      <div className="flex flex-col gap-4">
        <p className="text-sm text-muted-foreground italic">
          "O sistema teve uma contratura muscular súbita. Recomendamos uma liberação miofascial
          (recarregar a página) ou voltar para a posição neutra."
        </p>
