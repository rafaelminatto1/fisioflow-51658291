        ...
        {loading ? (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-6">
            <Card className="premium-glass rounded-[2rem]">
              <CardHeader><Skeleton className="h-6 w-1/3" /><Skeleton className="h-4 w-2/3" /></CardHeader>
              ...
              <Card className="premium-glass rounded-[2rem]">
                <CardHeader>
                  <div className="flex items-center gap-2">
                    ...
                    <CardTitle className="font-display font-black text-lg">Taxa de Retenção</CardTitle>
                  </div>
              ...
              <Card className="premium-glass rounded-[2rem]">
                <CardHeader>
                  <div className="flex items-center gap-2">
                    ...
                    <CardTitle className="font-display font-black text-lg">Evolução de No-shows</CardTitle>
                  </div>
                  <CardDescription className="font-medium ml-11">
                ...
                <CardContent className="h-[300px]">
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={noShowData} margin={{ top: 5, right: 20, bottom: 5, left: 0 }}>
                      ...
                      <Bar dataKey="rate" fill="#f97316" radius={[6, 6, 0, 0]} barSize={40} />
                    </BarChart>
                  </ResponsiveContainer>
                </CardContent>
              </Card>
              ...
              <Card className="premium-glass rounded-[2rem]">
                <CardHeader>
                  <div className="flex items-center gap-2">
                    ...
                    <CardTitle className="font-display font-black text-lg">Previsão de Receita (IA)</CardTitle>
                  </div>
                  <CardDescription className="font-medium ml-11">
                    Projeção financeira baseada no histórico de pagamentos e agendamentos futuros.
                  </CardDescription>
                </CardHeader>
                <CardContent className="h-[350px]">
                  <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={revenueForecastData} margin={{ top: 5, right: 20, bottom: 5, left: 0 }}>
                      ...
                      <Tooltip formatter={(value: number) => [`R$ ${value.toLocaleString('pt-BR')}`, ""]} contentStyle={{ borderRadius: '1rem', border: 'none', boxShadow: '0 10px 15px -3px rgb(0 0 0 / 0.1)' }} />
                      <Legend iconType="circle" wrapperStyle={{ paddingTop: '20px' }} />
                      <Line type="monotone" name="Realizado" dataKey="actual" stroke="#10b981" strokeWidth={4} dot={{ r: 4, fill: '#10b981', strokeWidth: 2, stroke: '#fff' }} />
                      <Line type="monotone" name="Previsto (IA)" dataKey="forecast" stroke="#94a3b8" strokeWidth={4} strokeDasharray="6 6" dot={false} />
                    </LineChart>
                  </ResponsiveContainer>
                </CardContent>
              </Card>
