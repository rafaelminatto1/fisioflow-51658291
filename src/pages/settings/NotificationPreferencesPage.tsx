  ...
  const mappedWorkerPrefs = useMemo<NotificationPreferencesForm>(() => {
    ...
    return {
      appointmentReminders:
        workerPreferences?.appointment_reminders ?? defaultPreferences.appointmentReminders,
      exerciseReminders:
        workerPreferences?.exercise_reminders ?? defaultPreferences.exerciseReminders,
      ...
      therapistMessages:
        workerPreferences?.therapist_messages ?? defaultPreferences.therapistMessages,
      paymentReminders: workerPreferences?.payment_reminders ?? defaultPreferences.paymentReminders,
      weekendNotifications:
        workerPreferences?.weekend_notifications ?? defaultPreferences.weekendNotifications,
      emailNotifications: localPrefs.emailNotifications ?? defaultPreferences.emailNotifications,
