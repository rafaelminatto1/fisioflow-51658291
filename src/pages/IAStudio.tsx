...
export const IAStudio: React.FC = () => {
	...
	const tools = [
		...
		},
		{
			...
			bg: "bg-amber-500/10",
			action: () =>
				setActiveFeatureTab(activeFeatureTab === "predict" ? null : "predict"),
		},
	];
								...
								{activeFeatureTab ? (
									...
									>
										...
										{activeFeatureTab === "predict" && (
											<FisioPredictIndicator patientId="test" />
										)}
												...
												>
													...
													>
														<CardContent className="p-8 flex items-center gap-8 relative">
															...
															>
																<tool.icon
																	className={cn("w-10 h-10", tool.color)}
																/>
															</div>
															<div className="flex-1 space-y-2 relative z-10">
																<div className="flex items-center justify-between">
																	...
																	>
																		<ChevronRight
																			className={cn("w-5 h-5", tool.color)}
																		/>
																	</div>
																</div>
											...
											<div className="relative z-10 space-y-6">
												...
												<h2 className="text-4xl font-black tracking-tighter leading-none italic uppercase">
													...
													<span className="text-blue-500">
														documentação pela metade.
													</span>
												</h2>
												<p className="text-slate-400 max-w-md text-sm font-medium leading-relaxed">
													Use o AI Scribe durante seus atendimentos e deixe que
													a nossa inteligência clínica gere o SOAP, o
													faturamento e a evolução para você.
												</p>
							...
							<Card className="border-none shadow-2xl bg-white dark:bg-slate-900 rounded-[32px] overflow-hidden">
								<div className="p-6 pb-0 flex items-center justify-between">
									<h3 className="text-xs font-black uppercase text-slate-400 tracking-widest flex items-center gap-2">
										<AlertTriangle className="w-4 h-4 text-amber-500" /> Risco
										de Churn
									</h3>
									<Button
										variant="ghost"
								...
								<div className="p-6 bg-slate-50 dark:bg-slate-900/50 border-t border-slate-100 dark:border-slate-800">
									<Button
										...
										onClick={() =>
											toast.success("Automação de reengajamento ativada!")
										}
									>
										Automação Ativa
									</Button>
							...
							<div className="grid grid-cols-1 gap-4">
								{[
									...
									>
										...
										<stat.icon
											className={cn("w-8 h-8 opacity-10", stat.color)}
										/>
									</Card>
								))}
