						...
						<div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pt-2">
							<div className="space-y-1">
								...
								<p className="text-xs text-muted-foreground leading-relaxed max-w-md">
									Ao excluir sua conta, seu acesso ao sistema será revogado
									imediatamente.
									<span className="block mt-1 font-semibold text-red-600/80">
										Importante: Conforme a Lei nº 13.787/2018 e LGPD, seus
										registros clínicos (evoluções, exames e dados de saúde)
										serão mantidos em arquivo digital seguro por um período de
										20 anos.
									</span>
								</p>
							</div>
