					...
					<Card className="max-w-md w-full shadow-lg">
						...
						<CardContent className="text-center space-y-4">
							<p className="text-gray-600">
								Seu cadastro foi realizado com sucesso e está aguardando
								aprovação da nossa equipe administrativa.
							</p>
							...
							<p className="text-sm text-gray-500">
								Se você acredita que isso é um erro ou precisa de acesso
								urgente, entre em contato com o administrador.
							</p>
						</CardContent>
