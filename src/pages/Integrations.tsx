...
export default function Integrations() {
  ...
  return (
    <PageLayout>
      <PageContainer>
        <PageHeader title="Integrações Google" />
          ...
          <div className="grid gap-6 md:grid-cols-2">
              ...
              <CardContent>
                <ul className="mb-4 space-y-2 text-sm text-gray-600">
                  <li className="flex gap-2">
                    <CheckCircle2 className="h-4 w-4 text-green-500" /> Bloqueia horários pessoais
                    na agenda da clínica.
                  </li>
                  <li className="flex gap-2">
                    <CheckCircle2 className="h-4 w-4 text-green-500" /> Envia agendamentos para seu
                    celular.
                  </li>
                </ul>
                <Button
            ...
            <Card>
              ...
              <CardContent>
                <ul className="mb-4 space-y-2 text-sm text-gray-600">
                  <li className="flex gap-2">
                    <CheckCircle2 className="h-4 w-4 text-green-500" /> Cria links de reunião
                    automaticamente.
                  </li>
                  <li className="flex gap-2">
                    <CheckCircle2 className="h-4 w-4 text-green-500" /> Sala de espera virtual.
                  </li>
                </ul>
            ...
            <Card>
              ...
              <CardContent>
                <ul className="mb-4 space-y-2 text-sm text-gray-600">
                  <li className="flex gap-2">
                    <CheckCircle2 className="h-4 w-4 text-green-500" /> Autocomplete de endereços no
                    cadastro.
                  </li>
                  <li className="flex gap-2">
                    <CheckCircle2 className="h-4 w-4 text-green-500" /> Mapas de localização para
                    pacientes.
                  </li>
                </ul>
                <Button disabled variant="outline" className="w-full">
