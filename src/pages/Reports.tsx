  ...
  const reportsData = useMemo(() => {
    ...
    return {
      patients: {
        ...
        newThisMonth:
          patients?.filter((p) => new Date(p.created_at).getMonth() === currentMonth).length || 0,
      ...
      <PageContainer>
        ...
        <div className="space-y-4 sm:space-y-6 animate-fade-in pb-20 md:pb-0">
          ...
          <section className="animate-in fade-in slide-in-from-bottom-4 duration-700">
            <Suspense
              fallback={<Card className="h-48 animate-pulse bg-muted/30 border-border/50" />}
            >
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4 sm:space-y-6">
                ...
                <CardHeader>
                  <CardTitle className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <div className="relative w-full sm:w-auto">
                      ...
                      <Input placeholder="Buscar relatórios..." className="pl-10 w-full sm:w-64" />
                    </div>
                  </CardTitle>
                </CardHeader>
                <CardContent>
            ...
            <TabsContent value="analytics" className="space-y-6">
              <Suspense
                fallback={<Card className="h-64 animate-pulse bg-muted/30 border-border/50" />}
              >
                <AdvancedAnalytics />
              </Suspense>
            </TabsContent>
