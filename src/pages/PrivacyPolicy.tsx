          ...
          <div className="prose prose-slate dark:prose-invert max-w-none space-y-6 text-sm">
            ...
            <section>
              ...
              <ul>
                ...
                <li>
                  <strong>Dados clínicos (sensíveis)</strong>: prontuário, evoluções de atendimento,
                  escalas funcionais (EVA, DASH, Oswestry etc.), exames, fotos clínicas, áudio de
                  transcrição assistida — usados exclusivamente para tutela da sua saúde.
                </li>
                <li>
            ...
            <section>
              ...
              <p>
                ...
                descartados pela clínica. Dados podem ser arquivados em armazenamento de longo prazo
                (Cloudflare R2), mantendo nível de segurança equivalente (criptografia AES-256 em
                repouso, TLS 1.3 em trânsito, controle de acesso por organização).
              </p>
            </section>
            ...
            <section>
              ...
              <p className="bg-amber-50 dark:bg-amber-950/30 border border-amber-200 dark:border-amber-900 rounded-lg p-3 text-amber-900 dark:text-amber-100">
                <strong>Importante:</strong> o direito de eliminação <strong>não se aplica</strong>{" "}
                aos dados clínicos durante o prazo legal de guarda obrigatória (20 anos). Pedidos de
                eliminação total serão respondidos com manutenção do prontuário sob base legal do
                art. 16, II da LGPD, mas dados cadastrais e de marketing podem ser excluídos a
                qualquer momento.
              </p>
              <p>
            ...
            <section>
              ...
              <ul>
                <li>
                  <strong>Profissionais de saúde</strong> envolvidos diretamente no seu atendimento.
                </li>
                <li>
            ...
            <section>
              ...
              <p>
                Usamos cookies essenciais para autenticação e sessão. Cookies analíticos (PostHog)
                são utilizados sob consentimento explícito.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                Esta política pode ser revisada periodicamente. Mudanças materiais serão comunicadas
                por e-mail e exibidas no portal antes de entrar em vigor.
              </p>
            </section>
