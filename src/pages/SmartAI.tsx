                        ...
                        <div className="relative group/content">
                          ...
                          <div className="text-sm prose dark:prose-invert max-w-none prose-p:leading-relaxed prose-pre:bg-muted/50 prose-pre:p-2 prose-pre:rounded-md prose-headings:text-foreground prose-a:text-primary prose-a:no-underline hover:prose-a:underline">
                            <ReactMarkdown
                              ...
                              components={{
                                h1: ({ _node, ...props }) => <h1 className="text-lg font-bold mt-4 mb-2 first:mt-0" {...props} />,
                                h2: ({ _node, ...props }) => <h2 className="text-base font-bold mt-3 mb-2" {...props} />,
                                h3: ({ _node, ...props }) => <h3 className="text-sm font-bold mt-2 mb-1" {...props} />,
                                p: ({ _node, ...props }) => <p className="mb-2 last:mb-0 leading-relaxed" {...props} />,
                                ul: ({ _node, ...props }) => <ul className="list-disc pl-4 mb-2 space-y-1" {...props} />,
                                ol: ({ _node, ...props }) => <ol className="list-decimal pl-4 mb-2 space-y-1" {...props} />,
                                li: ({ _node, ...props }) => <li className="pl-1" {...props} />,
                                strong: ({ _node, ...props }) => <strong className="font-bold text-foreground" {...props} />,
                                code: ({ _node, ...props }) => <code className="bg-muted-foreground/20 rounded px-1 py-0.5 font-mono text-xs" {...props} />,
                                blockquote: ({ _node, ...props }) => <blockquote className="border-l-4 border-primary/30 pl-4 italic my-2 text-muted-foreground" {...props} />,
                                a: ({ _node, ...props }) => <a target="_blank" rel="noopener noreferrer" {...props} />,
                                table: ({ _node, ...props }) => <div className="overflow-x-auto my-4 rounded-md border"><table className="w-full text-sm text-left" {...props} /></div>,
                                thead: ({ _node, ...props }) => <thead className="bg-muted text-muted-foreground font-medium" {...props} />,
                                tbody: ({ _node, ...props }) => <tbody className="divide-y" {...props} />,
                                tr: ({ _node, ...props }) => <tr className="hover:bg-muted/50 transition-colors" {...props} />,
                                th: ({ _node, ...props }) => <th className="px-4 py-2 font-medium" {...props} />,
