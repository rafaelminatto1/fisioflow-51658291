				...
				<Alert className="bg-blue-500/10 border-blue-500/20 text-blue-800 dark:text-blue-300 shadow-sm">
					<div className="flex items-start gap-3">
						...
						<AlertDescription className="text-sm">
							...
							Nossa inteligência artificial agora conta com um 'escudo'
							(Gateway) próprio. Consultas clínicas idênticas são devolvidas em
							milissegundos graças à memória temporária, e os dados dos
							pacientes têm uma barreira de proteção extra antes de tocar nos
							motores de IA.
						</AlertDescription>
					</div>
				</Alert>
