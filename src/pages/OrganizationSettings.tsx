...
export default function OrganizationSettings() {
	...
	if (currentOrganization && !formDirty) {
		...
		if (orgCity !== (currentOrganization.city ?? ""))
			setOrgCity(currentOrganization.city ?? "");
	}
								...
								<CardContent className="space-y-4 max-w-md">
									...
									<div className="space-y-2">
										...
										<p className="text-xs text-muted-foreground">
											Usado em URLs e integrações. Apenas letras minúsculas,
											números e hifens.
										</p>
									</div>
									<div className="space-y-2">
										...
										/>
										<p className="text-xs text-muted-foreground">
											Usada para gerar QR Code Pix dinâmico em cada recibo
											emitido aos pacientes.
										</p>
									</div>
									<div className="space-y-2">
										...
										/>
										<p className="text-xs text-muted-foreground">
											Aparece no QR Code Pix. Máx. 15 caracteres (limite do
											padrão EMV).
										</p>
									</div>
									<Button
										...
										<div className="flex items-start gap-3">
											...
											<div className="flex-1">
												...
												<p className="text-xs text-muted-foreground mt-1">
													Configure webhooks, Google Calendar, WhatsApp e outras
													integrações.
												</p>
												<Button
													variant="link"
									...
									<CardContent className="pt-6">
										<div className="flex items-start gap-3">
											...
											<div className="flex-1">
												...
												<p className="text-xs text-muted-foreground mt-1">
													2FA, logs de acesso, permissões avançadas e políticas
													de senha.
												</p>
												<Button
													variant="link"
					...
					<DialogContent>
						...
						<DialogFooter>
							...
							<Button
								...
								disabled={
									isAdding || (!inviteUserId.trim() && !inviteEmail.trim())
								}
								className="gap-2"
							>
					...
					<AlertDialogContent>
						<AlertDialogHeader>
							...
							<AlertDialogDescription>
								...
								<strong>
									{removeTarget?.user?.name ?? removeTarget?.user_id}
								</strong>{" "}
