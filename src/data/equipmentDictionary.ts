...
export const equipmentDictionary: (PhysioDictionaryEntry | {category: string})[] = [
  ...
  },
  {
    ...
    description_pt: 'Bandas com níveis variados de tensão comumente usadas em exercícios isotônicos resistidos.'
  },
  {
    id: 'eq_mini_band',
    pt: 'Mini Band',
  ...
  },
  {
    ...
    en: 'Swiss Ball',
    category: 'equipment' as any,
    aliases_pt: ['Bola suíça', 'Bola de Pilates', 'Bola de estabilidade', 'Bola de Bobath', 'Gymball'],
    aliases_en: ['Stability ball', 'Exercise ball', 'Gym ball', 'Physio ball'],
    description_pt: 'Bola ampla insuflável para gerar bases instáveis ou suportes confortáveis passivos.'
  },
  {
    id: 'eq_bosu',
  ...
  },
  {
    ...
    description_pt: 'Peso livre em formato oval assemelhando-se a uma chaleira para exercícios de swing.'
  },
  {
    id: 'eq_slanted_board',
    ...
    description_pt: 'Superfície de plano inclinado adaptável sob os pés, ótima para reabilitação patelar ou aquiliano.'
  }
] as any[];
