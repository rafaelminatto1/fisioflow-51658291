	...
	posture: {
		...
		guidedTemplates: [
			...
			},
			{
				...
				reportFocus: ["mudança perceptível", "manutenção do padrão de captura", "aderência visual ao tratamento"],
				clinicalQuestions: [
	...
	functional: {
		...
		guidedTemplates: [
			...
			},
			{
				...
				reportFocus: ["estabilidade em apoio único", "alinhamento de pelve", "alcance com controle"],
				clinicalQuestions: [
