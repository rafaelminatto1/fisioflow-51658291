...
export const clinicalReasoningRules: ActionRule[] = [
  {
    ...
    suggestions: [
      {
        ...
        content:
          "Atenção: Sinais de alerta detectados. Recomenda-se avaliação médica imediata ou monitoramento rigoroso.",
        priority: "high",
      },
      {
        type: "precaution",
    ...
    reasoning:
      "A presença de red flags pode indicar patologias sistêmicas ou compressões neurológicas graves que contraindicam a fisioterapia convencional imediata.",
  },
  {
    id: "rule-de-quervain",
    ...
    reasoning:
      "O teste de Finkelstein positivo é indicativo de irritação dos tendões do abdutor longo e extensor curto do polegar.",
  },
  {
    ...
    suggestions: [
      {
        ...
        content:
          "Teste de Thompson positivo indica perda de continuidade do tendão. Encaminhar para ortopedia.",
        priority: "high",
      },
      {
        type: "precaution",
    ...
    reasoning:
      "A ausência de flexão plantar ao comprimir a panturrilha (Thompson) é um sinal clássico de ruptura total do tendão de Aquiles.",
  },
  {
    ...
    suggestions: [
      ...
      },
      {
        ...
        content:
          "Priorize movimentos que centralizem a dor e reduzam os sintomas distais nos braços.",
        priority: "high",
      },
    ],
    reasoning:
      "O cluster de Wainner tem alta acurácia diagnóstica quando 3 ou 4 testes são positivos.",
  },
  {
    ...
    suggestions: [
      ...
      },
      {
        ...
        content:
          "Evitar exercícios de extensão de joelho em cadeia aberta (0-45º) para reduzir estresse no enxerto/ligamento.",
        priority: "high",
      },
    ],
    reasoning:
      "Testes de Lachman ou Gaveta Anterior positivos indicam alta probabilidade de lesão do Ligamento Cruzado Anterior.",
  },

  {
    ...
    suggestions: [
      ...
      },
      {
        ...
        content:
          "Evitar atividades de alto impacto ou mudanças bruscas de direção na fase inicial.",
        priority: "medium",
      },
    ],
    reasoning:
      "A combinação de dor na interlinha articular com testes compressivos positivos (McMurray/Thessaly) aumenta a especificidade diagnóstica.",
  },
  {
    ...
    suggestions: [
      {
        ...
        content:
          "Considere o uso de PNE (Neurociência da Dor) e evite condutas puramente passivas.",
        priority: "high",
      },
      {
        type: "exercise",
    ...
    reasoning:
      "Pontuação acima de 40 no CSI correlaciona-se com quadros de sensibilização central e dor persistente.",
  },
  {
    ...
    suggestions: [
      ...
      },
      {
        ...
        content:
          "Pacientes hipermóveis devem evitar o fim da amplitude passiva sem controle muscular.",
        priority: "medium",
      },
    ],
    reasoning:
      "Um escore de Beighton >= 5 em adultos indica hipermobilidade articular sistêmica, exigindo maior foco em estabilização.",
  },
  {
    ...
    reasoning:
      "O teste de Spurling e o de Distração são os componentes mais específicos do cluster de Wainner para radiculopatia.",
  },
  {
    ...
    suggestions: [
      {
        ...
        content:
          "Foco inicial em controle escapular e analgesia, progredindo para fortalecimento do manguito rotador.",
        priority: "high",
      },
      {
        type: "exercise",
    ...
    reasoning:
      "A positividade em múltiplos testes de impacto sugere redução do espaço subacromial ou tendinopatia do manguito.",
  },
  {
    ...
    reasoning:
      "Sinais de frouxidão ligamentar lateral exigem reabilitação sensório-motora agressiva para evitar entorses recorrentes.",
  },
  {
    ...
    reasoning:
      "A centralização dos sintomas com movimentos de extensão é o indicador mais forte de bom prognóstico no método McKenzie.",
  },
  {
    ...
    reasoning:
      "Diretrizes atuais recomendam o fortalecimento de posterolateral de quadril como pilar para o tratamento da dor patelofemoral.",
  },
  {
    ...
    reasoning:
      "O estímulo mecânico controlado via exercícios excêntricos promove a remodelação tendínea na epicondilite lateral.",
  },
  {
    ...
    suggestions: [
      {
        ...
        content:
          "Critérios de estabilidade atingidos. Iniciar carga progressiva e treino de marcha.",
        priority: "high",
      },
    ],
    reasoning:
      "Quando os testes de gaveta e Lachman se tornam negativos ou estáveis, o foco deve migrar da proteção para a carga funcional.",
  },
  {
    ...
    reasoning:
      "O teste de Windlass e a dor no tubérculo medial do calcâneo são marcos clínicos da fasciopatia plantar.",
  },
  {
    ...
    reasoning:
      "Disfunções vestibulares exigem reabilitação específica de reflexos oculares e manobras de reposicionamento.",
  },
];
