...
const lowerBody: PhysioDictionaryEntry[] = [
  ...
  ex(
    ...
    "Monster Walk",
    "Monster Walk",
    ["caminhada com faixa", "banda lateral", "caminhada do siri"],
    ["banded walk", "lateral band walk", "crab walk"],
    "Quadril",
    ...
    "Dynamic exercise for hip abductor activation in closed chain.",
    {
      ...
      image_url: "/exercises/illustrations/caminhada-siri-miniband.png",
...
const upperBody: PhysioDictionaryEntry[] = [
  ...
  ex(
    ...
    "Spanish Squat",
    ["agachamento com elastico atrás do joelho"],
    ["isometric squat with band"],
    "Joelho",
    "Agachamento isométrico para tendinopatia patelar.",
    "Isometric squat for patellar tendinopathy.",
    {
      intensity_level: 3,
      target_outcome: ["Analgesia", "Força"],
      required_equipment: ["Faixa Elástica"],
      suggested_sets: 3,
      suggested_reps: 45,
      suggested_rpe: "7-8",
  ...
  ex(
    "exd-copenhagen-lvl1",
    "Copenhagen Adduction (Nível 1)",
    "Copenhagen Adduction (Level 1)",
    ["aducao copenhagen"],
    ["adductor bridge"],
    "Quadril",
    "Fortalecimento de adutores para prevenção de pubalgia.",
    "Adductor strengthening for pubalgia prevention.",
    {
      intensity_level: 4,
      target_outcome: ["Força", "Prevenção"],
      required_equipment: ["Banco/Cadeira"],
      suggested_sets: 3,
      suggested_reps: 8,
      suggested_rpe: "8-9",
...
const coreSpine: PhysioDictionaryEntry[] = [
  ...
  ex(
    "exd-prancha-toque-ombro",
    "Prancha com Toque no Ombro",
    "Shoulder Tap Plank",
    ["prancha com toque", "toque no ombro"],
    ["shoulder taps", "high plank taps"],
    "Core",
    "Estabilização dinâmica do core com componente anti-rotacional.",
    "Dynamic core stabilization with anti-rotational component.",
    {
      intensity_level: 3,
      target_outcome: ["Estabilidade", "Força"],
      suggested_sets: 3,
      suggested_reps: 12,
      suggested_rpe: "7-8",
      progression_suggestion: "Aumentar a velocidade ou reduzir a base dos pés.",
      instruction_pt:
        "Em posição de prancha alta, toque o ombro oposto com uma das mãos, mantendo o quadril o mais imóvel possível.",
      image_url: "/exercises/illustrations/prancha-toque-ombro.png",
      indicated_pathologies: ["Estabilidade de Core", "Reabilitação de Ombro"],
      contraindicated_pathologies: ["Instabilidade Aguda de Ombro"],
      precaution_level: "supervised",
      scientific_references: [
        {
          title: "Core Stability Guidelines",
          year: 2024,
  ...
  ex(
    ...
    "McKenzie Extension",
    ["mckenzie", "press up", "extensao de tronco", "cobra"],
    ...
    "Centralization protocol for disc herniation.",
    {
      ...
      image_url: "/exercises/illustrations/extensao-tronco-cobra.png",
  ...
  ex(
    ...
    "Improving rotational mobility of the thoracic spine.",
    {
      ...
      image_url: "/exercises/illustrations/mobilidade-toracica-open-book.png",
  ...
  ex(
    ...
    "Abdominal Crunch",
    "Abdominal Crunch",
    ["abdominal clássico", "flexão de tronco"],
    ["abs crunch"],
    "Core",
    "Fortalecimento da musculatura anterior do abdômen.",
    "Strengthening of the anterior abdominal muscles.",
    {
      intensity_level: 2,
      target_outcome: ["Resistência", "Força"],
      suggested_sets: 3,
      suggested_reps: 15,
      suggested_rpe: "6-7",
      progression_suggestion: "Adicionar carga ou realizar em superfície instável.",
      instruction_pt: "Deitado de costas, eleve as escápulas do chão contraindo o abdômen.",
      image_url: "/exercises/illustrations/abdominal-crunch.avif",
    },
  ),
];
...
const mobility: PhysioDictionaryEntry[] = [
  ex(
    ...
    "Ankle Mobilization",
    ["mobilidade de tornozelo", "dorsiflexao em carga", "mobilidade de tornozelo na parede"],
    ...
    "Mobilization for dorsiflexion range of motion gain.",
    {
      ...
      image_url: "/exercises/illustrations/mobilidade-tornozelo-parede.png",
