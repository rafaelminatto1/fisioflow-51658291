...
export const physioDictionary: PhysioDictionaryEntry[] = [
	...
	},
	{
		...
		aliases_pt: ['esporão', 'dor na sola do pé', 'M72.2'],
	...
	},
	{
		...
		pt: 'Ciática',
		en: 'Sciatica',
		aliases_pt: ['dor ciática', 'nervo ciático', 'lombociatalgia', 'M54.3', 'M54.4'],
	...
	},
	{
		...
		pt: 'Dor Lombar',
		en: 'Low Back Pain',
		aliases_pt: ['lombalgia', 'dor nas costas', 'LBP', 'M54.5'],
		aliases_en: ['lumbago', 'low back pain'],
		category: 'condition',
	},
	{
		id: 'con_neck_pain',
		...
		aliases_en: ['cervicalgia', 'stiff neck'],
		category: 'condition',
	},
	{
		...
		aliases_pt: ['manguito rotador', 'tendinite de ombro', 'M75.1', 'M75.4'],
		aliases_en: ['rotator cuff syndrome', 'subacromial impingement'],
		category: 'condition',
	},
	{
		id: 'con_acl_injury',
		pt: 'Lesão de LCA',
		en: 'ACL Injury',
		aliases_pt: ['ruptura de cruzado anterior', 'entorse de joelho', 'S83.5'],
	...
	},
	{
		...
		en: 'Ankle Sprain',
		aliases_pt: ['virada de pé', 'lesão ligamentar tornozelo', 'S93.4'],
		aliases_en: ['twisted ankle', 'lateral ankle sprain'],
		category: 'condition',
	},
