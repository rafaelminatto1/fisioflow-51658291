...
function createClinicalIllustration(title: string, subtitle: string, preset: IllustrationPreset) {
...
function createBuiltinTest(input: BaseCatalogInput): ClinicalTestCatalogRecord {
  return {
    ...
    image_url:
      input.imageUrl ??
      createClinicalIllustration(input.name, input.target_joint, input.illustration),
    ...
    regularity_sessions:
      input.category === "Pós-Operatório" ? 2 : input.category === "Esportiva" ? 4 : null,
    layout_type: null,
    is_custom: false,
    is_builtin: true,
...
export const builtinClinicalTestsCatalog: ClinicalTestCatalogRecord[] = [
    ...
    fieldsDefinition: [
      {
        ...
        label: "Grau",
        type: "select",
        options: ["Grau 0 (Normal)", "Grau 1 (Glide)", "Grau 2 (Clunk)", "Grau 3 (Gross)"],
      },
    ],
    lr_positive: 28.0,
    lr_negative: 0.8,
  ...
  createBuiltinTest({
    ...
    fieldsDefinition: [{ id: "nprs_pain", label: "Intensidade da Dor (0-10)", type: "nprs" }],
    lr_positive: 1.9,
    lr_negative: 0.3,
    cluster_id: "cluster-subacromial-impingement",
  }),
  ...
  createBuiltinTest({
    ...
    fieldsDefinition: [{ id: "seconds", label: "Tempo (segundos)", type: "number" }],
  }),
  createBuiltinTest({
  ...
  createBuiltinTest({
    ...
    sensitivity_specificity: "Sensibilidade: ~0.65, Especificidade: ~0.70 (Consenso Clínico).",
  ...
  createBuiltinTest({
    ...
    sensitivity_specificity: "Confiabilidade: ICC > 0.85 (Delahunt et al. 2011).",
  ...
  createBuiltinTest({
    ...
    fieldsDefinition: [{ id: "time_to_symptoms", label: "Tempo (s)", type: "number" }],
    lr_positive: 1.5,
    lr_negative: 0.5,
  }),
  createBuiltinTest({
    ...
    fieldsDefinition: [
      {
        ...
        type: "select",
        options: ["Território Mediano", "Território Ulnar", "Território Radial"],
      },
    ],
    lr_positive: 1.6,
    lr_negative: 0.7,
  ...
  createBuiltinTest({
    ...
    fieldsDefinition: [{ id: "time_sustained", label: "Tempo (s)", type: "number" }],
  }),
  createBuiltinTest({
    id: "builtin-ely-test",
    name: "Teste de Ely",
    ...
    sensitivity_specificity: "Sensibilidade: 0.56-0.59, Especificidade: 0.64-0.85.",
  ...
  createBuiltinTest({
    ...
    illustration: "shoulder-impingement",
    fieldsDefinition: [{ id: "nprs_pain", label: "Dor no Sulco (0-10)", type: "nprs" }],
  }),
  createBuiltinTest({
  ...
  createBuiltinTest({
    ...
    fieldsDefinition: [{ id: "palpation", label: "Tendão Palpável", type: "boolean" }],
  }),
  createBuiltinTest({
  ...
  createBuiltinTest({
    ...
    fieldsDefinition: [{ id: "pain_intensity", label: "Intensidade da Dor", type: "nprs" }],
  }),
  createBuiltinTest({
    ...
    fieldsDefinition: [{ id: "total_score", label: "Pontuação Total (0-56)", type: "number" }],
  }),
  createBuiltinTest({
  ...
  createBuiltinTest({
    ...
    fieldsDefinition: [{ id: "sppb_total", label: "Escore SPPB (0-12)", type: "number" }],
  }),
];
...
export function mergeClinicalTestsCatalog(
  ...
  for (const remoteTest of remoteTests) {
    ...
    const remoteIsCustom =
      (remoteTest as ClinicalTestCatalogRecord).is_custom ?? Boolean(remoteTest.organization_id);
    ...
    merged.set(key, {
      ...
      execution:
        ...
        null,
      positive_sign:
        (remoteTest as ClinicalTestCatalogRecord).positive_sign ?? builtin?.positive_sign ?? null,
      positive_criteria: remoteTest.positive_criteria ?? builtin?.positive_criteria ?? null,
      reference: (remoteTest as ClinicalTestCatalogRecord).reference ?? builtin?.reference ?? null,
      ...
      initial_position_image_url:
        remoteTest.initial_position_image_url ?? builtin?.initial_position_image_url ?? null,
      final_position_image_url:
        remoteTest.final_position_image_url ?? builtin?.final_position_image_url ?? null,
      media_urls:
      ...
      regularity_sessions:
        ...
        null,
      layout_type:
        (remoteTest as ClinicalTestCatalogRecord).layout_type ?? builtin?.layout_type ?? null,
      ...
      evidence_summary: builtin?.evidence_summary ?? "Teste criado ou adaptado pela equipe.",
  ...
  return Array.from(merged.values()).sort((left, right) => {
    ...
    const leftCategory =
      categoryOrder[(left.category as keyof typeof categoryOrder) ?? "Ortopedia"] ?? 99;
    const rightCategory =
      categoryOrder[(right.category as keyof typeof categoryOrder) ?? "Ortopedia"] ?? 99;
