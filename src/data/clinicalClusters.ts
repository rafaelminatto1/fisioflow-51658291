...
export const diagnosticClusters: ClinicalDiagnosticCluster[] = [
    {
        ...
        interpretation: "A presença de 3 ou mais testes positivos aumenta significativamente a probabilidade de impacto subacromial.",
        logic: "min_count",
    ...
    },
    {
        ...
        tests: [
            "builtin-drop-arm-test",
            "builtin-external-rotation-lag-sign",
            "builtin-painful-arc"
        ],
        interpretation: "A combinação de arco doloroso, queda do braço e lag de rotação externa é altamente preditiva de ruptura.",
        logic: "min_count",
    ...
    },
    {
        ...
        tests: [
            "builtin-lachman-test",
            "builtin-anterior-drawer-test",
            "builtin-pivot-shift-test"
        ],
    ...
    },
    {
        ...
        tests: [
            "builtin-mcmurray-test",
            "builtin-joint-line-tenderness",
            "builtin-thessaly-test"
        ],
