...
export const knowledgeBase: KnowledgeArticle[] = [
  ...
  },
  {
    ...
    observations: ["Boa base para protocolos de dor e funcao em ombro degenerativo."],
  ...
  },
  {
    ...
    observations: ["Boa referencia para padronizar bundles de pos-operatorio e alta funcional."],
  ...
  },
  {
    ...
    observations: ["Complementa a CPG com panorama comparativo das estrategias de reabilitacao."],
  ...
  },
  {
    ...
    keyQuestions: ["Quais componentes realmente diferenciam um bom protocolo pos-THA?"],
    metadata: {
      attachments: [
        {
  ...
  },
  {
    ...
    observations: ["Bom artigo-base para trilhas de pre-op em artroplastia de quadril."],
  ...
  },
  {
    ...
    observations: ["Priorizar em pacientes com boa tolerancia a treino e perda funcional pre-op."],
  ...
  },
  {
    ...
    title: "Return-to-Play and Rehabilitation Protocols Following Isolated Meniscal Repair",
    group: "Pos-operatorio esportivo",
    subgroup: "Joelho",
    focus: ["Carga", "ROM", "RTS"],
    evidence: "SystematicReview",
  ...
  },
  {
    ...
    observations: ["Usar para calibrar sling, progressao de movimento e expectativas por fase."],
