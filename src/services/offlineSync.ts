...
class OfflineSyncService {
   ...
   */
  private async processAction(action: QueuedAction, db: IDBPDatabase<FisioFlowDB>): Promise<void> {
    try {
      // Execute the action
  ...
  private async executeAction(action: QueuedAction): Promise<void> {
    ...
    switch (actionType) {
      ...
      case ACTION_TYPES.UPDATE_GOAL:
        await goalsApi.update(String((payload as PayloadWithId).id), payload as any);
        break;
      ...
      case ACTION_TYPES.UPDATE_PATIENT:
        await patientsApi.update(String((payload as PayloadWithId).id), payload as any);
        break;
      case ACTION_TYPES.CREATE_APPOINTMENT:
        await appointmentsApi.create(payload as any);
        break;
      case ACTION_TYPES.UPDATE_APPOINTMENT:
        await appointmentsApi.update(String((payload as PayloadWithId).id), payload as any);
        break;
