...
>;
type PoseLandmarkerResultType = import("@mediapipe/tasks-vision").PoseLandmarkerResult;
...
export const processVideo = async (
  ...
  while (currentTime < duration) {
    ...
    const result: PoseLandmarkerResultType = landmarker.detectForVideo(videoElement, timestampMs);
