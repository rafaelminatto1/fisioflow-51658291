...
export async function generateBirthdayTemplate(
  ...
  try {
    ...
    const fallbackTemplate =
      DEFAULT_BIRTHDAY_TEMPLATES[relationship as keyof typeof DEFAULT_BIRTHDAY_TEMPLATES];
...
export async function generateRecallTemplate(
  ...
  try {
    ...
    const fallbackTemplate =
      DEFAULT_RECALL_TEMPLATES[motivationType as keyof typeof DEFAULT_RECALL_TEMPLATES];
