...
export const TUSS_FISIO_LIST: TUSSCode[] = [
  // CONSULTA E AVALIAÇÃO
  {
    ...
    description:
      "Avaliação inicial para diagnóstico fisioterapêutico e elaboração do plano de tratamento.",
  ...
  // FISIOTERAPIA / TRAUMATO-ORTOPEDIA (SESSÕES)
  {
    ...
    description:
      "Sessão completa para tratamento de um membro (ex: braço ou perna). Inclui Ultrassom, TENS e calor.",
    category: "fisioterapia",
  },
  {
    code: "20103492",
    ...
    description:
      "Sessão para reabilitação de múltiplos membros ou segmentos corporais simultaneamente.",
    category: "fisioterapia",
  },
  {
    code: "20103506",
    ...
    description:
      "Atendimento fisioterapêutico focado em um segmento da coluna (Cervical, Torácica ou Lombar).",
    category: "fisioterapia",
  },
  {
    code: "20103514",
  ...
  },
  {
    ...
    description:
      "Fisioterapia focada na reabilitação funcional após intervenções cirúrgicas ortopédicas.",
    category: "fisioterapia",
  },
  ...
  // ELETROTERAPIA E LASER (ESPECÍFICOS)
  {
    ...
    description:
      "Aplicação isolada de eletroestimulação transcutânea para analgesia e alívio de dor.",
    category: "fisioterapia",
  },
  {
    code: "20104014",
    ...
    description:
      "Tratamento que utiliza luz (como Laser de Baixa Intensidade) para cicatrização e inflamação.",
    category: "fisioterapia",
  },
  ...
  // RPG E POSTURA
  {
    ...
    description:
      "Reeducação Postural Global para correção de escolioses, hipercifoses e desvios da coluna.",
    category: "rpg",
  },
  {
    code: "20103999",
  ...
  // PILATES E CINESIOTERAPIA
  {
    ...
    description:
      "Exercícios terapêuticos focados em controle motor, fortalecimento e estabilização.",
    category: "pilates",
  },
  {
    code: "20103115",
    ...
    description:
      "Utilizado para Liberação Miofascial, Maitland, Mulligan e mobilizações articulares.",
    category: "fisioterapia",
  },
  ...
  // ACUPUNTURA
  {
    ...
    description:
      "Sessão tradicional de inserção de agulhas para tratamento de dores e desequilíbrios.",
    category: "acupuntura",
  },
  {
    code: "50000462",
  ...
  // TERAPIA MANUAL E OUTROS
  {
    ...
    description:
      "Ajustes de alta velocidade (estalidos) e manobras de quiropraxia clínica na coluna.",
    category: "fisioterapia",
  },
  {
    code: "20103212",
