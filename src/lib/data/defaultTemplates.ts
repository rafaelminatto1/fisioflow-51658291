...
} from "@/hooks/useExerciseTemplates";
...
export interface DefaultTemplateData
	...
	items: Omit<
		ExerciseTemplateItem,
		"id" | "template_id" | "created_at" | "exercise_id"
	>[]; // Items contain search criteria or placeholders
}
...
export const defaultTemplates: DefaultTemplateData[] = [
	{
		...
		description:
			"Protocolo de fase final para retorno ao esporte após reconstrução de LCA. Foco em pliometria, agilidade e força explosiva.",
	...
	},
	{
		...
		description:
			"Exercícios focados em estabilidade de core, propriocepção e fortalecimento excêntrico para atletas.",
	...
	},
	{
		...
		description:
			"Exercícios de mobilidade e controle motor para lombalgia aguda.",
		category: "patologia",
	...
	},
	{
		...
		description:
			"Fortalecimento de manguito rotador e estabilizadores de escápula.",
		category: "patologia",
