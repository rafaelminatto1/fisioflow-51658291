...
export const FRONT_MUSCLE_GROUPS: MuscleGroup[] = [
	{
		...
		muscles: [
			...
			{
				code: "orbicularis_oculi",
				name: "Orbicular dos Olhos",
				nameEn: "Orbicularis Oculi",
			},
			{ code: "nasalis", name: "Nasal", nameEn: "Nasalis" },
			{
				code: "orbicularis_oris",
	...
	},
	{
		...
		muscles: [
			{
				code: "deltoid_anterior_left",
				name: "Deltoide Anterior",
				nameEn: "Anterior Deltoid",
			},
			{
				code: "pectoralis_minor_left",
				name: "Peitoral Menor",
				nameEn: "Pectoralis Minor",
			},
			{
				code: "supraspinatus_left",
				name: "Supraespinhoso",
				nameEn: "Supraspinatus",
			},
			{
				code: "coracobrachialis_left",
				name: "Coracobraquial",
	...
	},
	{
		...
		muscles: [
			{
				code: "deltoid_anterior_right",
				name: "Deltoide Anterior",
				nameEn: "Anterior Deltoid",
			},
			{
				code: "pectoralis_minor_right",
				name: "Peitoral Menor",
				nameEn: "Pectoralis Minor",
			},
			{
				code: "supraspinatus_right",
				name: "Supraespinhoso",
				nameEn: "Supraspinatus",
			},
			{
				code: "coracobrachialis_right",
				name: "Coracobraquial",
				nameEn: "Coracobrachialis",
			},
		],
	},
	{
		...
		muscles: [
			{
				code: "pectoralis_major_clavicular_left",
				name: "Peitoral Maior Clavicular",
				nameEn: "Clavicular Pectoralis",
			},
			{
				code: "pectoralis_major_sternal_left",
				name: "Peitoral Maior Esternal",
				nameEn: "Sternal Pectoralis",
			},
			{
				code: "serratus_anterior_left",
				name: "Serrátil Anterior",
				nameEn: "Serratus Anterior",
			},
			{
				code: "intercostals_left",
				name: "Intercostais",
				nameEn: "Intercostals",
			},
		],
	},
	{
		...
		muscles: [
			{
				code: "pectoralis_major_clavicular_right",
				name: "Peitoral Maior Clavicular",
				nameEn: "Clavicular Pectoralis",
			},
			{
				code: "pectoralis_major_sternal_right",
				name: "Peitoral Maior Esternal",
				nameEn: "Sternal Pectoralis",
			},
			{
				code: "serratus_anterior_right",
				name: "Serrátil Anterior",
				nameEn: "Serratus Anterior",
			},
			{
				code: "intercostals_right",
				name: "Intercostais",
				nameEn: "Intercostals",
			},
		],
	...
	},
	{
		...
		muscles: [
			{
				code: "biceps_brachii_right",
				name: "Bíceps Braquial",
				nameEn: "Biceps Brachii",
			},
			{ code: "brachialis_right", name: "Braquial", nameEn: "Brachialis" },
			{
				code: "coracobrachialis_arm_right",
				name: "Coracobraquial",
				nameEn: "Coracobrachialis",
			},
			{
				code: "triceps_brachii_long_right",
				name: "Tríceps Braquial (cabeça longa)",
				nameEn: "Long Head Triceps",
			},
		],
	},
	{
		...
		muscles: [
			{
				code: "rectus_abdominis_upper",
				name: "Reto Abdominal Superior",
				nameEn: "Upper Rectus Abdominis",
			},
			{
				code: "external_oblique_upper_left",
				name: "Obliquo Externo Esq.",
				nameEn: "External Oblique",
			},
			{
				code: "external_oblique_upper_right",
				name: "Obliquo Externo Dir.",
				nameEn: "External Oblique",
			},
			{
				code: "internal_oblique_upper",
				name: "Obliquo Interno",
	...
	},
	{
		...
		muscles: [
			{
				code: "flexor_carpi_radialis_left",
				name: "Flexor Radial do Carpo",
				nameEn: "Flexor Carpi Radialis",
			},
			{
				code: "flexor_carpi_ulnaris_left",
				name: "Flexor Ulnar do Carpo",
				nameEn: "Flexor Carpi Ulnaris",
			},
			{
				code: "palmaris_longus_left",
				name: "Palmar Longo",
				nameEn: "Palmaris Longus",
			},
			{
				code: "flexor_digitorum_left",
				name: "Flexor dos Dedos",
				nameEn: "Flexor Digitorum",
			},
			{
				code: "pronator_teres_left",
	...
	},
	{
		...
		muscles: [
			{
				code: "flexor_carpi_radialis_right",
				name: "Flexor Radial do Carpo",
				nameEn: "Flexor Carpi Radialis",
			},
			{
				code: "flexor_carpi_ulnaris_right",
				name: "Flexor Ulnar do Carpo",
				nameEn: "Flexor Carpi Ulnaris",
			},
			{
				code: "palmaris_longus_right",
				name: "Palmar Longo",
				nameEn: "Palmaris Longus",
			},
			{
				code: "flexor_digitorum_right",
				name: "Flexor dos Dedos",
				nameEn: "Flexor Digitorum",
			},
			{
				code: "pronator_teres_right",
				name: "Pronador Redondo",
				nameEn: "Pronator Teres",
			},
		],
	},
	{
		...
		muscles: [
			{
				code: "rectus_abdominis_lower",
				name: "Reto Abdominal Inferior",
				nameEn: "Lower Rectus Abdominis",
			},
			{ code: "pyramidalis", name: "Piramidal", nameEn: "Pyramidalis" },
			{
				code: "external_oblique_lower_left",
				name: "Obliquo Externo Esq.",
				nameEn: "External Oblique",
			},
			{
				code: "external_oblique_lower_right",
				name: "Obliquo Externo Dir.",
				nameEn: "External Oblique",
			},
		],
	},
	{
		...
		muscles: [
			{
				code: "thenar_eminence_left",
				name: "Eminência Tenar",
				nameEn: "Thenar Eminence",
			},
			{
				code: "hypothenar_left",
				name: "Eminência Hipotenar",
				nameEn: "Hypothenar",
			},
			{
				code: "interossei_dorsal_left",
				name: "Interósseos Dorsais",
				nameEn: "Dorsal Interossei",
			},
			{
				code: "interossei_palmar_left",
				name: "Interósseos Palmares",
	...
	},
	{
		...
		muscles: [
			{
				code: "thenar_eminence_right",
				name: "Eminência Tenar",
				nameEn: "Thenar Eminence",
			},
			{
				code: "hypothenar_right",
				name: "Eminência Hipotenar",
				nameEn: "Hypothenar",
			},
			{
				code: "interossei_dorsal_right",
				name: "Interósseos Dorsais",
				nameEn: "Dorsal Interossei",
			},
			{
				code: "interossei_palmar_right",
				name: "Interósseos Palmares",
				nameEn: "Palmar Interossei",
			},
	...
	},
	{
		...
		muscles: [
			...
			{
				code: "tensor_fasciae_latae_left",
	...
	},
	{
		...
		muscles: [
			...
			{
				code: "tensor_fasciae_latae_right",
				name: "Tensor da Fáscia Lata",
				nameEn: "Tensor Fasciae Latae",
			},
	...
	},
	{
		...
		muscles: [
			{
				code: "rectus_femoris_left",
				name: "Reto Femoral",
				nameEn: "Rectus Femoris",
			},
			{
				code: "vastus_lateralis_left",
				name: "Vasto Lateral",
				nameEn: "Vastus Lateralis",
			},
			{
				code: "vastus_medialis_left",
				name: "Vasto Medial",
				nameEn: "Vastus Medialis",
			},
			{
				code: "vastus_intermedius_left",
				name: "Vasto Intermédio",
				nameEn: "Vastus Intermedius",
			},
			{
				code: "adductor_longus_left",
				name: "Adutor Longo",
				nameEn: "Adductor Longus",
			},
			{
				code: "adductor_magnus_left",
				name: "Adutor Magno",
	...
	},
	{
		...
		muscles: [
			{
				code: "rectus_femoris_right",
				name: "Reto Femoral",
				nameEn: "Rectus Femoris",
			},
			{
				code: "vastus_lateralis_right",
				name: "Vasto Lateral",
				nameEn: "Vastus Lateralis",
			},
			{
				code: "vastus_medialis_right",
				name: "Vasto Medial",
				nameEn: "Vastus Medialis",
			},
			{
				code: "vastus_intermedius_right",
				name: "Vasto Intermédio",
				nameEn: "Vastus Intermedius",
			},
			{
				code: "adductor_longus_right",
				name: "Adutor Longo",
				nameEn: "Adductor Longus",
			},
			{
				code: "adductor_magnus_right",
				name: "Adutor Magno",
				nameEn: "Adductor Magnus",
			},
	...
	},
	{
		...
		muscles: [
			{
				code: "patellar_tendon_left",
				name: "Tendão Patelar",
				nameEn: "Patellar Tendon",
			},
			{
				code: "quadriceps_tendon_left",
				name: "Tendão Quadríceps",
	...
	},
	{
		...
		muscles: [
			{
				code: "patellar_tendon_right",
				name: "Tendão Patelar",
				nameEn: "Patellar Tendon",
			},
			{
				code: "quadriceps_tendon_right",
				name: "Tendão Quadríceps",
				nameEn: "Quadriceps Tendon",
			},
			{
	...
	},
	{
		...
		muscles: [
			{
				code: "tibialis_anterior_left",
				name: "Tibial Anterior",
				nameEn: "Tibialis Anterior",
			},
			{
				code: "extensor_digitorum_left",
				name: "Extensor dos Dedos",
				nameEn: "Extensor Digitorum",
			},
			{
				code: "extensor_hallucis_left",
				name: "Extensor do Hálux",
				nameEn: "Extensor Hallucis",
			},
			{
				code: "peroneus_longus_left",
				name: "Peroneal Longo",
				nameEn: "Peroneus Longus",
			},
			{
				code: "peroneus_brevis_left",
				name: "Peroneal Curto",
				nameEn: "Peroneus Brevis",
			},
		],
	},
	{
		...
		muscles: [
			{
				code: "tibialis_anterior_right",
				name: "Tibial Anterior",
				nameEn: "Tibialis Anterior",
			},
			{
				code: "extensor_digitorum_right",
				name: "Extensor dos Dedos",
				nameEn: "Extensor Digitorum",
			},
			{
				code: "extensor_hallucis_right",
				name: "Extensor do Hálux",
				nameEn: "Extensor Hallucis",
			},
			{
				code: "peroneus_longus_right",
				name: "Peroneal Longo",
				nameEn: "Peroneus Longus",
			},
			{
				code: "peroneus_brevis_right",
				name: "Peroneal Curto",
				nameEn: "Peroneus Brevis",
			},
		],
	},
	{
		...
		muscles: [
			{
				code: "tibialis_posterior_tendon_left",
				name: "Tendão Tibial Posterior",
				nameEn: "Tibialis Posterior",
			},
			{
				code: "achilles_tendon_left",
				name: "Tendão de Aquiles",
	...
	},
	{
		...
		muscles: [
			{
				code: "tibialis_posterior_tendon_right",
				name: "Tendão Tibial Posterior",
				nameEn: "Tibialis Posterior",
			},
			{
				code: "achilles_tendon_right",
				name: "Tendão de Aquiles",
				nameEn: "Achilles Tendon",
			},
		],
	},
	{
		...
		muscles: [
			{
				code: "extensor_digitorum_brevis_left",
				name: "Extensor Curto dos Dedos",
				nameEn: "Extensor Digitorum Brevis",
			},
			{
				code: "flexor_digitorum_brevis_left",
				name: "Flexor Curto dos Dedos",
				nameEn: "Flexor Digitorum Brevis",
			},
			{
				code: "abductor_hallucis_left",
				name: "Abdutor do Hálux",
				nameEn: "Abductor Hallucis",
			},
			{
				code: "abductor_digiti_minimi_left",
				name: "Abdutor do 5º Dedo",
				nameEn: "Abductor Digiti Minimi",
			},
			{
				code: "intrinsic_foot_left",
				name: "Intrínsecos do Pé",
				nameEn: "Intrinsic Foot Muscles",
			},
		],
	},
	{
		...
		muscles: [
			{
				code: "extensor_digitorum_brevis_right",
				name: "Extensor Curto dos Dedos",
				nameEn: "Extensor Digitorum Brevis",
			},
			{
				code: "flexor_digitorum_brevis_right",
				name: "Flexor Curto dos Dedos",
				nameEn: "Flexor Digitorum Brevis",
			},
			{
				code: "abductor_hallucis_right",
				name: "Abdutor do Hálux",
				nameEn: "Abductor Hallucis",
			},
			{
				code: "abductor_digiti_minimi_right",
				name: "Abdutor do 5º Dedo",
				nameEn: "Abductor Digiti Minimi",
			},
			{
				code: "intrinsic_foot_right",
				name: "Intrínsecos do Pé",
				nameEn: "Intrinsic Foot Muscles",
			},
		],
...
export const BACK_MUSCLE_GROUPS: MuscleGroup[] = [
	...
	},
	{
		...
		muscles: [
			{
				code: "deltoid_posterior_left",
				name: "Deltoide Posterior",
				nameEn: "Posterior Deltoid",
			},
			{
				code: "infraspinatus_left",
				name: "Infraespinhoso",
	...
	},
	{
		...
		muscles: [
			{
				code: "deltoid_posterior_right",
				name: "Deltoide Posterior",
				nameEn: "Posterior Deltoid",
			},
			{
				code: "infraspinatus_right",
				name: "Infraespinhoso",
				nameEn: "Infraspinatus",
			},
	...
	},
	{
		...
		muscles: [
			{
				code: "trapezius_middle_left",
				name: "Trapézio Médio",
				nameEn: "Middle Trapezius",
			},
			{
				code: "rhomboid_minor_left",
				name: "Romboide Menor",
				nameEn: "Rhomboid Minor",
			},
			{
				code: "rhomboid_major_left",
				name: "Romboide Maior",
	...
	},
	{
		...
		muscles: [
			{
				code: "trapezius_middle_right",
				name: "Trapézio Médio",
				nameEn: "Middle Trapezius",
			},
			{
				code: "rhomboid_minor_right",
				name: "Romboide Menor",
				nameEn: "Rhomboid Minor",
			},
			{
				code: "rhomboid_major_right",
				name: "Romboide Maior",
				nameEn: "Rhomboid Major",
			},
		],
	},
	{
		...
		muscles: [
			{
				code: "triceps_brachii_lateral_left",
				name: "Tríceps (cabeça lateral)",
				nameEn: "Lateral Head Triceps",
			},
			{
				code: "triceps_brachii_medial_left",
				name: "Tríceps (cabeça medial)",
				nameEn: "Medial Head Triceps",
			},
	...
	},
	{
		...
		muscles: [
			{
				code: "triceps_brachii_lateral_right",
				name: "Tríceps (cabeça lateral)",
				nameEn: "Lateral Head Triceps",
			},
			{
				code: "triceps_brachii_medial_right",
				name: "Tríceps (cabeça medial)",
				nameEn: "Medial Head Triceps",
			},
	...
	},
	{
		...
		muscles: [
			{
				code: "latissimus_dorsi_left",
				name: "Grande Dorsal",
				nameEn: "Latissimus Dorsi",
			},
			{
				code: "erector_spinae_thoracic_left",
				name: "Erector da Coluna Torácica",
				nameEn: "Thoracic Erector Spinae",
			},
		],
	},
	{
		...
		muscles: [
			{
				code: "latissimus_dorsi_right",
				name: "Grande Dorsal",
				nameEn: "Latissimus Dorsi",
			},
			{
				code: "erector_spinae_thoracic_right",
				name: "Erecto da Coluna Torácica",
				nameEn: "Thoracic Erector Spinae",
			},
		],
	},
	{
		...
		muscles: [
			{
				code: "extensor_carpi_radialis_left",
				name: "Extensor Radial do Carpo",
				nameEn: "Extensor Carpi Radialis",
			},
			{
				code: "extensor_carpi_ulnaris_left",
				name: "Extensor Ulnar do Carpo",
				nameEn: "Extensor Carpi Ulnaris",
			},
			{
				code: "extensor_digitorum_back_left",
				name: "Extensor dos Dedos",
				nameEn: "Extensor Digitorum",
			},
			{ code: "supinator_left", name: "Supinador", nameEn: "Supinator" },
			{
				code: "brachioradialis_left",
				name: "Braquiorradial",
	...
	},
	{
		...
		muscles: [
			{
				code: "extensor_carpi_radialis_right",
				name: "Extensor Radial do Carpo",
				nameEn: "Extensor Carpi Radialis",
			},
			{
				code: "extensor_carpi_ulnaris_right",
				name: "Extensor Ulnar do Carpo",
				nameEn: "Extensor Carpi Ulnaris",
			},
			{
				code: "extensor_digitorum_back_right",
				name: "Extensor dos Dedos",
				nameEn: "Extensor Digitorum",
			},
			{ code: "supinator_right", name: "Supinador", nameEn: "Supinator" },
			{
				code: "brachioradialis_right",
				name: "Braquiorradial",
				nameEn: "Brachioradialis",
			},
		],
	},
	{
		...
		muscles: [
			{
				code: "erector_spinae_lumbar_left",
				name: "Eretor da Coluna Lombar",
				nameEn: "Lumbar Erector Spinae",
			},
			{ code: "multifidus_left", name: "Multífido", nameEn: "Multifidus" },
			{
				code: "quadratus_lumborum_left",
	...
	},
	{
		...
		muscles: [
			{
				code: "erector_spinae_lumbar_right",
				name: "Eretor da Coluna Lombar",
				nameEn: "Lumbar Erector Spinae",
			},
			{ code: "multifidus_right", name: "Multífido", nameEn: "Multifidus" },
			{
				code: "quadratus_lumborum_right",
				name: "Quadrado Lombar",
				nameEn: "Quadratus Lumborum",
			},
		],
	},
	{
		...
		muscles: [
			{
				code: "gluteus_maximus_left",
				name: "Glúteo Máximo",
				nameEn: "Gluteus Maximus",
			},
			{
				code: "gluteus_medius_left",
				name: "Glúteo Médio",
				nameEn: "Gluteus Medius",
			},
			{
				code: "gluteus_minimus_left",
				name: "Glúteo Mínimo",
	...
	},
	{
		...
		muscles: [
			{
				code: "gluteus_maximus_right",
				name: "Glúteo Máximo",
				nameEn: "Gluteus Maximus",
			},
			{
				code: "gluteus_medius_right",
				name: "Glúteo Médio",
				nameEn: "Gluteus Medius",
			},
			{
				code: "gluteus_minimus_right",
				name: "Glúteo Mínimo",
				nameEn: "Gluteus Minimus",
			},
	...
	},
	{
		...
		muscles: [
			{
				code: "biceps_femoris_left",
				name: "Bíceps Femoral",
				nameEn: "Biceps Femoris",
			},
			{
				code: "semitendinosus_left",
				name: "Semitendinoso",
				nameEn: "Semitendinosus",
			},
			{
				code: "semimembranosus_left",
				name: "Semimembranoso",
	...
	},
	{
		...
		muscles: [
			{
				code: "biceps_femoris_right",
				name: "Bíceps Femoral",
				nameEn: "Biceps Femoris",
			},
			{
				code: "semitendinosus_right",
				name: "Semitendinoso",
				nameEn: "Semitendinosus",
			},
			{
				code: "semimembranosus_right",
				name: "Semimembranoso",
				nameEn: "Semimembranosus",
			},
		],
	...
	},
	{
		...
		muscles: [
			{
				code: "flexor_retinaculum_left",
				name: "Retináculo dos Flexores",
				nameEn: "Flexor Retinaculum",
			},
			{
				code: "tarsal_tunnel_left",
				name: "Túnel do Tarso",
				nameEn: "Tarsal Tunnel",
			},
		],
	},
	{
		...
		muscles: [
			{
				code: "flexor_retinaculum_right",
				name: "Retináculo dos Flexores",
				nameEn: "Flexor Retinaculum",
			},
			{
				code: "tarsal_tunnel_right",
				name: "Túnel do Tarso",
				nameEn: "Tarsal Tunnel",
			},
		],
...
export function getMusclesByRegion(
	regionCode: string,
	view: "front" | "back",
): Muscle[] {
