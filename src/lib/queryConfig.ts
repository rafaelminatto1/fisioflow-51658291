...
export const QUERY_KEYS = {
	...
	patients: {
		...
		search: (term: string) =>
			[...QUERY_KEYS.patients.all, "search", term] as const,
	},
	...
	appointments: {
		...
		detail: (id: string) =>
			[...QUERY_KEYS.appointments.all, "detail", id] as const,
		byDate: (date: string) =>
			[...QUERY_KEYS.appointments.all, "date", date] as const,
		byPatient: (patientId: string) =>
			[...QUERY_KEYS.appointments.all, "patient", patientId] as const,
		byTherapist: (therapistId: string) =>
			[...QUERY_KEYS.appointments.all, "therapist", therapistId] as const,
	},
	...
	therapists: {
		...
		detail: (id: string) =>
			[...QUERY_KEYS.therapists.all, "detail", id] as const,
		availability: (id: string) =>
			[...QUERY_KEYS.therapists.all, "availability", id] as const,
	},
	...
	exercises: {
		...
		detail: (id: string) =>
			[...QUERY_KEYS.exercises.all, "detail", id] as const,
		byCategory: (category: string) =>
			[...QUERY_KEYS.exercises.all, "category", category] as const,
	},
	...
	financial: {
		...
		cashflow: (period: string) =>
			[...QUERY_KEYS.financial.all, "cashflow", period] as const,
	},
