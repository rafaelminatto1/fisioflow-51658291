...
export function validatePainPoints(
	points: Partial<PainPoint>[],
): ValidationResult {
...
export function sanitizeAndValidatePoint(point: Partial<PainPoint>): {
	...
	const sanitized: Partial<PainPoint> = {
		...
		muscleName: point.muscleName
			? sanitizeTextInput(point.muscleName)
			: undefined,
...
export function hasErrorCode(
	...
	return [...result.errors, ...result.warnings].some(
