...
export type EventoContratadoCreate = z.infer<
	typeof eventoContratadoCreateSchema
>;
export type EventoContratadoUpdate = z.infer<
	typeof eventoContratadoUpdateSchema
>;
