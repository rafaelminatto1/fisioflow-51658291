...
const plan = {
  ...
  patientId: "patient-123",
  exercises: [{ exerciseId: "ex-1", sets: 3, reps: 10, restTime: 60 }],
  status: "Ativo",
...
const patient = validateOrDefault(patientSchemas.base, rawData, {
  id: "default",
...
const patient = validateOrNull(patientSchemas.base, apiResponseData, "patient from API");
...
export const validatePatient = createValidator(patientSchemas.base, "patient");
