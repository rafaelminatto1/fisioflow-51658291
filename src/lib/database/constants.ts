...
export type PathologyStatus =
	(typeof PATHOLOGY_STATUS)[keyof typeof PATHOLOGY_STATUS];
...
export function isValidAppointmentStatus(
	...
	return Object.values(APPOINTMENT_STATUS).includes(
 ...
 */
export function isValidPathologyStatus(
	status: string,
): status is PathologyStatus {
