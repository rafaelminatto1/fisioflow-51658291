...
export const API_URLS = {
  ...
  financial: {
    listTransactions: WORKERS_ENDPOINT("/api/financial/transactions"),
    createTransaction: WORKERS_ENDPOINT("/api/financial/transactions"),
    updateTransaction: WORKERS_ENDPOINT("/api/financial/transactions"),
    deleteTransaction: WORKERS_ENDPOINT("/api/financial/transactions"),
    findTransactionByAppointmentId: WORKERS_ENDPOINT("/api/financial/payments"),
