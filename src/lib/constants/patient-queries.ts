 ...
 */
export const PATIENT_COLUMNS_MINIMAL = ["id", "full_name", "incomplete_registration"] as const;
 ...
 */
export const PATIENT_APPOINTMENT_JOIN = ["id", "full_name", "phone", "email"] as const;
...
export function getPatientName(
  patient:
    | { full_name?: string | null; name?: string | null; phone?: string | null }
    | null
    | undefined,
): string {
