...
export const COMMON_PATHOLOGIES = [
  ...
  {
    value: "Tendinopatia do Aquiles",
    label: "Tendinopatia do Aquiles",
    category: "Tendão/Ligamento",
  },
  ...
  {
    value: "Instabilidade de Ombro",
    label: "Instabilidade de Ombro",
    category: "Tendão/Ligamento",
  },
  {
    value: "Lesão de Manguito Rotador",
    label: "Lesão de Manguito Rotador",
    category: "Tendão/Ligamento",
  },
  // Articulares
  ...
  {
    value: "Síndrome do Túnel do Carpo",
  ...
  {
    value: "Pós-Artroplastia Joelho",
    label: "Pós-Artroplastia Joelho (PTJ)",
    category: "Pós-Operatória",
  },
  {
    value: "Pós-Artroplastia Quadril",
    label: "Pós-Artroplastia Quadril (PTQ)",
    category: "Pós-Operatória",
  },
...
export const PRECAUTION_LEVELS = [
  {
    ...
    label: "Seguro",
    color: "emerald",
    description: "Baixo risco, pode ser executado sem supervisão direta",
  },
  {
    value: "supervised",
    label: "Requer Supervisão",
    color: "amber",
    description: "Risco moderado, recomenda-se supervisão profissional",
  },
  {
    value: "restricted",
    label: "Restrito",
    color: "rose",
    description: "Alto risco, apenas sob supervisão profissional direta",
  },
] as const;
