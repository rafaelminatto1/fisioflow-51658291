...
export class ExerciseAIAssistant {
   ...
   */
  private findBestExerciseMatch(recommendedName: string, library: Exercise[]): Exercise | null {
    // Simple exact match first
    const exactMatch = library.find((e) => e.name.toLowerCase() === recommendedName.toLowerCase());
