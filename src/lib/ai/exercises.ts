...
const ExerciseRecommendationSchema = z.object({
	exerciseId: z
		.string()
		.optional()
		.describe("Unique exercise identifier from the library"),
	name: z.string().optional().describe("Exercise name"),
	category: z
		.string()
		.optional()
		.describe("Exercise category (e.g., stretching, strengthening, mobility)"),
	difficulty: z
	...
	rationale: z
		.string()
		.optional()
		.describe("Why this exercise is recommended for this patient"),
	targetArea: z.string().optional().describe("Primary anatomical target area"),
	goalsAddressed: z
		.array(z.string())
		.optional()
		.describe("Specific patient goals this exercise addresses"),
	...
	duration: z
		.number()
		.optional()
		.describe("Duration in minutes for timed exercises"),
	frequency: z
		.string()
		.optional()
		.describe("How often to perform this exercise"),
	precautions: z
		.array(z.string())
		.optional()
		.describe("Any contraindications or precautions"),
	confidence: z
		.number()
		.min(0)
		.max(1)
...
const ExerciseProgramSchema = z.object({
	exercises: z
		.array(ExerciseRecommendationSchema)
		.min(3)
		.max(10)
		.describe("3-10 recommended exercises"),
	programRationale: z
		.string()
		.describe("Overall explanation of the exercise program"),
	expectedOutcomes: z
		.array(z.string())
		.describe("Expected therapeutic outcomes"),
	progressionCriteria: z
		.array(z.string())
		.describe("Criteria for advancing the program"),
	redFlags: z
		.array(z.string())
		.optional()
		.describe("Any warning signs to monitor"),
	alternatives: z
		.array(ExerciseRecommendationSchema)
		.optional()
 ...
 */
export function createExerciseAIAssistant(
	apiKey?: string,
): ExerciseAIAssistant {
 ...
 */
export function determineTreatmentPhase(
	sessionCount: number,
): PatientProfileContext["treatmentPhase"] {
