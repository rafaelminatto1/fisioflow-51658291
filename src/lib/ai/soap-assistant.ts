...
export class SOAPAssistant {
  ...
  async transcribeAudio(
    ...
    try {
      ...
      // Prepare audio data
      const audioBase64 = Buffer.isBuffer(audioData) ? audioData.toString("base64") : audioData;
...
Retorne APENAS JSON válido.`;
   ...
   */
  private buildSOAPPrompt(consultationText: string, context: PatientSOAPContext): string {
