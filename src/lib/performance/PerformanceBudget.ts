...
export class PerformanceBudgetMonitor {
    ...
    try {
      this.longTaskObserver = new PerformanceObserver((list) => {
        for (const entry of list.getEntries()) {
          ...
          this.currentMetrics.longestTask = Math.max(this.currentMetrics.longestTask, duration);
  ...
  private recordMetric<K extends keyof PerformanceMetrics>(key: K, value: PerformanceMetrics[K]) {
...
export const usePerformanceBudget = (config?: Partial<PerformanceBudgetConfig>) => {
