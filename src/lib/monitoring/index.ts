 ...
 */
export function trackMetric(type: MetricType, data: Record<string, unknown>, value?: number) {
 ...
 */
export function trackBusinessEvent(event: string, data: Record<string, unknown>) {
 ...
 */
export function trackFeatureUsage(featureName: string, data?: Record<string, unknown>) {
 ...
 */
export function trackSearch(category: string, query: string, resultCount?: number) {
 ...
 */
export function createDebouncedTrack(metricType: MetricType, delay: number = 1000) {
