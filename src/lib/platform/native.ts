...
export async function getCameraPhoto(options: CameraPhotoOptions): Promise<CameraPhoto> {
...
export async function triggerHapticImpact(style: HapticImpactStyle = "light"): Promise<void> {
...
export async function triggerHapticNotification(type: HapticNotificationType): Promise<void> {
  if (!isNativePlatform()) return;
