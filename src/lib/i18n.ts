...
export const translations = {
	"pt-BR": {
		...
		"gamification.pointsToTop":
			"Continue assim! Você está a apenas {points} pontos do topo!",
	...
	"en-US": {
		...
		"gamification.levelUpDescription":
		...
		"gamification.pointsToTop":
			"Keep it up! You are only {points} points from the top!",
	...
	return {
		...
		formatDate: (date: Date | string) => {
			...
			return new Intl.DateTimeFormat(
				locale,
				localeConfig.dateFormat !== "dd/MM/yyyy"
...
export function useBrowserLocale(): SupportedLocale {
	...
	return ["pt-BR", "en-US", "es-ES"].includes(browserLang)
		? browserLang
		: "pt-BR";
}
