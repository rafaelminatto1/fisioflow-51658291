...
export const GOAL_PROFILES_SEED: GoalProfile[] = [
	{
		...
		evidence: [
			{
				label:
					"ACL-RSI ≥ 65 como ponto de corte em 2 anos (retorno ao mesmo esporte)",
				source:
					"Sadeqi et al., 2018 (ACL-RSI threshold ≥65 para retorno ao mesmo esporte em 2 anos)",
			},
			{
				label: "LSI pode superestimar função e se associar a risco de 2ª lesão",
				source:
					"Wellsandt et al., 2017 (LSI pode superestimar função pós-ACLR)",
			},
		],
		...
		evidence: [
			{
				...
				source:
					"Lohrer et al., 2011 (VISA-P máximo 100 representa indivíduo assintomático)",
			},
			{
		...
		evidence: [
			{
				...
				source:
					"Oswestry Disability Questionnaire (scoring: soma / total possível × 100)",
			},
			{
				label:
					"MCID do ODI varia; exemplos 7.5 pts e 8 pts em fontes diferentes",
				source:
		...
		targets: [
			{
				...
				minDeltaPct: 10,
				notes:
					"Reduzir diferença entre olhos fechados vs abertos (ratio menor).",
			},
			{
...

	{
		...
		clinicianNotesTemplate:
			"Priorize ADM passiva e ativa nos primeiros dias. O KOOS-JR ajuda a monitorar a percepção de dor e função.",
		patientNotesTemplate:
			"Nosso objetivo agora é dobrar mais o joelho e caminhar com mais firmeza.",
		evidence: [
			{
...

	{
		...
		clinicianNotesTemplate:
			"Foco em neuroplasticidade e segurança (prevenção de quedas). Use Romberg para monitorar controle de tronco.",
		patientNotesTemplate:
			"Estamos trabalhando para que você caminhe com mais equilíbrio e segurança no dia a dia.",
		evidence: [],
