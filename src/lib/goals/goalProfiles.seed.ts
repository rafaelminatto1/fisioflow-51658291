...
export type TargetMode = "CUT_OFF" | "IMPROVEMENT_ABS" | "IMPROVEMENT_PCT" | "RANGE" | "CUSTOM";
    ...
    targets: [
      {
        ...
        mode: "CUT_OFF",
        min: 80,
        notes: "Meta de referência (ajuste por fase/nível). VISA-P máximo 100 (assintomático).",
      },
...

  {
    ...
    targets: [
      {
        ...
        mode: "IMPROVEMENT_ABS",
        minDeltaAbs: 7.5,
        notes: "MCID varia por população/contexto. Default: reduzir ~7.5 pontos (ajustável).",
      },
    ...
    evidence: [
      ...
      },
      {
        ...
        source: "SRALab (ODI MCID 7.5 em recomendações) + Maughan & Lewis 2010 (ODI MCID ~8)",
      },
    ],
