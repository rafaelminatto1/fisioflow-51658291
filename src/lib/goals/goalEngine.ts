...
export const evaluateGoals = (
	...
	targets: GoalEvaluationResult[];
	overallStatus: "ON_TRACK" | "NEEDS_FOCUS" | "NA";
} => {
	...
	// Check Quality Gate
	if (
		profile.qualityGate?.minAnalysisConfidence0_100 &&
		compare.quality.analysis_confidence_overall_0_100 <
			profile.qualityGate.minAnalysisConfidence0_100
	) {
