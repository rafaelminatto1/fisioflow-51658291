...
export function getFeatureFlagsFromEnv(): Partial<FeatureFlags> {
	return {
		...
		ai_exercise_suggestions:
			getEnv("VITE_FEATURE_AI_EXERCISE_SUGGESTIONS") !== "false", // default true

		// Clinical Features
		digital_prescription:
			getEnv("VITE_FEATURE_DIGITAL_PRESCRIPTION") !== "false", // default true
		...
		whatsapp_notifications:
			getEnv("VITE_FEATURE_WHATSAPP_NOTIFICATIONS") !== "false", // default true
		google_calendar_sync:
			getEnv("VITE_FEATURE_GOOGLE_CALENDAR_SYNC") !== "false", // default true
