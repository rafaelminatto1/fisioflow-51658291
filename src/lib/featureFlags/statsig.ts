...
export async function initStatsig(_sdkKey?: string, _user?: StatsigUser): Promise<boolean> {
...
export function logExperimentExposure(_experimentName: string, _user?: StatsigUser): void {
  // No-op
}
