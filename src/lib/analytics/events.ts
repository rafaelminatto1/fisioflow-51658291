 ...
 * Nível alcançado
 */
export function trackLevelUp(data: { patientId: string; newLevel: number }) {
  track("level_up", {
    patient_id: data.patientId,
 ...
 * Streak alcançado
 */
export function trackStreakAchieved(data: { patientId: string; days: number }) {
 ...
 * Email aberto
 */
export function trackEmailOpened(data: { campaignId?: string; emailId: string }) {
  track("email_opened", {
 ...
 */
export function trackEmailLinkClicked(data: { emailId: string; url: string }) {
 ...
 * Busca realizada
 */
export function trackSearch(data: { page: string; queryLength: number; resultsCount: number }) {
  track("search", {
    page: data.page,
    query_length: data.queryLength,
    results_count: data.resultsCount,
 ...
 * Erro de validação
 */
export function trackValidationError(data: { field: string; message: string }) {
