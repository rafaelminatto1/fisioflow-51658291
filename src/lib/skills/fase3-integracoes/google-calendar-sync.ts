...
export class GoogleCalendarSync {
   ...
   */
  async getEvents(timeMin: Date, timeMax: Date, options?: SyncOptions): Promise<CalendarEvent[]> {
    try {
   ...
   */
  async checkAvailability(options: AvailabilityOptions): Promise<{ start: Date; end: Date }[]> {
    try {
...
export class GoogleCalendarSyncFactory {
  ...
  static async createFromEnv(): Promise<GoogleCalendarSync> {
    ...
    this.instance = new GoogleCalendarSync(clientId, clientSecret, redirectUri, refreshToken);
