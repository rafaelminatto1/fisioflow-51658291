...
export class NotionIntegration {
	...
	async createProcedurePage(procedure: {
		...
		contentBlocks.push({
			...
			paragraph: {
				rich_text: [
					{ type: "text" as const, text: { content: procedure.description } },
				],
			},
		});
		...
		contentBlocks.push({
			...
			heading_2: {
				rich_text: [
					{ type: "text" as const, text: { content: "✅ Indicações" } },
				],
			},
		});
		...
		contentBlocks.push({
			...
			heading_2: {
				rich_text: [
					{ type: "text" as const, text: { content: "❌ Contraindicações" } },
				],
			},
		});
		...
		for (const contraindication of procedure.contraindications) {
			contentBlocks.push({
				...
				bulleted_list_item: {
					rich_text: [
						{ type: "text" as const, text: { content: contraindication } },
					],
				},
			});
		}
		...
		contentBlocks.push({
			...
			heading_2: {
				rich_text: [
					{ type: "text" as const, text: { content: "📋 Passo a Passo" } },
				],
			},
		});
		...
		if (procedure.observations) {
			contentBlocks.push({
				...
				heading_2: {
					rich_text: [
						{ type: "text" as const, text: { content: "⚠️ Observações" } },
					],
				},
			});
		...
		if (procedure.references && procedure.references.length > 0) {
			contentBlocks.push({
				...
				heading_2: {
					rich_text: [
						{ type: "text" as const, text: { content: "📚 Referências" } },
					],
				},
			});
	...
	async createExercisePage(exercise: {
		...
		if (exercise.equipment) {
			contentBlocks.push({
				...
				heading_2: {
					rich_text: [
						{ type: "text" as const, text: { content: "🏋️ Equipamento" } },
					],
				},
			});
			...
			contentBlocks.push({
				...
				paragraph: {
					rich_text: [
						{ type: "text" as const, text: { content: exercise.equipment } },
					],
				},
			});
		}
		...
		contentBlocks.push({
			...
			heading_2: {
				rich_text: [
					{ type: "text" as const, text: { content: "📋 Instruções" } },
				],
			},
		});
		...
		for (const [index, instruction] of exercise.instructions.entries()) {
			contentBlocks.push({
				...
				numbered_list_item: {
					rich_text: [
						{ type: "text" as const, text: { content: instruction } },
					],
				},
			});
		}
		...
		if (exercise.repetitions || exercise.duration) {
			contentBlocks.push({
				...
				heading_2: {
					rich_text: [
						{ type: "text" as const, text: { content: "⏱️ Parâmetros" } },
					],
				},
			});
		...
		if (exercise.precautions && exercise.precautions.length > 0) {
			contentBlocks.push({
				...
				heading_2: {
					rich_text: [
						{ type: "text" as const, text: { content: "⚠️ Precauções" } },
					],
				},
			});
			...
			for (const precaution of exercise.precautions) {
				contentBlocks.push({
					...
					bulleted_list_item: {
						rich_text: [
							{ type: "text" as const, text: { content: precaution } },
						],
					},
				});
			}
	...
	async createMeetingPage(meeting: MeetingNotes): Promise<string> {
		...
		if (meeting.decisions.length > 0) {
			contentBlocks.push({
				...
				heading_2: {
					rich_text: [
						{ type: "text" as const, text: { content: "✅ Decisões" } },
					],
				},
			});
		...
		if (meeting.notes) {
			...
			contentBlocks.push({
				...
				paragraph: {
					rich_text: [
						{ type: "text" as const, text: { content: meeting.notes } },
					],
				},
			});
		}
	...
	async createFeatureDocumentation(feature: {
		...
		contentBlocks.push({
			...
			paragraph: {
				rich_text: [
					{ type: "text" as const, text: { content: feature.description } },
				],
			},
		});
		...
		contentBlocks.push({
			...
			heading_2: {
				rich_text: [
					{ type: "text" as const, text: { content: "📖 User Stories" } },
				],
			},
		});
		...
		if (feature.wireframes && feature.wireframes.length > 0) {
			contentBlocks.push({
				...
				heading_2: {
					rich_text: [
						{ type: "text" as const, text: { content: "🎨 Wireframes" } },
					],
				},
			});
		...
		if (feature.apiEndpoints && feature.apiEndpoints.length > 0) {
			contentBlocks.push({
				...
				heading_2: {
					rich_text: [
						{ type: "text" as const, text: { content: "🔌 API Endpoints" } },
					],
				},
			});
