...
class TextToSpeechService {
   ...
   */
  async synthesizeAccessibility(text: string, languageCode: string = "pt-BR"): Promise<Blob> {
    return this.synthesize({
      type: "accessibility",
      text,
      languageCode,
...
export async function synthesizeAccessibility(text: string, languageCode?: string): Promise<Blob> {
