...
describe("toLocalISOString", () => {
  it("builds a local ISO string from string date + HH:mm", () => {
    expect(toLocalISOString("2026-03-15", "14:30")).toBe("2026-03-15T14:30:00");
  });
  ...
  it("accepts already-HH:mm:ss strings", () => {
    expect(toLocalISOString("2026-06-01", "09:15:30")).toBe("2026-06-01T09:15:30");
  });

  it("handles midnight without rolling into next day", () => {
    expect(toLocalISOString("2026-12-31", "00:00")).toBe("2026-12-31T00:00:00");
  });
});
