  ...
  const steps: TourStep[] = [
    {
      ...
      title: "Seu QG",
      content:
        "Aqui é onde a mágica acontece. Se o sistema estiver lento, respire fundo e conte até 10... ou verifique sua internet!",
      position: "right",
    },
    {
      ...
      content:
        "Gerencie seus pacientes aqui. Lembre-se: prontuário em dia é como alongamento, dói na hora mas evita problemas depois.",
      position: "right",
    },
    {
      ...
      content:
        "Organize seus horários. Se um paciente faltar, não chore, use o tempo para estudar (ou tomar um café).",
      position: "right",
    },
  ];
