...
>[] = [
	{
		...
		title:
			"Rehabilitation and Return to Play Protocols After ACL Reconstruction: A Systematic Review",
		type: "pdf",
		...
		status: "verified",
		summary:
			"Revisão sistemática de 2024 focada em critérios objetivos para alta e retorno ao esporte.",
	...
	},
	{
		organizationId: "demo-org",
		title:
			"ASSET Consensus Statement on Rehabilitation Following Arthroscopic Rotator Cuff Repair",
		type: "pdf",
		...
		status: "verified",
		summary:
			"Consenso da Sociedade Americana de Terapeutas de Ombro e Cotovelo sobre reabilitação pós-reparo de manguito.",
		vectorStatus: "pending",
		metadata: {
	...
	},
	{
		...
		status: "verified",
		summary:
			"Diretrizes internacionais para manejo de entorses agudos e prevenção de recorrência.",
		vectorStatus: "pending",
		metadata: {
			year: 2024,
	...
	},
	{
		organizationId: "demo-org",
		title:
			"Delphi Consensus on Assessment and Treatment Approaches for Patellofemoral Pain",
		type: "pdf",
		url: "",
		group: "Ortopedia",
		subgroup: "Joelho",
		...
		status: "verified",
		summary:
			"Consenso Delphi atualizado sobre as melhores abordagens para dor anterior no joelho.",
		vectorStatus: "pending",
		metadata: {
			year: 2026,
