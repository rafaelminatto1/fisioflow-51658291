...
export default function WikiDashboard() {
	...
	const { data: artifacts = [], isLoading } = useQuery({
		...
		queryFn: () =>
			organizationId
				? knowledgeService.listArtifacts(organizationId)
				: Promise.resolve([]),
			...
			<section className="relative overflow-hidden rounded-3xl bg-slate-900 text-white p-8 md:p-12 shadow-2xl">
				...
				<div className="relative z-10 max-w-2xl space-y-6">
					...
					<p className="text-lg text-slate-300 leading-relaxed">
						Acesse protocolos verificados, consensos internacionais e diretrizes
						atualizadas. Use nossa IA para extrair respostas de documentos
		...
		>
			<div className="space-y-3">
				...
				<div className="text-xs text-slate-500 line-clamp-2">
					{artifact.summary ||
						"Sem resumo disponível. Clique para gerar com IA."}
				</div>
			</div>
