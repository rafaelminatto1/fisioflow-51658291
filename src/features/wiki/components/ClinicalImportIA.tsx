...
import { Brain, Upload, Loader2, Sparkles, CheckCircle2 } from "lucide-react";
...
export function ClinicalImportIA() {
  ...
  const handleImport = async () => {
    ...
    try {
      ...
      const response = await fetch(`${getWorkersApiUrl()}/api/ai/ingest`, {
        method: "POST",
    ...
    <Card className="border-primary/20 shadow-md bg-gradient-to-br from-background to-primary/5">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex items-center justify-between pt-2">
          ...
          <Button onClick={handleImport} disabled={loading || success} className="gap-2">
            {loading ? (
