...
export function AIHubView() {
    ...
    const [tutorMessage, setTutorMessage] = useState("Olá! Como você está se sentindo hoje com seus exercícios?");
        ...
        <div className="space-y-6">
            <header className="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="text-muted-foreground">Experimente e refine os agentes de inteligência clínica.</p>
                </div>
            </header>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>Otimize sua documentação clínica com feedback em tempo real.</CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                ...
                                >
                                    {loadingSoap ? <Loader2 className="h-4 w-4 animate-spin" /> : <Sparkles className="h-4 w-4" />}
                                    Analisar Nota
                                </Button>
                            </CardContent>
                        </Card>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>Teste seu AI Tutor contra diferentes perfis de pacientes.</CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="space-y-2">
                                        ...
                                        <input 
                                            ...
                                            onChange={e => setSimulatorProfile(p => ({...p, age: parseInt(e.target.value)}))}
                                        />
                                    </div>
                                    <div className="space-y-2">
                                        ...
                                        <input 
                                            ...
                                            onChange={e => setSimulatorProfile(p => ({...p, painLevel: parseInt(e.target.value)}))}
                                        />
                                    </div>
                                </div>
                                <div className="space-y-2">
                                    ...
                                    <Textarea 
                                        ...
                                        onChange={e => setSimulatorProfile(p => ({...p, condition: e.target.value}))}
                                        className="h-20"
                                    />
                                </div>
                                <div className="space-y-2">
                                ...
                                <Button 
                                    ...
                                    disabled={loadingSim}
                                >
                                    {loadingSim ? <Loader2 className="h-4 w-4 animate-spin" /> : <Send className="h-4 w-4" />}
                            ...
                            {simResult ? (
                                <Card className="border-emerald-200 bg-emerald-50/30">
                                    ...
                                    <CardContent className="space-y-4">
                                        ...
                                        <div className="space-y-2">
                                            <Label className="text-[10px] font-bold uppercase text-muted-foreground">Processo Interno de Pensamento</Label>
                    ...
                    <Card className="border-dashed border-2">
                        <CardContent className="py-20 flex flex-col items-center justify-center text-center">
                            ...
                            <p className="text-muted-foreground max-w-md mx-auto mt-2">
                                Este agente está sendo finalizado para integrar com o dashboard de evolução do paciente. 
                                Ele converterá automaticamente registros clínicos em gráficos interativos.
                            </p>
                        </CardContent>
                    </Card>
                </TabsContent>
