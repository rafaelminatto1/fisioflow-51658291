        ...
        <div className="mt-4 space-y-4 animate-in fade-in slide-in-from-top-2 duration-500">
                                            ...
                                            <TooltipProvider>
                                                <Tooltip>
                                                    <TooltipTrigger asChild>
                                                        <Button size="icon" variant="ghost" className="h-7 w-7 rounded-full text-slate-400 group-hover:text-sky-600 group-hover:bg-sky-50">
                                    ...
                                    <CardContent className="p-3 flex items-center justify-between gap-3">
                                        <div className="flex items-center gap-3 min-w-0">
                                            ...
                                            <div className="min-w-0">
                                                ...
                                                <div className="flex items-center gap-1">
                                                    <Badge variant="ghost" className="h-3 px-1 text-[8px] bg-slate-50 text-slate-500 p-0 font-normal">
                                                        {ex?.category}
                                                    </Badge>
                                                </div>
                                            </div>
                                        ...
                                        <div className="flex items-center gap-1 shrink-0">
                                            <TooltipProvider>
                                                <Tooltip>
                                                    <TooltipTrigger asChild>
                                                        <Button size="icon" variant="ghost" className="h-7 w-7 rounded-full text-slate-400 group-hover:text-emerald-600 group-hover:bg-emerald-50">
            ...
            <div className="bg-slate-900/5 border border-slate-200/60 rounded-xl p-3 flex items-start gap-2.5">
                ...
                <div className="space-y-0.5">
                    <p className="text-[10px] font-bold text-slate-700 uppercase">Sugestão Baseada em Evidência</p>
                    <p className="text-[10px] text-slate-600 leading-relaxed italic">
                        As ações acima foram extraídas automaticamente das diretrizes clínicas deste artigo para otimizar seu tempo de consultório.
                    </p>
                </div>
            </div>
        </div>
