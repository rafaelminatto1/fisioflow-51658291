...
export const WIKI_TEMPLATE_CATALOG: WikiTemplateBlueprint[] = [
	{
		...
		name: "PRD Enxuto",
		description:
			"Template para especificacao de produto com metas, escopo e riscos.",
		domain: "product",
	...
	},
	{
		...
		description:
			"Template para protocolo de atendimento com evidencias e checklist.",
		domain: "clinical",
	...
	},
	{
		...
		description:
			"Template para registrar resumo de artigo com implicacao clinica.",
		domain: "knowledge",
...
export function getTemplateById(
	templateId: string,
): WikiTemplateBlueprint | undefined {
