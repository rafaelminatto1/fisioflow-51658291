...
const PatientEvolution = lazy(
  () => import(/* webpackChunkName: "patient-evolution" */ "@/pages/PatientEvolution"),
);
const PatientEvolutionReport = lazy(
  () => import(/* webpackChunkName: "patient-evolution-report" */ "@/pages/PatientEvolutionReport"),
);
const SessionEvolutionPage = lazy(
  () => import(/* webpackChunkName: "session-evolution" */ "@/pages/SessionEvolutionPage"),
);
const PainMapHistoryPage = lazy(
  () => import(/* webpackChunkName: "pain-maps" */ "@/pages/patients/PainMapHistoryPage"),
);
const NewEvaluationPage = lazy(
  () => import(/* webpackChunkName: "evaluation-new" */ "@/pages/patients/NewEvaluationPage"),
);
const PatientProfilePage = lazy(
  () => import(/* webpackChunkName: "patient-profile" */ "@/pages/patients/PatientProfilePage"),
);
const NewPatientPage = lazy(
  () => import(/* webpackChunkName: "patient-new" */ "@/pages/patients/NewPatientPage"),
);
const PatientPortal = lazy(
  () => import(/* webpackChunkName: "portal-patient" */ "@/pages/PatientPortal"),
);
const ProntuarioEletronico = lazy(
  () => import(/* webpackChunkName: "prontuario-eletronico" */ "@/pages/ProntuarioEletronico"),
);
