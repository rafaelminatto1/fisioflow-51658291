...
const ServicosPage = lazy(
  () => import(/* webpackChunkName: "cadastros-services" */ "@/pages/cadastros/ServicosPage"),
);
const FornecedoresPage = lazy(
  () => import(/* webpackChunkName: "cadastros-suppliers" */ "@/pages/cadastros/FornecedoresPage"),
);
const FeriadosPage = lazy(
  () => import(/* webpackChunkName: "cadastros-holidays" */ "@/pages/cadastros/FeriadosPage"),
);
const AtestadosPage = lazy(
  () => import(/* webpackChunkName: "cadastros-certificates" */ "@/pages/cadastros/AtestadosPage"),
);
const ContratosPage = lazy(
  () => import(/* webpackChunkName: "cadastros-contracts" */ "@/pages/cadastros/ContratosPage"),
);
const ContratadosPage = lazy(
  () => import(/* webpackChunkName: "cadastros-contracted" */ "@/pages/cadastros/ContratadosPage"),
);
...
const EvaluationFormsPage = lazy(
  () => import(/* webpackChunkName: "cadastros-forms" */ "@/pages/cadastros/EvaluationFormsPage"),
);
...
const DoctorManagement = lazy(() =>
  import(/* webpackChunkName: "cadastros-doctors" */ "@/pages/DoctorManagement").then((module) => ({
    default: module.DoctorManagement,
  })),
);
