...
const WhatsAppDashboardPage = lazy(
	() =>
		import(
			/* webpackChunkName: "whatsapp-dashboard" */ "@/pages/WhatsAppDashboard"
		),
);
const WhatsAppAutomationsPage = lazy(
	() =>
		import(
			/* webpackChunkName: "whatsapp-automations" */ "@/pages/WhatsAppAutomations"
		),
);
const WhatsAppTemplatesPage = lazy(
	() =>
		import(
			/* webpackChunkName: "whatsapp-templates" */ "@/pages/WhatsAppTemplates"
		),
);
