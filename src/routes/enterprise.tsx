...
const ClinicalTestsLibrary = lazy(
  () => import(/* webpackChunkName: "clinical-tests" */ "@/pages/ClinicalTestsLibrary"),
);
const BiomechanicsAnalysisPage = lazy(
  () => import(/* webpackChunkName: "biomechanics" */ "@/pages/clinical/BiomechanicsAnalysisPage"),
);
const JumpAnalysisPage = lazy(
  () => import(/* webpackChunkName: "jump-analysis" */ "@/pages/clinical/jump/JumpAnalysisPage"),
);
const GaitAnalysisPage = lazy(
  () => import(/* webpackChunkName: "gait-analysis" */ "@/pages/clinical/gait/GaitAnalysisPage"),
);
...
const EventosAnalytics = lazy(
  () => import(/* webpackChunkName: "events-analytics" */ "@/pages/EventosAnalytics"),
);
...
const TelemedicineRoom = lazy(
  () => import(/* webpackChunkName: "telemedicine-room" */ "@/pages/TelemedicineRoom"),
);
// CRM
...
const EmailTest = lazy(
  () => import(/* webpackChunkName: "email-test" */ "@/pages/communications/EmailTest"),
);

// Settings
const ScheduleSettings = lazy(
  () => import(/* webpackChunkName: "settings-schedule" */ "@/pages/ScheduleSettings"),
);
