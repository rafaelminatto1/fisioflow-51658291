...
const Welcome = lazy(
	() => import(/* webpackChunkName: "auth-welcome" */ "./pages/Welcome"),
);
const SeedData = lazy(
	() => import(/* webpackChunkName: "seed-data" */ "./pages/SeedData"),
);
...
const Patients = lazy(
	() => import(/* webpackChunkName: "patients" */ "./pages/Patients"),
);
const Schedule = lazy(
	() => import(/* webpackChunkName: "schedule" */ "./pages/Schedule"),
);
const Exercises = lazy(
	() => import(/* webpackChunkName: "exercises" */ "./pages/Exercises"),
);
const Financial = lazy(
	() => import(/* webpackChunkName: "financial" */ "./pages/Financial"),
);
const Reports = lazy(
...
const AniversariantesPage = lazy(
	() =>
		import(
			/* webpackChunkName: "reports-birthdays" */ "./pages/relatorios/AniversariantesPage"
		),
);
const AttendanceReport = lazy(
	() =>
		import(
			/* webpackChunkName: "reports-attendance" */ "./pages/relatorios/AttendanceReport"
		),
);
const TeamPerformance = lazy(
	() =>
		import(
			/* webpackChunkName: "reports-team" */ "./pages/relatorios/TeamPerformance"
		),
);
const RelatorioMedicoPage = lazy(
	() =>
		import(
			/* webpackChunkName: "reports-medico" */ "./pages/relatorios/RelatorioMedicoPage"
		),
);
const RelatorioConvenioPage = lazy(
	() =>
		import(
			/* webpackChunkName: "reports-convenio" */ "./pages/relatorios/RelatorioConvenioPage"
		),
);
...
const Install = lazy(
	() => import(/* webpackChunkName: "install" */ "./pages/Install"),
);
const Surveys = lazy(
...
const AuditLogs = lazy(
	() => import(/* webpackChunkName: "admin-audit" */ "./pages/AuditLogs"),
);
const SecurityMonitoring = lazy(
	() =>
		import(
			/* webpackChunkName: "admin-security" */ "./pages/SecurityMonitoring"
		),
);
const SecuritySettings = lazy(
	() =>
		import(
			/* webpackChunkName: "settings-security" */ "./pages/SecuritySettings"
		),
);
const AdminCRUD = lazy(
	() => import(/* webpackChunkName: "admin-crud" */ "./pages/AdminCRUD"),
);
const OrganizationSettings = lazy(
	() =>
		import(
			/* webpackChunkName: "admin-organization" */ "./pages/OrganizationSettings"
		),
);
const Admin = lazy(
	() => import(/* webpackChunkName: "admin-analytics" */ "./pages/Admin"),
);
const AdvancedAnalytics = lazy(
	() =>
		import(
			/* webpackChunkName: "analytics-advanced" */ "./pages/AdvancedAnalytics"
		),
);
const CohortAnalysis = lazy(
	() =>
		import(
			/* webpackChunkName: "analytics-cohorts" */ "./pages/CohortAnalysis"
		),
);
...
// Gamification
const PatientGamificationPage = lazy(
	() =>
		import(
			/* webpackChunkName: "gamification-patient" */ "./pages/PatientGamificationPage"
		),
);
...
const GamificationAchievementsPage = lazy(
	() =>
		import(
			/* webpackChunkName: "gamification-achievements" */ "./pages/gamification/GamificationAchievementsPage"
		),
);
const GamificationQuestsPage = lazy(
	() =>
		import(
			/* webpackChunkName: "gamification-quests" */ "./pages/gamification/GamificationQuestsPage"
		),
);
const GamificationShopPage = lazy(
	() =>
		import(
			/* webpackChunkName: "gamification-shop" */ "./pages/gamification/GamificationShopPage"
		),
);
const GamificationLeaderboardPage = lazy(
	() =>
		import(
			/* webpackChunkName: "gamification-leaderboard" */ "./pages/gamification/GamificationLeaderboardPage"
		),
);
...
const GoalProfileListPage = lazy(
	() =>
		import(
			/* webpackChunkName: "goals-list" */ "./pages/admin/goals/GoalProfileListPage"
		),
);
const GoalProfileEditorPage = lazy(
	() =>
		import(
			/* webpackChunkName: "goals-editor" */ "./pages/admin/goals/GoalProfileEditorPage"
		),
);
...
const PreCadastroAdmin = lazy(
	() =>
		import(
			/* webpackChunkName: "pre-cadastro-admin" */ "./pages/PreCadastroAdmin"
		),
);
const FeedbackPreCadastro = lazy(
	() =>
		import(
			/* webpackChunkName: "feedback-pre-cadastro" */ "./pages/FeedbackPreCadastro"
		),
);
...
const PublicPrescriptionPage = lazy(
	() =>
		import(
			/* webpackChunkName: "prescription-public" */ "./pages/prescricoes/PublicPrescriptionPage"
		),
);
...
const BookingPage = lazy(() =>
	import(
		/* webpackChunkName: "public-booking" */ "./pages/public/BookingPage"
	).then((module) => ({ default: module.BookingPage })),
);
...
const IntegrationsPage = lazy(
	() =>
		import(
			/* webpackChunkName: "integrations-google" */ "./pages/Integrations"
		),
);
const ReviewsPage = lazy(
	() =>
		import(
			/* webpackChunkName: "marketing-reviews" */ "./pages/marketing/Reviews"
		),
);
const MarketingDashboard = lazy(
	() =>
		import(
			/* webpackChunkName: "marketing-dashboard" */ "./pages/marketing/Dashboard"
		),
);
const MarketingContentGenerator = lazy(
	() =>
		import(
			/* webpackChunkName: "marketing-content" */ "./pages/marketing/ContentGenerator"
		),
);
const MarketingContentCalendar = lazy(
	() =>
		import(
			/* webpackChunkName: "marketing-calendar" */ "./pages/marketing/ContentCalendar"
		),
);
const MarketingMythVsTruth = lazy(
	() =>
		import(
			/* webpackChunkName: "marketing-myth" */ "./pages/marketing/MythVsTruth"
		),
);
const MarketingWhatsAppScripts = lazy(
	() =>
		import(
			/* webpackChunkName: "marketing-whatsapp" */ "./pages/marketing/WhatsAppScripts"
		),
);
const MarketingJourneyTimelapse = lazy(
	() =>
		import(
			/* webpackChunkName: "marketing-timelapse" */ "./pages/marketing/JourneyTimelapse"
		),
);
const MarketingLocalSEO = lazy(
	() =>
		import(
			/* webpackChunkName: "marketing-seo" */ "./pages/marketing/LocalSEO"
		),
);
const MarketingGamification = lazy(
	() =>
		import(
			/* webpackChunkName: "marketing-gamification" */ "./pages/marketing/Gamification"
		),
);
const MarketingExports = lazy(
	() =>
		import(
			/* webpackChunkName: "marketing-exports" */ "./pages/marketing/Exports"
		),
);
const MarketingSettings = lazy(
	() =>
		import(
			/* webpackChunkName: "marketing-settings" */ "./pages/marketing/Settings"
		),
);
const FisioLinkPage = lazy(
	() =>
		import(
			/* webpackChunkName: "marketing-fisiolink" */ "./pages/marketing/FisioLink"
		),
);
const MarketingReferral = lazy(
	() =>
		import(
			/* webpackChunkName: "marketing-referral" */ "./pages/marketing/Referral"
		),
);
const MarketingROI = lazy(
	() => import(/* webpackChunkName: "marketing-roi" */ "./pages/marketing/ROI"),
);
...
const MasterDataHub = lazy(
	() =>
		import(
			/* webpackChunkName: "cadastros-hub" */ "./pages/cadastros/MasterDataHub"
		),
);
...
export function AppRoutes() {
	return (
		<Routes>
			...
			/>
			<Route
				path="/marketing/myth-truth"
				element={
					<ProtectedRoute>
						<MarketingMythVsTruth />
					</ProtectedRoute>
				}
			/>
			<Route
				...
				element={
					<ProtectedRoute>
						<MarketingWhatsAppScripts />
					</ProtectedRoute>
				}
			/>
			<Route
				path="/marketing/timelapse"
				element={
					<ProtectedRoute>
						<MarketingJourneyTimelapse />
					</ProtectedRoute>
				}
			/>
			<Route
