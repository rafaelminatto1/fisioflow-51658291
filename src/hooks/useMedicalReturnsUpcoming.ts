 ...
 */
export function useMedicalReturnsUpcoming(
	...
	const upcoming = useMemo(() => {
		...
		for (const p of patients) {
			const raw =
				(p as Record<string, unknown>).medical_return_date ??
				(p as Record<string, unknown>).medicalReturnDate;
			...
			const name =
				(p as Record<string, unknown>).full_name ??
				(p as Record<string, unknown>).name ??
				"";
			items.push({
				id: (p as Record<string, unknown>).id as string,
				name: typeof name === "string" ? name : "",
				full_name: (p as Record<string, unknown>).full_name as
					| string
					| undefined,
				medical_return_date: raw,
				referring_doctor_name: (p as Record<string, unknown>)
					.referring_doctor_name as string | undefined,
				referring_doctor_phone: (p as Record<string, unknown>)
					.referring_doctor_phone as string | undefined,
				medical_report_done: (p as Record<string, unknown>)
					.medical_report_done as boolean | undefined,
				medical_report_sent: (p as Record<string, unknown>)
					.medical_report_sent as boolean | undefined,
			});
		}
