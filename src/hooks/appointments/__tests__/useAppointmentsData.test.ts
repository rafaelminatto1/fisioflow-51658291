...
const mockAppointments = [
  { id: 'a1', patientId: 'p1', date: new Date(), status: 'scheduled', time: '09:00', duration: 60, type: 'Fisioterapia', createdAt: new Date(), updatedAt: new Date(), phone: '', notes: '' },
  { id: 'a2', patientId: 'p2', date: new Date(), status: 'confirmed', time: '10:00', duration: 60, type: 'Fisioterapia', createdAt: new Date(), updatedAt: new Date(), phone: '', notes: '' },
];
...
describe('useAppointmentsData', () => {
  ...
  it('desabilitado quando sem organization_id', async () => {
    ...
    renderHook(() => useAppointmentsData(), { wrapper: makeWrapper(queryClient) });
