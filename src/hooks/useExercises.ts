...
const makeMapper =
  ...
  (ex: WorkersExercise): Exercise => ({
    ...
    duration: ex.durationSeconds || ex.duration || undefined,
    sets: ex.sets || ex.setsRecommended || undefined,
    repetitions: ex.repetitions || ex.repsRecommended || undefined,
    indicated_pathologies: ex.indicated_pathologies || undefined,
    contraindicated_pathologies: ex.contraindicated_pathologies || undefined,
    scientific_references: ex.scientific_references || undefined,
