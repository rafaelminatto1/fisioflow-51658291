...
import { financialApi, type UserVoucherRecord, type VoucherRecord } from '@/lib/api/workers-client';
...
export function useCreateVoucher() {
  ...
  return useMutation({
    mutationFn: async (voucher: Omit<Voucher, 'id' | 'organization_id' | 'created_at' | 'updated_at'>) => {
