...
export const useCalendarDragDndKit = ({
	...
	const handleDragStart = useCallback(
		(appointment: Appointment) => {
			logger.debug(
				"[useCalendarDragDndKit] handleDragStart",
				{
			...
			if (!onAppointmentReschedule) {
				logger.warn(
					"[useCalendarDragDndKit] onAppointmentReschedule não está definido, drag não será iniciado",
					{},
					"useCalendarDragDndKit",
				);
				return;
	...
	const handleDragEnd = useCallback(
		(appointment: Appointment | null, droppableId: string | null) => {
