...
export const useGoniometer = (
    ...
    const [linkedKP, setLinkedKP] = useState<[number|null, number|null, number|null]>([null, null, null]);
	...
	return { 
        points, updatePoint, currentAngle, clearGoniometer,
        linkedKP, linkKeypoint,
        isRecording, toggleRecording, angleHistory
    };
};
