...
export const useAutoAngles = (poseKeypoints: (Point & { score: number })[]) => {
	...
	const angles = useMemo(() => {
		...
		// 1. Left Knee Flexion
		if (poseKeypoints[11].score > minScore && poseKeypoints[13].score > minScore && poseKeypoints[15].score > minScore) {
		...
		if (poseKeypoints[12].score > minScore && poseKeypoints[14].score > minScore && poseKeypoints[16].score > minScore) {
		...
		// 3. Left Hip Flexion
		if (poseKeypoints[5].score > minScore && poseKeypoints[11].score > minScore && poseKeypoints[13].score > minScore) {
		...
		// 4. Right Hip Flexion
		if (poseKeypoints[6].score > minScore && poseKeypoints[12].score > minScore && poseKeypoints[14].score > minScore) {
