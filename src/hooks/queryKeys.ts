...
export const QueryKeys = {
	...
	patientEvolutions: (patientId: string) =>
		["patient", patientId, "evolutions"] as const,
	patientEvaluations: (patientId: string) =>
		["patient", patientId, "evaluations"] as const,
	patientAppointments: (patientId: string) =>
		["patient", patientId, "appointments"] as const,
	patientGamification: (patientId: string) =>
		["patient", patientId, "gamification"] as const,
	...
	evaluationFormFields: (formId: string) =>
		["evaluation-form", formId, "fields"] as const,
	...
	gamificationHistory: (patientId: string) =>
		["gamification", patientId, "history"] as const,
} as const;
