...
export const useUpdateExerciseVideo = () => {
  ...
  return useMutation({
    ...
    onMutate: async ({ id, updates }) => {
      ...
      const previousVideo = queryClient.getQueryData<ExerciseVideo>(exerciseVideoKeys.detail(id));

      // Optimistically update to the new value
      queryClient.setQueryData<ExerciseVideo>(exerciseVideoKeys.detail(id), (old) =>
    ...
    onError: (error, variables, context) => {
      ...
      if (context?.previousVideo) {
        queryClient.setQueryData(exerciseVideoKeys.detail(variables.id), context.previousVideo);
      }
...
export const useDeleteExerciseVideo = () => {
  ...
  return useMutation({
    ...
    onMutate: async (id) => {
      ...
      // Snapshot previous value
      const previousVideos = queryClient.getQueryData<ExerciseVideo[]>(exerciseVideoKeys.list({}));
