...
export const useEvolutionShortcuts = (
  ...
  onComplete?: () => void,
  onNavigate?: (
    section: "subjective" | "objective" | "assessment" | "plan" | "measurements" | "history" | "ai",
  ) => void,
  onOpenHelp?: () => void,
  ...
  }, [onSave, onComplete, onNavigate, onOpenHelp, onOpenTemplates, onSaveAndAnalyze, onOpenScribe]);
