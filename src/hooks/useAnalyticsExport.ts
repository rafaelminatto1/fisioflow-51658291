...
import type { PatientAnalyticsData, PatientGoalTracking } from "@/types/patientAnalytics";
...
function createRiskAnalysisSheet(data: AnalyticsExportData, XLSX: ExcelApi): WorkSheet {
  const riskData = [
