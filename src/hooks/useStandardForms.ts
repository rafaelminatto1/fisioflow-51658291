...
export const STANDARD_FORMS = {
	ANAMNESE: {
		...
		campos: [
			...
			// Histórico Médico
			{
				...
				pergunta:
					"Possui alguma doença preexistente? (diabetes, hipertensão, etc.)",
				tipo_campo: "texto_longo",
	...
	AVALIACAO_FUNCIONAL: {
		...
		campos: [
			// Amplitude de Movimento
			{
				rotulo: "ADM - Cervical",
				pergunta:
					"Amplitude de movimento cervical (flexão, extensão, rotações, inclinações)",
				tipo_campo: "texto_longo",
	...
	FISIOTERAPIA_ORTOPEDICA: {
		...
		tipo: "ortopedica",
		descricao:
			"Avaliação detalhada para disfunções musculoesqueléticas e traumato-ortopédicas",
		campos: [
			{
				rotulo: "Mecanismo de Lesão",
				pergunta:
					"Descreva como e quando ocorreu a lesão ou início dos sintomas",
				tipo_campo: "texto_longo",
			...
			},
			{
				...
				pergunta:
					"A dor é constante ou intermitente? Piora em algum período do dia?",
				tipo_campo: "texto_longo",
				secao: "Anamnese Específica",
				ordem: 3,
				obrigatorio: false,
			...
			},
			{
				...
				pergunta:
					"Resultados de testes específicos (Ex: Lachman, Drawer, Hawkins, etc.)",
				tipo_campo: "texto_longo",
				secao: "Testes Específicos",
				ordem: 7,
				obrigatorio: false,
	...
	FISIOTERAPIA_ESPORTIVA: {
		...
		tipo: "esportiva",
		descricao:
			"Modelo focado em atletas, retorno ao esporte e performance funcional",
		campos: [
			{
			...
			},
			{
				...
				pergunta:
					"O atleta cumpre os critérios para progressão de carga/retorno?",
				tipo_campo: "texto_longo",
				secao: "Retorno ao Esporte",
				ordem: 8,
				obrigatorio: true,
	...
	FISIOTERAPIA_POS_OPERATORIA: {
		...
		tipo: "padrao",
		descricao:
			"Acompanhamento de reabilitação cirúrgica, fases de cicatrização e cuidados",
		campos: [
			{
			...
			},
			{
				...
				pergunta:
					"Estado dos pontos, presença de secreção, sinais inflamatórios",
				tipo_campo: "texto_longo",
