  ...
  return useMutation({
    mutationFn: async ({
      ...
      if (inputData.email !== undefined)
        sanitizedData.email = inputData.email ? sanitizeEmail(inputData.email) : null;
      if (inputData.phone !== undefined)
        sanitizedData.phone = inputData.phone ? cleanPhone(inputData.phone) : null;
      ...
      if (inputData.address !== undefined)
        sanitizedData.address = inputData.address ? sanitizeString(inputData.address, 500) : null;
      if (inputData.city !== undefined)
        sanitizedData.city = inputData.city ? sanitizeString(inputData.city, 100) : null;
      if (inputData.state !== undefined)
        sanitizedData.state = inputData.state ? sanitizeString(inputData.state, 2) : null;
      if (inputData.zip_code !== undefined)
        sanitizedData.zip_code = inputData.zip_code ? sanitizeString(inputData.zip_code, 10) : null;
      ...
      if (inputData.emergency_contact_relationship !== undefined)
        sanitizedData.emergency_contact_relationship = inputData.emergency_contact_relationship
      ...
      if (inputData.main_condition !== undefined)
        sanitizedData.main_condition = sanitizeString(inputData.main_condition, 500);
