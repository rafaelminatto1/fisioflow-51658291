...
export const validCPFs = ["529.982.247-25", "52998224725", "123.456.789-09", "12345678909"];
...
export const invalidEmails = ["invalid", "@nodomain.com", "no@domain", "spaces in@email.com", ""];
