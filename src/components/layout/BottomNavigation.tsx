...
import { LayoutDashboard, Users, Dumbbell, DollarSign, Plus } from "lucide-react";
...
export const BottomNavigation = memo(function BottomNavigation() {
  ...
  return (
    <nav
      ...
      className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-card border-t border-border/50 px-2 sm:px-4 py-2 pb-safe shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)] safe-area-inset-bottom"
    >
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive
                  ? "text-primary"
                  : "text-slate-500 hover:text-slate-600 dark:text-gray-500 dark:hover:text-slate-300 active:scale-95",
              )}
            >
              <div
                className={cn(
              ...
              >
                <Icon className={cn("w-6 h-6 transition-all", isActive && "scale-110")} />
                {isActive && (
