...
export function BoardLabelManager({ boardId, open, onOpenChange }: BoardLabelManagerProps) {
      ...
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="max-w-lg">
          ...
          <div className="space-y-3 border rounded-xl p-4 bg-muted/30">
            <p className="text-sm font-medium">{editingId ? "Editar etiqueta" : "Nova etiqueta"}</p>
            ...
            <div className="flex justify-end gap-2 pt-1">
              ...
              <Button size="sm" onClick={handleSubmit} disabled={!form.name.trim() || isPending}>
      ...
      <AlertDialog open={!!deleteId} onOpenChange={() => setDeleteId(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              A etiqueta será removida do board. Tarefas que a usam não serão afetadas, mas a cor
