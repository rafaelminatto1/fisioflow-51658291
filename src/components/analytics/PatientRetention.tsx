      ...
      <DialogContent className="max-w-lg">
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <Select
              value={channel}
              onValueChange={(v) => setChannel(v as "whatsapp" | "email" | "sms")}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
        ...
        <DialogFooter>
          ...
          <Button onClick={handleSend} disabled={sendCampaign.isPending} className="gap-2">
...
export function PatientRetention() {
  ...
  const filteredPatients = useMemo(() => {
    ...
    return patientsAtRisk.filter((patient) => {
      ...
      if (riskFilter === "medium" && (patient.riskScore < 50 || patient.riskScore >= 70))
        return false;
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex flex-wrap items-center gap-4">
                ...
                <Select
                  value={riskFilter}
                  onValueChange={(v) => setRiskFilter(v as "all" | "high" | "medium" | "low")}
                >
                ...
                <Badge variant="outline">{filteredPatients.length} pacientes</Badge>
              </div>
        ...
        <TabsContent value="trends" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Taxa de churn mensal nos últimos 12 meses</CardDescription>
            </CardHeader>
            <CardContent>
              {loadingTrends ? (
                <Skeleton className="h-80" />
                ...
                <ResponsiveContainer width="100%" height={350}>
                  <AreaChart data={churnTrends}>
                    ...
                    <Tooltip
                      ...
                      formatter={(value: number | string) => [`${value}%`, "Taxa de Churn"]}
                    />
                    <Area
                      type="monotone"
                      dataKey="churnRate"
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-3xl font-bold text-red-600">
                    R${" "}
                    {(metrics?.projectedRevenueLoss || 0).toLocaleString("pt-BR", {
