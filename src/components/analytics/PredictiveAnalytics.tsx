		...
		<div className="space-y-4">
			...
			{insights?.riskLevel === "high" && (
				<Alert variant="destructive">
					...
					<AlertDescription>
						Taxa de cancelamento acima do normal. Considere revisar políticas de
			...
			<Card className="border-none shadow-sm ring-1 ring-gray-200/50 dark:ring-gray-800/50 overflow-hidden">
				<CardHeader className="border-b border-gray-100/50 dark:border-gray-800/50 pb-4">
					...
					<CardDescription>
						Modelo preditivo baseado em séries temporais e comportamento
						histórico
					</CardDescription>
				</CardHeader>
