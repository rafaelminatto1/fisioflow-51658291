			...
			<Card className="border-destructive">
				<CardContent className="pt-6">
					<p className="text-destructive font-medium">
						Erro ao carregar insights clínicos.
					</p>
				</CardContent>
			</Card>
		);
						...
						<div className="flex items-center gap-4">
							...
							<div>
								...
								<h3 className="text-2xl font-bold">
									{goals.find((g) => g.status === "concluido")
										?.avg_days_to_achieve || "N/A"}{" "}
									dias
								</h3>
							</div>
						</div>
					...
					<CardContent className="pt-6">
						<div className="flex items-center gap-4">
							...
							<div>
								...
								<h3 className="text-2xl font-bold">
									{pathologies.reduce(
										(acc, curr) => acc + parseInt(acc + curr.patient_count),
										0,
									)}
								</h3>
							</div>
						...
						<div className="flex items-center gap-4">
							...
							<div>
								...
								<h3 className="text-2xl font-bold">
									{Math.round(
										(parseInt(
											goals.find((g) => g.status === "concluido")?.count || "0",
										) /
											goals.reduce(
			...
			<div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
				...
				<Card>
					<CardHeader>
						...
						<CardDescription>
							Distribuição de patologias ativas na clínica
						</CardDescription>
					</CardHeader>
					<CardContent>
							...
							<ResponsiveContainer width="100%" height="100%">
								<PieChart>
									<Pie
										...
										cy="50%"
										outerRadius={80}
										label={({ pathology, avg_pain_level }) =>
											`${pathology}: ${avg_pain_level}`
										}
									>
