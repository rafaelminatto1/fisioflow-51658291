    ...
    <div className="space-y-4">
      <Card className="border-none shadow-sm ring-1 ring-gray-200/50 dark:ring-gray-800/50">
        <CardHeader className="pb-4 sm:pb-6">
          <CardTitle className="text-base sm:text-lg">Agendamentos por Dia</CardTitle>
          <CardDescription className="text-xs sm:text-sm">Volume diário de agendamentos no período selecionado</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card className="border-none shadow-sm ring-1 ring-gray-200/50 dark:ring-gray-800/50">
        <CardHeader className="pb-4 sm:pb-6">
          ...
          <CardDescription className="text-xs sm:text-sm">Status dos agendamentos no período selecionado</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="h-[200px] sm:h-[250px] lg:h-[300px] w-full">
            {isLoadingStatus ? (
