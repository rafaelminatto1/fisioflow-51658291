		...
		try {
			...
			if (reportType === "medical") {
				...
				ReportGeneratorService.generateMedicalReport({
					...
					reportDate,
					therapistName,
					diagnosis: pathologies.find((p) => p.status === "em_tratamento")
						?.pathology_name,
				...
				ReportGeneratorService.generatePatientReport({
					...
					therapistName,
					startDate:
						painEvolution[painEvolution.length - 1]?.date || reportDate,
									...
									<div className="flex-1">
										<label htmlFor="medical" className="cursor-pointer">
											...
											<p className="text-sm text-muted-foreground">
												Relatório técnico completo para envio ao médico
												solicitante. Inclui histórico cirúrgico, patologias,
												medicações, evolução clínica detalhada com testes e
												medições.
											</p>
										</label>
								...
								<div className="flex items-start gap-3">
									...
									<div className="flex-1">
										<label htmlFor="patient" className="cursor-pointer">
											...
											<p className="text-sm text-muted-foreground">
												Relatório simplificado e motivacional para o paciente.
												Destaca conquistas, progresso em linguagem acessível,
												objetivos atuais e próximos passos.
											</p>
										</label>
										<Badge variant="secondary" className="mt-2">
											Simplificado
								...
								<div className="flex items-start gap-3">
									...
									<div className="flex-1">
										<label htmlFor="internal" className="cursor-pointer">
											...
											<p className="text-sm text-muted-foreground">
												Relatório para equipe interna de fisioterapeutas. Inclui
												métricas de adesão, análise de risco, recomendações
												técnicas e observações clínicas.
											</p>
										</label>
										<Badge variant="secondary" className="mt-2">
											Interno
