...
import { Cloud, Download, Edit, Eye, FileText, Stethoscope, Trash2 } from "lucide-react";
    ...
    <MainLayout>
      <div className="space-y-6">
        ...
        <Alert>
          ...
          <AlertDescription>
            Estes relatórios são destinados à comunicação entre profissionais de saúde. Todas as
            informações são confidenciais e protegidas por sigilo profissional.
          </AlertDescription>
        </Alert>
