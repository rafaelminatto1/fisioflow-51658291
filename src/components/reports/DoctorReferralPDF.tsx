...
export const DoctorReferralPDF = ({
	patient,
	clinic,
	analysis,
}: DoctorReferralPDFProps) => (
	<Document>
		<Page size="A4" style={styles.page}>
			...
			<View style={styles.section}>
				<Text style={styles.sectionTitle}>
					Adesão ao Tratamento (Digital Health Metrics)
				</Text>
				<View style={styles.row}>
					<Text style={styles.label}>Adesão:</Text>
					<Text style={styles.value}>
						{analysis.adherence}% dos exercícios prescritos concluídos
					</Text>
				</View>
				<View style={styles.row}>
					<Text style={styles.label}>Engajamento:</Text>
					<Text style={styles.value}>
						Nível {analysis.level} • {analysis.streaks} dias seguidos de
						atividade
					</Text>
				</View>
