...
export function WaitlistManager() {
  ...
  const handleChangePriority = useCallback(
    (id: string, priority: "normal" | "high" | "urgent") => {
        ...
        <CardHeader className="border-b">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
              ...
              <CardDescription>Pacientes aguardando vagas disponíveis</CardDescription>
            </div>
            <Button
              onClick={() => {
                          ...
                          <div className="flex items-start gap-3 flex-1 min-w-0">
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-center gap-2 mb-2 flex-wrap">
                                <h4 className="font-semibold truncate">{entry.patient?.name}</h4>
                                <Badge
                                  variant="outline"
                                  className={cn(getPriorityColor(entry.priority))}
                                >
                          ...
                          <div className="flex gap-2 flex-shrink-0">
                            ...
                            <DropdownMenu>
                              ...
                              <DropdownMenuContent align="end">
                                ...
                                <DropdownMenuSeparator />
                                <DropdownMenuItem
                                  onClick={() => handleChangePriority(entry.id, "urgent")}
                                >
                                  Definir como Urgente
                                </DropdownMenuItem>
                                <DropdownMenuItem
                                  onClick={() => handleChangePriority(entry.id, "high")}
                                >
                                  Definir como Alta
                                </DropdownMenuItem>
                                <DropdownMenuItem
                                  onClick={() => handleChangePriority(entry.id, "normal")}
                                >
                                  Definir como Normal
                                </DropdownMenuItem>
                                <DropdownMenuSeparator />
