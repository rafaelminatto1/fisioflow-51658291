...
export function WaitlistManager() {
	...
	const { mutate: removeFromWaitlist, isPending: isRemoving } =
		useRemoveFromWaitlist();
																...
																{entry.preferred_days &&
																	entry.preferred_days.length > 0 && (
																		<span className="flex items-center gap-1">
																			...
																			{entry.preferred_days.length} dias
																			preferidos
																		</span>
																	)}
															</div>
													...
													<div className="flex gap-2 flex-shrink-0">
														...
														<DropdownMenu>
															...
															<DropdownMenuContent align="end">
																...
																<DropdownMenuItem
																	onClick={() =>
																		handleChangePriority(entry.id, "urgent")
																	}
																>
																...
																<DropdownMenuItem
																	onClick={() =>
																		handleChangePriority(entry.id, "high")
																	}
																>
																	Definir como Alta
																</DropdownMenuItem>
																<DropdownMenuItem
																	onClick={() =>
																		handleChangePriority(entry.id, "normal")
																	}
																>
																	Definir como Normal
																</DropdownMenuItem>
