...
export const SessionImageUpload: React.FC<SessionImageUploadProps> = ({
	...
	const [selectedCategory, setSelectedCategory] =
		useState<SessionAttachmentCategory>("before_after");
	const [previewImage, setPreviewImage] = useState<SessionAttachment | null>(
		null,
	);
		...
		<>
						...
						<div>
							<div className="flex gap-2 mb-3">
								<Select
									...
									onValueChange={(v) =>
										setSelectedCategory(v as SessionAttachmentCategory)
									}
								>
			...
			<Dialog open={!!previewImage} onOpenChange={() => setPreviewImage(null)}>
				<DialogContent className="max-w-4xl">
					<DialogHeader>
						<DialogTitle>{previewImage?.original_name || "Anexo"}</DialogTitle>
					</DialogHeader>
			...
			>
				<AlertDialogContent>
					<AlertDialogHeader>
						...
						<AlertDialogDescription>
							Tem certeza que deseja excluir o arquivo "{deleteConfirm?.name}"?
