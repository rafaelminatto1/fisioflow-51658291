...
export const SessionImageUpload: React.FC<SessionImageUploadProps> = ({
  ...
  const imageCount = attachments.filter(
    (a) => a.file_type === "jpg" || a.file_type === "png" || a.file_type === "gif",
  ).length;
              ...
              >
                {isUploading ? (
                  ...
                  <div className="space-y-2">
                    ...
                    <p className="text-xs text-muted-foreground">JPG, PNG, PDF, Word (máx. 10MB)</p>
                  </div>
                )}
              </div>
            </div>
      ...
      <AlertDialog open={!!deleteConfirm} onOpenChange={() => setDeleteConfirm(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Tem certeza que deseja excluir o arquivo "{deleteConfirm?.name}"? Esta ação não pode
              ser desfeita.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
