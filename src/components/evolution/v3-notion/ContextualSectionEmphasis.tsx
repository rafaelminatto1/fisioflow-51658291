	...
	return useMemo(
		() => ({
			...
			observations: {
				...
				isRequired: false,
				isFilled:
					!!data.observations?.trim() || !!data.homeCareExercises?.trim(),
				importance: "optional",
...
export const MemoizedContextualSectionEmphasis = React.memo(
	ContextualSectionEmphasis,
);
MemoizedContextualSectionEmphasis.displayName =
	"ContextualSectionEmphasis (Memoized)";
