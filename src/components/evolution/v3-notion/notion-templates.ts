...
export const NOTION_TEMPLATES: SOAPTemplate[] = [
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    plan: [
      ...
      callout(
        "🏠",
        `<strong>HEP — Exercícios para casa:</strong><br>
...
Frequência: ___ vezes ao dia / semana`,
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    usageCount: 0,
    subjective: [
      callout("🆕", "<strong>Primeira sessão — anamnese completa obrigatória</strong>"),
      h3("Queixa Principal"),
    ...
    assessment: [
      callout("🩺", `${bold("Diagnóstico Fisioterapêutico:")} __________`),
      p(
    ...
    plan: [
      ...
      ul(["Frequência: ___× semana · Duração estimada: ___ semanas", "Próxima sessão: __________"]),
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    plan: [
      ...
      h3("Resposta ao Tratamento"),
      ul(["EVA pós-sessão: __/10", "ADM pós-mobilização: Flexão ___° / Extensão ___°"]),
      hr(),
      callout("📌", "Orientações domiciliares: __________"),
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    plan: [
      ...
      ul(["Critério para progressar: __________", "EVA pós-sessão: __/10"]),
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    plan: [
      ...
      callout(
        "📌",
        "Orientações: Evitar elevação acima de ____ / Exercícios domiciliares: __________",
      ),
      p("Retorno: __________"),
    ].join(""),
  },
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    subjective: [
      ...
      callout(
        "🚩",
        "Red flags triados: cefaleia em trovão? déficit neurológico progressivo? mielopatia?",
      ),
    ].join(""),
  ...
  // ═══════════════════════════════════════════════════════════════════════════
  {
    ...
    assessment: [
      ...
      p(
        "Punho/mão __________ (D/E) com EVA __/10, déficit de força __% comparado ao lado contralateral e __________.",
      ),
    ].join(""),
