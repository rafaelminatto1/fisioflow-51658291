...
const MobileSheetContext = createContext<MobileSheetContextValue | undefined>(
	undefined,
);

export const MobileSheetProvider: React.FC<{ children: React.ReactNode }> = ({
	children,
}) => {
	const [isMobile, setIsMobile] = useState(false);
	const [currentSheet, setCurrentSheet] =
		useState<MobileSheetContextValue["currentSheet"]>(null);
