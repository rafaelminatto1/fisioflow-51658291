...
export const AdaptiveSectionCollapse: React.FC<
	AdaptiveSectionCollapseProps
> = ({
	id,
	title,
	subtitle,
...
export const MemoizedAdaptiveSectionCollapse = React.memo(
	AdaptiveSectionCollapse,
);
MemoizedAdaptiveSectionCollapse.displayName =
	"AdaptiveSectionCollapse (Memoized)";
