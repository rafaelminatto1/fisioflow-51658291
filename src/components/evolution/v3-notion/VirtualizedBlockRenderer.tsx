...
export const VirtualizedBlockRenderer = forwardRef<HTMLDivElement, VirtualizedBlockRendererProps>(
  ({ blocks, className, bufferSize = 3, estimatedHeight = 200, onBlockRendered }, ref) => {
...
export const MemoizedVirtualizedBlockRenderer = React.memo(VirtualizedBlockRenderer);
MemoizedVirtualizedBlockRenderer.displayName = "VirtualizedBlockRenderer (Memoized)";
