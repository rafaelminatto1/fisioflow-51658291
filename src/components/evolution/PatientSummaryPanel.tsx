...
import { User, Phone, MessageCircle, Calendar, Activity, Target, TrendingUp } from "lucide-react";
        ...
        <ScrollArea className="h-full px-4 pb-4">
          <div className="space-y-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  {engagement && (
                    <EngagementBadge
                      ...
                      days={engagement.daysSinceLastActivity}
                    />
                  )}
                </div>
              </div>
            ...
            <div className="flex gap-2">
              ...
              {patient.phone && (
                <Button size="sm" variant="outline" className="flex-1 h-8" onClick={onPhoneClick}>
            ...
            {nextAppointment && (
              <div className="p-3 rounded-lg border bg-primary/5">
                ...
                <p className="font-medium text-sm">
                  {format(nextAppointment, "EEEE, d 'de' MMMM", {
                    locale: ptBR,
                  })}
                </p>
                <p className="text-xs text-muted-foreground">{format(nextAppointment, "HH:mm")}</p>
              </div>
            )}
