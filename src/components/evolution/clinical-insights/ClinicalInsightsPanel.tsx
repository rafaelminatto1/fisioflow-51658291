    ...
    <div className="flex flex-col gap-4 p-2">
      <div className="flex items-center justify-between px-2">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h3 className="text-sm font-bold text-slate-900 dark:text-white">Clinical Insights</h3>
            <p className="text-[10px] text-slate-500">Sugestões baseadas em evidências</p>
          </div>
        </div>
