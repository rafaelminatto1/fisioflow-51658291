										...
										>
											<div className="flex items-start justify-between gap-3">
												<div className="min-w-0 flex-1">
													...
													<div className="flex items-center gap-2 mt-1.5 text-sm text-muted-foreground flex-wrap">
														<span
															className={`flex items-center gap-1.5 ${isUpcoming ? "text-primary font-semibold" : ""}`}
														>
															{returnDate
											...
											<div className="flex gap-2 mt-1">
												{r.report_done ? (
													<Badge
														variant="outline"
														className="h-6 text-xs font-medium bg-green-500/10 text-green-700 dark:text-green-400 border-green-500/20 px-2 gap-1.5"
													>
													...
													<Badge
														variant="outline"
														className="h-6 text-xs font-medium bg-yellow-500/10 text-yellow-700 dark:text-yellow-400 border-yellow-500/20 px-2 gap-1.5"
													>
												...
												{r.report_sent && (
													<Badge
														variant="outline"
														className="h-6 text-xs font-medium bg-blue-500/10 text-blue-700 dark:text-blue-400 border-blue-500/20 px-2 gap-1.5"
													>
														<FileText className="h-3.5 w-3.5" />
														Enviado
													</Badge>
