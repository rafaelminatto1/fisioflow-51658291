  ...
  renderHTML({ HTMLAttributes, node }) {
    return [
      ...
      [
        ...
        {
          class:
            "flex items-center justify-between p-2 bg-slate-100 dark:bg-slate-800 border border-b-0 border-slate-200 dark:border-slate-700 rounded-t-lg",
        },
        [
          "span",
      ...
      [
        "iframe",
        {
          ...
          class:
            "w-full h-[500px] border border-slate-200 dark:border-slate-700 rounded-b-lg shadow-sm",
