...
export const MeasurementForm: React.FC<MeasurementFormProps> = ({
    ...
    if (test?.fields_definition && test.fields_definition.length > 0) {
      ...
      const newCustomFields = customFields.map((f) => {
        const templateField = test.fields_definition?.find(
          (tf) => tf.id === f.id || tf.label.toLowerCase() === f.label.toLowerCase(),
        );
        if (templateField) {
          return {
            ...f,
  ...
  const showYBalanceDiagram = (m: MeasurementInput) =>
    ...
    (!!m.measurement_name && /y\s*test|y\s*balance|ybt/i.test(m.measurement_name));
      ...
      {measurements.length > 1 && (
        <div className="px-6 pt-4 pb-2">
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs font-semibold text-slate-600">Progresso do Registro</span>
            <span className="text-xs text-slate-500">
              {measurements.filter((m) => m.measurement_name && hasAnyValue(m)).length} /{" "}
              {measurements.length}
            </span>
          </div>
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-semibold text-slate-700">Modelos Rápidos</span>
            </div>
            <Badge
              variant="secondary"
                  ...
                  <div className="lg:col-span-5 space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          handleUpdateMeasurement(index, "measurement_type", value)
                        }
                      >
                        <SelectTrigger
                          className={cn(
                  ...
                  <div className="lg:col-span-7 space-y-4">
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          handleUpdateMeasurement(index, "measurement_name", e.target.value)
                        }
                        ...
                        <div className="col-span-2 space-y-4">
                          ...
                          <div className="space-y-2 pt-2 border-t border-slate-100">
                            ...
                            <Textarea
                              ...
                              onChange={(e) =>
                                handleUpdateMeasurement(index, "notes", e.target.value)
                              }
                            ...
                            {measurement.selectedTest!.fields_definition!.map((field) => (
                              ...
                              >
                                ...
                                <Input
                                  ...
                                  onChange={(e) =>
                                    handleUpdateCustomData(index, field.id, e.target.value)
                                  }
                            ...
                            {enabledFields.map((field) => {
                              ...
                              return (
                                <motion.div
                                  ...
                                  className={cn(
                                    "space-y-2",
                                    field.type === "textarea" || field.id === "notes"
                                      ? "col-span-2"
                                      : "",
                                  )}
                                >
                                  ...
                                  {field.type === "select" ? (
                                    <Select
                                      ...
                                      onValueChange={(val) =>
                                        handleUpdateCustomData(index, fieldKey, val)
                                      }
                                    >
                                      <SelectTrigger
                                        className={cn(
                                    ...
                                    <Textarea
                                      value={measurement.custom_data[fieldKey] || ""}
                                      onChange={(e) =>
                                        handleUpdateCustomData(index, fieldKey, e.target.value)
                                      }
                        ...
                        <>
                          <div className="space-y-2">
                            ...
                            <Input
                              ...
                              onChange={(e) =>
                                handleUpdateMeasurement(index, "value", e.target.value)
                              }
                              placeholder="0.0"
                              className={cn(
                                "h-11 bg-white border-slate-200 font-semibold text-slate-700",
                          ...
                          <div className="space-y-2">
                            ...
                            <Input
                              ...
                              onChange={(e) =>
                                handleUpdateMeasurement(index, "unit", e.target.value)
                              }
          ...
          <div className="space-y-4">
            ...
            <AnimatePresence>
              {showFieldsConfig && (
                ...
                >
                  <CustomFieldsConfig fields={customFields} onChange={setCustomFields} />
