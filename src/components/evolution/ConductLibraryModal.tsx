...
export function ConductLibraryModal({
	...
	const [conductToEdit, setConductToEdit] = useState<ConductTemplate | null>(
		null,
	);
	...
	return (
		<>
			...
			<AlertDialog
				open={!!conductToDelete}
				onOpenChange={() => setConductToDelete(null)}
			>
				<AlertDialogContent>
					<AlertDialogHeader>
						<AlertDialogTitle>Remover conduta?</AlertDialogTitle>
						<AlertDialogDescription>
							Esta ação não pode ser desfeita. A conduta será removida
