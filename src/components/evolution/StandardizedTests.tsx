		...
		},
		{
			...
			options: [
				...
				{ value: 4, label: "Preciso de ajuda todos os dias" },
				{
					value: 5,
					label:
						"Não consigo me vestir, me lavo com dificuldade e fico na cama",
				},
			],
		},
		{
			...
			options: [
				...
				},
				{
					value: 3,
					label:
						"A dor me impede de levantar objetos pesados mas consigo com objetos leves",
				},
...
export function StandardizedTests({
	...
	const getScoreInterpretation = (score: number, testId: string) => {
		if (testId === "oswestry") {
			...
			if (score <= 40)
				return { text: "Incapacidade Moderada", color: "warning" };
			if (score <= 60)
				return { text: "Incapacidade Severa", color: "destructive" };
