  ...
  questions: [
    ...
    },
    {
      ...
      options: [
        ...
        {
          value: 3,
          label: "Preciso de alguma ajuda mas consigo fazer a maior parte",
        },
        { value: 4, label: "Preciso de ajuda todos os dias" },
        {
          value: 5,
          label: "Não consigo me vestir, me lavo com dificuldade e fico na cama",
        },
      ],
    },
    {
      ...
      options: [
        ...
        {
          value: 1,
          label: "Posso levantar objetos pesados mas causa dor extra",
        },
        {
          value: 2,
          label: "A dor me impede de levantar objetos pesados do chão",
        },
        {
          value: 3,
          label: "A dor me impede de levantar objetos pesados mas consigo com objetos leves",
        },
    ...
    },
    {
      ...
      options: [
        {
          value: 0,
          label: "A dor não me impede de caminhar qualquer distância",
        },
        ...
        {
          value: 5,
          label: "Fico na cama a maior parte do tempo e preciso me arrastar para ir ao banheiro",
        },
      ],
    },
    {
      ...
      options: [
        {
          value: 0,
          label: "Posso sentar em qualquer cadeira pelo tempo que quiser",
        },
        {
          value: 1,
          label: "Posso sentar em minha cadeira favorita pelo tempo que quiser",
        },
...
export function StandardizedTests({ patientId, onSave }: StandardizedTestsProps) {
  ...
  const interpretation = selectedTest
    ? getScoreInterpretation(currentScore, selectedTest.id)
    : null;
  const progress = selectedTest
    ? (Object.keys(answers).length / selectedTest.questions.length) * 100
    : 0;
                    ...
                    <Card key={test.id} className="p-4">
                      <div className="flex items-start justify-between gap-4">
                        ...
                        <div className="text-right text-xs text-muted-foreground">
                          {format(new Date(test.created_at), "dd/MM/yyyy 'às' HH:mm", {
                            locale: ptBR,
                          })}
                        </div>
                      </div>
        ...
        <div className="space-y-6">
              ...
              {Object.keys(answers).length === selectedTest.questions.length && interpretation && (
                <div className="mb-6 p-4 rounded-lg bg-muted/30 border border-border/30">
                  <div className="flex items-center justify-between">
                    ...
                    <Badge
                      variant={
                        interpretation.color as "default" | "secondary" | "outline" | "destructive"
                      }
                    >
                      {interpretation.text}
                    </Badge>
          ...
          <div className="flex justify-end gap-3">
            ...
            <Button
              ...
              disabled={
                Object.keys(answers).length !== selectedTest.questions.length || saveTest.isPending
              }
              className="gap-2"
            >
