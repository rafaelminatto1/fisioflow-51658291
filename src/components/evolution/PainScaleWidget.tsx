...
const PainLevelIndicator = memo<PainLevelIndicatorProps>(({ level }) => {
  ...
  return (
    <motion.div
      ...
      role="img"
    >
      <span className="text-xl sm:text-2xl md:text-3xl font-bold" aria-hidden="true">
        {level}
      </span>
      <span className="text-[10px] sm:text-xs md:text-sm opacity-90 font-medium" aria-hidden="true">
        /10
      </span>
    </motion.div>
  );
...
const PainChart = memo<PainChartProps>(({ history }) => {
  ...
  return (
    <div
      ...
      role="region"
      aria-label="Gráfico de histórico de dor"
    >
...
const PainScaleSegment = memo<PainScaleSegmentProps>(
  ({ levelInfo, currentLevel, disabled, onClick }) => {
        ...
        <TooltipTrigger asChild>
          <motion.button
            ...
            className={cn(
              ...
              levelInfo.color,
              isSelected &&
                "ring-2 ring-white ring-offset-1 ring-offset-background z-10 shadow-md brightness-110",
              isPast && "opacity-70",
...
const PainOptionButton = memo<PainOptionButtonProps>(
  ({ value, selectedValue, onClick, disabled, ariaLabel }) => {
            ...
            <div className="flex-1 space-y-2.5 sm:space-y-3 min-w-0">
              ...
              <div className="flex items-center gap-2 sm:gap-2.5">
                ...
                <Button
                  ...
                  type="button"
                >
                  <span className="text-base sm:text-lg font-medium" aria-hidden="true">
                    +
                  </span>
                </Button>
              </div>
          ...
          <div className="space-y-2">
                      ...
                      style={{
                        backgroundColor:
                          levelInfo.color
                            ...
                            .replace("-600", "") === "green"
                            ? "#22c55e"
                            : levelInfo.color.includes("green-400")
                              ? "#4ade80"
                              : levelInfo.color.includes("lime-400")
                                ? "#bef264"
                                : levelInfo.color.includes("lime-500")
                                  ? "#84cc16"
                                  : levelInfo.color.includes("yellow-400")
                                    ? "#fde047"
                                    : levelInfo.color.includes("yellow-500")
                                      ? "#facc15"
                                      : levelInfo.color.includes("orange-400")
                                        ? "#fb923c"
                                        : levelInfo.color.includes("orange-500")
                                          ? "#f97316"
                                          : levelInfo.color.includes("red-400")
                                            ? "#ef4444"
                                            : levelInfo.color.includes("red-500")
                                              ? "#dc2626"
                                              : "#991b1b",
                      }}
                    />
            ...
            >
              ...
              <div className="relative z-10 flex items-center justify-center gap-2 h-full">
                <span className="text-lg sm:text-xl font-bold leading-tight text-white">10</span>
