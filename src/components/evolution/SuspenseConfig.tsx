 ...
 */
export function CriticalDataBoundary({ children, fallback, className }: SuspenseBoundaryProps) {
 ...
 */
export function SecondaryDataBoundary({ children, fallback, className }: SuspenseBoundaryProps) {
  const defaultFallback = (
 ...
 */
export function AIComponentBoundary({ children, fallback, className }: SuspenseBoundaryProps) {
  const defaultFallback = (
 ...
 */
export function MediaBoundary({ children, fallback, className }: SuspenseBoundaryProps) {
  const defaultFallback = (
    <div
      className={cn(
        "aspect-square bg-muted/30 rounded-lg flex items-center justify-center",
        className,
      )}
    >
...
export function EvolutionSuspenseLayout({ children }: { children: ReactNode }) {
  return (
    <>
      ...
      <CriticalDataBoundary>{children}</CriticalDataBoundary>
    </>
  );
}
