...
const EmptyState: React.FC<EmptyStateProps> = ({ onCreateCycle }) => (
	...
	>
		...
		<p className="text-sm text-slate-500 max-w-sm leading-relaxed mb-6">
			Agrupe sessões em ciclos terapêuticos de 2-4 semanas, acompanhe o
			progresso e faça transições estruturadas entre fases do tratamento.
			Inspirado nas melhores práticas de gestão ágil.
		</p>
...
export const TreatmentCycles: React.FC<TreatmentCyclesProps> = ({
	...
	return (
		<Card
			className={cn(
				"border border-slate-100 bg-slate-50/40 shadow-sm",
				className,
			)}
		>
