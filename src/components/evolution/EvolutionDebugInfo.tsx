...
export function EvolutionDebugInfo({
	patientId,
	patient,
	appointmentId,
	appointment,
			...
			<AlertDescription className="font-mono text-xs">
				<div className="grid grid-cols-2 gap-4">
					<div>
						...
						<p>
							Patient ID (from appointment): {appointmentPatientId || "<null>"}
						</p>
					...
					<div>
						...
						<p>
							Date: {appointment?.date ? String(appointment.date) : "<null>"}
						</p>
					</div>
				</div>
				...
				{!patient && !patientError && appointment && (
					<div className="mt-2 pt-2 border-t border-slate-800">
						...
						<p className="text-yellow-400">
							Appointment exists but patient is null. Check if patient_id is
							valid and patient exists in database.
						</p>
					</div>
				)}
			</AlertDescription>
