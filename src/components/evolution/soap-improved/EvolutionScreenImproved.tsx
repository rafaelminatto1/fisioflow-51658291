...
const PAIN_LEVELS = [
  {
    ...
    label: "Sem dor",
    color: COLORS.success,
    iconName: "happy-outline" as any,
  },
  {
    value: 3,
    label: "Dor leve",
    color: "#84CC16",
    iconName: "sad-outline" as any,
  },
  {
    value: 6,
    label: "Dor moderada",
      ...
      <View style={styles.cardContent}>
        ...
        <View style={styles.painDisplay}>
          ...
          <View style={styles.painInfo}>
            <Text style={[styles.painLabel, { color: painConfig.color }]}>{painConfig.label}</Text>
        ...
        >
          ...
          <View style={styles.sliderMarks}>
            {[0, 2, 4, 6, 8, 10].map((num) => (
              <Text key={num} style={styles.sliderMark}>
                {num}
              </Text>
            ))}
          </View>
    ...
    <View style={styles.card}>
      <View style={styles.cardHeader}>
        ...
        <View
          style={[
            ...
            {
              backgroundColor:
                completionPercentage === 100 ? COLORS.primary + "20" : COLORS.surface,
            },
          ]}
        >
          <Text
            style={[
              ...
              {
                color: completionPercentage === 100 ? COLORS.primary : COLORS.textSecondary,
              },
            ]}
          >
      ...
      <View style={styles.progressBarContainer}>
        <View style={styles.progressBarTrack}>
          <Animated.View style={[styles.progressBarFill, { width: `${completionPercentage}%` }]} />
        </View>
      </View>
    </View>
  );
...
const SOAPSectionCard: React.FC<{
  ...
  return (
    <View style={[styles.card, styles.soapCard, isExpanded && { borderColor: section.color }]}>
      <TouchableOpacity style={styles.soapCardHeader} onPress={onToggle} activeOpacity={0.7}>
      ...
      {isExpanded && (
        <View style={styles.soapCardContent}>
          ...
          <Text style={styles.soapDescription}>
            <Ionicons name={section.iconName} size={14} color={COLORS.textSecondary} />{" "}
            {section.description}
          </Text>
        </View>
      )}
  ...
  return (
    <View style={styles.card}>
      <View style={styles.cardHeader}>
        ...
        {photos.length > 0 && <Text style={styles.photoCount}>{photos.length}/5</Text>}
      </View>

      <View style={styles.cardContent}>
        {photos.length === 0 ? (
          <TouchableOpacity style={styles.emptyPhotos} onPress={onAddPhoto} activeOpacity={0.7}>
