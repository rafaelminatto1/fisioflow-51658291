			...
			>
				...
				{SOAP_SECTIONS.map((section) => (
					<SOAPSectionCard
						...
						onToggle={() =>
							setExpandedSOAP(expandedSOAP === section.key ? null : section.key)
						}
					/>
				))}
...
// Patient Info Card
const PatientInfoCard: React.FC<{ patientName: string }> = ({
	patientName,
}) => {
...
// SOAP Progress Card
const SOAPProgressCard: React.FC<{ completionPercentage: number }> = ({
	...
	return (
		<View
			style={[
				styles.card,
				styles.soapCard,
				isExpanded && { borderColor: section.color },
			]}
		>
			<TouchableOpacity
			...
			>
				<View
					style={[styles.soapLabelBadge, { backgroundColor: section.bgColor }]}
				>
					<Text style={[styles.soapLabelText, { color: section.color }]}>
						{section.shortLabel}
					</Text>
				</View>
