...
export const SOAPEvolutionFormImproved: React.FC<SOAPEvolutionFormProps> = ({
	...
	const [activeSOAPSection, setActiveSOAPSection] = useState<string | null>(
		null,
	);
	...
	const updateFormData = useCallback(
		<K extends keyof SOAPEvolutionFormData>(
			key: K,
			...
			<div className="p-4 space-y-4">
				...
				<div className="pt-1">
					...
					<Input
						...
						onChange={(e) =>
							onChange({ ...painLevel, location: e.target.value })
						}
						disabled={disabled}
			...
			<div className="p-3">
				{exercises.length === 0 ? (
					<div className="text-center py-10 text-muted-foreground">
						...
						<p className="text-xs mt-1.5 opacity-70">
							Digite abaixo e Enter para adicionar
						</p>
					</div>
				) : (
