...
import { Activity, Smile, Meh, Frown, Grimace, Info } from "lucide-react";
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative">
            ...
            >
              ...
              <span className="text-3xl font-bold text-white drop-shadow-sm">{value.level}</span>
            </div>
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-muted-foreground">
              ...
              {value.level > 3 &&
                value.level <= 6 &&
                "Dor moderada - interfere em algumas atividades"}
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    if (descArray.includes(desc)) {
                      ...
                      onChange?.({
                        ...value,
                        description: [...descArray, desc].join(", "),
                      });
                    }
                  }}
                  disabled={disabled}
