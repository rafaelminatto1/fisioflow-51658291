...
const SOAP_SECTIONS: SOAPSection[] = [
  {
    ...
    examples: [
      '"Paciente relata dor na região lombar"',
      '"Melhora do desconforto ao sentar"',
      '"Dor ao realizar movimentos de flexão"',
    ],
  },
  {
    key: "objective",
  ...
  },
  {
    ...
    examples: [
      "Paciente apresentando melhora de 30%",
      "Resposta positiva ao tratamento proposto",
      "Necessita ajuste na conduta",
    ],
  },
  {
    key: "plan",
                    ...
                    <div className="flex items-center gap-2 flex-wrap mb-3">
                      ...
                      {showCopyButton && onCopyLast && (
                        <Tooltip>
                          ...
                          <TooltipContent>Copiar da última sessão</TooltipContent>
                        </Tooltip>
                      )}
                    </div>
