					...
					<Dialog open={isUploadOpen} onOpenChange={setIsUploadOpen}>
						...
						<DialogContent>
							<DialogHeader>
								...
								<DialogDescription>
									Envie laudos, exames ou outros documentos relacionados ao
									paciente.
								</DialogDescription>
							</DialogHeader>
							<div className="space-y-4">
								<div>
									<Label htmlFor="file">
										Arquivo (PDF, JPG, PNG, DOC - Max: 10MB)
									</Label>
									<Input
										id="file"
										type="file"
								...
								<div>
									...
									<Select
										value={category}
										onValueChange={(v) =>
											setCategory(v as PatientDocument["category"])
										}
									>
										<SelectTrigger>
											<SelectValue />
									...
									<div className="flex items-center gap-1 flex-shrink-0">
										...
										<Button
											...
											onClick={() => {
												if (
													confirm(
														`Deseja realmente remover "${doc.file_name}"?`,
													)
												) {
