...
import { FileText, Upload, Download, Trash2, FileIcon, Loader2 } from "lucide-react";
...
const categoryColors: Record<PatientDocument["category"], string> = {
  ...
  receita: "bg-emerald-500/10 text-emerald-500",
            ...
            <DialogContent>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <Select
                    value={category}
                    onValueChange={(v) => setCategory(v as PatientDocument["category"])}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
