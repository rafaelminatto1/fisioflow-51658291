        ...
        <Card className="w-full max-w-md">
          <CardContent className="pt-6">
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              <p className="text-sm text-muted-foreground" data-testid="evolution-error">
                {loadError}
              </p>
              ...
              {therapists.length > 0 && (
                <div className="flex flex-wrap items-center gap-2 mt-2">
                  ...
                  <Select
                    ...
                    onValueChange={(v) =>
                      setSelectedTherapistId(v === THERAPIST_SELECT_NONE ? "" : v)
                    }
                    ...
                    <SelectContent>
                      ...
                      {selectedTherapistId &&
                        !getTherapistById(therapists, selectedTherapistId) && (
                          <SelectItem value={selectedTherapistId}>Responsável atual</SelectItem>
                        )}
                      {therapists.map((t) => (
