    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Selecione uma conduta anterior deste paciente ou da biblioteca para copiar para o plano
            atual.
          </DialogDescription>
        </DialogHeader>
                ...
                {loadingLibrary ? (
                  ...
                  filteredLibrary.map((conduct) => (
                    ...
                    >
                      ...
                      {conduct.description && (
                        <p className="text-xs text-muted-foreground mb-1">{conduct.description}</p>
                      )}
                      <p className="text-sm text-muted-foreground line-clamp-2">
