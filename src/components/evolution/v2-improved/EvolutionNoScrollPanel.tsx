...
import { Maximize2, Bold, Italic, Underline, Heading2, List, ListChecks, ArrowRight, EyeOff, Activity, Stethoscope, History } from "lucide-react";
    ...
    <div className="flex-1 min-h-0 grid grid-cols-1 md:grid-cols-[1fr_340px_300px] gap-3 p-3">
      ...
      <div className="min-h-0 flex flex-col bg-card border border-border border-t-[3px] border-t-[#F59E0B] rounded-xl overflow-hidden shadow-sm">
        <div className="flex items-center gap-2.5 px-3.5 py-2">
          ...
          <div className="flex flex-col min-w-0">
            <div className="text-[13px] font-extrabold truncate text-slate-800">Observações Clínicas</div>
            <div className="text-[10px] text-muted-foreground font-semibold truncate">Registro principal da sessão</div>
          </div>
      ...
      <div className="min-h-0 flex flex-col bg-card border border-border border-t-[3px] border-t-primary rounded-xl overflow-hidden shadow-sm">
        <div className="flex items-center gap-2.5 px-3.5 py-2">
          ...
          <div className="flex flex-col min-w-0">
            <div className="text-[13px] font-extrabold truncate text-slate-800">Procedimentos</div>
            <div className="text-[10px] text-muted-foreground font-semibold truncate">O que foi feito em sessão?</div>
          </div>
          <div className="flex-1" />
      ...
      <div className="min-h-0 flex flex-col gap-3 overflow-y-auto pr-1 pb-1 custom-scrollbar">
        ...
        <div className="bg-card border border-border border-t-[3px] border-t-rose-500 rounded-xl overflow-hidden shadow-sm flex flex-col p-3 gap-2">
          <div className="flex items-center gap-2">
            ...
            <div className="flex flex-col min-w-0">
              <div className="text-xs font-extrabold text-slate-800">Escala Analógica de Dor (EVA)</div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              <div className="w-6 h-6 rounded-md bg-[#F5F3FF] text-[#8B5CF6] flex items-center justify-center shrink-0">
                <span className="w-3.5 h-3.5 flex items-center justify-center">
                  <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M2 12h20"/><path d="M4 12v-4"/><path d="M8 12v-2"/><path d="M12 12v-4"/><path d="M16 12v-2"/><path d="M20 12v-4"/></svg>
                </span>
              </div>
