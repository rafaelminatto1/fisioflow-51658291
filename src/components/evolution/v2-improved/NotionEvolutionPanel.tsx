        ...
        <div className="relative flex items-center justify-between px-5 py-4 border-b border-border/50">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              <div className="flex items-center gap-2">
                ...
                <Badge
                  variant="outline"
                  className="text-[10px] font-normal h-5 px-1.5 rounded-full border-primary/30 text-primary bg-primary/5"
                >
                  V2 - Texto Livre
                </Badge>
              </div>
          ...
          <div className="flex items-center gap-3">
            {autoSaveEnabled && lastSaved && (
              <Badge
                variant="outline"
                className="text-xs h-7 px-2.5 gap-1.5 rounded-lg border-green-200 bg-green-50 text-green-700"
              >
