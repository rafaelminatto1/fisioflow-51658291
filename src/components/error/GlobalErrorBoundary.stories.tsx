...
const ErrorThrowingComponent = ({ shouldThrow }: { shouldThrow?: boolean }) => {
  ...
  return <div className="p-4 text-green-700 font-medium">Conteúdo normal sem erros ✅</div>;
};
  ...
  args: {
    ...
    fallback: (
      <div className="p-6 bg-orange-50 border border-orange-200 rounded-lg">
        ...
        <p className="text-orange-600 text-sm mt-1">Este fallback foi passado via prop.</p>
      </div>
    ),
  },
};
