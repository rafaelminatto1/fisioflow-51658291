		...
		<div className="space-y-6">
			<Card>
				<CardHeader>
					...
					<CardDescription>
						Solicite uma cópia de todos os seus dados ou a exclusão permanente
						da sua conta
					</CardDescription>
				</CardHeader>
				<CardContent className="space-y-4">
					<Alert>
						...
						<AlertDescription>
							<strong>Direito à Portabilidade (Art. 18 LGPD):</strong> Você pode
							solicitar uma cópia completa dos seus dados em formato
							estruturado. O arquivo será disponibilizado em até 15 dias.
						</AlertDescription>
					</Alert>
