...
export function DataExportPanel() {
  const { requests, isLoading, requestExport, isRequesting, hasPendingExport, hasPendingDeletion } =
    useDataExport();
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <Alert>
            ...
            <AlertDescription>
              <strong>Direito à Portabilidade (Art. 18 LGPD):</strong> Você pode solicitar uma cópia
              completa dos seus dados em formato estruturado. O arquivo será disponibilizado em até
              15 dias.
            </AlertDescription>
          </Alert>
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <Card className="border-destructive">
              <CardHeader>
                ...
                <CardDescription>Solicitar exclusão permanente de todos os dados</CardDescription>
              </CardHeader>
              <CardContent>
                <Button
                  variant="destructive"
