      ...
      <CustomModalBody className="p-0 sm:p-0">
        <div className="px-6 py-4 space-y-6">
          <p className="text-sm text-muted-foreground">
            Gerencie suas autorizações de uso de dados conforme a Lei Geral de Proteção de Dados
            (LGPD)
          </p>
          ...
          <Alert className="bg-primary/5 border-primary/10">
            ...
            <AlertDescription className="text-xs text-slate-600">
              Você pode revogar qualquer consentimento a qualquer momento. Isso pode impactar
              algumas funcionalidades do sistema que dependem desses dados.
            </AlertDescription>
          </Alert>
