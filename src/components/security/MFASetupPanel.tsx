        ...
        {showOTPInput && (
          <div className="space-y-4">
            ...
            <div className="flex flex-col items-center space-y-4">
              ...
              <Button variant="link" size="sm" onClick={handleEnableMFA} disabled={isSendingOTP}>
          ...
          <div className="space-y-4">
            <Alert className="border-yellow-500 bg-yellow-50 dark:bg-yellow-950/20">
              ...
              <AlertDescription className="text-yellow-800 dark:text-yellow-200">
                <strong>IMPORTANTE:</strong> Guarde estes códigos de backup em um local seguro. Você
                pode usá-los para acessar sua conta se perder acesso ao seu email.
              </AlertDescription>
            </Alert>
