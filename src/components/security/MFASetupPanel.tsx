	...
	return (
		<Card>
			<CardHeader>
				...
				<CardDescription>
					Adicione uma camada extra de segurança à sua conta via código por
					email
				</CardDescription>
			</CardHeader>
				...
				{!isMFAEnabled && !backupCodes && !showOTPInput && (
					<div className="space-y-4">
						<Alert>
							...
							<AlertDescription>
								A autenticação de dois fatores enviará um código de verificação
								para seu email sempre que você fizer login, adicionando uma
						...
						<div className="flex flex-col items-center space-y-4">
							...
							<div className="flex gap-2 w-full">
								...
								<Button
									...
									disabled={
										isVerifyingOTP || isEnabling || otpCode.length !== 6
									}
									className="flex-1"
								>
									{isVerifyingOTP || isEnabling
										? "Verificando..."
										: "Verificar e Ativar"}
								</Button>
							</div>
					...
					<div className="space-y-4">
						<Alert className="border-yellow-500 bg-yellow-50 dark:bg-yellow-950/20">
							...
							<AlertDescription className="text-yellow-800 dark:text-yellow-200">
								<strong>IMPORTANTE:</strong> Guarde estes códigos de backup em
								um local seguro. Você pode usá-los para acessar sua conta se
								perder acesso ao seu email.
							</AlertDescription>
						</Alert>
