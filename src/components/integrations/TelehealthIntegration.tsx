...
export const TelehealthIntegration: React.FC = () => {
    ...
    const icons: Record<TelehealthProvider, React.ReactNode> = {
      zoom: (
        <svg className="w-5 h-5" viewBox="0 0 24 24">
          <path
            fill="#2D8CFF"
            d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 14H5v-2h6v2zm8-6h-2v2h2v-2z"
          />
        </svg>
      ),
      "google-meet": (
        <svg className="w-5 h-5" viewBox="0 0 24 24">
          <path
            fill="#00897B"
            d="M17 10.5V7c0-.55-.45-1-1-1H4c-.55 0-1 .45-1 1v10c0 .55.45 1 1 1h1l-2 2v2h-1c-.55 0-1-.45-1-1v-6c0-.55.45-1 1-1h7l2 2v2h1c.55 0 1 .45 1 1v-6z"
          />
        </svg>
      ),
      teams: (
        <svg className="w-5 h-5" viewBox="0 0 24 24">
          <path
            fill="#6264A7"
            d="M22 12.5c0-2.5-2-4.5-4.5-4.5S13 10 13 12.5V7c0-1.65-1.35-3-3-3H6C4.35 4 3 5.35 3 7v10.5c0 1.65 1.35 3 3 3h2.22l2.78 5.56 2.78-5.56H21c1.65 0 3-1.35 3-3V12.5z"
          />
        </svg>
      ),
      jitsi: (
        <svg className="w-5 h-5" viewBox="0 0 24 24">
          <path
            fill="#2C6F9F"
            d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-2 15l-5-5 1.5-1.5L12 17V7zm7 0l-2-2v9l2-2-3.5 3.5z"
          />
        </svg>
      ),
    };
  ...
  const handleActivate = useCallback(
    async (provider: TelehealthProvider) => {
      ...
      try {
        ...
        setConfigs((prev) =>
          prev.map((c) => (c.provider === provider ? { ...c, enabled: true } : c)),
        );
  ...
  const handleUpdateConfig = useCallback(
    (provider: TelehealthProvider, updates: Partial<MeetingConfig>) => {
              ...
              <div className="mt-4 pt-4 border-t space-y-3">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span
                      className={
                        config.enableWaitingRoom ? "text-green-600" : "text-muted-foreground"
                      }
                    >
                  ...
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span
                      className={
                        config.enableRecording ? "text-green-600" : "text-muted-foreground"
                      }
                    >
                  ...
                  <div className="flex items-center justify-between text-sm">
                    <span>Chat</span>
                    <span
                      className={config.enableChat ? "text-green-600" : "text-muted-foreground"}
                    >
                    ...
                    <div className="flex flex-wrap gap-4 text-sm text-muted-foreground">
                      ...
                      {room.participants !== undefined && (
                        <div className="flex items-center gap-1">
                          ...
                          <span>
                            {room.participants} participante
