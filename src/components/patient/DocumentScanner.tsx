...
export const DocumentScanner = ({
  ...
  onScanComplete: (data: { text: string; summary?: string; category: string }) => void;
}) => {
  ...
  const startScan = async () => {
    ...
    try {
      ...
      const summary = typeof extractedData.summary === "string" ? extractedData.summary : undefined;
      const category =
        typeof extractedData.category === "string" ? extractedData.category : "outro";
        ...
        {!preview && !selectedFile ? (
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-2">
              <Button className="flex-1 bg-blue-600" onClick={startScan} disabled={isScanning}>
                {isScanning ? (
