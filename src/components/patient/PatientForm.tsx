...
export const PatientForm = forwardRef<HTMLFormElement, PatientFormProps>(
  (
    ...
    const onFormInvalid = (formErrors: FieldErrors<PatientFormData>) => {
      ...
      // Mapeamento de campos para abas para garantir que o usuário veja o erro
      if (firstField) {
        const basicFields: Array<keyof PatientFormData> = [
          "full_name",
          "email",
          "phone",
          "cpf",
        ...
        const medicalFields: Array<keyof PatientFormData> = [
          "medical_history",
          "main_condition",
          "allergies",
          "medications",
        ...
        const addressFields: Array<keyof PatientFormData> = [
          "address",
          "city",
          "state",
          "zip_code",
        ...
        if (basicFields.includes(firstField)) {
          setActiveTab("basic");
        } else if (medicalFields.includes(firstField)) {
          setActiveTab("medical");
        } else if (addressFields.includes(firstField)) {
      ...
      toast.error(
        `Verifique o campo: ${String(firstField || "do formulário")} - ${String(firstMsg)}`,
        {
          description: "Corrija os erros destacados para continuar.",
        },
      );
    };
