            ...
            {state === "idle" && (
              <div className="absolute inset-0 flex items-center justify-center bg-muted/20">
                <div className="text-center space-y-4">
                  ...
                  <p className="text-sm text-muted-foreground max-w-md">{labels.grantPermission}</p>
                </div>
              </div>
            )}
          ...
          <div className="mt-4 flex items-center justify-between">
            ...
            {state === "recording" && (
              <Alert className="max-w-xs">
                ...
                <AlertDescription className="text-xs">{labels.maxDurationWarning}</AlertDescription>
              </Alert>
            )}
          </div>
        </CardContent>
        ...
        <div className="space-y-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
          ...
          {analysisResult.deviations.length > 0 && (
            <Card>
              <CardHeader>
                <CardTitle>
                  {language === "pt-BR" ? "Desvios Identificados" : "Identified Deviations"}
                </CardTitle>
              </CardHeader>
              <CardContent>
              ...
              <CardContent>
                <div className="space-y-3">
                  {analysisResult.safetyConcerns.map((concern, i) => (
                    <Alert
                      key={i}
                      variant={concern.severity === "danger" ? "destructive" : "default"}
                    >
                      <AlertTriangle className="h-4 w-4" />
                      <AlertDescription>
