...
function LifecycleStage({ stage, date, duration, isActive = false }: LifecycleStageProps) {
  ...
  return (
    <div className="flex items-center gap-3">
      <div className={cn("w-3 h-3 rounded-full", isActive ? "bg-primary" : "bg-muted")} />
...
function InsightCard({ insight, onAcknowledge }: InsightCardProps) {
  ...
  return (
    <Card
      className={cn(
        "border-l-4",
        insight.insight_type === "risk_detected" ? "border-l-red-500" : "border-l-primary",
      )}
    >
      <CardContent className="p-4">
                  ...
                  <CardContent>
                    <div className="flex items-center justify-center gap-8">
                      ...
                      <div className="space-y-3">
                        ...
                        >
                          <RefreshCw
                            className={cn("h-3 w-3", updateRiskScore.isPending && "animate-spin")}
                          />
                          Atualizar
                        </Button>
                      </div>
            ...
            <Card>
              <CardContent className="p-8 text-center">
                ...
                <Button variant="outline" onClick={handleRefreshRiskScore} className="mt-4 gap-2">
                  <RefreshCw
                    className={cn("h-4 w-4", updateRiskScore.isPending && "animate-spin")}
                  />
                  Calcular Risco
                </Button>
              </CardContent>
