...
export const PatientCard = memo(
	({ patient, index, onClick, stats, actions }: PatientCardProps) => {
						...
						<div className="mt-3 flex flex-col gap-2">
							<div className="flex items-center gap-3 text-[10px] font-bold text-slate-500 dark:text-slate-400">
								...
								<span className="uppercase tracking-wider">
									Último: {formatLastActivity(stats)}
								</span>
							</div>
							...
							{classificationInfo ? (
								<div
									className={cn(
										...
										stats?.classification === "active"
											? "border-emerald-100 bg-emerald-50 text-emerald-700 dark:bg-emerald-900/20 dark:border-emerald-800"
											: stats?.classification === "no_show_risk"
												? "border-red-100 bg-red-50 text-red-700 dark:bg-red-900/20 dark:border-red-800"
