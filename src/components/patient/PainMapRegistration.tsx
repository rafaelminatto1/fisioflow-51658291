...
export const PainMapRegistration: React.FC<PainMapRegistrationProps> = ({
	patientId,
	onSuccess,
}) => {
	...
	const handleSave = async () => {
		...
		try {
			setLoading(true);
			await PatientService.savePainRecord(
				patientId,
				level,
				painType,
				bodyPart,
	...
	return (
		<Card className="w-full">
			<CardHeader>
				...
				<CardDescription>
					Informe como você está se sentindo hoje para que possamos ajustar seu
					tratamento.
				</CardDescription>
			</CardHeader>
