				...
				<CardContent>
					<div className="space-y-4">
						{(data.specialTests || []).map((test, i) => (
							<div
								key={i}
								className="flex flex-col md:flex-row gap-3 items-start p-3 bg-muted/30 rounded-lg border"
							>
									...
									{readOnly ? (
										...
										>
											<Badge
												...
												className={`cursor-pointer transition-all hover:opacity-80 py-1.5 px-3 ${
													test.result === "negative"
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
						<div className="space-y-2">
							...
							<p className="text-xs text-muted-foreground">
								Descreva as amplitudes de movimento mensuradas.
							</p>
						</div>
						<div className="space-y-2">
