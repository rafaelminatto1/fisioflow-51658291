					...
					{!readOnly && (
						<Button
							...
							onClick={() => {
								...
								handleChange("newPathologies", [
									...current,
									{ name: "", status: "active", diagnosedAt: "" },
								]);
							}}
							className="gap-2"
						>
					...
					{!data.newPathologies || data.newPathologies.length === 0 ? (
						<div className="flex flex-col items-center justify-center py-12 text-muted-foreground border-2 border-dashed rounded-xl bg-muted/5">
							...
							<p className="text-sm italic">
								Nenhuma patologia registrada no momento.
							</p>
						</div>
					) : (
					...
					<CardContent className="space-y-6">
						<div className="space-y-2">
							...
							<Input
								...
								onChange={(e) =>
									handleChange("physicalActivity", e.target.value)
								}
					...
					{!readOnly && (
						<Button
							...
							onClick={() => {
								...
								handleChange("newSurgeries", [
									...current,
									{ name: "", date: "", surgeon: "", hospital: "", notes: "" },
								]);
							}}
							className="gap-2"
						>
				...
				<CardContent>
					{!data.newSurgeries || data.newSurgeries.length === 0 ? (
						<div className="flex flex-col items-center justify-center py-12 text-muted-foreground border-2 border-dashed rounded-xl bg-muted/5">
							<ClipboardList className="w-10 h-10 mb-3 opacity-20" />
							<p className="text-sm italic">
								Nenhuma cirurgia registrada. Clique em "Adicionar Cirurgia" para
								começar.
							</p>
						</div>
					) : (
				...
				<CardContent>
					{!data.newGoals || data.newGoals.length === 0 ? (
						<div className="flex flex-col items-center justify-center py-12 text-muted-foreground border-2 border-dashed rounded-xl bg-muted/5">
							<ClipboardList className="w-10 h-10 mb-3 opacity-20" />
							<p className="text-sm italic">
								Nenhum objetivo definido no momento.
							</p>
						</div>
					) : (
						<div className="rounded-md border">
