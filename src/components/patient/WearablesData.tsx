      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {latestHeartRate
                ? `Última leitura: ${formatDate(latestHeartRate.timestamp)}`
                : "Sem dados recentes"}
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              {latestSteps
                ? `Última leitura: ${formatDate(latestSteps.timestamp)}`
                : "Sem dados recentes"}
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">{latestSleep ? `${latestSleep.value}h` : "--"}</div>
            <p className="text-xs text-muted-foreground">
              {latestSleep
                ? `Última leitura: ${formatDate(latestSleep.timestamp)}`
                : "Sem dados recentes"}
            </p>
          </CardContent>
        </Card>
