...
import { TrendingUp, ClipboardList, Calendar, ChevronRight, Activity } from "lucide-react";
          ...
          <Card className="h-full flex items-center justify-center border-dashed border-2 bg-slate-50/30">
            <div className="text-center p-12">
              ...
              <p className="text-slate-500 max-w-xs mx-auto">
                Escolha um teste no histórico ao lado para analisar a curva de força e métricas
                biomecânicas.
              </p>
            </div>
          </Card>
