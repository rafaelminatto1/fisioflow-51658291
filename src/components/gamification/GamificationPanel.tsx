...
export function GamificationPanel({ patientId }: GamificationPanelProps) {
  ...
  const questPercent =
    totalDailyQuests > 0 ? Math.round((completedDailyQuests / totalDailyQuests) * 100) : 0;
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-3 gap-3">
            <div className="text-center p-3 rounded-lg bg-muted/50">
              ...
              <p className="text-xs text-muted-foreground">de {totalAchievements} conquistas</p>
            </div>
            ...
            <div className="text-center p-3 rounded-lg bg-muted/50">
              ...
              <p className="text-xs text-muted-foreground">de {totalDailyQuests} quests hoje</p>
            </div>
          </div>
