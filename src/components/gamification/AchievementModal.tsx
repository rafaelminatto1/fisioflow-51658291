          ...
          >
            ...
            <div className="relative pt-12 pb-8 px-8 flex flex-col items-center text-center">
              ...
              >
                ...
                <p className="text-slate-500 font-medium">{achievement.description}</p>
              </motion.div>
              ...
              <div className="w-full grid grid-cols-2 gap-3 mt-8">
                ...
                <Button className="rounded-2xl h-12 bg-indigo-600 hover:bg-indigo-700 text-white font-bold shadow-lg shadow-indigo-200">
