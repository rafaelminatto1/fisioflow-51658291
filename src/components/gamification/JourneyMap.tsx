  ...
  const milestones: Milestone[] = useMemo(
    () => [
      ...
      },
      {
        ...
        description: "1ª Sessão concluída",
        icon: Flag,
        position: "left",
      },
      {
        ...
        sessionsRequired: 5,
        title: "Pegando Ritmo",
        description: "5 Sessões realizadas",
        icon: Star,
        position: "right",
      },
      {
        ...
        sessionsRequired: 10,
        title: "Consistência",
        description: "10 Sessões - Hábito formado",
        icon: CheckCircle2,
        position: "left",
      },
      {
        ...
        description: "20 Sessões - Resultados visíveis",
        icon: Trophy,
        position: "center",
      },
    ],
      ...
      <CardContent className="relative py-10 px-4">
        ...
        <div className="flex flex-col gap-12 relative max-w-2xl mx-auto">
          {milestones.map((milestone, index) => {
            ...
            const isNext =
              !isUnlocked &&
              (index === 0 || totalSessions >= milestones[index - 1].sessionsRequired);
            ...
            return (
              <div
                key={milestone.id}
                className={cn("flex items-center gap-4 relative md:w-full", justifyClass)}
              >
                ...
                >
                  ...
                  {isUnlocked ? (
                    <span className="text-[10px] font-bold text-green-600 mt-2 block">
                      Concluído
                    </span>
                  ) : (
                    <span className="text-[10px] font-medium text-muted-foreground mt-2 block">
                      Necessário: {milestone.sessionsRequired} sessões
                    </span>
                  )}
                </div>
              </div>
