  ...
  if (isLoading) {
    return (
      <div className="flex flex-col items-center justify-center p-12 gap-3">
        ...
        <p className="text-sm font-bold text-slate-400 uppercase tracking-widest">Acessando estoque...</p>
      </div>
    );
  }
    ...
    <div className="space-y-6 animate-fade-in">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs font-bold text-slate-400 uppercase tracking-wider">Troque seus pontos por itens exclusivos</p>
        </div>
        <div className="bg-slate-900 px-4 py-2 rounded-2xl shadow-lg border border-slate-800 flex items-center gap-3 transition-transform hover:scale-105">
          ...
          <span className="text-[8px] uppercase font-black text-slate-400 leading-none">Pontos<br/>Disponíveis</span>
        </div>
      </div>
              ...
              <CardHeader className="pb-2">
                <div className="flex justify-between items-start">
                  <div className={cn(
                    ...
                    item.type === 'consumable' ? "bg-blue-50 text-blue-600 border border-blue-100" :
                    item.type === 'cosmetic' ? "bg-purple-50 text-purple-600 border border-purple-100" :
                ...
                <CardTitle className="text-lg font-black tracking-tight text-slate-800">{item.name}</CardTitle>
      ...
      >
          ...
          <div className="p-8 text-center space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm font-medium text-slate-500">
                Confirmar a troca de <span className="text-primary font-bold">{selectedItem?.cost} pontos</span> por este item?
              </p>
            </div>
        ...
        <CustomModalFooter isMobile={isMobile}>
          <Button variant="ghost" onClick={() => setIsConfirmOpen(false)} className="rounded-xl h-11 px-6 font-bold text-slate-500">
            Mudei de ideia
          </Button>
          <Button 
