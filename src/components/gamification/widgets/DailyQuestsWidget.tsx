					...
					{quests.slice(0, 3).map((quest) => {
						...
						return (
							...
							>
								...
								<span
									className={`flex-1 truncate ${quest.completed ? "line-through text-muted-foreground" : ""}`}
								>
									{quest.title}
								</span>
								...
								return (
									...
									>
										...
										<div className="flex-1 min-w-0">
											<h4
												className={`text-sm font-semibold mb-0.5 ${quest.completed ? "line-through text-muted-foreground" : ""}`}
											>
												{quest.title}
											</h4>
