...
const rewards: RewardItem[] = [
	{
		...
		description:
			"Adicione 15 minutos extras de terapia manual ou ventosaterapia na sua próxima sessão.",
		cost: 1500,
		category: "bonus",
	...
	},
	{
		...
		description:
			"Desconto em lojas de suplementos e equipamentos esportivos parceiros.",
		cost: 800,
		category: "discount",
	...
	},
	{
		...
		description:
			"Proteja seu streak se você não conseguir treinar hoje. (Automático)",
		cost: 500,
		category: "digital",
		...
		<div className="space-y-6">
			...
			<div className="p-4 rounded-2xl border border-dashed border-slate-300 dark:border-slate-700 flex items-center justify-center gap-3 text-slate-500">
				...
				<span className="text-sm font-medium italic">
					Novas recompensas são adicionadas mensalmente com base na sua
					performance.
				</span>
			</div>
		</div>
