...
export const LevelUpModal: React.FC<LevelUpModalProps> = ({
  ...
  return (
    ...
    >
      <CustomModalHeader className="border-none bg-transparent" onClose={onClose}>
      ...
      <CustomModalFooter isMobile={isMobile} className="bg-transparent border-none pb-8 px-8">
        <Button
          onClick={onClose}
