          ...
          <div className="flex-1 space-y-1">
            <div className="flex items-center justify-between">
              ...
              {unlocked ? (
                <Badge
                  variant="secondary"
                  className="bg-green-500/15 text-green-600 dark:text-green-400 hover:bg-green-500/25 border-green-500/20 text-[10px] px-2"
                >
                  Completo
                </Badge>
              ) : (
    ...
    <div className="space-y-6 animate-fade-in">
        ...
        <CardContent className="space-y-6 relative z-10">
          <div className="space-y-2">
            <div className="flex justify-between text-xs font-semibold uppercase tracking-wider text-muted-foreground">
              ...
              <span>
                {Math.round(currentXp)} / {xpPerLevel} XP
              </span>
            </div>
            ...
            <p className="text-xs text-center text-muted-foreground pt-1">
              ...
              <span className="font-bold text-primary">
                {Math.max(0, xpPerLevel - currentXp)} XP
              </span>{" "}
          ...
          <div className="grid grid-cols-3 gap-4 pt-2">
            ...
            <div className="text-center p-4 bg-background/50 backdrop-blur-sm rounded-xl border border-border/50 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-2xl font-bold text-foreground">
                {Math.floor((profile?.total_points || 0) / 100)}%
              </p>
              <p className="text-[10px] uppercase font-bold text-muted-foreground tracking-wide">
                Engajamento
              </p>
      ...
      <Tabs defaultValue="overview" className="w-full space-y-6">
        <TabsList className="w-full justify-start overflow-x-auto h-auto p-1 bg-muted/50">
          <TabsTrigger value="overview" className="rounded-full px-4 text-xs sm:text-sm">
            Visão Geral
          </TabsTrigger>
          <TabsTrigger value="ranking" className="rounded-full px-4 text-xs sm:text-sm">
            Ranking
          </TabsTrigger>
          <TabsTrigger value="achievements" className="rounded-full px-4 text-xs sm:text-sm">
            Conquistas
          </TabsTrigger>
          ...
          <TabsTrigger value="inventory" className="rounded-full px-4 text-xs sm:text-sm">
            Inventário
          </TabsTrigger>
        </TabsList>
          ...
          <div className="space-y-4">
            ...
            <Tabs defaultValue="all" className="w-full">
              <TabsList className="w-full justify-start overflow-x-auto h-auto p-1 bg-muted/30 mb-4">
                ...
                <TabsTrigger value="streak" className="rounded-full px-3 text-xs">
                  Consistência
                </TabsTrigger>
                <TabsTrigger value="milestone" className="rounded-full px-3 text-xs">
                  Marcos
                </TabsTrigger>
                <TabsTrigger value="timing" className="rounded-full px-3 text-xs">
                  Horários
                </TabsTrigger>
                <TabsTrigger value="recovery" className="rounded-full px-3 text-xs">
                  Saúde
                </TabsTrigger>
                <TabsTrigger value="level" className="rounded-full px-3 text-xs">
                  Níveis
                </TabsTrigger>
              </TabsList>
          ...
          <div className="bg-background/95 backdrop-blur-md rounded-lg p-4 flex items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Faltam apenas {xpPerLevel - currentXp} XP para subir de nível.
                </p>
              </div>
            </div>
            <Button
