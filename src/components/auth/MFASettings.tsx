...
export function MFASettings({ userId }: MFASettingsProps) {
  ...
  async function handleDisableMFA() {
    if (
      !confirm("Tem certeza que deseja desabilitar MFA? Isso reduzirá a segurança da sua conta.")
    ) {
      return;
    }
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-sm text-muted-foreground mb-4">
                Use um aplicativo autenticador (Google Authenticator, Authy, etc.) para escanear
                este QR code:
              </p>
            ...
            <div>
              ...
              <div className="flex space-x-2">
                <input
                  ...
                  autoFocus
                />
                <Button onClick={handleVerifyMFA} disabled={loading || code.length !== 6}>
