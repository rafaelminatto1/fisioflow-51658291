...
export function AuthLayout({ children }: AuthLayoutProps) {
	return (
		<div
			className="flex min-h-screen w-full bg-slate-50 dark:bg-slate-950 relative overflow-hidden"
			role="presentation"
		>
			...
			>
				...
				<div
					className="absolute bottom-0 right-1/4 w-[500px] h-[500px] bg-sky-300/10 dark:bg-sky-700/10 rounded-full blur-[120px] animate-pulse"
			...
			<header
				className="hidden lg:flex w-[45%] xl:w-1/2 relative overflow-hidden bg-slate-900"
				role="banner"
			>
				...
				<div className="relative z-10 w-full h-full flex flex-col justify-between p-16 xl:p-24">
					...
					<div className="space-y-8 animate-slide-up-fade">
						<div className="space-y-4">
							...
							<p className="text-xl text-blue-100/80 leading-relaxed max-w-lg">
								Centralize seus atendimentos, evoluções e financeiro em uma
								única plataforma inteligente e intuitiva.
							</p>
						</div>
						...
						<div className="space-y-4">
							{[
								...
								<div
									key={i}
									className="flex items-center gap-3 text-blue-50/90 group"
								>
					...
					<footer
						className="flex justify-between items-center text-sm text-blue-200/50"
						role="contentinfo"
					>
						...
						<div className="flex gap-6">
							<button
								type="button"
								className="hover:text-white transition-colors duration-200 bg-transparent border-0 p-0 cursor-pointer text-inherit"
							>
								Segurança
							</button>
							<button
