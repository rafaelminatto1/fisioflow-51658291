  ...
  return (
    ...
    >
            ...
            <div className="space-y-8 animate-slide-up-fade">
              <div className="space-y-4">
                ...
                <p className="text-xl text-blue-100/80 leading-relaxed max-w-lg">
                  Centralize seus atendimentos, evoluções e financeiro em uma única plataforma
      ...
      >
        ...
        <div className="w-full max-w-[440px] animate-scale-in relative z-10">{children}</div>
      </main>
    </div>
  );
}
