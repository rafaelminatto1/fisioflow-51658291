...
const onboardingSteps: OnboardingStep[] = [
	{
		...
		description:
			"Sistema completo para gestão de clínicas de fisioterapia. Vamos fazer um tour rápido pelas principais funcionalidades.",
	...
	},
	{
		...
		description:
			"Cadastre e gerencie todos os seus pacientes, histórico clínico, evolução e documentos em um só lugar.",
	...
	},
	{
		...
		description:
			"Organize seus atendimentos com uma agenda visual e intuitiva. Configure horários, salas e lembretes automáticos.",
	...
	},
	{
		...
		description:
			"Registre evoluções no formato SOAP, anexe fotos, mapas de dor e exames. Tudo organizado por paciente.",
	...
	},
	{
		...
		description:
			"Gerencie pacotes de sessões, pagamentos, contas a pagar e receber, tudo integrado com a agenda.",
	...
	},
	{
		...
		description:
			"Envie lembretes de consulta por WhatsApp, e-mails de aniversário e campanhas de marketing.",
	...
	},
	{
		...
		title: "Tudo Pronto!",
		description:
			"Você está pronto para começar. Explore o sistema e entre em contato se precisar de ajuda.",
