...
import {
	...
	useTourContext,
	tourSteps,
} from "@/hooks/onboarding/tourContext";
...
export function TourGuide() {
	const { isOpen, currentStep, steps, _setIsOpen, _setSteps, setCurrentStep } =
		useTour();
	const { _hasSeenTour, setHasSeenTour, closeTour, startTour } =
		useTourContext();
