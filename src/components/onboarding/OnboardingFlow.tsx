...
import {
	OnboardingContext,
	useOnboarding,
} from "@/hooks/onboarding/onboardingContext";
...
const DEFAULT_STEPS: OnboardingStep[] = [
	{
		...
		description:
			"Seu sistema completo de gestão para fisioterapeutas. Vamos fazer um tour rápido?",
		action: "Começar Tour",
	},
	{
		id: "agenda",
		...
		description:
			"Visualize seus agendamentos, gerencie horários e configure lembretes automáticos.",
	...
	},
	{
		...
		description:
			"Registe evoluções, anexe arquivos e mantenha o histórico completo dos pacientes.",
	...
	},
	{
		...
		description:
			"Acesse centenas de exercícios com vídeos, crie planos personalizados.",
	...
	},
	{
		...
		description:
			"Acompanhe o desempenho da sua clínica com gráficos e relatórios detalhados.",
		...
		<>
			...
			>
				...
				<div className="p-6 md:p-8">
					{step.image && (
						<div className="mb-6 flex justify-center">{step.image}</div>
					)}
...
export function OnboardingProvider({
	...
	const { isCompleted, isVisible, start, dismiss, reset, complete } =
		useOnboarding();
	const [currentStep, setCurrentStep] = useState(0);
