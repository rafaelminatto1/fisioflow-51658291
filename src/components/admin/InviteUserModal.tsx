					...
					{!inviteLink ? (
						<>
							<p className="text-sm text-muted-foreground">
								Envie um convite para adicionar um novo membro à sua
								organização. O usuário receberá as permissões baseadas na função
								escolhida.
							</p>
						...
						<div className="space-y-6 animate-in fade-in zoom-in-95 duration-300">
							<div className="bg-emerald-50 border border-emerald-100 p-4 rounded-2xl flex items-start gap-3 text-emerald-800">
								...
								<div className="text-xs leading-relaxed">
									...
									<p>
										Compartilhe o link abaixo com o usuário para que ele possa
										completar o cadastro. Este link expira em 7 dias.
									</p>
								</div>
							</div>
