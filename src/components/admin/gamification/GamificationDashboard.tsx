...
const CustomChartTooltip = React.memo(({ active, payload, label }: TooltipContentProps) => {
...
export const GamificationDashboard: React.FC = () => {
  ...
  const chartData = useMemo(() => {
    ...
    return dataToDisplay.map((d) => ({
      dia: new Date(d.date).toLocaleDateString("pt-BR", {
        day: "2-digit",
        month: "2-digit",
      }),
  ...
  return (
    <div className="space-y-6 md:space-y-8 animate-fade-in">
            ...
            <AnimatedCard delay={50}>
              <Card className="rounded-xl border border-border/50 shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-1 bg-gradient-to-br from-card to-yellow-500/5">
                ...
                <CardContent>
                  ...
                  <Progress
                    value={75}
                    className="h-1 mt-3 bg-yellow-500/20 [&>div]:bg-yellow-500"
                  />
                </CardContent>
              </Card>
            </AnimatedCard>
            ...
            <AnimatedCard delay={300}>
              <Card className="rounded-xl border border-border/50 shadow-sm h-full">
                <CardHeader>
                  ...
                  <CardDescription>As conquistas mais desbloqueadas</CardDescription>
                </CardHeader>
                <CardContent>
      ...
      {!loading && (
        <section
          aria-label="Ações sugeridas de engajamento"
              ...
              <CardContent className="p-5 flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground mt-1 leading-relaxed">
                    {stats?.atRiskPatients || 0} pacientes estão prestes a perder sequências de +7
                    dias.
                  </p>
                  <Button
                    variant="link"
                    className="p-0 h-auto text-xs font-bold text-blue-600 mt-2"
            ...
            <Card className="border-none shadow-lg bg-gradient-to-br from-emerald-500/10 to-teal-500/10 hover:shadow-emerald-500/10 transition-all group cursor-pointer">
              <CardContent className="p-5 flex items-start gap-4">
                ...
                <div>
                  ...
                  <Button
                    variant="link"
                    className="p-0 h-auto text-xs font-bold text-emerald-600 mt-2"
                    onClick={() => navigate("/admin/gamification?tab=challenges")}
                  >
            ...
            <Card className="border-none shadow-lg bg-gradient-to-br from-amber-500/10 to-orange-500/10 hover:shadow-amber-500/10 transition-all group cursor-pointer">
              <CardContent className="p-5 flex items-start gap-4">
                ...
                <div>
                  ...
                  <Button
                    variant="link"
                    className="p-0 h-auto text-xs font-bold text-amber-600 mt-2"
                    onClick={() => navigate("/admin/gamification?tab=ranking")}
                  >
                    Ver líderes do mês →
                  </Button>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      {stats?.atRiskPatients} pacientes não interagem com a plataforma há mais de 7
                      dias.
                    </p>
                  </div>
                </div>
