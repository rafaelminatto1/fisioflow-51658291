...
const AnimatedCard = React.memo(
	({ children, delay = 0, className = "" }: AnimatedCardProps) => (
		<div
				...
				>
					<div className="flex items-center gap-2 mb-4">
						...
						<h3 className="text-lg font-bold">
							Ações Sugeridas de Engajamento
						</h3>
					</div>
							...
							<CardContent className="p-5 flex items-start gap-4">
								...
								<div>
									...
									<p className="text-xs text-muted-foreground mt-1 leading-relaxed">
										{stats?.atRiskPatients || 0} pacientes estão prestes a
										perder sequências de +7 dias.
									</p>
									<Button
										variant="link"
							...
							<CardContent className="p-5 flex items-start gap-4">
								...
								<div>
									...
									<Button
										...
										onClick={() =>
											navigate("/admin/gamification?tab=challenges")
										}
									>
						...
						<Card className="border-none shadow-lg bg-gradient-to-br from-amber-500/10 to-orange-500/10 hover:shadow-amber-500/10 transition-all group cursor-pointer">
							<CardContent className="p-5 flex items-start gap-4">
								...
								<div>
									...
									<p className="text-xs text-muted-foreground mt-1 leading-relaxed">
										O mês está acabando. O TOP 3 merece um reconhecimento
										especial.
									</p>
									<Button
										variant="link"
							...
							<CardContent className="p-4 flex items-center justify-between gap-4">
								<div className="flex items-center gap-4">
									...
									<div>
										...
										<p className="text-sm text-muted-foreground">
											{stats?.atRiskPatients} pacientes não interagem com a
											plataforma há mais de 7 dias.
										</p>
									</div>
								</div>
								<Button
