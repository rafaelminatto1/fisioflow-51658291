...
import { Trophy, TrendingUp, Save, RefreshCw, Settings, Info, Sparkles } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Escolha como os níveis serão calculados</CardDescription>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Ajuste os valores base do sistema</CardDescription>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            {progressionType === "exponential" && (
              <>
                ...
                <div className="space-y-2">
                  <Label htmlFor="multiplier">Multiplicador: {multiplier}x</Label>
                  <Slider
                    id="multiplier"
                    min={1.1}
                    max={3}
                    ...
                    className="py-4"
                  />
                  <p className="text-xs text-muted-foreground">Controla a curva de dificuldade</p>
                </div>
              </>
            )}
          ...
          <div className="space-y-3">
            {levelCurve.slice(0, 10).map((level) => {
              ...
              const progressPercentage =
                level.level <= 1
                  ? 100
                  : ((level.xpRequired - (previousLevel?.xpRequired || 0)) / level.xpRequired) *
                    100;
      ...
      <div className="flex justify-end gap-3">
        ...
        <Button onClick={handleSave} disabled={!hasChanges || updateLevelSettings.isPending}>
          {updateLevelSettings.isPending && <RefreshCw className="mr-2 h-4 w-4 animate-spin" />}
