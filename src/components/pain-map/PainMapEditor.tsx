...
interface PainMapEditorProps {
	...
	onSave: (
		data: { view: "front" | "back"; points: PainPoint[] }[],
	) => Promise<void>;
	onCancel?: () => void;
}
...
const PAIN_TYPES = [
	...
	{ value: "throbbing", label: "Latejante 💓", description: "Dor pulsante" },
	{
		value: "burning",
		label: "Queimação 🔥",
		description: "Sensação de ardência",
	},
	{
		value: "tingling",
		label: "Formigamento ✨",
		description: "Sensação de agulhadas",
	},
	{
		value: "numbness",
		label: "Dormência ❄️",
		description: "Perda de sensibilidade",
	},
	{
		value: "stiffness",
		label: "Rigidez 🔒",
		description: "Dificuldade de movimento",
	},
] as const;
...
export function PainMapEditor({
	...
	const [frontPoints, setFrontPoints] =
		useState<PainPoint[]>(initialFrontPoints);
	...
	const [selectedPainType, setSelectedPainType] =
		useState<PainPoint["painType"]>("sharp");
	...
	const setCurrentPoints =
		activeView === "front" ? setFrontPoints : setBackPoints;

	// Adicionar ponto
	const handlePointAdd = useCallback(
		(point: Omit<PainPoint, "id">) => {
		...
		<div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">
				...
				<CardContent className="space-y-6">
					...
					<div className="space-y-2">
						...
						<Select
							...
							onValueChange={(v) =>
								setSelectedPainType(v as PainPoint["painType"])
							}
						>
							<SelectTrigger>
								<SelectValue />
			...
			<Card className="lg:col-span-2">
				...
				<CardContent>
					<Tabs
						value={activeView}
						onValueChange={(v) => setActiveView(v as "front" | "back")}
					>
