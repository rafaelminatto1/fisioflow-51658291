...
export function PainMapEditor({
  ...
  const avgIntensity =
    totalPoints > 0
      ? Math.round(
          ([...frontPoints, ...backPoints].reduce((sum, p) => sum + p.intensity, 0) / totalPoints) *
            10,
        ) / 10
      : 0;
        ...
        <CardContent className="space-y-6">
          ...
          {totalPoints > 0 && (
            <div className="flex flex-col items-center justify-center py-4 bg-muted/30 rounded-lg border border-border">
              <PainGauge score={avgIntensity * 10} intensity={Math.round(avgIntensity)} size="md" />
            </div>
          )}
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(v) => setSelectedPainType(v as PainPoint["painType"])}
            >
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
      ...
      <Card className="lg:col-span-2">
        <CardHeader className="pb-2">
          <div className="flex items-center justify-between">
            ...
            <p className="text-sm text-muted-foreground">Clique para marcar pontos de dor</p>
          </div>
        </CardHeader>
        <CardContent>
