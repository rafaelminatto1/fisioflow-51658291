...
const getIntensityColor = (intensity: number): string =>
	INTENSITY_COLORS[intensity as keyof typeof INTENSITY_COLORS]?.primary ||
	"#94a3b8";
const getIntensityBg = (intensity: number): string =>
	INTENSITY_COLORS[intensity as keyof typeof INTENSITY_COLORS]?.secondary ||
	"#f1f5f9";
const getIntensityLabel = (intensity: number): string =>
	INTENSITY_COLORS[intensity as keyof typeof INTENSITY_COLORS]?.label ||
	"Desconhecido";

const getIntensityColorWithAlpha = (
	intensity: number,
	alpha: number = 0.4,
): string => {
...
const MUSCLE_PATHS_FRONT: MusclePath[] = [
	// Cabeça e Pescoço
	{
		code: "head_front",
		name: "Cabeça",
		d: "M 50 4 C 56 4 60 8 60 12 C 60 16 56 20 50 20 C 44 20 40 16 40 12 C 40 8 44 4 50 4",
		x: 50,
		y: 12,
		muscleGroup: "Cabeça",
	},
	{
		code: "neck_front",
		name: "Pescoço",
		d: "M 45 20 L 45 26 L 55 26 L 55 20",
		x: 50,
		y: 23,
		muscleGroup: "Pescoço",
	},
	...
	// Ombros
	{
		...
		name: "Ombro Esquerdo",
		d: "M 26 20 Q 24 24 26 30 L 34 30 Q 36 24 34 18 L 26 20",
		x: 30,
		y: 24,
		muscleGroup: "Ombro",
	},
	{
		...
		name: "Ombro Direito",
		d: "M 74 20 Q 76 24 74 30 L 66 30 Q 64 24 66 18 L 74 20",
		x: 70,
		y: 24,
		muscleGroup: "Ombro",
	},
	...
	// Peito
	{
		code: "chest_left",
		name: "Peito Esquerdo",
		d: "M 34 30 Q 32 35 34 45 L 48 45 Q 50 35 48 30 L 34 30",
		x: 41,
		y: 37,
		muscleGroup: "Peito",
	},
	{
		code: "chest_right",
		name: "Peito Direito",
		d: "M 66 30 Q 68 35 66 45 L 52 45 Q 50 35 52 30 L 66 30",
		x: 59,
		y: 37,
		muscleGroup: "Peito",
	},
	...
	// Braços
	{
		code: "arm_left_front",
		name: "Braço Esquerdo",
		d: "M 26 30 Q 22 35 22 50 L 28 50 Q 28 35 26 30",
		x: 24,
		y: 40,
		muscleGroup: "Braço",
	},
	{
		...
		name: "Braço Direito",
		d: "M 74 30 Q 78 35 78 50 L 72 50 Q 72 35 74 30",
		x: 76,
		y: 40,
		muscleGroup: "Braço",
	},
	...
	// Abdômen
	{
		...
		d: "M 34 45 Q 32 50 34 54 L 66 54 Q 68 50 66 45 L 34 45",
		x: 50,
		y: 50,
		muscleGroup: "Abdômen",
	},
	{
		...
		d: "M 34 54 Q 32 58 34 62 L 66 62 Q 68 58 66 54 L 34 54",
		x: 50,
		y: 58,
		muscleGroup: "Abdômen",
	},
	...
	// Antebraços
	{
		...
		d: "M 22 50 Q 20 55 20 65 L 26 65 Q 26 55 22 50",
		x: 22,
		y: 57,
	...
	},
	{
		...
		d: "M 78 50 Q 80 55 80 65 L 74 65 Q 74 55 78 50",
		x: 78,
		y: 57,
		muscleGroup: "Antebraço",
	},
	...
	// Mãos
	{
		code: "hand_left",
		name: "Mão Esquerda",
		d: "M 20 65 Q 18 68 20 75 L 26 75 Q 28 68 26 65 L 20 65",
		x: 22,
		y: 70,
		muscleGroup: "Mão",
	},
	{
		code: "hand_right",
		name: "Mão Direita",
		d: "M 80 65 Q 82 68 80 75 L 74 75 Q 72 68 74 65 L 80 65",
		x: 78,
		y: 70,
		muscleGroup: "Mão",
	},
	...
	// Quadris
	{
		...
		d: "M 34 62 Q 30 66 32 72 L 48 72 Q 50 66 48 62 L 34 62",
		x: 40,
		y: 67,
		muscleGroup: "Quadril",
	},
	{
		...
		d: "M 66 62 Q 70 66 68 72 L 52 72 Q 50 66 52 62 L 66 62",
		x: 60,
		y: 67,
		muscleGroup: "Quadril",
	},
	...
	// Coxas
	{
		...
		name: "Coxa Esquerda",
		d: "M 32 72 Q 28 78 30 88 L 46 88 Q 48 78 46 72 L 32 72",
		x: 38,
		y: 80,
		muscleGroup: "Coxa",
	},
	{
		...
		name: "Coxa Direita",
		d: "M 68 72 Q 72 78 70 88 L 54 88 Q 52 78 54 72 L 68 72",
		x: 62,
		y: 80,
		muscleGroup: "Coxa",
	},
	...
	// Joelhos
	{
		...
		d: "M 30 88 Q 28 92 30 96 L 46 96 Q 48 92 46 88 L 30 88",
		x: 38,
		y: 92,
		muscleGroup: "Joelho",
	},
	{
		code: "knee_right",
		name: "Joelho Direito",
		d: "M 70 88 Q 72 92 70 96 L 54 96 Q 52 92 54 88 L 70 88",
		x: 62,
		y: 92,
		muscleGroup: "Joelho",
	},
	...
	// Panturrilhas
	{
		...
		d: "M 30 96 Q 28 100 30 106 L 44 106 Q 46 100 44 96 L 30 96",
		x: 37,
		y: 101,
	...
	},
	{
		...
		d: "M 70 96 Q 72 100 70 106 L 56 106 Q 54 100 56 96 L 70 96",
		x: 63,
		y: 101,
		muscleGroup: "Panturrilha",
	},
	...
	// Tornozelos e Pés
	{
		...
		d: "M 30 106 L 44 106 L 44 108 L 30 108 Z",
		x: 37,
		y: 107,
		muscleGroup: "Tornozelo",
	},
	{
		code: "ankle_right",
		name: "Tornozelo Direito",
		d: "M 70 106 L 56 106 L 56 108 L 70 108 Z",
		x: 63,
		y: 107,
		muscleGroup: "Tornozelo",
	},
	{
		code: "foot_left",
		name: "Pé Esquerdo",
		d: "M 28 108 Q 26 110 28 112 L 46 112 Q 48 110 46 108 L 28 108",
		x: 37,
		y: 110,
		muscleGroup: "Pé",
	},
	{
		code: "foot_right",
		name: "Pé Direito",
		d: "M 72 108 Q 74 110 72 112 L 54 112 Q 52 110 54 108 L 72 108",
		x: 63,
		y: 110,
		muscleGroup: "Pé",
	},
...
const MUSCLE_PATHS_BACK: MusclePath[] = [
	...
	// Costas Médias
	{
		...
		d: "M 34 45 Q 32 50 34 54 L 48 54 Q 50 50 48 45 L 34 45",
		x: 41,
		y: 50,
		muscleGroup: "Costas",
	},
	{
		...
		d: "M 66 45 Q 68 50 66 54 L 52 54 Q 50 50 52 45 L 66 45",
		x: 59,
		y: 50,
		muscleGroup: "Costas",
	},
	...
	// Lombar
	{
		...
		d: "M 34 54 Q 32 58 34 62 L 48 62 Q 50 58 48 54 L 34 54",
		x: 41,
		y: 58,
		muscleGroup: "Lombar",
	},
	{
		...
		name: "Lombar Direita",
		d: "M 66 54 Q 68 58 66 62 L 52 62 Q 50 58 52 54 L 66 54",
		x: 59,
		y: 58,
		muscleGroup: "Lombar",
	},
	...
	// Glúteos
	{
		...
		d: "M 34 62 Q 28 66 30 72 L 48 72 Q 50 66 48 62 L 34 62",
		x: 39,
		y: 67,
		muscleGroup: "Glúteo",
	},
	{
		code: "glute_right",
		name: "Glúteo Direito",
		d: "M 66 62 Q 72 66 70 72 L 52 72 Q 50 66 52 62 L 66 62",
		x: 61,
		y: 67,
		muscleGroup: "Glúteo",
	},
	...
	// Coxas (Posterior)
	{
		...
		name: "Coxa Esquerda",
		d: "M 30 72 Q 26 78 28 88 L 46 88 Q 48 78 46 72 L 30 72",
		x: 37,
		y: 80,
		muscleGroup: "Coxa",
	},
	{
		...
		name: "Coxa Direita",
		d: "M 70 72 Q 74 78 72 88 L 54 88 Q 52 78 54 72 L 70 72",
		x: 63,
		y: 80,
		muscleGroup: "Coxa",
	},
	...
	// Panturrilhas (Posterior)
	{
		code: "calf_left_back",
		name: "Panturrilha Esquerda",
		d: "M 28 88 Q 26 94 28 102 L 44 102 Q 46 94 44 88 L 28 88",
		x: 36,
		y: 95,
		muscleGroup: "Panturrilha",
	},
	{
		...
		name: "Panturrilha Direita",
		d: "M 72 88 Q 74 94 72 102 L 56 102 Q 54 94 56 88 L 72 88",
		x: 64,
		y: 95,
		muscleGroup: "Panturrilha",
	},
	...
	// Tornozelos e Pés (Posterior)
	{
		code: "ankle_left",
		name: "Tornozelo Esquerdo",
		d: "M 28 102 L 44 102 L 44 106 L 28 106 Z",
		x: 36,
		y: 104,
		muscleGroup: "Tornozelo",
	},
	{
		code: "ankle_right",
		name: "Tornozelo Direito",
		d: "M 72 102 L 56 102 L 56 106 L 72 106 Z",
		x: 64,
		y: 104,
		muscleGroup: "Tornozelo",
	},
...
export function BodyMapAnatomical({
	...
	const processedPoints = useMemo(() => {
		...
		if (filterType === "high-intensity") {
			...
			result = result.filter(
				(p) => p.painType === "cronica" || p.painType === "stiffness",
			);
	...
	const regionStats = useMemo(() => {
		...
		points.forEach((point) => {
			...
			current.avgIntensity =
				(current.avgIntensity * (current.count - 1) + point.intensity) /
				current.count;
			current.hasMuscleSpecific =
				current.hasMuscleSpecific || !!point.muscleCode;
	...
	const globalStats = useMemo(() => {
		...
		const chronicCount = points.filter(
			(p) => p.painType === "cronica" || p.painType === "stiffness",
		).length;
		...
		points.forEach((p) => {
			typeDistribution.set(
				p.painType,
				(typeDistribution.get(p.painType) || 0) + 1,
			);
		});
					...
					<div className="flex flex-wrap gap-2 items-center">
						...
						>
							...
							<SelectContent>
								...
								<SelectItem value="muscle-specific">
								...
								<Badge
									...
									style={{
										borderColor: getIntensityColor(
											Math.round(globalStats.avgIntensity),
										),
						...
						return (
							<g key={region.code}>
								...
								<path
									...
									fill={
										hasPain
											? getIntensityColorWithAlpha(maxIntensity, 0.25)
											: "transparent"
									}
									stroke={
										isHovered
											? "rgb(59, 130, 246)"
											: hasPain
												? getIntensityColor(maxIntensity)
												: "rgb(203, 213, 225)"
									}
				...
				{hoveredRegion && (
					<div className="absolute bottom-20 left-2 z-30">
						<div className="bg-background/95 backdrop-blur-sm px-4 py-3 rounded-xl shadow-xl border">
							{(() => {
								const region = musclePaths.find(
									(r) => r.code === hoveredRegion,
								);
											...
											<>
												...
												<div className="flex items-center gap-2">
													<div
														...
														style={{
															backgroundColor: getIntensityBg(
																stats.maxIntensity,
															),
												...
												<div className="flex gap-1 flex-wrap">
													{Array.from(stats.types).map((type) => (
														<Badge
															...
															style={{
																borderColor: PAIN_TYPE_DATA[type]?.color,
															}}
														>
															{PAIN_TYPE_DATA[type]?.icon}{" "}
															{PAIN_TYPE_DATA[type]?.label}
														</Badge>
													))}
												</div>
											</>
									...
									<div className="space-y-4">
										...
										<div className="flex items-center gap-2">
											<Badge
												...
												style={{
													borderColor: painData.color,
													color: painData.color,
												}}
											>
							...
							{[0, 2, 4, 6, 8, 10].map((level) => (
								<div key={level} className="flex items-center gap-2">
									...
									<span
										...
										style={{ color: getIntensityColor(level) }}
									>
										{level === 0
											? "Sem dor"
											: `${level} - ${getIntensityLabel(level)}`}
									</span>
								</div>
							))}
						</div>
