	...
	const filteredAndSortedPoints = useMemo(() => {
		...
		if (filterIntensity !== "all") {
			result = result.filter((p) => {
				...
				if (filterIntensity === "medium")
					return p.intensity >= 4 && p.intensity <= 6;
				if (filterIntensity === "high")
					return p.intensity >= 7 && p.intensity <= 8;
					...
					<div className="grid grid-cols-4 gap-2 text-center">
						<div className="bg-muted/50 rounded-lg p-2">
							<div
								...
								style={{ color: getIntensityColor(stats.avgIntensity) }}
							>
				...
				<CardContent className="pt-4">
					<div className="space-y-3">
						...
						<div className="flex gap-2">
							<Select
								value={filterType}
								onValueChange={(v) => setFilterType(v as FilterPainType)}
							>
							...
							<Select
								...
								onValueChange={(v) => setFilterIntensity(v as FilterIntensity)}
							>
								<SelectTrigger className="flex-1">
											...
											<div className="flex-1 min-w-0">
												<div className="flex items-start justify-between gap-2 mb-1">
													...
													>
														...
														{PAIN_TYPE_LABELS[point.painType]}
													</Badge>
												</div>
