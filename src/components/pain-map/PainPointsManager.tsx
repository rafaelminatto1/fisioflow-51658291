...
export function PainPointsManager({
  ...
  const stats = useMemo(() => {
    ...
    const avgIntensity = total > 0 ? points.reduce((sum, p) => sum + p.intensity, 0) / total : 0;
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <Button variant="ghost" size="sm" className="h-8 px-2" onClick={toggleSort}>
                  {sortOrder === "asc" ? (
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-start justify-between gap-2 mb-1">
                          <div className="flex-1">
                            <h4 className="font-medium text-sm text-foreground">{point.region}</h4>
                            {point.muscleName && (
