...
export function BodyMap({
  ...
  return (
    <div
      ...
      role="application"
      aria-label={`Mapa de dor - Vista ${view === "front" ? "frontal" : "posterior"}`}
    >
      {/* Legenda */}
      <div
          ...
          {(() => {
            ...
            return (
              <div className="space-y-2">
                ...
                {point.muscleName && (
                  <div className="text-sm font-medium text-primary">💪 {point.muscleName}</div>
                )}
                ...
                {point.notes && (
                  <div className="text-sm text-muted-foreground">Notas: {point.notes}</div>
                )}
                <button
                  onClick={() => {
