...
import { CheckCircle2, FileText, Pencil, Plus, RefreshCw, Save, Trash2 } from "lucide-react";
...
export function TemplateManager() {
  ...
  const contentVariables = useMemo(() => extractVariables(editContent), [editContent]);
          ...
          {selectedTemplate ? (
                ...
                <div className="flex items-center justify-between gap-4">
                  ...
                  <div className="flex shrink-0 gap-2">
                    ...
                    <Button
                      ...
                      disabled={
                        updateTemplate.isPending || editContent === selectedTemplate.content
                      }
                    ...
                    <div className="flex items-center gap-1.5 px-2 py-1 rounded-md bg-amber-500/10 text-amber-600 border border-amber-500/20">
                      ...
                      <span className="text-[9px] font-black uppercase tracking-tighter">
                        ...
                        {contentVariables.length > 0
                          ? contentVariables.map((variable) => `{{${variable}}}`).join(", ")
                          : "{{name}}, {{date}}, {{time}}"}
                      </span>
                    </div>
                  </div>
            ...
            <div className="flex-1 flex flex-col items-center justify-center text-center p-12 space-y-4">
              ...
              <div className="max-w-xs space-y-1">
                <p className="text-sm font-black uppercase tracking-tight">Selecione um template</p>
                <p className="text-[10px] text-muted-foreground uppercase font-bold tracking-widest leading-relaxed">
                  Escolha um template à esquerda para editar o conteúdo ou use Novo para criar uma
                  mensagem reutilizável.
                </p>
              </div>
            </div>
          )}
        ...
        <DialogContent className="sm:max-w-2xl">
          ...
          <DialogFooter>
            ...
            <Button
              ...
              disabled={isSaving || !formValues.name.trim() || !formValues.content.trim()}
            >
