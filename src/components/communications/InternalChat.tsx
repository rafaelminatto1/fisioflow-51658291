      ...
      <Card className="flex flex-col overflow-hidden col-span-1 border-r md:border-r-0 rounded-r-none md:rounded-r-xl bg-background/50 backdrop-blur-sm">
        <div className="p-4 border-b space-y-3">
          <div className="flex items-center justify-between">
            ...
            <Popover open={newChatPopoverOpen} onOpenChange={setNewChatPopoverOpen}>
          ...
          {isLoadingConversations ? (
            ...
            <div className="flex flex-col items-center justify-center p-12 text-center space-y-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-muted-foreground">Inicie um papo com sua equipe.</p>
              </div>
              <Button
                size="sm"
                variant="outline"
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex justify-between items-baseline mb-0.5">
                      <span className="font-bold truncate text-sm">{conv.participantName}</span>
                      <span
                        className={cn(
                    ...
                    <div className="flex justify-between items-center gap-2">
                      ...
                      {conv.unreadCount > 0 && selectedParticipantId !== conv.participantId && (
            ...
            <div className="text-center max-w-xs space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs font-medium leading-relaxed uppercase tracking-widest opacity-60">
                  Selecione um colega de equipe para alinhar tratamentos, agendamentos ou trocar
