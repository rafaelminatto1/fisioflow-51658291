...
export function ComplianceBanner() {
  ...
  if (pendingPolicies.length === 0) return null;

  return (
    <div className="bg-amber-500 text-white overflow-hidden shadow-lg border-b border-amber-600 relative z-50 animate-in fade-in slide-in-from-top-2 duration-300">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-amber-50/90 hidden sm:block">
              É obrigatório ler e confirmar o recebimento dessas diretrizes para manter sua
              conformidade na clínica.
            </p>
          </div>
        </div>
