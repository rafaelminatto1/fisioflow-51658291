    ...
    <div className="space-y-6">
      <div className="flex justify-between items-start gap-6">
        <div className="space-y-4 flex-1">
          <div>
            <h2 className="text-xl font-bold tracking-tight">Cultura & Políticas</h2>
            ...
            >
              ...
              {progressPercentage < 100 && (
                <p className="text-[10px] text-muted-foreground font-medium uppercase tracking-wider">
                  Faltam {mandatoryPolicies.length - readPolicies.length} documentos obrigatórios.
                </p>
              )}
            </motion.div>
          )}
            ...
            <DialogContent className="sm:max-w-xl">
              <DialogHeader>
                <DialogTitle className="text-xl font-bold">
                  {editingPolicy ? "Editar Política Obrigatória" : "Publicar Política Obrigatória"}
                </DialogTitle>
              </DialogHeader>
              <div className="space-y-4 py-4">
                ...
                <div className="p-4 bg-amber-50 dark:bg-amber-950/20 border border-amber-200 dark:border-amber-800/50 rounded-2xl">
                  <p className="text-xs text-amber-700 dark:text-amber-400 font-medium">
                    <strong>Nota:</strong> Este documento será marcado como obrigatório. Todos os
                    profissionais receberão um alerta até que confirmem a leitura.
                  </p>
                </div>
                <Button
                  ...
                  <CardFooter className="border-t border-border/40 bg-slate-50/30 dark:bg-slate-900/30 p-5 flex flex-col sm:flex-row gap-4 sm:items-center justify-between">
                    ...
                    {!policy.is_read && !isAdmin ? (
                      ...
                      >
                        ...
                        {markReadMutation.isPending ? "Confirmando..." : "Confirmar Recebimento"}
                      </Button>
                    ) : isAdmin ? (
                      <Badge
                        variant="outline"
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Esta ação remove a política e apaga seus registros de confirmação de leitura.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
