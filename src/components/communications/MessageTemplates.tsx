...
const MESSAGE_TEMPLATES: MessageTemplate[] = [
  ...
  },
  {
    ...
    subject: "Confirmação de sessão - FisioFlow",
    body: "Olá {nome}! Sua sessão foi agendada para {data} às {hora}. Por favor, chegue com 15 minutos de antecedência. Até logo!",
    icon: Calendar,
  ...
  },
  {
    ...
    body: "Olá {nome}! Lembrando que sua sessão é amanhã às {hora}. Confirmamos seu horário e aguardamos sua presença!",
    icon: Clock,
        ...
        {filteredTemplates.map((template) => {
          ...
          return (
            ...
            >
              <CardHeader className="pb-2">
                <div className="flex items-start justify-between gap-2">
                  <div className="flex items-center gap-2">
                    <div className={cn("p-1.5 rounded-md", CATEGORY_COLORS[template.category])}>
              ...
              <CardContent>
                <p className="text-sm text-muted-foreground line-clamp-2 mb-2">{template.body}</p>
                {template.tags && (
