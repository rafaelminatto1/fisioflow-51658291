            ...
            <DialogContent className="sm:max-w-lg">
              ...
              <div className="space-y-4 py-4">
                ...
                <div className="flex items-center space-x-2 bg-slate-50 dark:bg-slate-900 p-4 rounded-2xl border border-dashed border-muted-foreground/30">
                  <Switch id="push-notify" checked={pushNotify} onCheckedChange={setPushNotify} />
                  <Label htmlFor="push-notify" className="flex flex-col cursor-pointer flex-1">
                    <span className="font-bold text-sm">Notificar via Push</span>
      ...
      <div className="grid gap-4">
        {announcements.length === 0 ? (
          ...
          >
            ...
            <p className="font-medium tracking-tight">Nenhum comunicado disponível.</p>
          </motion.div>
        ) : (
                      ...
                      <div className="space-y-1">
                        ...
                        <CardDescription className="flex items-center gap-2 text-[10px] font-black uppercase tracking-widest">
                          ...
                          <span className="text-muted-foreground">
                            {format(new Date(announcement.created_at), "HH:mm", { locale: ptBR })}
                          </span>
                        </CardDescription>
                      </div>
      ...
      >
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Esta ação remove o aviso do mural e apaga seus registros de leitura.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
