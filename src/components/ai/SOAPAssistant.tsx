    ...
    <div className="space-y-6">
        ...
        <CardHeader>
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              ...
              <CardDescription>Geração de notas clínicas para {patient.name}</CardDescription>
            </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Digite ou grave a consulta para gerar a nota SOAP</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          {loading && progress > 0 && <Progress value={progress} className="h-2" />}
        </CardContent>
      </Card>
          ...
          <CardContent className="p-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <Button variant="outline" size="sm" className="mt-2" onClick={() => generateSOAP()}>
                  Tentar novamente
                </Button>
              </div>
            </div>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Button variant="outline" size="sm" onClick={() => applySection("subjective")}>
                    <Wand2 className="h-3 w-3 mr-1" />
                    Aplicar
                  </Button>
                </div>
                <p className="text-sm bg-muted/50 p-3 rounded">{finalResult.soap.subjective}</p>
              </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Button variant="outline" size="sm" onClick={() => applySection("objective")}>
                    <Wand2 className="h-3 w-3 mr-1" />
                    Aplicar
                  </Button>
                </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Button variant="outline" size="sm" onClick={() => applySection("assessment")}>
                    <Wand2 className="h-3 w-3 mr-1" />
                    Aplicar
                  </Button>
                </div>
                <p className="text-sm bg-muted/50 p-3 rounded">{finalResult.soap.assessment}</p>
              </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Button variant="outline" size="sm" onClick={() => applySection("plan")}>
                    <Wand2 className="h-3 w-3 mr-1" />
                    Aplicar
                  </Button>
                </div>
