  ...
  return (
    <div className="space-y-6">
        ...
        <CardHeader>
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              ...
              <CardDescription>Análises e insights para {patient.name}</CardDescription>
            </div>
          </div>
        </CardHeader>
        <CardContent>
          <Button onClick={runAllAnalyses} disabled={loading} className="w-full" size="lg">
            {loading ? (
              <>
          ...
          <CardContent className="p-6">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <Button variant="outline" size="sm" className="mt-2" onClick={runAllAnalyses}>
                  Tentar novamente
                </Button>
              </div>
            </div>
      ...
      {(painAnalysis || recoveryPrediction || treatmentResponse) && (
        <Tabs
          value={activeTab}
          onValueChange={(v) => setActiveTab(v as "pain" | "recovery" | "response")}
        >
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="text-center p-4 bg-muted/50 rounded-lg">
                    ...
                    <p className="text-sm text-muted-foreground">Mudança no nível de dor</p>
                    <Badge
                      variant={
                  ...
                  <div className="grid grid-cols-3 gap-2 text-center">
                    <div className="p-2 bg-muted/30 rounded">
                      ...
                      <p className="font-semibold text-sm">
                        {formatDate(recoveryPrediction.confidenceInterval.lower)}
                      </p>
                    </div>
                    <div className="p-2 bg-muted/30 rounded">
                      <p className="text-xs text-muted-foreground">Esperado</p>
                      <p className="font-semibold text-sm">
                        {recoveryPrediction.confidenceInterval.expectedDays} dias
                      </p>
                    </div>
                    <div className="p-2 bg-muted/30 rounded">
                      <p className="text-xs text-muted-foreground">Pessimista</p>
                      <p className="font-semibold text-sm">
                        {formatDate(recoveryPrediction.confidenceInterval.upper)}
                      </p>
                    </div>
                  </div>
            ...
            <TabsContent value="response" className="space-y-4">
              <Card>
                ...
                <CardContent className="space-y-4">
                  <div className="text-center p-4 bg-muted/50 rounded-lg">
                    <Badge
                      variant={getEffectivenessColor(treatmentResponse.effectiveness)}
                      className="mb-2"
                    >
