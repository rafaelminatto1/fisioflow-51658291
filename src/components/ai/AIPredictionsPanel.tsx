        ...
        <CardHeader>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <CardDescription>Análise preditiva para otimizar tratamento</CardDescription>
            </div>
          </div>
        </CardHeader>
        <CardContent>
          <Button onClick={runPredictions} disabled={loading} className="w-full" size="lg">
            {loading ? (
              <>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Badge variant="default">{100 - predictions.riskScore}%</Badge>
              </div>
              <Progress value={100 - predictions.riskScore} className="h-2" />
              <p className="text-2xl font-bold text-green-600">{100 - predictions.riskScore}%</p>
            </CardContent>
          </Card>
