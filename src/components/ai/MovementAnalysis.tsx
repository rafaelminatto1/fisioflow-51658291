...
export function MovementAnalysis({
	...
	const [analysisResult, setAnalysisResult] =
		useState<MovementAnalysisResult | null>(null);
	...
	const handleRecordVideo = useCallback(async () => {
		try {
			...
			logger.error(
				"[MovementAnalysis] Error recording",
				err,
				"MovementAnalysis",
			);
			toast({
	...
	const analyzeForm = useCallback(async () => {
		...
		try {
			...
			setAnalysisProgress({
				...
				message:
					language === "pt-BR"
						? "Analisando movimento com IA..."
						: "Analyzing movement with AI...",
			});
					...
					<CardContent>
						<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
							...
							>
								...
								<span>
									{isPTBR ? "Gravar da Câmera" : "Record from Camera"}
								</span>
			...
			{analysisResult && (
				<>
						...
						<CardContent>
							...
							<div className="mt-4 p-4 bg-muted/50 rounded">
								<p className="text-sm">
									...
									{expectedReps &&
										` / ${expectedReps} ${isPTBR ? "esperadas" : "expected"}`}
								</p>
											...
											<div className="flex items-start gap-2 mb-2">
												...
												<div className="flex-1">
													...
													<p className="text-xs mt-1">
														<strong>
															{isPTBR ? "Recomendação:" : "Recommendation:"}
														</strong>{" "}
					...
					<Card>
						<CardHeader>
							<CardTitle>
								{isPTBR ? "Progressão Sugerida" : "Suggested Progression"}
							</CardTitle>
						</CardHeader>
						<CardContent>
							<p className="text-sm bg-muted/50 p-3 rounded">
