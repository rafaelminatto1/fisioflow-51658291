...
const NO_PATIENT_ERROR_MSG = "Selecione um paciente para liberar recomendações personalizadas.";
...
export function ExerciseAI({
  ...
  const contextSnapshot = useMemo(() => {
    ...
    const soapSummary = recentSoap
      ? [recentSoap.subjective, recentSoap.objective, recentSoap.assessment, recentSoap.plan]
          .filter(Boolean)
          .join(" | ")
          .slice(0, 220)
      : "";
  ...
  const sendChatMessage = useCallback(async () => {
    ...
    if (!hasPatient) {
      toast({
        ...
        description: "O chat clínico precisa de um paciente para usar contexto e histórico.",
        variant: "destructive",
      });
      return;
    }
...
`
  ...
  }, [chatMessages, hasPatient, patientName, patientId, contextSnapshot, onChatExport]);
                    ...
                    <div className="w-full lg:max-w-md">
                      ...
                      {!hasPatient && (
                        <p className="mt-2 text-xs text-muted-foreground">
                          O envio e as ações clínicas ficam bloqueados até selecionar um paciente.
                        </p>
                      )}
                    </div>
                  )}
              ...
              <CardContent className="space-y-4">
                <div className="flex flex-wrap gap-2">
                  ...
                  <Button
                    ...
                    disabled={isChatLocked || loading}
                    onClick={() =>
                      setChatInput("Quais precauções devo priorizar para ombro doloroso?")
                    }
                  >
                    Precauções clínicas
                  </Button>
                ...
                <CardHeader>
                  <div className="flex items-center justify-between">
                    ...
                    {selectedExercises.size > 0 && (
                      <Badge variant="default">{selectedExercises.size} selecionados</Badge>
                    )}
                  </div>
                </CardHeader>
                <CardContent>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm space-y-1">
              ...
              <p className="text-muted-foreground text-[11px]">
                As recomendações de IA são ferramentas de suporte e não substituem o julgamento
