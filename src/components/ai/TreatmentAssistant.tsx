...
export function TreatmentAssistant({
	...
	const [suggestion, setSuggestion] = useState<string | null | undefined>(
		undefined,
	);
	...
	const callNativeAI = async (
		...
		try {
			...
			setSuggestion(
				action === "summarize" ? result.data.summary : result.data.translated,
			);
							...
							<Button
								onClick={() => {
									...
									toast({
										...
										description:
											"O conteúdo foi adicionado ao campo de Avaliação (A).",
									});
								}}
								variant="secondary"
							...
							<Button
								onClick={() => {
									...
									toast({
										...
										description:
											"O conteúdo foi adicionado ao campo de Plano (P).",
									});
								}}
								variant="secondary"
							...
							<Button
								onClick={() => {
									...
									toast({
										...
										description:
											"O conteúdo foi anexado ao campo de Avaliação (A).",
									});
								}}
								variant="outline"
								size="sm"
							...
							<Button
								onClick={() => {
									...
									toast({
										...
										description:
											"O conteúdo foi anexado ao campo de Plano (P).",
									});
								}}
								variant="outline"
								size="sm"
					...
					<div className="flex items-start gap-3">
						...
						<div className="text-sm space-y-1">
							...
							<p className="text-muted-foreground">
								Análises baseadas em evidências científicas e guidelines
								internacionais de fisioterapia. As sugestões devem ser sempre
								validadas pelo profissional responsável.
							</p>
						</div>
					</div>
				</CardContent>
