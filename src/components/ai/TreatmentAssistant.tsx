        ...
        <CardHeader>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <CardDescription>Análise inteligente para {patientName}</CardDescription>
            </div>
          </div>
        </CardHeader>
      </Card>
        ...
        <Card
          ...
          onClick={() => {
            ...
            if (!loading) {
              callNativeAI(
                "summarize",
                text.length > 10 ? text : "Sem conteúdo clínico suficiente para resumir.",
              );
            }
          }}
        >
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm space-y-1">
              ...
              <p className="text-muted-foreground">
                Análises baseadas em evidências científicas e guidelines internacionais de
                fisioterapia. As sugestões devem ser sempre validadas pelo profissional responsável.
              </p>
            </div>
          </div>
        </CardContent>
