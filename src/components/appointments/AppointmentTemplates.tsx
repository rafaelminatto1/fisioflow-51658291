...
export const TEMPLATE_VARIABLES: AppointmentTemplateVariable[] = [
	...
	{ key: "{{duracao}}", label: "Duração", example: "60 min" },
	{
		key: "{{observacoes}}",
		label: "Observações",
		example: "Trazer exames recentes",
	},
];
...
const DEFAULT_TEMPLATES: AppointmentTemplate[] = [
	{
		...
		duration: 60,
		notes:
			"Anamnese completa, avaliação postural, teste de amplitude de movimento",
		color: "#3b82f6",
		isDefault: true,
		createdAt: new Date(),
		updatedAt: new Date(),
...
export const AppointmentTemplates: React.FC<AppointmentTemplatesProps> = ({
	...
	const [templates, setTemplates] =
		useState<AppointmentTemplate[]>(DEFAULT_TEMPLATES);
	...
	const handleCreate = useCallback(
		(template: Partial<AppointmentTemplate>) => {
