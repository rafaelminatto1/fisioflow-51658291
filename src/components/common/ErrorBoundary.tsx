        ...
        <MainLayout>
          <div className="flex flex-col items-center justify-center min-h-[60vh] p-6 text-center">
            ...
            <p className="text-slate-500 max-w-md mb-8">
              Ocorreu um erro inesperado ao carregar esta página. Não se preocupe, seus dados estão
              seguros.
            </p>
            ...
            {process.env.NODE_ENV === "development" && this.state.error && (
              <div className="mb-8 p-4 bg-slate-50 rounded-xl text-left max-w-2xl overflow-auto border border-slate-200">
                ...
                <pre className="text-[10px] text-slate-400 font-mono">{this.state.error.stack}</pre>
              </div>
            )}
