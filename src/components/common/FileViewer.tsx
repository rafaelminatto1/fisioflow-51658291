	...
	return (
		<>
						...
						>
							{isImg && url ? (
								<OptimizedImage
									src={url}
									alt={file.file_name}
									className="w-full h-full transition-transform duration-500 group-hover/file:scale-110"
									aspectRatio="auto"
								/>
							) : (
								<div className="flex flex-col items-center justify-center h-full p-2 text-center bg-slate-50">
									...
									<span className="text-[10px] font-bold text-slate-500 truncate w-full px-1 uppercase">
			...
			>
									...
									<div className="flex flex-col items-center justify-center p-12 text-center space-y-6">
										...
										<div className="space-y-2">
											...
											<p className="text-slate-500 text-sm">
												Este tipo de arquivo não possui pré-visualização direta.
											</p>
										</div>
										<Button
				...
				<CustomModalFooter
					isMobile={isMobile}
					className="bg-slate-900 border-slate-800 py-3"
				>
					<div className="flex items-center justify-between w-full">
						...
						<div className="flex items-center gap-4">
							...
							<Button
								...
								className="rounded-xl h-9 px-4 font-bold text-slate-400 hover:text-white hover:bg-white/5 uppercase text-xs"
							>
								Fechar
							</Button>
						</div>
