			...
			<CardContent className="space-y-6">
				<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
					<div className="space-y-2">
						...
						<Select
							...
							onValueChange={(value) =>
								setPosturalData({ ...posturalData, headPosition: value })
							}
						>
							<SelectTrigger>
							...
							<SelectContent>
								...
								<SelectItem value="inclinada-direita">
									Inclinada à direita
								</SelectItem>
								<SelectItem value="inclinada-esquerda">
					...
					<div className="space-y-2">
						...
						<Select
							...
							onValueChange={(value) =>
								setPosturalData({ ...posturalData, shoulderAlignment: value })
							}
						>
							<SelectTrigger>
								<SelectValue placeholder="Selecione..." />
							...
							<SelectContent>
								...
								<SelectItem value="elevado-direito">
									Elevado à direita
								</SelectItem>
								<SelectItem value="elevado-esquerdo">
									Elevado à esquerda
								</SelectItem>
							</SelectContent>
						</Select>
					...
					<div className="space-y-2">
						...
						<Select
							...
							onValueChange={(value) =>
								setPosturalData({ ...posturalData, spineAlignment: value })
							}
						>
							<SelectTrigger>
								<SelectValue placeholder="Selecione..." />
					...
					<div className="space-y-2">
						...
						<Select
							...
							onValueChange={(value) =>
								setPosturalData({ ...posturalData, pelvisPosition: value })
							}
						>
							<SelectTrigger>
								<SelectValue placeholder="Selecione..." />
					...
					<div className="space-y-2">
						...
						<Select
							...
							onValueChange={(value) =>
								setPosturalData({ ...posturalData, kneeAlignment: value })
							}
						>
							<SelectTrigger>
								<SelectValue placeholder="Selecione..." />
					...
					<div className="space-y-2">
						...
						<Select
							...
							onValueChange={(value) =>
								setPosturalData({ ...posturalData, footPosition: value })
							}
						>
							<SelectTrigger>
								<SelectValue placeholder="Selecione..." />
				...
				<div className="space-y-2">
					...
					<Textarea
						...
						onChange={(e) =>
							setPosturalData({ ...posturalData, observations: e.target.value })
						}
						rows={4}
					/>
				</div>
