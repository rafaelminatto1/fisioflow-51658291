				...
				<CardContent>
					...
					<div className="mt-4">
						<Badge className="bg-blue-100 text-blue-800">
							Melhora média de 42% na amplitude
						</Badge>
					</div>
				</CardContent>
			</Card>
				...
				<CardContent>
					<div className="space-y-4">
						<div className="p-4 bg-muted rounded-lg">
							...
							<p className="text-sm">
								Paciente apresenta melhora significativa na amplitude de
								movimento. Redução da dor durante exercícios.
							</p>
						</div>
						<div className="p-4 bg-muted rounded-lg">
							<div className="flex items-center justify-between mb-2">
							...
							<p className="text-sm">
								Boa adesão aos exercícios domiciliares. Força muscular em
								evolução.
							</p>
						</div>
						<div className="p-4 bg-muted rounded-lg">
