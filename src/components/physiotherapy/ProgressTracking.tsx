      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="mt-4 flex items-center justify-between">
            ...
            <p className="text-sm text-muted-foreground">Escala: 0 (sem dor) - 10 (dor máxima)</p>
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent>
          <div className="space-y-4">
            <div className="p-4 bg-muted rounded-lg">
              ...
              <p className="text-sm">
                Paciente apresenta melhora significativa na amplitude de movimento. Redução da dor
                durante exercícios.
              </p>
            </div>
            <div className="p-4 bg-muted rounded-lg">
            ...
            <div className="p-4 bg-muted rounded-lg">
              ...
              <p className="text-sm">
                Paciente relatou dificuldade em realizar alguns exercícios. Ajustada intensidade do
                treino.
              </p>
            </div>
          </div>
