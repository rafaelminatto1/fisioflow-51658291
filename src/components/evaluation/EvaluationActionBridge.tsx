    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-700">
                          ...
                          <div className="min-w-0">
                            <div className="flex items-center gap-1.5">
                              ...
                              {s.priority === "high" && (
                                <Badge
                                  variant="destructive"
                                  className="h-3 px-1 text-[8px] animate-pulse"
                                >
                                  URGENTE
                                </Badge>
                              )}
      ...
      <div className="px-3 py-3 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-slate-800 flex items-start gap-3">
        ...
        <p className="text-[10px] text-slate-500 leading-relaxed">
          ...
          As sugestões da IA são baseadas em evidências científicas e diretrizes de prática clínica,
          mas não substituem o julgamento clínico do fisioterapeuta.
        </p>
      </div>
    </div>
  );
