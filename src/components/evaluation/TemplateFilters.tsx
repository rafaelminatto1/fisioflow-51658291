...
export function TemplateFilters({
  ...
  const activeFiltersCount = [filters.search, filters.category, filters.favorites].filter(
    Boolean,
  ).length;
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <TooltipProvider>
          <Tooltip>
            ...
            <TooltipContent>
              {filters.favorites ? "Mostrar todos os templates" : "Mostrar apenas favoritos"}
            </TooltipContent>
          </Tooltip>
        </TooltipProvider>
        ...
        <Select
          ...
          onValueChange={(value) => updateFilter("sortBy", value as TemplateFiltersType["sortBy"])}
        >
          <SelectTrigger className="w-full sm:w-[180px]">
