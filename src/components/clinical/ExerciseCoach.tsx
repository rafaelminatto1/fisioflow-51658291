			...
			<Card className="shadow-lg">
				<CardContent className="p-8">
					<div className="flex flex-col items-center justify-center text-gray-500">
						...
						<p className="text-sm">
							Escolha um exercício para iniciar a sessão de coaching
						</p>
					</div>
				</CardContent>
			</Card>
				...
				<CardContent className="p-4">
					...
					<div className="grid grid-cols-2 gap-4 mb-6">
						...
						<div className="p-4 bg-slate-50 rounded-lg">
							...
							<Progress
								value={(currentRep / targetReps) * 100}
								className="h-2"
							/>
						</div>
					</div>
						...
						<div className="mb-6 p-4 rounded-lg border-2 bg-white">
							<div className="flex items-center justify-between">
								<div>
									...
									<p
										className={`text-2xl font-bold ${getFormScoreColor(formScore)}`}
									>
										{formScore}%
									</p>
			...
			<Card className="shadow-lg">
				...
				<CardContent className="p-4 space-y-4">
					...
					<div className="p-4 bg-slate-50 rounded-lg">
						...
						<p
							className={`text-3xl font-bold ${getFormScoreColor(averageFormScore)}`}
						>
							{averageFormScore.toFixed(0)}%
						</p>
						<p
							className={`text-sm mt-1 ${getFormScoreColor(averageFormScore)}`}
						>
