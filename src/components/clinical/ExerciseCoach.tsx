            ...
            <div className="flex items-center gap-2">
              {isActive ? (
                <>
                  ...
                  <Button size="sm" onClick={manualRepCount} disabled={isPaused}>
                    + Rep
                  </Button>
          ...
          {isActive && formScore > 0 && (
            <div className="mt-4">
              <div className="flex items-center justify-between text-sm mb-1">
                ...
                <span className={`font-medium ${getFormScoreColor(formScore)}`}>{formScore}%</span>
              </div>
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <CardHeader>
          <div className="flex items-start justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              {/* Mute Toggle */}
              <Button size="sm" variant={isMuted ? "outline" : "default"} onClick={toggleMute}>
        ...
        <CardContent className="p-4">
            ...
            <div className="mb-6 p-4 rounded-lg border-2 bg-white">
              <div className="flex items-center justify-between">
                ...
                <div className="text-right">
                  ...
                  <p className="text-sm text-slate-500">Média: {averageFormScore.toFixed(0)}%</p>
                </div>
              </div>
            </div>
          )}
          ...
          <div className="border rounded-lg">
            <div className="flex items-center justify-between p-3 border-b bg-slate-50">
              ...
              <Badge variant="secondary">{feedback.length} mensagens</Badge>
            </div>
              ...
              <div className="space-y-2">
                {feedback.length === 0 ? (
                  ...
                  feedback.map((msg) => {
                    ...
                    return (
                      <div key={msg.id} className={`p-3 rounded-lg border ${colors[msg.type]}`}>
          ...
          <div className="mt-6 flex items-center justify-center gap-4">
            {isActive ? (
              <>
                {isPaused ? (
                  <Button size="lg" onClick={resumeSession} className="rounded-full w-16 h-16">
      ...
      <Card className="shadow-lg">
        <CardHeader>
          ...
          <CardDescription>Desempenho durante a sessão</CardDescription>
        </CardHeader>
