      ...
      <Card className="shadow-lg">
        <CardContent className="p-4">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              {isActive ? (
                <Button size="sm" variant="destructive" onClick={stopSession} className="gap-2">
        ...
        <CardHeader>
          <div className="flex items-start justify-between">
            <div>
              ...
              <CardDescription>Comunicação em tempo real por voz durante a sessão</CardDescription>
            </div>
        ...
        <CardContent className="p-4">
            ...
            <div className="mb-6">
              <div className="flex items-center justify-center gap-8 py-6">
                ...
                <div className="flex flex-col items-center gap-2">
                  <div
                    className={`w-16 h-16 rounded-full flex items-center justify-center transition-all ${
                      isListening ? "bg-green-100 ring-4 ring-green-200" : "bg-slate-100"
                    }`}
                  >
                    {isListening ? (
                      <div className="relative">
                ...
                <div className="flex flex-col items-center gap-2">
                  <div
                    className={`w-16 h-16 rounded-full flex items-center justify-center transition-all ${
                      isSpeaking ? "bg-blue-100 ring-4 ring-blue-200" : "bg-slate-100"
                    }`}
                  >
                    {isSpeaking ? (
                      <div className="relative">
          ...
          <div className="border rounded-lg">
            <div className="flex items-center justify-between p-3 border-b bg-slate-50">
              ...
              <Badge variant="secondary">{transcripts.length} mensagens</Badge>
            </div>
          ...
          <div className="mt-6 flex items-center justify-center gap-4">
            {isActive ? (
              ...
              <Button size="lg" onClick={startSession} className="rounded-full w-16 h-16 gap-2">
      ...
      <Card className="shadow-lg">
        <CardHeader>
          <div className="flex items-center justify-between">
            ...
            <Button size="sm" variant="ghost" onClick={() => setShowKeyPoints(!showKeyPoints)}>
              <Info className="h-4 w-4" />
            </Button>
          </div>
          <CardDescription>Informações importantes extraídas da conversa</CardDescription>
        </CardHeader>
                        ...
                        {[1, 2, 3, 4, 5].map((level) => (
                          <div
                            ...
                            className={`w-1.5 h-1.5 rounded-full ${
                              level <= point.importance ? "bg-orange-500" : "bg-slate-300"
                            }`}
                          />
                        ))}
                      </div>
