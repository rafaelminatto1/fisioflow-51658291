...
export function ClinicalTestMetricsBuilder({ fields, onChange }: ClinicalTestMetricsBuilderProps) {
  const addField = () => {
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <Label className="text-sm font-semibold text-slate-700">Métricas de Medição</Label>
        <Button
          type="button"
          variant="outline"
          size="sm"
      ...
      {fields.length === 0 && (
        <div className="border-2 border-dashed border-slate-200 rounded-lg p-6 text-center">
          <p className="text-sm text-slate-500">
            Nenhuma métrica definida. Adicione campos para coletar dados durante a execução do
            teste.
          </p>
        </div>
      )}
            ...
            <div className="flex items-start gap-2">
              ...
              <div className="flex-1 grid grid-cols-2 md:grid-cols-4 gap-3">
                ...
                <div>
                  ...
                  <Select
                    value={field.type}
                    onValueChange={(value: MetricField["type"]) =>
