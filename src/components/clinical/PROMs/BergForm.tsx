...
export function BergForm({ onSave, onCancel }: BergFormProps) {
	...
	const interpretation =
		answeredCount === totalItems ? getBergInterpretation(totalScore) : null;
		...
		<Card className="w-full">
			<CardHeader className="pb-3">
				...
				<p className="text-sm text-muted-foreground">
					14 tarefas de equilíbrio. Score máximo: 56 pontos. Escore {"< 45"}{" "}
					indica risco de queda.
				</p>
			</CardHeader>
			<CardContent className="space-y-5">
				<div className="rounded-md border bg-blue-50/50 p-3 text-sm text-blue-800">
					...
					<p>
						Demonstre e/ou instrua o paciente conforme necessário. Ao pontuar,
						registre a menor categoria que se aplica. Para a maioria dos itens,
						o paciente deve manter a posição por um período específico sem
						apoio.
					</p>
				</div>
