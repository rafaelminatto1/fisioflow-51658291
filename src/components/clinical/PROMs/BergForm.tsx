...
function getBergInterpretation(score: number): { label: string; color: string } {
  if (score <= 20) return { label: 'Cadeira de rodas necessária', color: 'bg-red-100 text-red-800' };
  if (score <= 40) return { label: 'Ambulação com auxílio', color: 'bg-orange-100 text-orange-800' };
