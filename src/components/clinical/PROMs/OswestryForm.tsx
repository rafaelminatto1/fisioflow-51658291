    ...
    <Card className="w-full">
      ...
      <CardContent className="space-y-5">
        <div className="rounded-md border bg-blue-50/50 p-3 text-sm text-blue-800">
          ...
          <p>
            Este questionário foi elaborado para dar informações sobre como a dor nas costas ou
            perna afeta sua capacidade de realizar atividades diárias. Por favor, responda a cada
            seção marcando apenas a opção que melhor se aplica a você hoje.
          </p>
        </div>
