...
export function PROMSelector({
  ...
  const renderForm = () => {
    const commonProps = { patientId, sessionId, onSave: handleSave, onCancel: handleCancel };
    switch (selectedScale) {
      case 'VAS': return <VasForm {...commonProps} />;
      case 'PSFS': return <PsfsForm {...commonProps} />;
      case 'DASH': return <DashForm {...commonProps} />;
      case 'OSWESTRY': return <OswestryForm {...commonProps} />;
      case 'NDI': return <NdiForm {...commonProps} />;
      case 'LEFS': return <LefsForm {...commonProps} />;
      case 'BERG': return <BergForm {...commonProps} />;
      default: return null;
    }
  };
              ...
              {SCALES.map((scale) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0 space-y-1">
                    ...
                    <p className="text-xs text-muted-foreground leading-snug">{scale.description}</p>
