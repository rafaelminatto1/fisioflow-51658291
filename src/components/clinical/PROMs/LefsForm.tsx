...
function getLefsInterpretation(score: number): { label: string; color: string } {
  if (score <= 40) return { label: 'Incapacidade grave', color: 'bg-red-100 text-red-800' };
  if (score <= 60) return { label: 'Incapacidade moderada', color: 'bg-yellow-100 text-yellow-800' };
