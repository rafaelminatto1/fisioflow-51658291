    ...
    <Card className="w-full">
      <CardHeader className="pb-3">
        ...
        <p className="text-sm text-muted-foreground">
          Avaliação de atividades funcionais específicas do paciente. MCID: 2 pontos (melhora
      ...
      <CardContent className="space-y-5">
        <div className="rounded-md border bg-blue-50/50 p-3 text-sm text-blue-800">
          ...
          <p>
            Identifique até 5 atividades importantes que você tem dificuldade de realizar devido ao
            seu problema. Para cada atividade, indique sua capacidade atual de 0 (incapaz) a 10 (sem
            dificuldade).
          </p>
        </div>
