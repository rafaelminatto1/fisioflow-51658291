...
export function GanttDependencyLine({
  ...
  const strokeColor = isCritical ? "hsl(var(--destructive))" : "hsl(var(--muted-foreground) / 0.5)";
  ...
  return (
    ...
    >
      ...
      {/* Cabeça de seta */}
      <polygon points={getArrowPoints(toX, toY)} fill={strokeColor} />

      {/* Círculo de conexão na origem */}
      <circle cx={fromX} cy={fromY} r={3} fill={strokeColor} />
    </g>
  );
}
