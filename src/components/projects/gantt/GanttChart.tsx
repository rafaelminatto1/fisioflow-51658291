				...
				<CardContent className="p-0">
					...
					>
						...
						>
							...
							>
								{/* Timeline Header */}
								<GanttTimelineHeader cells={timeCells} zoom={zoom} y={0} />
								...
								>
									...
									{timeCells.map((cell, index) => (
										<line
											...
											strokeDasharray={cell.is_working_day ? undefined : "4 4"}
										/>
									))}
									...
									dependencies.map((dep) => {
										...
										return (
											<GanttDependencyLine
												...
												type={dep.type}
												isCritical={criticalPath?.task_ids.includes(
													dep.from_task_id,
												)}
