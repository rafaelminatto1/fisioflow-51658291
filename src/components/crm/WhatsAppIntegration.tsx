...
export default function WhatsAppIntegration() {
	...
	const mensagens = mensagensData.map((msg) => ({
		...
		recipient_name: String(
			msg.metadata?.recipient_name ?? msg.metadata?.recipient ?? "",
		),
	...
	return (
		<div className="space-y-6">
			...
			<Tabs
				value={activeTab}
				onValueChange={(v) =>
					setActiveTab(v as "mensagens" | "templates" | "config")
				}
			>
				<TabsList>
							...
							{isLoading ? (
								...
								<div className="space-y-2">
									{mensagens.map((msg) => (
										<div
											key={msg.id}
											className="flex items-center gap-4 p-3 border rounded-lg hover:bg-accent/5"
										>
										...
										<div className="flex items-start gap-3">
											...
											<div className="flex-1">
												...
												<p className="text-sm text-muted-foreground mt-1">
													Olá {"{nome}"}, seu agendamento para {"{data}"} às{" "}
													{"{hora}"} foi confirmado. Esperamos você na{" "}
													{"{clinica}"}!
												</p>
									...
									<CardContent className="pt-4">
										<div className="flex items-start gap-3">
											...
											<div className="flex-1">
												...
												<p className="text-sm text-muted-foreground mt-1">
													Olá {"{nome}"}, lembramos que sua sessão de
													fisioterapia é amanhã às {"{hora}"}. Confirmamos?
												</p>
												<Button variant="outline" size="sm" className="mt-2">
													Usar Template
												</Button>
									...
									<CardContent className="pt-4">
										<div className="flex items-start gap-3">
											...
											<div className="flex-1">
												...
												<p className="text-sm text-muted-foreground mt-1">
													Olá {"{nome}"}! Bem-vindo à {"{clinica}"}. Estamos
													felizes em atender você!
												</p>
												<Button variant="outline" size="sm" className="mt-2">
													Usar Template
												</Button>
									...
									<CardContent className="pt-4">
										<div className="flex items-start gap-3">
											...
											<div className="flex-1">
												...
												<p className="text-sm text-muted-foreground mt-1">
													Olá {"{nome}"}, como você está se sentindo após a
													sessão? Alguma dúvida sobre os exercícios?
												</p>
												<Button variant="outline" size="sm" className="mt-2">
													Usar Template
												</Button>
						...
						<CardContent className="space-y-4">
							<div className="bg-blue-50 dark:bg-blue-950/30 p-4 rounded-lg">
								<p className="text-sm text-blue-700 dark:text-blue-300">
									Para configurar o WhatsApp Business, você precisa de uma conta
									no Meta Business Suite e criar um aplicativo com acesso à
								...
								<div className="flex items-center justify-between">
									...
									<Switch
										...
										onCheckedChange={(checked) =>
											setConfigData({ ...configData, enabled: checked })
										}
									/>
								</div>
					...
					<div className="space-y-4">
						...
						<div className="space-y-2">
							...
							<Select
								...
								onValueChange={(v) =>
									setFormData({ ...formData, template_id: v })
								}
							>
								<SelectTrigger>
							...
							<div className="flex flex-wrap gap-2">
								...
								<Badge
									...
									onClick={() =>
										setFormData({
											...formData,
											message: formData.message + "{clinica}",
										})
									}
								>
									{"{clinica}"}
