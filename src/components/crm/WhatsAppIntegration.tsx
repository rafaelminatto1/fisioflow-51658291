...
export default function WhatsAppIntegration() {
  ...
  return (
    <div className="space-y-6">
      ...
      <Tabs
        value={activeTab}
        onValueChange={(v) => setActiveTab(v as "mensagens" | "templates" | "config")}
      >
        <TabsList>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-muted-foreground mt-1">
                          Olá {"{nome}"}, seu agendamento para {"{data}"} às {"{hora}"} foi
                          confirmado. Esperamos você na {"{clinica}"}!
                        </p>
                  ...
                  <CardContent className="pt-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-muted-foreground mt-1">
                          Olá {"{nome}"}, lembramos que sua sessão de fisioterapia é amanhã às{" "}
                          {"{hora}"}. Confirmamos?
                        </p>
                        <Button variant="outline" size="sm" className="mt-2">
                          Usar Template
                  ...
                  <CardContent className="pt-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-muted-foreground mt-1">
                          Olá {"{nome}"}! Bem-vindo à {"{clinica}"}. Estamos felizes em atender
                          você!
                        </p>
                        <Button variant="outline" size="sm" className="mt-2">
                          Usar Template
                  ...
                  <CardContent className="pt-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-muted-foreground mt-1">
                          Olá {"{nome}"}, como você está se sentindo após a sessão? Alguma dúvida
                          sobre os exercícios?
                        </p>
                        <Button variant="outline" size="sm" className="mt-2">
                          Usar Template
            ...
            <CardContent className="space-y-4">
              <div className="bg-blue-50 dark:bg-blue-950/30 p-4 rounded-lg">
                <p className="text-sm text-blue-700 dark:text-blue-300">
                  Para configurar o WhatsApp Business, você precisa de uma conta no Meta Business
                  Suite e criar um aplicativo com acesso à WhatsApp Business API.
                </p>
              </div>
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>Enviar mensagem para um paciente ou lead</DialogDescription>
          </DialogHeader>
