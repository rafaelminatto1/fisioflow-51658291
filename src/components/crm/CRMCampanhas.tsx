                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                          <Badge className={cn("text-[10px] h-4", statusInfo.color)}>
                            {statusInfo.label}
                          </Badge>
                    ...
                    <AlertDialog>
                      ...
                      <AlertDialogContent className="rounded-2xl">
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription>
                            Esta ação removerá todos os dados de métricas desta campanha e não
                            poderá ser desfeita.
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
              ...
              <div className="flex flex-wrap gap-2 bg-slate-50 p-3 rounded-xl border border-slate-100">
                {ESTAGIOS.map((estagio) => (
                  <Badge
                    key={estagio.value}
                    variant={
                      formData.filtro_estagios.includes(estagio.value) ? "default" : "outline"
                    }
                    className={cn(
