			...
			<CustomModalBody className="p-0 sm:p-0">
				<div className="px-6 py-4 space-y-4">
					<div className="space-y-2">
						<Label htmlFor="lead-nome" className="font-semibold">
							Nome Completo *
						</Label>
						<Input
							id="lead-nome"
					...
					<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
						<div className="space-y-2">
							<Label htmlFor="lead-origem" className="font-semibold text-xs">
								Origem do Lead
							</Label>
							<Select
								value={formData.origem}
								onValueChange={(v) =>
									setFormData((prev) => ({ ...prev, origem: v }))
								}
							>
								<SelectTrigger
									id="lead-origem"
					...
					<div className="space-y-2">
						<Label htmlFor="lead-estagio" className="font-semibold">
							Estágio no Funil
						</Label>
						<Select
								...
								{estagios.map((e) => (
									<SelectItem key={e.value} value={e.value}>
										<div className="flex items-center gap-2">
											<div
												className={cn("w-2.5 h-2.5 rounded-full", e.color)}
											/>
											{e.label}
										</div>
									</SelectItem>
						...
						<div className="space-y-2 animate-in fade-in zoom-in-95 duration-200">
							...
							<Input
								...
								onChange={(e) =>
									setFormData((prev) => ({
										...prev,
										motivo_nao_efetivacao: e.target.value,
									}))
								}
					...
					<AlertDialog>
						<AlertDialogTrigger asChild>
							<Button
								variant="ghost"
								type="button"
								className="text-destructive hover:text-destructive hover:bg-destructive/10 rounded-xl mr-auto"
							>
						...
						<AlertDialogContent>
							<AlertDialogHeader>
								...
								<AlertDialogDescription>
									Tem certeza que deseja excluir o lead "{lead.nome}"? Esta ação
									removerá todo o histórico e não poderá ser desfeita.
								</AlertDialogDescription>
							</AlertDialogHeader>
							<AlertDialogFooter>
