...
export function TimeEntryModal({ onClose, onSave, entry }: TimeEntryModalProps) {
  ...
  const form = useForm<TimeEntryFormData>({
    ...
    defaultValues: {
      ...
      start_time: entry ? format(new Date(entry.start_time), "HH:mm") : format(new Date(), "HH:mm"),
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea placeholder="O que você fez?" {...field} rows={2} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                  <div className="space-y-0.5">
                    ...
                    <FormDescription>Este tempo pode ser cobrado do cliente?</FormDescription>
                  </div>
                  <FormControl>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="admin, reunião, projeto-x" {...field} />
                  </FormControl>
                  <FormDescription className="text-xs">
