...
import { Edit2, Trash2, Clock, DollarSign, Tag, MoreVertical } from "lucide-react";
                ...
                <TableRow key={entry.id}>
                  ...
                  <TableCell>
                    <div className="text-sm">
                      <div>
                        {format(new Date(entry.start_time), "dd/MMM", {
                          locale: ptBR,
                        })}
                      </div>
                  ...
                  <TableCell>
                    <div className="flex items-center gap-2">
                      {entry.is_billable && <DollarSign className="w-4 h-4 text-green-500" />}
                      <span className="text-sm">{entry.is_billable ? "Sim" : "Não"}</span>
                    </div>
                  </TableCell>
                  ...
                  <TableCell>
                    {entry.total_value ? (
                      <span className="font-mono text-sm">R$ {entry.total_value.toFixed(2)}</span>
                    ) : (
