...
export function GlobalTimer({ position = "bottom-right", minimized = false }: GlobalTimerProps) {
  const { user } = useAuth();
...
function MinimizedTimer({ isRunning, formattedTime, onExpand, _onStop }: MinimizedTimerProps) {
  return (
    <motion.div
    ...
    >
      ...
      <div className="p-4 space-y-4">
        ...
        <div className="text-center">
          <div className="font-mono text-4xl font-bold tracking-tight">{formattedTime}</div>
          {activeTimer && (
        ...
        {isEditing && activeTimer && (
          <div className="space-y-2">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <Switch id="billable" checked={isBillable} onCheckedChange={onBillableChange} />
              ...
              <Input
                ...
                value={hourlyRate || ""}
                onChange={(e) =>
                  onHourlyRateChange(e.target.value ? Number(e.target.value) : undefined)
                }
                className="w-24"
              />
            </div>
