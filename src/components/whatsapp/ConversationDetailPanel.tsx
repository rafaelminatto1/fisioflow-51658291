      ...
      <ScrollArea className="flex-1">
        <div className="p-5 space-y-6">
          <div className="flex flex-col items-center text-center">
            ...
            <h3 className="text-lg font-semibold">{conversation.contactName}</h3>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Badge className={`${STATUS_COLORS[conversation.status] || ""} font-semibold`}>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-2">
              <Button variant="outline" size="sm" className="text-xs h-9" onClick={onAssign}>
                <UserPlus className="h-3.5 w-3.5 mr-1.5" /> Atribuir
              </Button>
              <Button variant="outline" size="sm" className="text-xs h-9" onClick={onTransfer}>
                ...
                <DropdownMenuTrigger asChild>
                  ...
                  >
                    <span className="flex items-center">
                      <Zap className="h-3.5 w-3.5 mr-1.5 text-amber-500" /> Modelos
                    </span>
                  ...
                  activity.map((item) => (
                    <div key={item.id} className="flex gap-2 text-xs">
                      ...
                      <div>
                        ...
                        {item.by && <p className="text-muted-foreground text-[10px]">{item.by}</p>}
