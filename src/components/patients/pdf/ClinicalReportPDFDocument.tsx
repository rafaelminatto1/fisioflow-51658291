...
export const ClinicalReportPDFDocument: React.FC<Props> = ({
	reportText,
	reportInput,
}) => {
	...
	const finalPain =
		sessions.length > 0 ? sessions[sessions.length - 1].painLevel : undefined;
		...
		<Document>
			<Page size="A4" style={styles.page}>
				...
				<View style={styles.header} fixed>
					<View style={styles.headerTextContainer}>
						...
						<Text style={styles.subtitle}>
							Evolução Clínica Assistida por IA
						</Text>
					</View>
					<View>
				...
				<View style={styles.patientInfoBox}>
					...
					<View style={styles.patientInfoRow}>
						...
						<Text style={styles.patientInfoValue}>
							{patientInfo.condition || "Não informado"}
						</Text>
					</View>
					<View style={styles.patientInfoRow}>
					...
					{initialPain !== undefined && finalPain !== undefined && (
						<View style={styles.painChartContainer}>
							...
							<View style={styles.painBarWrapper}>
								<View
									style={[
										styles.painBarInitial,
										{ width: `${initialPain * 10}%` },
									]}
								/>
								<View
									style={[
										styles.painBarFinal,
										{
											...
											zIndex: 1,
											backgroundColor:
												finalPain <= initialPain ? "#22c55e" : "#ef4444",
										},
									]}
								/>
							</View>
					...
					{romMovements.length > 0 && (
						<View style={styles.romChartContainer}>
							<Text style={styles.romTitle}>
								Evolução de Amplitude de Movimento (ADM):
							</Text>
									...
									<View key={idx} style={styles.romItem}>
										...
										<View style={styles.romBarContainer}>
											...
											<View style={styles.romBarBackground}>
												<View
													style={[
														styles.romBarInitial,
														{ width: `${(initVal / maxVal) * 100}%` },
													]}
												/>
												<View
													style={[
														styles.romBarCurrent,
														{ width: `${(currVal / maxVal) * 100}%` },
													]}
												/>
											</View>
											<Text style={styles.romValueLabel}>
				...
				<Text style={styles.footer} fixed>
					Este relatório foi gerado com base nos registros clínicos do
					prontuário digital e assistido por Inteligência Artificial.
				</Text>
				<Text
