    ...
    <Document>
      <Page size="A4" style={styles.page}>
          ...
          {initialPain !== undefined && finalPain !== undefined && (
            <View style={styles.painChartContainer}>
              ...
              <View style={styles.painBarWrapper}>
                ...
                <View style={[styles.painBarFinal, { width: `${finalPain * 10}%`, zIndex: 1, backgroundColor: finalPain <= initialPain ? '#22c55e' : '#ef4444' }]} />
              </View>
                ...
                return (
                  <View key={idx} style={styles.romItem}>
                    <View style={styles.romLabelRow}>
                      ...
                      <Text style={[styles.romImprovement, { color: currVal >= initVal ? '#16a34a' : '#dc2626' }]}>
                        {currVal >= initVal ? '↑' : '↓'} {rom.improvement}%
                      </Text>
                    </View>
                    <View style={styles.romBarContainer}>
                      <Text style={styles.romValueLabel}>Inicial: {rom.initial.value}{rom.initial.unit}</Text>
                      <View style={styles.romBarBackground}>
                        <View style={[styles.romBarInitial, { width: `${(initVal / maxVal) * 100}%` }]} />
                        <View style={[styles.romBarCurrent, { width: `${(currVal / maxVal) * 100}%` }]} />
                      </View>
                      <Text style={styles.romValueLabel}>Atual: {rom.current.value}{rom.current.unit}</Text>
                    </View>
                  </View>
                );
              })}
        ...
        <Text style={styles.footer} fixed>
          Este relatório foi gerado com base nos registros clínicos do prontuário digital e assistido por Inteligência Artificial.
        </Text>
        <Text
