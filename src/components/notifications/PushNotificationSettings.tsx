			...
			case "granted":
				return (
					<Badge variant="default" className="bg-success">
						<CheckCircle className="h-3 w-3 mr-1" /> Permitido
					</Badge>
				);
			case "denied":
				return (
			...
			<Card>
				...
				<CardContent>
					<p className="text-sm text-muted-foreground">
						Para receber notificações push, use um navegador moderno como
				...
				{permission === "denied" && (
					<div className="p-4 bg-destructive/10 rounded-lg border border-destructive/20">
						<p className="text-sm text-destructive">
							As notificações estão bloqueadas. Para ativá-las, clique no ícone
							de cadeado na barra de endereço e altere as permissões de
							notificação.
						</p>
					</div>
				)}
