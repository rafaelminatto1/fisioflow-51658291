          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 rounded-xl p-4 space-y-2">
            <div className="flex items-center gap-4 text-sm">
              ...
              <span className="font-medium">
                {format(appointmentTime, "EEEE', dia 'de' MMMM 'às' HH:mm", {
                  locale: ptBR,
                })}
              </span>
            </div>
          ...
          <div className="text-center py-4">
            {minutesUntil > 5 ? (
              ...
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">A consulta já pode começar!</p>
              </div>
            ) : (
              <div className="space-y-2">
                ...
                <p className="text-sm text-muted-foreground">
                  O horário da consulta já passou. Entre em contato se ainda deseja realizar a
                  consulta.
                </p>
              </div>
            )}
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div className="text-sm">
                    ...
                    <p className="text-amber-600 dark:text-amber-400 text-xs mt-1">
                      Para participar da videochamada, permita o acesso à câmera e microfone do seu
                      navegador.
                    </p>
                  </div>
                </div>
