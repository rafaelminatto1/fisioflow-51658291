...
export function VideoCall({
  ...
  const { provider, isReady, error, canRecord, _supportsChat, supportsScreenShare } =
    useVideoIntegration(config);
    ...
    return (
      <Card className="p-8">
        <Alert variant="destructive">
          ...
          <AlertDescription>Erro ao inicializar vídeo: {error}</AlertDescription>
        </Alert>
      </Card>
    );
  }
      ...
      <Card className="relative overflow-hidden bg-black aspect-video">
        {!isConnected ? (
          <div className="absolute inset-0 flex flex-col items-center justify-center text-white">
            ...
            <Button onClick={joinCall} className="mt-6 bg-green-600 hover:bg-green-700" size="lg">
...
function WherebyEmbed({
  ...
  useEffect(() => {
    if (
      ...
      ).WherebyEmbed(containerRef.current, {
        roomUrl,
...
export function VideoIntegrationSettings({
  ...
  const providers: {
  ...
  }[] = [
    {
      value: "builtin",
      label: "Nativo",
      description: "Usar WebRTC nativo do navegador",
    },
    {
      value: "whereby",
      label: "Whereby",
      description: "Integração com Whereby Embed",
    },
    {
      value: "twilio",
      label: "Twilio Video",
      description: "Integração com Twilio Programmable Video",
    },
    {
      value: "agora",
      label: "Agora.io",
      description: "Integração com Agora Video SDK",
    },
    {
      value: "daily",
      label: "Daily.co",
      description: "Integração com Daily video APIs",
    },
  ];
