...
import { Calendar, TrendingUp, DollarSign, Users, Target, CheckCircle2 } from 'lucide-react';
        ...
        >
          <CardContent className="p-0">
            <div className={cn("p-6 bg-gradient-to-br", stat.gradient)}>
              <div className="flex items-center justify-between mb-4">
                <div className={cn("p-2.5 rounded-2xl bg-white dark:bg-slate-900 shadow-sm group-hover:scale-110 transition-transform duration-300", stat.iconColor)}>
