  ...
  const handleTemplateSelect = (templateId: string) => {
    ...
    if (template) {
      ...
      if (template.checklist_padrao && template.checklist_padrao.length > 0) {
        console.log("Checklist padrão do template detectado:", template.checklist_padrao);
      }
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="md:col-span-2 space-y-2">
                    ...
                    <Input id="nome" {...register("nome")} placeholder="Ex: Corrida de Rua 5K" />
                    {errors.nome && (
                  ...
                  <div className="space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        setValue(
                          "categoria",
                          value as "corrida" | "corporativo" | "ativacao" | "workshop" | "outro",
                        )
                      }
                    >
                      <SelectTrigger>
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="local" {...register("local")} placeholder="Ex: Parque Ibirapuera" />
                    {errors.local && (
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    ...
                    <Popover open={isCalendarInicioOpen} onOpenChange={setIsCalendarInicioOpen}>
                      <PopoverTrigger asChild>
                        ...
                        >
                          ...
                          {watchedDataInicio
                            ? format(watchedDataInicio, "dd/MM/yyyy", {
                                locale: ptBR,
                              })
                            : "Selecione uma data"}
                        </Button>
                    ...
                    {errors.data_inicio && (
                      <p className="text-sm text-destructive">
                        {String(errors.data_inicio.message)}
                      </p>
                    )}
                  </div>
                    ...
                    <Popover open={isCalendarFimOpen} onOpenChange={setIsCalendarFimOpen}>
                      <PopoverTrigger asChild>
                        ...
                        >
                          <CalendarIcon className="mr-2 h-4 w-4" />
                          {watchedDataFim
                            ? format(watchedDataFim, "dd/MM/yyyy", {
                                locale: ptBR,
                              })
                            : "Selecione uma data"}
                        </Button>
