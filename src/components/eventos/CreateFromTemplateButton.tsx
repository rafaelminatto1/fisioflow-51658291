...
export const CreateFromTemplateButton: React.FC<
		...
		<Dialog open={open} onOpenChange={setOpen}>
			...
			<DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
				<DialogHeader>
					...
					<DialogDescription>
						Selecione um template e preencha as informações específicas do novo
						evento
					</DialogDescription>
				</DialogHeader>
												...
												{template.checklist_padrao &&
													...
													template.checklist_padrao.length > 0 && (
														<Badge variant="outline" className="text-xs">
															{template.checklist_padrao.length} itens no
															checklist
														</Badge>
													)}
											</div>
