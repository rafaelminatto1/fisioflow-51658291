...
export function ContratadosTab({ eventoId, evento }: ContratadosTabProps) {
  ...
  const contratadosMap = useMemo(() => new Map(contratados.map((c) => [c.id, c])), [contratados]);
            ...
            <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
              ...
              <div className="flex justify-end gap-2 mt-6">
                ...
                <Button
                  ...
                  disabled={createEventoContratado.isPending || createContratado.isPending}
                >
                  {createEventoContratado.isPending || createContratado.isPending
                    ? "Salvando..."
                    : "Salvar"}
                </Button>
              </div>
                  ...
                  <TableRow key={item.id}>
                    ...
                    <TableCell>
                      <Badge
                        ...
                        onClick={() =>
                          canWrite("eventos") && handleTogglePagamento(item.id, item.contratado_id)
                        }
                      >
          ...
          <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="flex justify-between gap-2 mt-6">
              ...
              <div className="flex gap-2 ml-auto">
                ...
                <Button
                  onClick={handleEdit}
                  disabled={updateEventoContratado.isPending || updateContratado.isPending}
                >
                  {updateEventoContratado.isPending || updateContratado.isPending
                    ? "Salvando..."
                    : "Salvar"}
                </Button>
              </div>
