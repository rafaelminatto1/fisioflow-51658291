...
export function NPSSurveyForm({
	...
	const [facilityCleanliness] = useState<number | null>(null);
	const [schedulingEase] = useState<number | null>(null);
			...
			<CardContent>
				<form onSubmit={handleSubmit} className="space-y-6">
					...
					<div className="space-y-3">
						...
						{npsScore !== null && (
							<p className="text-sm text-muted-foreground">
								{npsScore <= 6 &&
									"Detrator - Obrigado pelo feedback, vamos melhorar!"}
								{npsScore >= 7 &&
									npsScore <= 8 &&
					...
					<Button
						type="submit"
						className="w-full"
						disabled={npsScore === null || createSurvey.isPending}
					>
