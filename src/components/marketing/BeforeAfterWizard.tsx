...
export function BeforeAfterWizard({
	...
	const handleImageUpload = useCallback(
		async (
			...
			toast.success(
				`Imagem "${type === "before" ? "Antes" : "Depois"}" carregada`,
			);
		},
		[],
	);
			...
			<CardContent className="space-y-6">
							...
							<div className="space-y-3">
								...
								<div className="space-y-2">
									...
									<Slider
										...
										onValueChange={([v]) =>
											setGridConfig({ ...gridConfig, size: v })
										}
										min={20}
										max={100}
										step={5}
				...
				<div className="p-3 bg-amber-50 border border-amber-200 rounded-lg text-sm text-amber-800 dark:bg-amber-950 dark:border-amber-900 dark:text-amber-200">
					...
					<p>
						...
						para Uso de Imagem. Use a opção de desfocar rostos para maior
						privacidade.
					</p>
				</div>
			</CardContent>
