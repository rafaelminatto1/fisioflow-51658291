...
import { Upload, Image as ImageIcon, Download, Sparkles, Grid3x3, X, Layers } from "lucide-react";
  ...
  const renderCanvas = useCallback(() => {
    ...
    imgBefore.onload = () => {
      imgAfter.onload = () => {
        ...
        ctx.fillText(`Autorizado: ${patientName}`, padding, maxHeight - padding - 15);
      };
    ...
    <Card>
      ...
      <CardContent className="space-y-6">
            ...
            >
              {images.before ? (
                ...
                <>
                  ...
                  <p className="text-sm text-muted-foreground mb-2">Foto inicial do tratamento</p>
                  <label>
                    <input
                      type="file"
                      accept="image/*"
          ...
          <div className="space-y-2">
            ...
            >
              {images.after ? (
                ...
                <>
                  <ImageIcon className="h-12 w-12 mx-auto mb-3 text-muted-foreground" />
                  <p className="text-sm text-muted-foreground mb-2">Foto após o tratamento</p>
                  <label>
                    <input
                      type="file"
                      accept="image/*"
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => setGridConfig({ ...gridConfig, show: checked })}
                  />
                </div>
        ...
        <div className="p-3 bg-amber-50 border border-amber-200 rounded-lg text-sm text-amber-800 dark:bg-amber-950 dark:border-amber-900 dark:text-amber-200">
          ...
          <p>
            Certifique-se de que o paciente assinou o Termo de Consentimento para Uso de Imagem. Use
            a opção de desfocar rostos para maior privacidade.
          </p>
        </div>
      </CardContent>
    </Card>
