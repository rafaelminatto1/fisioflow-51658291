...
export function LocalSEOTracker() {
	...
	const loadMockData = () => {
		...
		setRankings([
			...
			{
				keyword: "fisioterapia dor nas costas",
				rank: 2,
				previousRank: 4,
				change: 2,
				volume: 320,
			...
			{
				keyword: "fisioterapia ortopédica",
				rank: 6,
				previousRank: 5,
				change: -1,
				volume: 280,
			...
			{
				keyword: "fisioterapia pós cirúrgica",
				rank: 1,
				previousRank: 3,
				change: 2,
				volume: 190,
		...
		<div className="space-y-6">
			...
			<Card>
				<CardHeader>
					...
					<CardDescription>
						Posições nas buscas locais do Google
					</CardDescription>
				</CardHeader>
				<CardContent>
					...
					{rankings.length === 0 && (
						<div className="text-center py-8 text-muted-foreground">
							...
							<p className="text-sm">
								Adicione palavras-chave acima para começar
							</p>
						</div>
					)}
				</CardContent>
					...
					<div className="flex items-start gap-3">
						...
						<div className="text-sm">
							...
							<ul className="space-y-1 text-emerald-800 dark:text-emerald-200">
								<li>
									• Mantenha seu perfil do Google Business sempre atualizado
								</li>
								<li>• Responda a todas as avaliações, positivas e negativas</li>
								<li>• Adicione fotos regularmente do seu estabelecimento</li>
								<li>
									• Consista o NAP (Nome, Endereço, Phone) em todos os
									diretórios
								</li>
								<li>
									• Peça que clientes satisfeitos deixem reviews no Google
								</li>
