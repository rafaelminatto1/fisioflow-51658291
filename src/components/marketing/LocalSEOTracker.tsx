...
export function LocalSEOTracker() {
  ...
  const getRankBadge = (rank: number) => {
    ...
    if (rank <= 3)
      return <Badge className="bg-emerald-100 text-emerald-700 border-emerald-200">Top 3</Badge>;
    if (rank <= 10)
      return <Badge className="bg-blue-100 text-blue-700 border-blue-200">Top 10</Badge>;
              ...
              <tbody>
                {rankings.map((item, index) => (
                  <tr key={index} className="border-t">
                    ...
                    <td className="p-3 text-center">{getRankBadge(item.rank)}</td>
