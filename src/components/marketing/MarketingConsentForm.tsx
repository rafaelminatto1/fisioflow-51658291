...
export function MarketingConsentForm({
  ...
  const previouslyHadConsent =
    ...
    (consentDetails.social_media || consentDetails.educational_material || consentDetails.website);
      ...
      <CardContent className="space-y-6">
        ...
        <Alert className="border-blue-200 bg-blue-50 dark:border-blue-900 dark:bg-blue-950">
          ...
          <AlertDescription className="text-blue-800 dark:text-blue-200 text-sm">
            O paciente tem o direito de revogar este consentimento a qualquer momento. A revogação
            não afeta o uso autorizado anteriormente, mas impedirá novas utilizações de sua imagem e
            dados.
          </AlertDescription>
        </Alert>
        ...
        {!socialMedia && (
          <Alert className="border-amber-200 bg-amber-50 dark:border-amber-900 dark:bg-amber-950">
            ...
            <AlertDescription className="text-amber-800 dark:text-amber-200 text-sm">
              Sem consentimento para redes sociais, o sistema não permitirá exportar conteúdo com
              imagem identificável do paciente, mesmo com anonimização.
            </AlertDescription>
          </Alert>
        )}
        ...
        <div className="flex items-center justify-between pt-4 border-t">
          ...
          <div className="flex gap-2 ml-auto">
            ...
            <Button onClick={handleSave} disabled={!hasAnyConsent || isSettingConsent}>
              {isSettingConsent
                ? "Salvando..."
                : previouslyHadConsent
                  ? "Atualizar"
      ...
      <Dialog open={showRevokeDialog} onOpenChange={setShowRevokeDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Esta ação não pode ser desfeita. O paciente {patientName} terá todos os consentimentos
              de marketing revogados. Isso impedirá novas utilizações de sua imagem e dados em
          ...
          <DialogFooter>
            ...
            <Button variant="destructive" onClick={handleRevoke} disabled={isRevokingConsent}>
