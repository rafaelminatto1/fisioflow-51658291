	...
	const handleAIGenerate = async () => {
		...
		try {
			...
			if (
				...
				selectedTemplate?.category === "recall"
			)
				type = "recall";
			else if (
				selectedCategory === "aniversario" ||
				selectedTemplate?.category === "aniversario"
			)
				type = "birthday";
			else if (
			...
			<div className="grid gap-6 lg:grid-cols-2">
				...
				<Card>
					<CardHeader>
						...
						<CardDescription>
							Clique para selecionar e personalizar
						</CardDescription>
					</CardHeader>
					<CardContent>
				...
				<Card>
					<CardHeader>
						...
						<CardDescription>
							Personalize as variáveis e visualize o resultado
						</CardDescription>
					</CardHeader>
					...
					<div className="flex items-start gap-3">
						...
						<div className="text-sm">
							...
							<ul className="space-y-1 text-green-800 dark:text-green-200">
								<li>
									• Use textos curtos e diretos - WhatsApp é sobre rapidez
								</li>
								<li>• Emojis ajudam a dar tom humano e amigável</li>
								<li>
									• Use negrito entre asteriscos para destacar informações
									importantes
								</li>
								<li>
									• Sempre inclua call-to-action claro (responda, confirme,
									etc.)
								</li>
								<li>
									• Respeite o horário comercial (9h às 18h) para mensagens
								</li>
							</ul>
						</div>
					</div>
