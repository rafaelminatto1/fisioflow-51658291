...
import { CheckCircle, XCircle, UserPlus, Search, Eye } from "lucide-react";
...
export const PreCadastroList = ({
	precadastros,
	isLoading,
	onUpdateStatus,
}: PreCadastroListProps) => {
	const [search, setSearch] = useState("");
	const [statusFilter, setStatusFilter] = useState("todos");
	const [selectedPreCadastro, setSelectedPreCadastro] =
		useState<PreCadastro | null>(null);

	const filteredPrecadastros =
	...
	return (
		<Card>
			<CardHeader>
				<div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
					<div>
						...
						<CardDescription>
							Gerencie os pré-cadastros de novos pacientes
						</CardDescription>
					</div>
			...
			<Dialog
				open={!!selectedPreCadastro}
				onOpenChange={(open) => !open && setSelectedPreCadastro(null)}
			>
						...
						<div className="space-y-4">
							<div className="grid grid-cols-2 gap-4">
								...
								<div>
									...
									<p>
										{format(
											new Date(selectedPreCadastro.created_at),
											"dd/MM/yyyy HH:mm",
											{ locale: ptBR },
										)}
									</p>
							...
							<div className="flex justify-end gap-2 pt-4">
								<Button
									variant="outline"
									onClick={() => setSelectedPreCadastro(null)}
								>
									Fechar
								</Button>
