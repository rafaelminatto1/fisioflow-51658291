    ...
    <Card>
            ...
            <DialogContent className="max-w-2xl max-h-[85vh] overflow-y-auto">
              ...
              <div className="space-y-6 py-4">
                ...
                <div className="space-y-4 border-t pt-6">
                  <div className="flex items-center gap-2">
                    <Settings2 className="h-4 w-4" />
                    <Label className="text-base font-medium">Personalização Visual (Premium)</Label>
                  </div>
      ...
      <CardContent>
        {isLoading ? (
          ...
          <div className="text-center py-8 text-muted-foreground">Nenhum link criado ainda</div>
        ) : (
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Dialog
                    ...
                    onOpenChange={(open) => setQrCodeOpen(open ? t.token : null)}
                  >
                    <DialogTrigger asChild>
                    ...
                    <DialogContent className="sm:max-w-sm flex flex-col items-center justify-center py-6">
                      ...
                      <Button
                        className="mt-4"
                        variant="secondary"
                        onClick={() => window.open(getFullLink(t.token), "_blank")}
                      >
                        Abrir Link
                      </Button>
                    </DialogContent>
