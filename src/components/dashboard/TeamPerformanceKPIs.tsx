...
function TherapistRow({ t, rank }: { t: TherapistKPI; rank: number }) {
  ...
  return (
    <div className="grid grid-cols-12 items-center gap-3 px-4 py-3 rounded-xl border border-border/40 bg-card hover:bg-muted/20 transition-colors">
      <span className="col-span-1 text-lg font-black text-muted-foreground/40 w-5 text-center">{rank}</span>
      ...
      <div className="col-span-2 text-center text-emerald-600 dark:text-emerald-500">
...
export function TeamPerformanceKPIs() {
  ...
  return (
    <Card className="border border-border/50 shadow-sm bg-card">
      ...
      <CardContent className="space-y-2">
        {/* Column headers */}
        <div className="grid grid-cols-12 items-center gap-3 px-4 pb-1">
          <span className="col-span-1 w-5" />
          <span className="col-span-3 text-[10px] font-black uppercase tracking-wider text-muted-foreground">
            Profissional
          </span>
          <span className="col-span-2 text-[10px] font-black uppercase tracking-wider text-muted-foreground text-center">
            Sessões
          </span>
          <span className="col-span-2 text-[10px] font-black uppercase tracking-wider text-muted-foreground text-center">
            Ocupação
