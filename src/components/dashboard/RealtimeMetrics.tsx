...
export const RealtimeMetrics = memo(function RealtimeMetrics() {
  ...
  const formattedRevenue = useMemo(
    () =>
      metrics.todayRevenue.toLocaleString("pt-BR", {
  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold text-green-600">{metrics.confirmedAppointments}</div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold text-red-600">{metrics.cancelledAppointments}</div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold text-blue-600">{metrics.patientsInSession}</div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold text-green-600">R$ {formattedRevenue}</div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold text-orange-600">{occupancyRateFormatted}%</div>
          <CardDescription>
      ...
      <Card>
        ...
        <CardContent>
          ...
          <CardDescription>
            {isSubscribed ? "Dados em tempo real" : "Aguardando conexão"}
          </CardDescription>
        </CardContent>
      </Card>
    </div>
