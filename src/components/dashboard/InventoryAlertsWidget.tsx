      ...
      <CardContent className="px-2">
        <div className="space-y-1">
          {lowStockItems.map((item) => (
            <div
              key={item.id}
              className="flex items-center justify-between p-3 rounded-2xl bg-white/50 dark:bg-slate-900/50"
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-amber-700 font-medium uppercase tracking-tighter">
                    Estoque Crítico: {item.current_stock} {item.unit}
                  </p>
                </div>
              </div>
