...
function NotificationItem({
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <p
          className={cn(
            ...
            n.is_read ? "text-slate-500 dark:text-slate-400" : "text-slate-900 dark:text-white",
          )}
        >
          {n.title}
        </p>
      ...
      {!n.is_read && <div className="flex-shrink-0 w-2 h-2 bg-primary rounded-full mt-1.5" />}
    </div>
  );
}
