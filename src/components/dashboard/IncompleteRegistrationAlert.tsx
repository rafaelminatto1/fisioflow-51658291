...
export const IncompleteRegistrationAlert: React.FC = () => {
  ...
  const visiblePatients = incompletePatients.filter((p) => !dismissedIds.includes(p.id));
    ...
    >
      <Card
        className={cn(
          ...
          isExpanded
            ? "shadow-md ring-1 ring-amber-200 dark:ring-amber-800"
            : "shadow-sm hover:shadow-md cursor-pointer hover:bg-amber-100/40 dark:hover:bg-amber-900/10",
        )}
        ...
        <CardContent className="p-0">
          ...
          <div
            className={cn(
              ...
              isExpanded
                ? "border-b border-amber-100 dark:border-amber-800/30 bg-amber-50/80 dark:bg-amber-950/30"
                : "",
            )}
          >
                        ...
                        <div className="flex items-start justify-between gap-2">
                          <div className="flex items-center gap-2 min-w-0">
                            ...
                            <span
                              ...
                              title={PatientHelpers.getName(patient)}
                            >
