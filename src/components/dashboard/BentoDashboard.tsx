...
import { AreaChart, Area, CartesianGrid, Tooltip, XAxis } from "recharts";
          ...
          <CardContent className="p-6 relative z-10">
            <p
              className={cn(
                ...
                (metrics?.pendingEvolutions || 0) > 0 ? "text-white/80" : "text-muted-foreground",
              )}
            >
              Evoluções Pendentes
            </p>
          ...
          <CardContent className="p-6 relative z-10">
            ...
            <div className="flex items-center gap-2 mt-4">
              ...
              <span className="text-[9px] font-black text-muted-foreground uppercase">
                Meta: R$ {metrics?.financialToday.projected.toLocaleString("pt-BR")}
              </span>
            </div>
          </CardContent>
        </Card>
                  ...
                  >
                    <div className="flex items-center gap-6">
                      ...
                      <div>
                        ...
                        <Badge
                          variant="outline"
                          className="text-[8px] font-black uppercase border-slate-100 px-3 mt-1"
                        >
                          RPG / Pilates
                        </Badge>
                      </div>
