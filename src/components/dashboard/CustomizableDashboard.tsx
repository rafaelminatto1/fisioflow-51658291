    ...
    switch (type) {
      case 'appointments-today':
        return {
          ...
          description: isLoading ? 'Carregando...' : `${safeSummary.appointmentGrowth}% vs. mes anterior`,
        };
      case 'revenue-month':
        return {
          value: isLoading ? '...' : `R$ ${safeSummary.monthlyRevenue.toFixed(2).replace('.', ',')}`,
          description: isLoading ? 'Carregando...' : `${safeSummary.revenueGrowth}% vs. mes anterior`,
        };
      case 'patients-active':
        return {
          value: isLoading ? '...' : safeSummary.activePatients,
          description: isLoading ? 'Carregando...' : `${safeSummary.patientGrowth}% vs. mes anterior`,
        };
      case 'ocupancy-rate':
        return {
              ...
              return (
                ...
                >
                  ...
                  <CardContent className="pt-0">
                    ...
                    <p className="mt-2 text-xs leading-5 text-muted-foreground">{data.description}</p>
                  </CardContent>
                </Card>
              );
            })}
