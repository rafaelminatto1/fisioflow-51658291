...
export function CustomizableDashboard() {
	const { widgets, toggleWidget, updateWidgetSize, resetToDefault } =
		useDashboardWidgets();
						...
						<Dialog open={customizeOpen} onOpenChange={setCustomizeOpen}>
							...
							<DialogContent className="max-h-[85vh] max-w-[95vw] overflow-y-auto md:max-w-2xl">
								<DialogHeader>
									...
									<DialogDescription>
										Escolha os widgets visiveis e defina o peso visual de cada
										um.
									</DialogDescription>
								</DialogHeader>
					...
					<Card className="rounded-[1.75rem] border-dashed border-border/70 bg-background/60 p-10 shadow-none">
						<div className="space-y-3 text-center">
							...
							<p className="text-sm text-muted-foreground">
								Abra a personalizacao para adicionar os widgets mais relevantes
								ao seu dashboard.
							</p>
						</div>
					</Card>
