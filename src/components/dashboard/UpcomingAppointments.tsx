			...
			<CardContent className="space-y-3">
				{upcomingAppointments.length === 0 ? (
					...
					upcomingAppointments.map((appointment) => (
						<div
							key={appointment.id}
							className="flex items-center justify-between p-3 bg-gradient-card rounded-lg border border-border hover:shadow-card transition-all"
						>
							<div className="flex items-center gap-3">
								...
								<div>
									<p className="font-medium text-foreground">
										{AppointmentHelpers.getPatientName(appointment)}
									</p>
							...
							<Button
								variant="ghost"
								size="icon"
								aria-label={`Ligar para ${AppointmentHelpers.getPatientName(appointment)}`}
							>
