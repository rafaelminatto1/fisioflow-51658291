...
export function TherapistDashboard({
  ...
  const dashboardStats = useMemo(() => {
    ...
    const periodLabel =
      period === "semana" ? "Esta Semana" : period === "mes" ? "Mês Atual" : "Hoje";
    ...
    const avgSessionsPerPatient =
      myPatients > 0 ? parseFloat((recentAptsCount / myPatients).toFixed(1)) : 0;
            ...
            {isLoading ? (
              ...
              <div className="flex flex-col items-center justify-center py-12 text-center">
                ...
                <p className="mt-1 text-xs text-muted-foreground">
                  A agenda será atualizada assim que novos atendimentos entrarem.
                </p>
              </div>
            ) : (
              <div className="space-y-3">
