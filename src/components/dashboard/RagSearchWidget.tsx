					...
					<AnimatePresence mode="wait">
						{loading ? (
							...
							>
								...
								<p className="text-[10px] font-black uppercase tracking-widest animate-pulse">Consultando I.A. Clínica...</p>
							</motion.div>
						) : result ? (
							<motion.div
								key="result"
				...
				{result && !loading && (
					<div className="flex gap-2 mt-auto">
						...
						<Button 
							...
							onClick={() => navigate("/smart-ai", { state: { initialQuery: query, initialResult: result, initialSources: sources } })}
						>
