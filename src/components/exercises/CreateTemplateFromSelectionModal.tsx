...
export function CreateTemplateFromSelectionModal({
	...
	const [category, setCategory] = useState<"patologia" | "pos_operatorio">(
		"patologia",
	);
				...
				<form onSubmit={handleSubmit} className="space-y-4">
					...
					<div className="space-y-2">
						...
						<Select
							value={category}
							onValueChange={(v) =>
								setCategory(v as "patologia" | "pos_operatorio")
							}
						>
							<SelectTrigger>
					...
					<div className="pt-2 text-sm text-muted-foreground">
						{selectedExerciseIds.length} exercícios selecionados serão
						adicionados.
					</div>
