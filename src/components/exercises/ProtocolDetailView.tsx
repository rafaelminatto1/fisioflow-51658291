      ...
      >
        ...
        <div className="relative h-48 sm:h-56 bg-gradient-to-br from-[#13ecc8]/20 via-[#0f172a] to-[#0f172a] p-6 sm:p-8 flex flex-col justify-end border-b border-white/5">
          ...
          <div className="space-y-3">
            <div className="flex flex-wrap items-center gap-2">
              ...
              <Badge variant="outline" className="border-white/20 text-white/70 backdrop-blur-md">
            ...
            <div className="relative p-6 rounded-2xl bg-white/5 border border-white/10 overflow-hidden">
                  ...
                  {[0, 25, 50, 75, 100].map((percent) => (
                    <div key={percent} className="flex flex-col items-center">
                      <div className={cn(
                        ...
                        percent <= 50 ? "bg-black border-[#13ecc8] shadow-[0_0_10px_rgba(19,236,200,0.5)]" : "bg-black border-white/20"
                      )}>
                        <div className={cn(
                      ...
                      <span className="text-[10px] text-white/40 mt-2 font-bold uppercase tracking-tighter">
                        Semana {Math.round((percent / 100) * (protocol.weeks_total || 12))}
                      </span>
                    </div>
                  ))}
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="flex items-center gap-3 p-3 rounded-xl bg-white/[0.03] border border-white/5">
                  ...
                  <div>
                    <p className="text-[10px] text-white/40 font-bold uppercase">Status Atual</p>
                    <p className="text-sm font-medium text-white">Início do Protocolo</p>
                  </div>
                </div>
                <div className="flex items-center gap-3 p-3 rounded-xl bg-white/[0.03] border border-white/5">
                  ...
                  <div>
                    <p className="text-[10px] text-white/40 font-bold uppercase">Objetivo Final</p>
                    <p className="text-sm font-medium text-white">Retorno Total às Atividades</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <motion.div variants={itemVariants} className="space-y-3">
                <h3 className="text-sm font-bold uppercase tracking-widest text-[#13ecc8]">Visão Geral</h3>
                <p className="text-white/70 leading-relaxed">
                  {(protocol as any).description || "Este protocolo estabelece diretrizes para a progressão segura baseada em marcos de recuperação, respeitando a biologia da cicatrização e buscando o retorno funcional otimizado."}
                </p>
              </motion.div>
                      ...
                      >
                        ...
                        <div className="space-y-1">
                          <h4 className="font-bold text-white group-hover:text-[#13ecc8] transition-colors flex items-center gap-2">
                            Semana {m.week} <ChevronRight className="w-4 h-4 text-white/20" />
                          </h4>
            ...
            <div className="space-y-8">
                ...
                <div className="space-y-3">
                  {restrictions.length === 0 ? (
                    <div className="p-4 bg-green-500/5 border border-green-500/10 rounded-xl text-green-500/70 text-xs flex items-center gap-2 font-medium">
                      <CheckCircle2 className="w-4 h-4" /> Nenhuma restrição severa listada.
                    </div>
                  ) : (
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <span className="text-[10px] font-black uppercase text-red-400 bg-red-400/10 px-2 py-0.5 rounded">
                            Semanas {r.week_start} {r.week_end ? `- ${r.week_end}` : ''}
                          </span>
              ...
              {/* Extra Info / Notes */}
              <motion.div variants={itemVariants} className="p-5 rounded-2xl bg-blue-500/5 border border-blue-500/10 space-y-3">
              ...
              {/* References */}
              <motion.div variants={itemVariants} className="space-y-3">
                <h3 className="text-sm font-bold uppercase tracking-widest text-[#13ecc8]">Base de Evidência</h3>
        ...
        <div className="p-6 border-t border-white/10 bg-white/5 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs text-white/40 font-bold uppercase">Protocolo Adaptável</p>
              <p className="text-sm text-white font-medium">FisioFlow Intelligence</p>
            </div>
          </div>
