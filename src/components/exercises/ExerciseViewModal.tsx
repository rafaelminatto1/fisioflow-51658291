...
const difficultyColors: Record<string, string> = {
	Fácil:
		"bg-emerald-500/10 text-emerald-600 border-emerald-500/20 ring-emerald-500/20",
	Iniciante:
		"bg-emerald-500/10 text-emerald-600 border-emerald-500/20 ring-emerald-500/20",
	Médio: "bg-amber-500/10 text-amber-600 border-amber-500/20 ring-amber-500/20",
	Intermediário:
		"bg-amber-500/10 text-amber-600 border-amber-500/20 ring-amber-500/20",
...
export function ExerciseViewModal({
	...
	return (
		<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogContent
				className="fixed left-[50%] top-[50%] z-50 !-translate-x-1/2 !-translate-y-1/2w-[90vw] md:w-[80vw] lg:w-[75vw] max-w-5xl max-h-[85vh] p-0 gap-0 overflow-hidden flex flex-col bg-background/95 backdrop-blur-xl border-border/50 shadow-2xl rounded-lg"
