...
import { PoseLandmark, MainJoint, getAngleTriad } from "@/types/pose";
...
export const PoseFeedbackOverlay: React.FC<PoseFeedbackOverlayProps> = ({
  ...
  }, [landmarks, jointAngles, showSkeleton, showConnections, showAngles, width, height]);
  ...
  return (
    <Card className="overflow-hidden bg-transparent border-0 shadow-none">
      <canvas
        ...
        width={width}
        height={height}
        className={cn("w-full h-full object-contain", opacity)}
        style={{
          width,
          height,
        }}
...
export const PoseFeedbackOverlaySimple: React.FC<PoseFeedbackOverlayProps> = (props) => {
  return (
    <PoseFeedbackOverlay {...props} simpleMode={true} showAngles={false} showConnections={true} />
  );
};
