...
export const ExerciseVideoUpload: React.FC<ExerciseMediaUploadProps> = ({
  ...
  const isFormValid = () => {
    return title.trim().length >= 3 && category !== "" && difficulty !== "" && mediaFile !== null;
  };
              ...
              <div className="flex flex-wrap gap-2">
                {BODY_PARTS.map((part) => (
                  ...
                  >
                    ...
                    {selectedBodyParts.includes(part) && <Check className="h-3 w-3 ml-1" />}
                  </Badge>
                ))}
              </div>
            </div>
              ...
              <div className="flex flex-wrap gap-2">
                {EQUIPMENT_OPTIONS.map((eq) => (
                  ...
                  >
                    ...
                    {selectedEquipment.includes(eq) && <Check className="h-3 w-3 ml-1" />}
                  </Badge>
                ))}
              </div>
            </div>
