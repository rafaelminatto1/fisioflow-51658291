  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-2 mb-1.5">
        <h4
          className="font-bold text-sm leading-tight flex-1 text-foreground"
        ...
        {template.templateType === "system" ? (
          <Badge
            variant="secondary"
            className="shrink-0 text-[10px] uppercase font-black bg-blue-100 text-blue-700 hover:bg-blue-100 border-none"
          >
            Sistema
          </Badge>
        ) : (
          <Badge
            variant="outline"
            className="shrink-0 text-[10px] uppercase font-black text-green-700 border-green-200 bg-green-50"
          >
            Personalizado
          </Badge>
        )}
      ...
      {template.conditionName && (
        <p
          className="text-xs text-muted-foreground mb-3 font-medium line-clamp-1"
