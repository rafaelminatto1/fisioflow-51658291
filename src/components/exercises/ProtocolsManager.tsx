        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-1">
            ...
            <p className="text-muted-foreground text-base max-w-lg leading-relaxed">
              Diretrizes clínicas de reabilitação e progressão funcional baseadas em evidência para
        ...
        {loading ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {[1, 2, 3, 4, 5, 6, 7, 8].map((i) => (
              <div
                key={i}
                className="bg-white p-6 rounded-2xl border border-border shadow-sm h-48 space-y-4"
              >
          ...
          >
            ...
            <h3 className="text-xl font-bold text-foreground mb-2">Nenhum protocolo encontrado</h3>
        ...
        <AlertDialogContent className="bg-white border-border rounded-3xl overflow-hidden max-w-md">
          <AlertDialogHeader>
            ...
            <AlertDialogDescription className="text-muted-foreground text-sm">
              Você está prestes a remover permanentemente o protocolo de reabilitação. Esta ação é
              irreversível.
            </AlertDialogDescription>
          </AlertDialogHeader>
