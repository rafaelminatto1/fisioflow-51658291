				...
				<div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
					<div className="space-y-2">
						...
						<p className="text-white/50 text-lg max-w-lg leading-relaxed">
							Diretrizes inteligentes de reabilitação e progressão funcional
					...
					<div className="glass-card p-6 rounded-2xl border-white/10">
						...
						<div className="space-y-6">
							...
							<div className="space-y-3">
								<Label className="text-white/50 text-xs font-bold uppercase ml-1">
							...
							<div className="pt-4 border-t border-white/5">
								...
								<div className="p-4 rounded-xl bg-[#13ecc8]/5 border border-[#13ecc8]/10 flex items-center gap-3">
									...
									<p className="text-[10px] text-white/50 leading-tight">
										Novos marcos podem ser adicionados em tempo real durante a
										sessão.
									</p>
								</div>
							</div>
					...
					{loading ? (
						<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
							{[1, 2, 3, 4].map((i) => (
								<div
									key={i}
									className="glass-card p-6 rounded-2xl border-white/10 h-48"
								>
														...
														>
															<div className="space-y-3 mb-6 relative z-10">
																...
																<div className="flex flex-wrap gap-2">
																	<Badge
																		variant="outline"
																		className="bg-white/5 border-white/10 text-[10px] text-white/50 px-2 py-0"
																	>
																	...
																	{Array.isArray(protocol.milestones) &&
																		protocol.milestones.length > 0 && (
																			<Badge
																				variant="outline"
																				className="bg-[#13ecc8]/5 border-[#13ecc8]/20 text-[10px] text-[#13ecc8]/70 px-2 py-0"
																			>
