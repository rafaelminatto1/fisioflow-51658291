...
export const ExerciseCoachAI: React.FC<ExerciseCoachAIProps> = ({
	sessionData,
}) => {
			...
			<CardContent className="space-y-4">
				{!feedback && !loading ? (
					<Button
						...
						className="w-full rounded-xl font-bold bg-primary text-primary-foreground shadow-sm"
					>
					...
					<div className="flex flex-col items-center py-4 space-y-2">
						...
						<p className="text-xs text-muted-foreground">
							O Gemini está analisando sua biomecânica...
						</p>
					</div>
				) : (
					<motion.div
