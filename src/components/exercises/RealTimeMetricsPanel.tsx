 ...
 */
const ScoreGauge: React.FC<{ value: number; size?: number }> = ({
	value,
	size = 120,
}) => {
...
export const RealTimeMetricsPanel: React.FC<RealTimeMetricsPanelProps> = ({
	...
	const { formScore, stabilityScore, rangeOfMotion, romPercentage, avgFps } =
		metrics;
	...
	if (compact) {
		return (
			<div className="flex gap-3">
				{/* Score */}
				<div
					className={cn("flex items-center gap-2 p-2 rounded-lg", scoreColor)}
				>
