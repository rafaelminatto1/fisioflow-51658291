...
export function ExerciseFiltersPanel({
	...
	const equipmentOptions = React.useMemo(() => {
		const baseOptions = filters.homeOnly
			...
			: EQUIPMENT.filter((e) => !HOME_EQUIPMENT_GROUP.includes(e.value)) // Exclude individual items
		...
		<div className="space-y-3">
			...
			<div className="flex items-center gap-2 flex-wrap">
				...
				<MultiSelectPopover
					...
					onChange={(values) =>
						onFiltersChange({ ...filters, bodyParts: values })
					}
				...
				<MultiSelectPopover
					...
					onChange={(values) =>
						onFiltersChange({ ...filters, categories: values })
					}
				...
				<MultiSelectPopover
					...
					onChange={(values) =>
						onFiltersChange({ ...filters, equipment: values })
					}
				...
				<Button
					...
					size="sm"
					onClick={() =>
						onFiltersChange({ ...filters, homeOnly: !filters.homeOnly })
					}
					className={cn(
						"h-9 gap-2",
