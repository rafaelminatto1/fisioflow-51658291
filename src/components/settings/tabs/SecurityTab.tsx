...
import { Shield, Bell, UserPlus, Users, FileText, Mail, Eye, EyeOff, Loader2 } from "lucide-react";
...
export function SecurityTab({ isAdmin, user: _user, mfa, password, navigate, onInvite }: any) {
  return (
      ...
      <Dialog open={mfa.showModal} onOpenChange={mfa.setShowModal}>
        <DialogContent>
          ...
          <div className="flex flex-col items-center space-y-4 py-4">
            {mfa.qrCode && (
              <img src={mfa.qrCode} alt="QR Code" className="w-48 h-48 border rounded" />
            )}
