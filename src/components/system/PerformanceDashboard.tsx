      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="space-y-4">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{report?.slowQueries.length || 0}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{report?.largeTables.length || 0}</div>
              ...
              {!report?.slowQueries.length ? (
                ...
                report.slowQueries.map((query) => (
                  <TableRow key={query.queryId}>
                    ...
                    <TableCell>
                      <Badge
                        variant={query.meanTime > 500 ? "destructive" : "secondary"}
                        className="font-mono"
                      >
