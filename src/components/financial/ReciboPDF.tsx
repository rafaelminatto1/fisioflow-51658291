    ...
    <div className="border rounded-lg p-8 bg-white max-w-2xl mx-auto shadow-lg">
      ...
      <div className="flex items-start gap-4 mb-6">
        ...
        <div className="flex-1">
          ...
          {data.emitente.telefone && (
            <p className="text-xs text-gray-500">Tel: {data.emitente.telefone}</p>
          )}
          {data.emitente.email && (
            <p className="text-xs text-gray-500">Email: {data.emitente.email}</p>
          )}
        </div>
      </div>
      ...
      {data.pagador && (
        <div className="mb-6">
          ...
          {data.pagador.cpfCnpj && (
            <p className="text-sm">
              <span className="font-semibold">CPF/CNPJ:</span> {data.pagador.cpfCnpj}
            </p>
          )}
        </div>
      )}
      ...
      <div className="mb-8">
        ...
        {data.emitente.cpfCnpj && (
          <p className="text-sm">
            <span className="font-semibold">CPF/CNPJ:</span> {data.emitente.cpfCnpj}
          </p>
        )}
      </div>
