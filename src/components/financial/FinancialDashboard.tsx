    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">Acompanhe o desempenho financeiro da sua clínica.</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="text-xs text-muted-foreground mt-1">Por atendimento realizado</div>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="text-xs text-muted-foreground mt-1">Pagamentos realizados vs total</div>
          </CardContent>
        </Card>
      </div>
                  ...
                  <div key={cat} className="space-y-1">
                    ...
                    <div className="h-2 w-full bg-secondary rounded-full overflow-hidden">
                      <div
                        ...
                        style={{
                          width: `${(value / stats.totalRevenue) * 100}%`,
                        }}
                      />
                    </div>
                  </div>
            ...
            <div className="space-y-4">
              {transactions.slice(0, 5).map((t) => (
                ...
                >
                  ...
                  <div
                    className={`font-bold ${t.tipo === "despesa" ? "text-red-500" : "text-emerald-500"}`}
                  >
                    {t.tipo === "despesa" ? "-" : "+"}
