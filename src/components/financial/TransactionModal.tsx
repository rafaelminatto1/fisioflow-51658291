            ...
            >
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="font-bold text-xs" htmlFor="transaction-tipo">
                        Tipo de Lançamento
                      </FormLabel>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel className="font-bold text-xs" htmlFor="transaction-status">
                        Status Atual
                      </FormLabel>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="font-bold text-xs" htmlFor="transaction-valor">
                      Valor (R$)*
                    </FormLabel>
                    <FormControl>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="font-bold text-xs" htmlFor="transaction-descricao">
