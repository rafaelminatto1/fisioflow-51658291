...
import { DollarSign, Save, Loader2, ArrowUpCircle, ArrowDownCircle, Clock, CheckCircle2, XCircle } from 'lucide-react';
    ...
    >
      ...
      <CustomModalBody className="p-0 sm:p-0">
        <div className="px-6 py-4">
          <Form {...form}>
            <form id="transaction-form" onSubmit={form.handleSubmit(handleSubmit)} className="space-y-5">
