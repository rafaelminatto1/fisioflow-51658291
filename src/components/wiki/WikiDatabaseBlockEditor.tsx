  ...
  return (
    <div className="space-y-3">
      <Input
        ...
        onChange={(event) => onChange({ ...database, title: event.target.value })}
      ...
      <div className="grid grid-cols-1 gap-2 md:grid-cols-3">
        <div>
          ...
          <Input
            ...
            onChange={(event) => onChange({ ...database, filter: event.target.value })}
        ...
        <div>
          <Label className="mb-1 block text-xs text-muted-foreground">Direcao</Label>
          <select
            className="h-10 w-full rounded-md border bg-background px-2 text-sm"
