 ...
 */
export const AppointmentModalTest: React.FC<AppointmentModalTestProps> = ({ isOpen, onClose }) => {
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-4">
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            ...
            <p className="text-sm text-blue-700 mt-1">
              Este modal não usa react-hook-form, Dialog ou Sheet. Se funcionar, o problema está
              nesses componentes.
            </p>
