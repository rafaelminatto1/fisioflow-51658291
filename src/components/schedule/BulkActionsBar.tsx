...
import { Trash2, CheckCircle2, X, UserCheck, AlertCircle, Slash, CalendarOff } from 'lucide-react';
        ...
        >
          ...
          <div className="flex items-center gap-3">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-56 rounded-2xl p-2 shadow-premium-lg border-blue-100/50 bg-white/95 backdrop-blur-xl">
                <DropdownMenuItem onClick={() => onUpdateStatusSelected('atendido')} className="rounded-xl gap-2 py-2.5">
                  <div className="w-2 h-2 rounded-full bg-emerald-500" />
                  Marcar como Atendido
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => onUpdateStatusSelected('faltou')} className="rounded-xl gap-2 py-2.5">
                  <div className="w-2 h-2 rounded-full bg-red-500" />
                  Marcar como Faltou
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => onUpdateStatusSelected('remarcar')} className="rounded-xl gap-2 py-2.5">
                  <div className="w-2 h-2 rounded-full bg-slate-400" />
                  Marcar para Remarcar
                </DropdownMenuItem>
                <DropdownMenuItem onClick={() => onUpdateStatusSelected('cancelado')} className="rounded-xl gap-2 py-2.5">
            ...
            <AlertDialog>
              ...
              <AlertDialogContent className="rounded-[2rem] border-red-100/50">
                <AlertDialogHeader>
                  <AlertDialogTitle className="font-serif text-2xl">Excluir {selectedCount} agendamentos?</AlertDialogTitle>
                  <AlertDialogDescription className="text-slate-500">
                    Esta ação é irreversível e removerá permanentemente os registros da sua agenda e histórico financeiro.
                  </AlertDialogDescription>
                </AlertDialogHeader>
