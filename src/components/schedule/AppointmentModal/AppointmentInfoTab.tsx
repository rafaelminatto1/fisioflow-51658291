...
export const AppointmentInfoTab: React.FC<AppointmentInfoTabProps> = ({
  ...
  return (
    <div className="space-y-4">
      {/* Bloco 1: Paciente */}
      <div className="rounded-2xl border border-blue-100 bg-white/50 backdrop-blur-sm p-5 shadow-premium-sm hover:shadow-premium-md transition-all duration-300">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="rounded-2xl border border-blue-100 bg-white/50 backdrop-blur-sm p-5 shadow-premium-sm hover:shadow-premium-md transition-all duration-300 space-y-4">
          <h4 className="text-base font-semibold text-blue-900 mb-4 flex items-center gap-2">
