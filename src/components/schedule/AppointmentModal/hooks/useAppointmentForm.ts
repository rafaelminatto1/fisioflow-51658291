...
export const useAppointmentForm = ({
  ...
  const buildRecurringDates = useCallback(
    (startDate: Date, config: RecurringConfig): { date: Date; time: string }[] => {
  ...
  const persistAppointment = async (
    ...
    const formattedData: any = {
      ...
      session_type: (appointmentData.type === "Fisioterapia" ? "individual" : "group") as
        | "individual"
        | "group",
      ...
      try {
        for (const date of config.dates) {
          ...
          const duplicateData = {
            ...
            session_type: (appointment.type === "Fisioterapia" ? "individual" : "group") as
              | "individual"
              | "group",
          };
