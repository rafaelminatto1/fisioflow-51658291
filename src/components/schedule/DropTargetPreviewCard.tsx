    ...
    return (
      <div
        ...
        className={cn(
          ...
          statusColors.border,
          isDraggedCard &&
            "bg-primary/20 dark:bg-primary/30 border-primary ring-1 ring-primary/30 shadow-md z-10",
        )}
        style={{
      ...
      >
        <div className={cn("flex flex-col h-full min-w-0", isCompact ? "p-0.5" : "p-1")}>
