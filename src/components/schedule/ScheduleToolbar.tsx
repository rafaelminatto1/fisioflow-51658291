	...
	const DesktopToolbar = () => (
		<div className="flex items-center justify-between px-8 py-4 border-b border-slate-200 dark:border-slate-800 bg-white/80 dark:bg-slate-950/80 backdrop-blur-xl sticky top-0 z-40">
				...
				<div className="flex items-center gap-2">
					...
					<SmartDatePicker
						...
						onChange={(date) => {
							if (date) {
								window.dispatchEvent(
									new CustomEvent("schedule-date-change", { detail: date }),
								);
							}
						}}
			...
			<div className="absolute left-1/2 -translate-x-1/2 hidden 2xl:block">
				<div
					className="flex bg-slate-100 dark:bg-slate-900 p-1 rounded-xl border border-slate-200/50 dark:border-slate-800/50"
					role="group"
				>
			...
			<div className="flex items-center gap-3">
				...
				<div className="flex items-center gap-1">
					...
					<Button
						...
						title={
							isSelectionMode ? "Desativar seleção" : "Ativar seleção em massa"
						}
					>
