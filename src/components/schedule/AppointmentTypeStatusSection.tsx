...
import type { AppointmentFormData, AppointmentStatus, AppointmentType } from "@/types/appointment";
...
export function AppointmentTypeStatusSection({ disabled }: AppointmentTypeStatusSectionProps) {
  const {
    watch,
    setValue,
    formState: { errors },
