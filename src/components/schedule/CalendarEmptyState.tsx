	...
	return (
		...
		>
			...
			<motion.div
				...
				animate={{ opacity: 1, y: 0 }}
				transition={
					reducedMotion ? { duration: 0 } : { delay: 0.2, duration: 0.3 }
				}
			...
			>
				...
				{onCreateAppointment && (
					<motion.div
						...
						transition={
							reducedMotion ? { duration: 0 } : { delay: 0.3, duration: 0.2 }
						}
					>
						<Button
							...
							<p className="text-xs text-slate-600 dark:text-gray-500 mt-1">
								{viewType === "day" ? (
									...
									<>
										...
										<br />
										Ou clique no agendamento e use <strong>Editar</strong> para
										mudar data e horário (sem arrastar).
									</>
								) : (
