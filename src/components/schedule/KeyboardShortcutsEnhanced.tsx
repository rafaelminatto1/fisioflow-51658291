...
const KeyboardShortcutsEnhanced = memo(({ open, onClose }: KeyboardShortcutsEnhancedProps) => {
              ...
              <div className="p-6 overflow-y-auto max-h-[calc(90vh-80px)]">
                ...
                <div className="px-6 py-4 bg-slate-50 dark:bg-slate-900/50 border-t border-slate-200 dark:border-slate-800">
                  <p className="text-xs text-slate-500 dark:text-slate-400 text-center">
                    <kbd className="font-mono px-2 py-1 bg-slate-200 dark:bg-slate-800 rounded">
                      ESC
                    </kbd>{" "}
                    para fechar
                  </p>
