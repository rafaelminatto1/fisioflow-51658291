...
export const TimeSlotCell = memo(
  ({
    ...
    const draggedIsFromThisSlot =
      draggedAppointment && targetAppointments.some((apt) => apt.id === draggedAppointment.id);
    const showPreview =
      isDropTarget && !isInvalidDrop && draggedAppointment && !draggedIsFromThisSlot;
    ...
    return (
      <div
        ...
        className={cn(
          ...
          !isHourStart && "border-t border-dashed border-slate-200 dark:border-slate-800/60",
      ...
      >
        ...
        {isDropTarget && !isInvalidDrop && (
          <div
            className="absolute inset-0 flex flex-col items-center justify-center gap-1.5 text-primary font-medium"
            aria-hidden="true"
          >
