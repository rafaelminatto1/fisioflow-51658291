    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
                ...
                <div className="flex flex-wrap gap-2">
                  {WEEKDAYS.map((day) => (
                    <Button
                      ...
                      type="button"
                      variant={
                        formData.recurrence.daysOfWeek?.includes(day.value) ? "default" : "outline"
                      }
                      size="sm"
                  ...
                  <PopoverTrigger asChild>
                    ...
                    >
                      ...
                      {formData.recurrence.endDate ? (
                        format(formData.recurrence.endDate, "dd/MM/yyyy", {
                          locale: ptBR,
                        })
                      ) : (
            ...
            {formData.recurrence.endType === "occurrences" && (
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    updateRecurrence("maxOccurrences", parseInt(e.target.value) || undefined)
                  }
                  placeholder="Ex: 12"
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Popover>
                  <PopoverTrigger asChild>
                    ...
                    >
                      <CalendarIcon className="mr-2 h-4 w-4" />
                      {format(formData.firstDate, "dd/MM/yyyy", {
                        locale: ptBR,
                      })}
                    </Button>
                  </PopoverTrigger>
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked) =>
                  setFormData((prev) => ({ ...prev, auto_confirm: checked }))
                }
              />
            ...
            <div className="flex items-start gap-2 p-3 bg-amber-50 dark:bg-amber-950 border border-amber-200 dark:border-amber-800 rounded-lg">
              ...
              <div className="text-sm">
                ...
                <p className="text-amber-700 dark:text-amber-300">
                  Esta configuração gerará {previewDates.length} agendamentos. Considere reduzir o
                  número ou adicionar uma data limite.
                </p>
              </div>
            </div>
          )}
        ...
        <DialogFooter>
          ...
          <Button onClick={handleSubmit}>Criar Série Recorrente</Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
  );
