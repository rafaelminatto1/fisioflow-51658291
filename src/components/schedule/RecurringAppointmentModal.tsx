...
export const RecurringAppointmentModal: React.FC<
...
> = ({ open, onOpenChange, initialData, onSuccess }) => {
	...
	const handleSubmit = useCallback(async () => {
		try {
			...
			logger.error(
				"Erro ao criar série recorrente",
				error,
						...
						<div className="flex items-start gap-2 p-3 bg-amber-50 dark:bg-amber-950 border border-amber-200 dark:border-amber-800 rounded-lg">
							...
							<div className="text-sm">
								...
								<p className="text-amber-700 dark:text-amber-300">
									Esta configuração gerará {previewDates.length} agendamentos.
									Considere reduzir o número ou adicionar uma data limite.
								</p>
							</div>
						</div>
					)}
