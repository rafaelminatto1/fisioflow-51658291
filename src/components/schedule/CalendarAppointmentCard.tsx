...
import { normalizeStatus, getCalendarCardColors } from "./shared/appointment-status";
...
const CalendarAppointmentCardBase = forwardRef<HTMLDivElement, CalendarAppointmentCardProps>(
  (
    ...
    const { getStatusConfig: getSharedStatusConfig, getStatusColors } = useStatusConfig();
    ...
    const cardContent = (
      ...
      >
        <AppointmentCard
          ...
          compact={isCompact}
          statusConfig={{
            color: isOverbooked ? "#dc2626" : customColors.color || cardColors.accent,
