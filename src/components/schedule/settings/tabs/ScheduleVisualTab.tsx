            ...
            <div className="space-y-1">
              <p
                className={cn(
                  ...
                  isActive ? preset.color : "text-slate-700 dark:text-slate-300",
                )}
              >
                {preset.name}
              </p>
          ...
          <div className="p-6 rounded-[2rem] bg-gradient-to-br from-teal-500 to-emerald-600 text-white shadow-xl shadow-teal-500/10 overflow-hidden relative">
            <div className="relative z-10 space-y-3">
              ...
              <p className="text-xs font-medium leading-relaxed opacity-90">
                Ajuste a <b>densidade</b> para ver mais pacientes na mesma tela ou aumente a{" "}
                <b>legibilidade</b> para telas menores.
              </p>
            </div>
