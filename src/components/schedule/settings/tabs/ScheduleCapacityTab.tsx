...
export function ScheduleCapacityTab() {
	...
	const stats = useMemo(() => {
		...
		const avgPerDay = Object.values(dayCapacities).length > 0
			? Math.round(Object.values(dayCapacities).reduce((a, b) => a + b, 0) / Object.values(dayCapacities).length)
			: 0;
	...
	return (
		<div className="space-y-5">
			<CapacityHeroCard
				onAddRule={triggerAddRule}
				totalVagasDia={stats.totalVagasDia}
			/>
