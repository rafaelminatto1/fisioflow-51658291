			...
			<CardContent className="space-y-4">
							...
							<button
								...
								className={cn(
									...
									rules.min_hours_before === preset.min_hours_before &&
										rules.max_cancellations_month ===
											preset.max_cancellations_month
				...
				<div className="space-y-4 p-4 rounded-xl border bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/20 dark:to-indigo-950/20">
					...
					<p className="text-sm text-muted-foreground">
						Pacientes devem cancelar com pelo menos {hoursBefore}h de
						antecedência
					</p>
					<Slider
						value={[hoursBefore]}
						...
						<Switch
							...
							className={cn(
								...
								rules.charge_late_cancellation
									? "bg-red-600 data-[state=checked]:bg-red-600"
									: "",
							)}
						/>
					</div>
