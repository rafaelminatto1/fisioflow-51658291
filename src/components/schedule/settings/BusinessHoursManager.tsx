			...
			<CardContent className="space-y-6 pt-6">
				...
				{invalidOpenDays.length > 0 && (
					<div className="p-3 rounded-lg border border-red-200 bg-red-50 text-sm text-red-700 dark:border-red-900/50 dark:bg-red-950/20 dark:text-red-300">
						Existem dias com horário inválido. Ajuste para que a abertura seja
									...
									<div className="space-y-4 pl-14">
										...
										<div className="space-y-2">
											...
											<Slider
												...
												onValueChange={([value]) =>
													updateOpenTime(day.value, value)
												}
												min={minTime}
												max={maxTime}
												step={15}
										...
										<div className="space-y-2">
											...
											<Slider
												...
												onValueChange={([value]) =>
													updateCloseTime(day.value, value)
												}
												min={minTime}
												max={maxTime}
												step={15}
