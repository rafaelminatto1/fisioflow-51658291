        ...
        <CardContent className="space-y-4">
          ...
          <Alert className="border-blue-200 bg-blue-50/50 dark:bg-blue-950/20">
            ...
            <AlertDescription className="text-blue-700 dark:text-blue-300 text-sm">
              Presets configuram automaticamente o tamanho dos cards e a altura dos slots. Use as
              opções de acessibilidade para personalizar ainda mais.
            </AlertDescription>
          </Alert>
        ...
        <CardHeader>
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <CardDescription>Opções para melhorar a usabilidade e acessibilidade</CardDescription>
            </div>
          </div>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center justify-between p-3 rounded-lg border bg-muted/30">
            <div className="flex items-center gap-3">
              ...
              <div className="text-left">
                ...
                <p className="text-xs text-muted-foreground">Minimiza animações e transições</p>
              </div>
            </div>
            <Switch
              id="reduced-motion"
      ...
      <div className="p-4 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-950/20 dark:to-orange-950/20 rounded-xl border border-amber-200 dark:border-amber-800">
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground">
              Os presets configuram automaticamente o tamanho dos cards e a altura dos slots. Use as
              opções de acessibilidade para personalizar ainda mais sua experiência.
            </p>
          </div>
        </div>
      </div>
