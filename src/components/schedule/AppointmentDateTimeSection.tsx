...
import { AlertTriangle, CalendarIcon, Check, ChevronDown, Clock, Wand2, Zap } from "lucide-react";
...
export function AppointmentDateTimeSection({
  ...
  const maxCapacity =
    watchedDate && resolvedTime && resolvedDuration
      ? getMinCapacityForInterval(watchedDate.getDay(), resolvedTime, resolvedDuration)
      : 0;
    ...
    <div className="space-y-4">
      <div className="space-y-1.5">
        ...
        <Popover open={isCalendarOpen} onOpenChange={setIsCalendarOpen}>
          <PopoverTrigger asChild>
            <Button
              ...
              className={cn(
                ...
                errors.appointment_date && "border-red-300 bg-red-50/30 text-red-600",
              )}
              disabled={disabled}
            >
          ...
          >
            <div className="px-3 py-2.5 border-b border-slate-100 flex items-center justify-between gap-2">
              <span className="text-xs font-medium text-slate-500">Selecionar data</span>
        ...
        {errors.appointment_date && (
          <p id="date-error" className="text-xs text-red-500 flex items-center gap-1 mt-1">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="space-y-1.5">
          ...
          <Select
            ...
            onValueChange={(value) => setValue("duration", Number.parseInt(value, 10))}
            disabled={disabled}
          >
            <SelectTrigger className="h-9 rounded-lg border-slate-200 bg-white text-sm text-slate-700 focus:ring-2 focus:ring-blue-500/20 focus:border-blue-400">
              <SelectValue />
