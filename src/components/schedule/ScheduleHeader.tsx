				...
				<div className="relative z-10 border-t border-white/10 bg-black/20 backdrop-blur-md px-8 py-3 flex items-center justify-between">
					<div className="flex items-center gap-6 text-xs font-medium text-white/90">
						<div className="flex items-center gap-2">
							...
							Ultrassom{" "}
							<span className="opacity-60 font-light ml-1">Disponível</span>
						</div>
						<div className="flex items-center gap-2">
							<span className="w-2 h-2 rounded-full bg-amber-400 animate-pulse" />
							Laser Co2{" "}
							<span className="opacity-60 font-light ml-1">Em manutenção</span>
						</div>
						<div className="flex items-center gap-2">
							<span className="w-2 h-2 rounded-full bg-blue-400" />
							Tens{" "}
							<span className="opacity-60 font-light ml-1">Em uso (15m)</span>
						</div>
					</div>
