...
export const RescheduleCapacityDialog: React.FC<
	RescheduleCapacityDialogProps
> = ({
	open,
	onOpenChange,
	appointment,
					...
					<AlertDialogDescription asChild>
						<div className="space-y-4">
							<p className="text-muted-foreground leading-relaxed">
								A agenda para o novo horário de{" "}
								<span className="font-semibold text-foreground underline decoration-red-200 underline-offset-4">
									{appointment.patientName}
								</span>{" "}
								já atingiu o limite de capacidade configurado.
							</p>
