			...
			<CardContent className="space-y-3 text-xs">
				...
				<div className="space-y-1 border-t pt-2">
					...
					<div className="flex items-center justify-between">
						...
						<span
							className={
								organizationId ? "text-green-600 font-mono" : "text-red-600"
							}
						>
					...
					{appointments.length > 0 && (
						<div className="mt-2 p-2 bg-white rounded border">
							...
							<div className="space-y-0.5 text-[10px] font-mono">
								...
								<div>
									Data:{" "}
									{appointments[0].date instanceof Date
										? appointments[0].date.toLocaleDateString("pt-BR")
										: String(appointments[0].date)}
								</div>
				...
				{!organizationId && (
					<div className="border-t pt-2">
						<div className="p-2 bg-yellow-50 rounded border border-yellow-200 text-yellow-800">
							...
							<div>
								O usuário não possui um Organization ID definido. Verifique o
								perfil no banco principal e certifique-se de que o campo
