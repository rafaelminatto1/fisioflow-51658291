...
export function GoogleCalendarButton({
	...
	const { isConnected, email, isLoading, connect, disconnect } =
			...
			>
				<AlertDialogContent>
					<AlertDialogHeader>
						...
						<AlertDialogDescription>
							Isso interromperá a sincronização automática com o Google
							Calendar. Você pode reconectar sua conta a qualquer momento.
						</AlertDialogDescription>
					</AlertDialogHeader>
					<AlertDialogFooter>
