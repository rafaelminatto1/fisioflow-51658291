...
export const DuplicateAppointmentDialog: React.FC<
	DuplicateAppointmentDialogProps
> = ({ open, onOpenChange, appointment, onDuplicate }) => {
	const [duplicateType, setDuplicateType] = useState<
		"single" | "multiple" | "weekly"
	>("single");
						...
						<div className="grid grid-cols-3 gap-2">
							{[
								...
								<Button
									...
									type="button"
									variant={
										duplicateType === option.value ? "default" : "outline"
									}
						...
						<div className="space-y-2">
							<div className="flex items-center gap-2">
								<Checkbox
									...
									onCheckedChange={(checked) =>
										setKeepNotes(checked as boolean)
									}
								/>
								<Label htmlFor="keep-notes" className="text-sm cursor-pointer">
									Observações
								</Label>
							</div>
							<div className="flex items-center gap-2">
								<Checkbox
									...
									onCheckedChange={(checked) =>
										setKeepEquipments(checked as boolean)
									}
								/>
								<Label
									htmlFor="keep-equipments"
							...
							<div className="flex items-center gap-2">
								<Checkbox
									...
									onCheckedChange={(checked) =>
										setKeepPaymentInfo(checked as boolean)
									}
								/>
								<Label
									htmlFor="keep-payment"
									className="text-sm cursor-pointer"
								>
									Info de pagamento
								</Label>
