    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>Crie cópias deste agendamento para outras datas</DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-2 pt-2 border-t">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-2">
                ...
                />
                <Label htmlFor="keep-equipments" className="text-sm cursor-pointer">
                  Equipamentos
                </Label>
              </div>
              <div className="flex items-center gap-2">
                ...
                />
                <Label htmlFor="keep-payment" className="text-sm cursor-pointer">
                  Info de pagamento
                </Label>
              </div>
            </div>
        ...
        <DialogFooter>
          ...
          <Button
            ...
            disabled={
              (duplicateType !== "weekly" && selectedDates.length === 0) || (!keepTime && !newTime)
            }
          >
