					...
					<AlertDialogHeader>
						<div className="flex items-center gap-4 mb-4">
							...
							<div>
								...
								<p className="text-sm text-red-600/80 font-medium tracking-wide">
					...
					<AlertDialogDescription asChild>
						<div className="space-y-4">
							<p className="text-muted-foreground leading-relaxed">
								Este horário já ultrapassa a capacidade configurada para os
								profissionais disponíveis no momento.
							</p>
									...
									<div className="pt-3 border-t border-slate-200/60">
										...
										<div className="h-2 w-full bg-slate-200 rounded-full overflow-hidden flex">
											<div
												...
												style={{
													width: `${Math.min(100, (maxCapacity / currentCount) * 100)}%`,
												}}
											/>
											<div
												className="h-full bg-red-500 animate-pulse"
												style={{
													width: `${Math.max(0, 100 - (maxCapacity / currentCount) * 100)}%`,
												}}
											/>
										</div>
										{exceededBy > 0 && (
											<p className="text-[10px] text-red-500 font-bold mt-2 text-right uppercase tracking-tighter">
												Excedente de {exceededBy} paciente
												{exceededBy > 1 ? "s" : ""}
											</p>
										)}
									</div>
								...
								<div className="grid gap-2">
									...
									>
										...
										<div className="text-left">
											...
											<p className="text-[10px] text-red-100/80 font-medium">
												Confirmar atendimento extra
											</p>
										</div>
									</Button>
									...
									<div className="grid grid-cols-2 gap-2">
										...
										>
											...
											<div className="text-left">
												<p className="font-bold text-[11px] leading-tight text-slate-700">
													Outro Horário
												</p>
