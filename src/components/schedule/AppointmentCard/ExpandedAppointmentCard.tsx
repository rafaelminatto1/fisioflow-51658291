...
export const ExpandedAppointmentCard: React.FC<
	ExpandedAppointmentCardProps
> = ({
	appointment,
	onClick,
	className,
	...
	const ongoing = isAppointmentOngoing(
		dateStr,
		appointment.time,
				...
				<div className="mb-12">
					...
					<div className="flex items-center gap-2.5">
						...
						<p className="text-[12px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-[0.2em]">
							{appointment.type} <span className="mx-1 opacity-30">•</span>{" "}
							{statusConfig.label}
						</p>
					</div>
				</div>
