...
export const AppointmentAvatar: React.FC<AppointmentAvatarProps> = ({
	...
	return (
		<div className="relative">
			...
			>
				{imageUrl ? <AvatarImage src={imageUrl} alt={patientName} /> : null}
			...
			{status && (
				<div
					className="absolute -bottom-0.5 -right-0.5 h-3 w-3 rounded-full border-2 border-background shadow-sm animate-pulse"
					style={{
						backgroundColor:
							status === "confirmado"
								? "#10b981"
