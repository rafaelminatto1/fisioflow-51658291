      ...
      <CardContent className="p-3 sm:p-4 lg:p-6 relative h-full">
        <div className="flex flex-col gap-1.5 sm:gap-2 lg:gap-3 h-full">
          <div className="flex items-start justify-between gap-1">
            <p className="text-[10px] sm:text-xs lg:text-sm font-medium text-muted-foreground leading-tight line-clamp-2">
              {title}
            </p>
            <div
              className={cn(
                "p-1.5 sm:p-2 lg:p-2.5 rounded-lg group-hover:scale-110 transition-transform shrink-0",
                iconColor,
              )}
            >
          ...
          <div className="flex-1 flex flex-col justify-end">
            <div className={cn("text-xl sm:text-2xl lg:text-3xl font-bold", valueColor)}>
              {value}
            </div>
            <p className="text-[9px] sm:text-[10px] lg:text-xs text-muted-foreground mt-0.5 sm:mt-1 line-clamp-1">
              {description}
            </p>
          </div>
        </div>
