...
describe("AppointmentSearch", () => {
	it("deve renderizar com valor inicial", () => {
		render(
			<AppointmentSearch searchTerm="João Silva" onSearchChange={vi.fn()} />,
		);
	...
	it("deve chamar onClear quando clicar no botão", () => {
		...
		render(
			<AppointmentSearch searchTerm="Teste" onSearchChange={handleClear} />,
		);
	...
	it("deve ter ícone de busca", () => {
		const { container } = render(
			<AppointmentSearch searchTerm="" onSearchChange={vi.fn()} />,
		);
