...
describe("AppointmentSearch", () => {
  it("deve renderizar com valor inicial", () => {
    render(<AppointmentSearch searchTerm="João Silva" onSearchChange={vi.fn()} />);
  ...
  it("deve chamar onChange quando digitar", () => {
    ...
    render(<AppointmentSearch searchTerm="" onSearchChange={handleChange} />);
  ...
  it("deve mostrar botão de limpar quando tem valor", () => {
    render(<AppointmentSearch searchTerm="Teste" onSearchChange={vi.fn()} />);
  ...
  it("não deve mostrar botão de limpar quando não tem valor", () => {
    render(<AppointmentSearch searchTerm="" onSearchChange={vi.fn()} />);
  ...
  it("deve chamar onClear quando clicar no botão", () => {
    ...
    render(<AppointmentSearch searchTerm="Teste" onSearchChange={handleClear} />);
  ...
  it("deve ter ícone de busca", () => {
    const { container } = render(<AppointmentSearch searchTerm="" onSearchChange={vi.fn()} />);
