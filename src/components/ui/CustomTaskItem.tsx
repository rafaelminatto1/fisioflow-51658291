  ...
  return (
    ...
    >
      <label
        ...
        className="mt-1 flex-shrink-0 flex items-center justify-center"
      >
        <input
          type="checkbox"
          checked={isChecked}
      ...
      <div
        className="flex items-center gap-1 opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-all ml-2 self-start mt-0.5"
        contentEditable={false}
      >
        <button
          type="button"
