...
export const Preloaded: Story = {
  args: {
    value: '<h2>Avaliação do Paciente</h2><p>Paciente apresenta <strong>lombalgia crônica</strong> há 6 meses.</p><ul><li>Dor nível 6/10</li><li>Mobilidade reduzida</li></ul>',
    placeholder: 'Escreva aqui...',
  },
};
