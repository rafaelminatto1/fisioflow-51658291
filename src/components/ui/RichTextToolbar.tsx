...
export const RichTextToolbar: React.FC<RichTextToolbarProps> = ({
  ...
  const [lineHeightMode, setLineHeightMode] = useState<"compact" | "normal" | "comfortable">(
    "normal",
  );
        ...
        content: [
          ...
          },
          {
            ...
            content: [
              {
                type: "tableCell",
                content: [{ type: "paragraph", content: [{ type: "text", text: "Dor" }] }],
              },
              {
                type: "tableCell",
                content: [{ type: "paragraph", content: [{ type: "text", text: "EVA /10" }] }],
              },
              {
                type: "tableCell",
                content: [
  ...
  const commandItems = [
    ...
    },
    {
      ...
      preview:
        '<ul data-type="taskList"><li data-type="taskItem" data-checked="false"><p>Item 1</p></li><li data-type="taskItem" data-checked="true"><p>Item 2</p></li></ul>',
    ...
    },
    {
      ...
      preview:
        '<div class="notion-callout notion-callout--info"><span class="notion-callout-icon">💡</span><div class="notion-callout-content"><p><strong>Dica:</strong> Conteúdo</p></div></div>',
    ...
    },
    {
      ...
      preview:
        '<div class="notion-callout notion-callout--success"><span class="notion-callout-icon">✅</span><div class="notion-callout-content"><p><strong>Sucesso:</strong> Conteúdo</p></div></div>',
    ...
    },
    {
      ...
      preview:
        '<div class="notion-callout notion-callout--warning"><span class="notion-callout-icon">⚠️</span><div class="notion-callout-content"><p><strong>Atenção:</strong> Conteúdo</p></div></div>',
  ...
  const selectedCommand =
    commandItems.find((item) => item.id === selectedCommandId) || commandItems[0];
      ...
      <div className="max-w-[1200px] mx-auto w-full flex items-center flex-wrap gap-x-3 gap-y-2 overflow-x-auto no-scrollbar">
              ...
              <div className="grid grid-cols-5 gap-1">
                {COLORS.map((c) => (
                  <button
                    ...
                    style={{
                      backgroundColor: c.color === "inherit" ? "#fff" : c.color,
                    }}
                    onClick={() => {
                      if (c.color === "inherit") {
        ...
        <ToolbarGroup>
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button
                className="rich-text-toolbar-btn-long group px-2 flex items-center gap-2 min-w-[100px]"
                title="Tipo de texto"
              >
        ...
        <ToolbarGroup>
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button
                className="rich-text-toolbar-btn-long group px-2 flex items-center gap-2 min-w-[96px]"
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button
                className="rich-text-toolbar-btn-long group px-2 flex items-center gap-2 min-w-[110px]"
                title="Espaçamento"
              >
                <AlignJustify className="h-4 w-4" />
                <span className="text-xs font-medium truncate">
                  {lineHeightMode === "compact"
                    ? "Compacto"
                    : lineHeightMode === "comfortable"
                      ? "Confortável"
                      : "Normal"}
                </span>
                <ChevronDown className="h-3 w-3 ml-auto text-muted-foreground group-hover:text-foreground" />
        ...
        <ToolbarGroup>
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button
                className="rich-text-toolbar-btn-long bg-primary/5 text-primary hover:bg-primary/10 px-2 flex items-center gap-1.5"
                title="Inserir mídia ou blocos"
              >
            ...
            <DropdownMenuContent align="start" className="w-56">
              ...
              <DropdownMenuSeparator />
              <DropdownMenuItem onClick={insertDefaultTable}>
        ...
        <ToolbarGroup>
          ...
          <ToolbarButton onClick={insertDefaultTable} title="Tabela">
          ...
          <ToolbarButton onClick={() => imageInputRef.current?.click()} title="Imagem">
        ...
        <ToolbarGroup className="ml-auto">
          ...
          <ToolbarButton onClick={copyAsText} title="Copiar como texto">
