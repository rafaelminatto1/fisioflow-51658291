		...
		<>
			<nav aria-label="Links de atalho" className="sr-only">
				<ul>
					{SKIP_LINKS.map((link) => (
						<li key={link.id}>
							<Link to={`#${link.target}`} className="skip-link">
								{link.label}
							</Link>
						</li>
					))}
...
export const Announcement: React.FC<AnnouncementProps> = ({
	...
	const typeStyles = {
		...
		success:
			"bg-green-50 dark:bg-green-900/20 text-green-900 dark:text-green-200 border-green-200 dark:border-green-800",
		warning:
			"bg-yellow-50 dark:bg-yellow-900/20 text-yellow-900 dark:text-yellow-200 border-yellow-200 dark:border-yellow-800",
		error:
			"bg-red-50 dark:bg-red-900/20 text-red-900 dark:text-red-200 border-red-200 dark:border-red-800",
	};
			...
			>
				{type === "error" && (
					...
					>
						<path
							fillRule="evenodd"
							d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm2-3.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0z"
							clipRule="evenodd"
						/>
					</svg>
				)}
				...
				{type === "info" && (
					...
					>
						<path
							fillRule="evenodd"
							d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 0V9z"
							clipRule="evenodd"
						/>
					</svg>
				)}
