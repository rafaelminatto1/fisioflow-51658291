...
> = {
  agenda: {
    ...
    description:
      "Não há agendamentos para o período selecionado. Clique em um horário disponível para criar um novo agendamento.",
  ...
  ({
    ...
    return (
      ...
      >
        ...
        <h3 className="text-xl font-semibold text-foreground mb-3">{config.title}</h3>
          ...
          >
            <div className="flex items-start gap-3 text-sm text-muted-foreground">
              ...
              <div className="flex-1">
                ...
                <p className="text-muted-foreground/80">{config.description}</p>
              </div>
            </div>
          </motion.div>
        )}
