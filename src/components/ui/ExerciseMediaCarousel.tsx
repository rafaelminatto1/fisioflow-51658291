...
export function ExerciseMediaCarousel({ media, className }: ExerciseMediaCarouselProps) {
    ...
    >
      ...
      {currentMedia.caption && (
        <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-6 pt-12">
          <p className="text-sm font-medium text-white line-clamp-2">{currentMedia.caption}</p>
        </div>
      )}
