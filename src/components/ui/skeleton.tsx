...
function Skeleton({
  ...
  const baseClasses = cn("bg-muted rounded", animate && "animate-pulse", className);
  ...
  if (variant === "card") {
    return (
      <div
        ...
        className={cn("border rounded-lg p-4 space-y-3", animate && "animate-pulse")}
        {...props}
      >
  ...
  if (variant === "chart") {
    return (
      <div
        ...
        className={cn("border rounded-lg p-4", animate && "animate-pulse")}
        {...props}
      >
