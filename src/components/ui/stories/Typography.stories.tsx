  ...
  render: () => (
    <div className="space-y-8 p-8">
      <div className="space-y-4">
        <h2 className="text-4xl font-display text-foreground">Font Display - Heading Level 1</h2>
        <h3 className="text-3xl font-display-title text-primary">Font Display Title</h3>
        <h4 className="text-2xl font-display-heading text-muted-foreground">
          Font Display Heading
        </h4>
        <p className="text-xl font-display-body text-foreground">Font Display Body text</p>
      </div>

      <div className="space-y-4">
        <h2 className="text-3xl font-display tracking-tight">Tracking Variants</h2>
      ...
      <div className="space-y-4">
        <h2 className="text-2xl font-display uppercase tracking-wider">Uppercase with Tracking</h2>
...
export const ColorVariants: StoryObj = {
  render: () => (
    <div className="space-y-4 p-8">
      <h2 className="text-2xl font-display text-foreground mb-4">Color Variants</h2>
