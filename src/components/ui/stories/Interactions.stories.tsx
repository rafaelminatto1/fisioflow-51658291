...
export const PremiumHover: Story = {
  render: () => (
    <div className="p-8 space-y-6">
      <h2 className="text-3xl font-display text-foreground mb-4">Premium Hover Effects</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="gradient-brand text-white p-6 rounded-2xl card-premium-hover">
          ...
          <p className="text-sm text-white/80">
            Sky blue to emerald gradient with elevation effect
          </p>
        </div>

        <div className="gradient-success text-white p-6 rounded-2xl card-premium-hover">
          <h3 className="text-xl font-display text-foreground">Success Gradient</h3>
          <p className="text-sm text-white/80">Emerald gradient for positive feedback</p>
        </div>

        <div className="gradient-warm text-white p-6 rounded-2xl card-premium-hover">
          <h3 className="text-xl font-display text-foreground">Warm Gradient</h3>
          <p className="text-sm text-white/80">Orange to red gradient for attention</p>
        </div>

        <div className="gradient-dark text-white p-6 rounded-2xl card-premium-hover">
          <h3 className="text-xl font-display text-foreground">Dark Gradient</h3>
...
export const FocusStates: Story = {
  render: () => (
    <div className="p-8 space-y-6">
      <h2 className="text-3xl font-display text-foreground mb-4">Focus States</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="gradient-brand-light p-6 rounded-2xl focus-glow-primary-strong">
          ...
          <p className="text-sm text-muted-foreground">Outline + Glow effect with primary color</p>
        </div>

        <div className="gradient-brand-light p-6 rounded-2xl focus-scale-lg">
          <h3 className="text-xl font-display text-primary">Focus with Scale</h3>
...
export const ActivePressed: Story = {
  render: () => (
    <div className="p-8 space-y-6">
      <h2 className="text-3xl font-display text-foreground mb-4">Active/Pressed States</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-card p-6 rounded-2xl card-pressed">
          ...
          <p className="text-sm text-muted-foreground">Scale down + Darken background</p>
        </div>
...
export const CombinedExample: Story = {
  render: () => (
    <div className="p-8 space-y-6">
      <h2 className="text-3xl font-display text-foreground mb-4">Combined Effects</h2>
      ...
      <div className="space-y-8">
        <div className="p-8 gradient-brand text-white rounded-2xl magnetic-button glow-on-hover">
          ...
          <p className="text-white/80">Magnetic + Glow hover + Magnetic scale</p>
        </div>
