...
const ToolbarButton = memo(
  ({ onClick, title, icon: Icon, shortcut, disabled = false, ariaLabel }: ToolbarButtonProps) => (
  ...
  alignment: [
    {
      ...
      endTag: "\n</div>",
      ariaLabel: "Alinhar texto à esquerda",
    },
    {
      icon: AlignCenter,
      label: "Centralizar",
    ...
    },
    {
      ...
      endTag: "\n</div>",
      ariaLabel: "Alinhar texto à direita",
    },
    {
      icon: AlignJustify,
      label: "Justificar",
  ...
  emphasis: [
    {
      ...
      format: "==",
      endTag: "==",
      ariaLabel: "Adicionar destaque ao texto",
    },
    {
      icon: Superscript,
      label: "Sobrescrito",
      format: "^",
      endTag: "^",
      ariaLabel: "Formatar como sobrescrito",
    },
    {
      icon: Subscript,
      label: "Subscrito",
      format: "~",
      endTag: "~",
      ariaLabel: "Formatar como subscrito",
    },
  ],
  structure: [
    {
    ...
    },
    {
      ...
      format: "    ",
      ariaLabel: "Aumentar indentação",
    },
    {
      icon: IndentDecrease,
      label: "Diminuir Indentação",
      format: "",
      ariaLabel: "Diminuir indentação (seleção)",
    },
  ],
});

const MemoizedSmartTextarea = memo(
  React.forwardRef<HTMLTextAreaElement, SmartTextareaProps>(
    (
      {
        className,
        value,
      ...
      return (
        <div
          className={cn(
            ...
            isFullScreen &&
              "fixed inset-0 z-[100] rounded-none bg-background flex flex-col h-screen",
          ...
          onMouseLeave={() =>
            !showToolbarOnFocus && !internalRef.current?.matches(":focus") && setIsFocused(false)
          }
        >
          {/* Toolbar */}
          {showToolbar && (
            <div
              className={cn(
                ...
                showToolbarOnFocus && !isFocused && !isFullScreen
                  ? "h-0 p-0 border-b-0 opacity-0 scale-y-95 pointer-events-none"
              ...
              <div className="ml-auto flex items-center gap-1 pl-2 border-l border-border/50">
                ...
                {fullScreenEnabled && (
                  <ToolbarButton
                    ...
                    ariaLabel={
                      isFullScreen ? "Sair do modo tela cheia" : "Entrar em modo tela cheia"
                    }
                  />
                )}
              </div>
          ...
          <div
            className={cn(
              "relative flex-1 flex flex-col min-h-0 h-full",
          ...
          >
            <Textarea
              ...
              className={cn(
                ...
                showToolbar && (!showToolbarOnFocus || isFocused || isFullScreen)
                  ? "rounded-t-none"
                  : "rounded-t-lg",
                isFullScreen
                  ? "flex-1 resize-none h-full text-lg p-8 max-w-5xl mx-auto"
                  : "flex-1 resize-none h-full min-h-0",
                className,
              )}
              placeholder={
                props.placeholder ||
                "Comece a digitar... Use Ctrl+B para negrito, Ctrl+I para itálico, etc."
              }
