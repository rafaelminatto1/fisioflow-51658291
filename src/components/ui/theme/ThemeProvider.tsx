...
export const ThemeProvider: React.FC<ThemeProviderProps> = ({ children, defaultPreferences }) => {
  ...
  return (
    <div className="flex items-center gap-1">
      ...
      <button
        ...
        title={resolvedMode === "light" ? "Mudar para modo escuro" : "Mudar para modo claro"}
      >
