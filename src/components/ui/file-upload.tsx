...
import { Upload, File, Image, Video, FileText, X, Download, Eye } from "lucide-react";
...
export function FileUpload({
  ...
  const { isUploading, progress, uploadedFiles, upload, removeFile } = useFileUpload(uploadOptions);
