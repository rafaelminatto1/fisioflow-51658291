...
export const FunctionalAnalysisStudio: React.FC<FunctionalAnalysisStudioProps> = ({
  ...
  const [activeTool, setActiveTool] = useState<
    "none" | "goniometer" | "trajectory" | "tracking" | "auto_angles"
  >("auto_angles");
  ...
  const [autoAngleHistory, setAutoAngleHistory] = useState<
    Array<{ frame: number } & Record<string, number>>
  >([]);
  ...
  const exportReport = async () => {
    const { generateBiomechanicsReport } = await import("@/utils/biomechanics-reports");
          ...
          <div className="relative w-full h-full flex items-center justify-center overflow-hidden">
              ...
              <div className="absolute inset-0 z-20 flex flex-col items-center justify-center gap-3 bg-slate-950/90 px-6 text-center">
                ...
                <div>
                  ...
                  <p className="mt-2 max-w-md text-sm text-white/70">
                    Use vídeos gravados do gesto que deseja avaliar. O modo live ficará para o app
                    professional depois.
                  </p>
                </div>
              </div>
            ...
            >
              <Layer>
                ...
                {activeTool === "auto_angles" && aiEnabled && (
                  <AutoAngleOverlay angles={autoAngles} />
                )}
