...
const MarketingExportModal: React.FC<MarketingExportModalProps> = ({
	...
	const [captionType, setCaptionType] = useState<
		"technical" | "motivational" | "educational"
	>("technical");
			...
			<Dialog open={isOpen} onOpenChange={onClose}>
				<DialogContent>
					<DialogHeader>
						...
						<DialogDescription>
							O paciente <strong>{patientName}</strong> não possui Termo de
							Consentimento para Uso de Imagem (Marketing) ativo.
						</DialogDescription>
					</DialogHeader>
					<div className="bg-red-50 p-4 rounded text-sm text-red-800">
						Para habilitar esta função, é necessário coletar a assinatura de um
						novo termo específico para divulgação.
					</div>
					<DialogFooter>
						...
						{exportUrl && (
							<div className="bg-green-50 p-4 rounded border border-green-200 flex justify-between items-center mt-4">
								...
								<Button asChild className="bg-green-600 hover:bg-green-700">
									<a
										href={exportUrl}
										download={"comparativo_" + patientId + ".webm"}
									>
					...
					<div className="space-y-6">
						...
						<div className="space-y-4">
							...
							<Tabs
								...
								onValueChange={(v) =>
									setCaptionType(
										v as "technical" | "motivational" | "educational",
									)
								}
							>
