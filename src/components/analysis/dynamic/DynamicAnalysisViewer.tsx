        ...
        <Card>
          ...
          <CardContent className="text-sm space-y-2">
            ...
            <div className="flex justify-between">
              ...
              <span>
                {metrics.synchronization.mode} (Ref: {metrics.synchronization.anchor.anchor_type})
              </span>
            </div>
          </CardContent>
        </Card>
        ...
        <CardContent className="grid grid-cols-2 gap-4">
          <div>
            ...
            <p className="text-2xl font-bold">
              ...
              <span className="text-xs font-normal text-muted-foreground"> spm</span>
            </p>
          </div>
          <div>
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
      ...
      <Card className="md:col-span-2">
        <CardHeader>
          <CardTitle className="text-sm">Valgo por Repetição (No fundo)</CardTitle>
        </CardHeader>
        <CardContent className="h-60">
          <ResponsiveContainer width="100%" height="100%">
      ...
      <Card className="md:col-span-3">
        <CardHeader>
          <CardTitle className="text-sm">Inclinação do Tronco (Sagital)</CardTitle>
        </CardHeader>
        <CardContent className="h-40">
          <ResponsiveContainer width="100%" height="100%">
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
      ...
      <Card className="md:col-span-3 lg:col-span-2 row-span-2">
        <CardHeader>
          <CardTitle className="text-sm">Estabilometria (Caminho do CoP)</CardTitle>
        </CardHeader>
