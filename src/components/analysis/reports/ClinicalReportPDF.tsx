		...
		<Document>
			<Page size="A4" style={styles.page}>
				...
				<View style={styles.header}>
					<View>
						...
						<Text style={styles.subtitle}>
							Avaliação Biomecânica Assistida por IA
						</Text>
					</View>
					<View>
				...
				<View style={styles.section}>
					...
					<Text style={[styles.sectionTitle, { fontSize: 10, marginTop: 8 }]}>
						Resumo para Paciente
					</Text>
					<Text style={{ fontSize: 9, lineHeight: 1.4, color: "#15803d" }}>
				...
				<View style={styles.section}>
					<Text style={styles.sectionTitle}>
						Principais Achados Biomecânicos
					</Text>
						...
						>
							...
							<View
								style={[
									...
									{
										backgroundColor:
											finding.confidence === "HIGH" ? "#dcfce7" : "#fef3c7",
										color:
											finding.confidence === "HIGH" ? "#166534" : "#92400e",
									},
								]}
							>
								<Text>
					...
					{report.suggested_exercises.map((ex, i) => (
						<View
							...
							style={{
								...
								paddingBottom: 8,
								borderBottomWidth:
									i === report.suggested_exercises.length - 1 ? 0 : 1,
								borderBottomColor: "#eee",
							}}
						>
				...
				{report.red_flags_generic.length > 0 && (
					...
					>
						<Text
							style={[
								styles.sectionTitle,
								{ color: "#991b1b", borderBottomColor: "#fecaca" },
							]}
						>
							Red Flags / Atenção
						</Text>
						{report.red_flags_generic.map((flag, i) => (
							<Text key={i} style={{ fontSize: 9, color: "#991b1b" }}>
								! {flag}
							</Text>
						))}
					</View>
				...
				<Text style={styles.disclaimer}>
					AVISO LEGAL: {report.disclaimer} Este relatório foi gerado
					automaticamente por inteligência artificial ("PhysioScience Master
					AI") e revisado eletronicamente. Não substitui o laudo médico oficial
					ou a avaliação física presencial.
				</Text>
