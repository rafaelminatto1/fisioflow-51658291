    ...
    <Document>
      <Page size="A4" style={styles.page}>
          ...
          {report.suggested_exercises.map((ex, i) => (
            <View
              ...
              style={{
                marginBottom: 8,
                paddingBottom: 8,
                borderBottomWidth: i === report.suggested_exercises.length - 1 ? 0 : 1,
                borderBottomColor: "#eee",
              }}
            >
        ...
        {report.red_flags_generic.length > 0 && (
          ...
          >
            <Text style={[styles.sectionTitle, { color: "#991b1b", borderBottomColor: "#fecaca" }]}>
              Red Flags / Atenção
            </Text>
        ...
        <Text style={styles.disclaimer}>
          AVISO LEGAL: {report.disclaimer} Este relatório foi gerado automaticamente por
          inteligência artificial ("PhysioScience Master AI") e revisado eletronicamente. Não
          substitui o laudo médico oficial ou a avaliação física presencial.
        </Text>
