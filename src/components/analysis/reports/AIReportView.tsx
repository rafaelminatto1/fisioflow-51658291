				...
				<CardHeader className="flex flex-row items-center gap-4 pb-2">
					...
					<div>
						<CardTitle className="text-lg text-blue-800">
							Análise PhysioScience Master AI
						</CardTitle>
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
						...
						<div className="bg-green-50 p-4 rounded-lg border border-green-100">
							<h4 className="flex items-center gap-2 font-semibold text-green-800 mb-2 text-sm">
								<CheckCircle2 className="w-4 h-4 text-green-600" /> Resumo para
								Paciente
							</h4>
			...
			<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
				...
				<Card>
					...
					<CardContent className="space-y-3">
						...
						<div>
							<h4 className="text-xs font-bold text-amber-700 mb-1 uppercase">
								Foco de Correção
							</h4>
							<ul className="list-disc list-inside text-sm text-muted-foreground">
						...
						{report.suggested_exercises.map((ex, idx) => (
							<div key={idx} className="border rounded-lg p-4 bg-slate-50">
								...
								<div className="text-[10px] space-y-1">
									<p>
										<span className="font-semibold text-green-600">Prog:</span>{" "}
										{ex.progression}
									</p>
									<p>
										<span className="font-semibold text-amber-600">Reg:</span>{" "}
										{ex.regression}
									</p>
								</div>
							</div>
