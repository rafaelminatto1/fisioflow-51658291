    ...
    <div className="space-y-6">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-slate-50 p-4 rounded-lg border">
              ...
              <p className="text-sm text-slate-600 leading-relaxed">{report.technical_analysis}</p>
            </div>
            <div className="bg-green-50 p-4 rounded-lg border border-green-100">
              ...
              <p className="text-sm text-green-700 leading-relaxed">{report.patient_summary}</p>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Card>
          <CardHeader>
            <CardTitle className="text-base flex items-center gap-2">
              <Activity className="w-4 h-4" /> Principais Achados
            </CardTitle>
          </CardHeader>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-base flex items-center gap-2">
              <ArrowRight className="w-4 h-4" /> Plano de Ação
            </CardTitle>
          </CardHeader>
          <CardContent className="space-y-3">
            <div>
              <h4 className="text-xs font-bold text-green-700 mb-1 uppercase">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-base">Exercícios Sugeridos</CardTitle>
        </CardHeader>
        <CardContent>
            ...
            {report.suggested_exercises.map((ex, idx) => (
              <div key={idx} className="border rounded-lg p-4 bg-slate-50">
                ...
                <div className="text-[10px] space-y-1">
                  <p>
                    <span className="font-semibold text-green-600">Prog:</span> {ex.progression}
                  </p>
                  <p>
                    <span className="font-semibold text-amber-600">Reg:</span> {ex.regression}
                  </p>
                </div>
              </div>
            ))}
