		...
		<Dialog open={isOpen} onOpenChange={onClose}>
			<DialogContent className="sm:max-w-2xl">
				<DialogHeader>
					...
					<DialogDescription>
						Selecione o formato e o destinatário do relatório.
					</DialogDescription>
				</DialogHeader>
				...
				<Tabs defaultValue="pdf" className="w-full">
					...
					<TabsContent value="pdf" className="space-y-4 py-4">
						<div className="bg-slate-100 p-4 rounded text-sm text-slate-600">
							<p className="mb-2">
								<strong>Conteúdo:</strong> Relatório completo com dados
								técnicos, resumo ao paciente, gráficos e exercícios.
							</p>
							<p>
								<strong>Ideal para:</strong> Registro em prontuário, impressão
								ou envio por e-mail.
							</p>
						</div>
					...
					<TabsContent value="whatsapp" className="space-y-4 py-4">
						<div className="bg-green-50 p-3 rounded border border-green-200 text-green-800 text-sm mb-2">
							Atenção: A FisioFlow não envia mensagens automaticamente. Copie o
							texto abaixo e cole no seu WhatsApp.
						</div>
						<div className="space-y-2">
