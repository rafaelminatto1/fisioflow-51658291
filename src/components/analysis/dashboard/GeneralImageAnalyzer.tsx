...
} from "@/services/ai/geminiVisionService";
...
const GeneralImageAnalyzer: React.FC<GeneralImageAnalyzerProps> = ({
	file,
}) => {
			...
			<Card className="w-[400px] flex flex-col p-4 gap-4 bg-slate-50 border-l">
				...
				>
					...
					<AlertDescription className="text-xs">
						Esta ferramenta é apenas para fins educacionais e de pesquisa. **Não
						deve ser usada para diagnóstico primário.**
					</AlertDescription>
				</Alert>
