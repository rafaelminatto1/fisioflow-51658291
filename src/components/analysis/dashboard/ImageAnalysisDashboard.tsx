...
const MOCK_GAIT_DATA: GaitMetrics = {
  ...
  quality: {
    landmark_confidence_mean_0_1: 0.95,
    occlusion_pct: 0,
    analysis_confidence_0_100: 98,
  },
    ...
    <MainLayout>
      <div className="flex flex-col h-[calc(100vh-8rem)] gap-6">
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold tracking-tight">Análise de Imagens & Movimento</h1>
              ...
              <div className="flex flex-col items-center gap-4 text-center p-8">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground max-w-sm mx-auto">
                    Suporta vídeos clínicos e imagens comuns para postura, marcha, corrida em
                    esteira e comparação antes x depois.
                  </p>
                </div>
                ...
                <div className="mt-8 border-t pt-6 w-full max-w-md space-y-2">
                  ...
                  <Button
                    variant="outline"
                    className="w-full"
                    onClick={() => handleModeChange("dynamic_demo")}
                  >
                  ...
                  <Button
                    ...
                    onClick={() => handleModeChange("dynamic_compare")}
                  >
