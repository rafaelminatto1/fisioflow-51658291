...
export function getPatientId(
  appointment: AppointmentUnified | { patientId?: string; patient_id?: string } | null | undefined,
): string {
...
export function getDate(
  appointment: AppointmentUnified | { date?: string; appointment_date?: string } | null | undefined,
): string {
  if (!appointment) return "";
