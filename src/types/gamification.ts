 ...
 */
export function isValidAchievementRequirement(
	value: unknown,
): value is AchievementRequirement {
 ...
 */
export function parseAchievementRequirements(
	requirements: AchievementRequirement | string,
): AchievementRequirement {
	if (typeof requirements === "string") {
		try {
			const parsed = JSON.parse(requirements);
			return achievementRequirementSchema.parse(
				parsed,
