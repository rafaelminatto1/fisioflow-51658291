...
const emailValidator = z
	.string()
	.refine((val) => !val || isValidEmail(val), { message: "Email inválido" })
	.optional()
	.nullable();
...
const nameValidator = z
	.string()
	.refine((val) => val.trim().length >= 3 && isValidName(val), {
...
export const PatientFormSchema = z.object({
	...
	full_name: z
		...
		.refine((val) => isValidName(val), {
			message: "Digite o nome completo (nome + sobrenome)",
		}),
	...
	medical_history: z
		.string()
		.max(5000, "Histórico muito longo")
		.optional()
		.nullable(),
	main_condition: z
		.string()
		.max(500, "Condição muito longa")
		.optional()
		.nullable(),
	allergies: z.string().max(500, "Alergias muito longas").optional().nullable(),
	medications: z
		.string()
		.max(500, "Medicamentos muito longos")
		.optional()
		.nullable(),
	...
	profession: z
		.string()
		.max(200, "Profissão muito longa")
		.optional()
		.nullable(),
	education_level: z.string().optional().nullable(),
	health_insurance: z
		.string()
		.max(200, "Plano muito longo")
		.optional()
		.nullable(),
	insurance_number: z
		.string()
