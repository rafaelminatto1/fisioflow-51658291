...
const nameValidator = z.string().refine((val) => val.trim().length >= 3 && isValidName(val), {
...
export const PatientFormSchema = z.object({
  ...
  referred_by: z.string().max(150, "Origem da indicação muito longa").optional().nullable(),
