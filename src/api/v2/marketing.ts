...
export const marketingApi = {
  ...
  reviewConfig: {
    get: () => request<{ data: ReviewAutomationConfigRecord }>("/api/marketing/review-config"),
  ...
  birthdayConfig: {
    get: () => request<{ data: BirthdayAutomationConfigRecord }>("/api/marketing/birthday-config"),
  ...
  recallCampaigns: {
    list: () => request<{ data: RecallCampaignRecord[] }>("/api/marketing/recall-campaigns"),
  ...
  fisiolink: {
    getMine: () => request<{ data: FisioLinkConfigRecord | null }>("/api/marketing/fisiolink"),
  ...
  contentCalendar: {
    list: () => request<{ data: ContentCalendarRecord[] }>("/api/marketing/content-calendar"),
  ...
  sendWhatsAppTemplate: (data: {
    ...
    request<{ data: { status: string; message_id?: string } }>("/api/whatsapp/send-template", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  atRiskPatients: () =>
