...
export const tarefasApi = {
  list: (params?: { projectId?: string }) =>
    request<{ data: Record<string, unknown>[] }>(withQuery("/api/tarefas", params)),
...
export const boardsApi = {
  ...
  get: (id: string) => request<{ data: Record<string, unknown> }>(`/api/boards/${id}`),
  create: (data: {
    name: string;
    description?: string;
  ...
  delete: (id: string) => request<{ ok: boolean }>(`/api/boards/${id}`, { method: "DELETE" }),
...
export const boardLabelsApi = {
  list: (boardId: string) =>
    request<{ data: Record<string, unknown>[] }>(`/api/boards/${boardId}/labels`),
  create: (boardId: string, data: { name: string; color: string; description?: string }) =>
    request<{ data: Record<string, unknown> }>(`/api/boards/${boardId}/labels`, {
      method: "POST",
      body: JSON.stringify(data),
    }),
  update: (labelId: string, data: Record<string, unknown>) =>
    request<{ data: Record<string, unknown> }>(`/api/boards/labels/${labelId}`, {
      method: "PATCH",
      body: JSON.stringify(data),
    }),
...
export const boardChecklistTemplatesApi = {
  list: (boardId: string) =>
    request<{ data: Record<string, unknown>[] }>(`/api/boards/${boardId}/checklist-templates`),
  create: (
    boardId: string,
    data: {
      name: string;
  ...
  update: (templateId: string, data: Record<string, unknown>) =>
    request<{ data: Record<string, unknown> }>(`/api/boards/checklist-templates/${templateId}`, {
      method: "PATCH",
      body: JSON.stringify(data),
    }),
  delete: (templateId: string) =>
    request<{ ok: boolean }>(`/api/boards/checklist-templates/${templateId}`, { method: "DELETE" }),
...
export const boardAutomationsApi = {
  list: (boardId: string) =>
    request<{ data: Record<string, unknown>[] }>(`/api/boards/${boardId}/automations`),
  ...
  update: (automationId: string, data: Record<string, unknown>) =>
    request<{ data: Record<string, unknown> }>(`/api/boards/automations/${automationId}`, {
      method: "PATCH",
      body: JSON.stringify(data),
    }),
  delete: (automationId: string) =>
    request<{ ok: boolean }>(`/api/boards/automations/${automationId}`, { method: "DELETE" }),
