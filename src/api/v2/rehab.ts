...
export const telemedicineApi = {
  rooms: {
    ...
    get: (id: string) => request<{ data: TelemedicineRoomRecord }>(`/api/telemedicine/rooms/${id}`),
...
export const exercisePlansApi = {
  list: (params?: { patientId?: string }) =>
    request<{ data: Array<Record<string, unknown>> }>(withQuery("/api/exercise-plans", params)),
  create: (data: Record<string, unknown>) =>
...
export const exerciseVideosApi = {
  list: (params?: {
    ...
    request<{ data: Array<Record<string, unknown>> }>(withQuery("/api/exercise-videos", params)),
  get: (id: string) =>
