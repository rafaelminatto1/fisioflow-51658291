...
export const gamificationApi = {
  ...
  getShopItems: () => request<{ data: ShopItemRow[] }>("/api/gamification/shop"),

  getAllShopItems: () => request<{ data: ShopItemRow[] }>("/api/gamification/shop-items"),
  ...
  getSettings: () => request<{ data: GamificationSettingRow[] }>("/api/gamification/settings"),
  ...
  achievementDefinitions: {
    list: () => request<{ data: AchievementRow[] }>("/api/gamification/achievement-definitions"),
  ...
  questDefinitions: {
    list: () => request<{ data: QuestDefinitionRow[] }>("/api/gamification/quest-definitions"),
