...
exports.runMigration = (0, https_1.onCall)({ cors: cors_1.CORS_ORIGINS }, function (request) { return __awaiter(void 0, void 0, void 0, function () {
    var pool, client, slugCheck, activeCheck, result, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            return [4 /*yield*/, client.query("UPDATE organizations SET active = true WHERE active IS NULL")];
            case 14:
                // Update any NULL values
                _a.sent();
