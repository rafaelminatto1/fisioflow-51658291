...
exports.dailyPatientDigest = void 0;
var scheduler_1 = require("firebase-functions/v2/scheduler");
var init_1 = require("../init");
var logger_1 = require("../lib/logger");
exports.dailyPatientDigest = (0, scheduler_1.onSchedule)({
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                logger_1.logger.info('Running daily patient digest...');
            ...
            case 2:
                result = _a.sent();
                logger_1.logger.info("Found ".concat(result.rows.length, " patients requiring clinical review."));
                return [3 /*break*/, 4];
            case 3:
                error_1 = _a.sent();
                logger_1.logger.error('Error in dailyPatientDigest:', error_1);
                return [3 /*break*/, 4];
