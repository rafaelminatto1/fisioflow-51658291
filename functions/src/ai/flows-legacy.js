...
exports.analyzeProgressLegacy = exports.analyzePatientProgressFlow = void 0;
 ...
 */
exports.analyzePatientProgressFlow = ai.defineFlow({
    name: 'analyzePatientProgress',
    inputSchema: genkit_1.z.object({
        patientName: genkit_1.z.string(),
        diagnosis: genkit_1.z.string(),
        lastEvolutions: genkit_1.z.array(genkit_1.z.string()), // Últimas 3 evoluções
        goals: genkit_1.z.array(genkit_1.z.string()) // Metas do paciente
    }),
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [2 /*return*/, output]; // Cast necessário pois o output é inferido
        }
    });
}); });
/**
 ...
 */
exports.analyzeProgressLegacy = (0, https_1.onCall)({ cpu: 2, memory: '1GiB' }, function (request) { return __awaiter(void 0, void 0, void 0, function () {
    var RequestSchema, validData, result, e_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!request.auth) {
                ...
                RequestSchema = genkit_1.z.object({
                    patientName: genkit_1.z.string().min(1),
                    diagnosis: genkit_1.z.string().min(1),
                    lastEvolutions: genkit_1.z.array(genkit_1.z.string()).min(1, 'Pelo menos uma evolução é necessária'),
                    goals: genkit_1.z.array(genkit_1.z.string()).min(1, 'Pelo menos uma meta é necessária')
                });
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                validData = RequestSchema.parse(request.data);
                return [4 /*yield*/, (0, exports.analyzePatientProgressFlow)(validData)];
            case 2:
                result = _a.sent();
            ...
            case 3:
                ...
                if (e_1 instanceof genkit_1.z.ZodError) {
                    throw new Error("Dados inv\u00E1lidos: ".concat(e_1.issues.map(function (err) { return err.message; }).join(', ')));
                }
