...
exports.generateExercisePlan = void 0;
 ...
 */
exports.generateExercisePlan = config_1.ai.defineFlow({
    name: 'generateExercisePlan',
    inputSchema: schemas_1.GeneratePlanInputSchema,
    outputSchema: schemas_1.ExercisePlanSchema,
}, function (input) { return __awaiter(void 0, void 0, void 0, function () {
    var prompt, output;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                prompt = "Como fisioterapeuta especialista, crie um plano de exerc\u00EDcios personalizado:\n\nDADOS DO PACIENTE:\n".concat(JSON.stringify(input, null, 2), "\n\nGere um plano estruturado com exerc\u00EDcios espec\u00EDficos, progress\u00F5es e orienta\u00E7\u00F5es.");
                return [4 /*yield*/, config_1.ai.generate({
                        ...
                        output: {
                            format: 'json',
                            schema: schemas_1.ExercisePlanSchema,
                        },
                    })];
            case 1:
