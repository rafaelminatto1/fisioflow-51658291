...
exports.fixAppointmentIndexHandler = void 0;
 ...
 */
var fixAppointmentIndexHandler = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var pool, constraintsToDrop, _i, constraintsToDrop_1, constraint, e_1, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, pool.query("DROP INDEX IF EXISTS idx_appointments_time_conflict")];
            case 2:
                // 1. Drop known indices
                _a.sent();
                ...
                _i = 0, constraintsToDrop_1 = constraintsToDrop;
                _a.label = 3;
            case 3:
                if (!(_i < constraintsToDrop_1.length)) return [3 /*break*/, 8];
                constraint = constraintsToDrop_1[_i];
                _a.label = 4;
            case 4:
                _a.trys.push([4, 6, , 7]);
                return [4 /*yield*/, pool.query("ALTER TABLE appointments DROP CONSTRAINT IF EXISTS \"".concat(constraint, "\""))];
            case 5:
                _a.sent();
                console.log("[Migration] Attempted to drop constraint: ".concat(constraint));
                return [3 /*break*/, 7];
            case 6:
                e_1 = _a.sent();
                console.warn("[Migration] Failed to drop constraint ".concat(constraint, " (likely does not exist):"), e_1.message);
                return [3 /*break*/, 7];
            case 7:
                _i++;
                return [3 /*break*/, 3];
            ...
            case 11:
                error_1 = _a.sent();
                console.error('[Migration] Critical error fixing indices:', error_1);
                res.status(500).json({
                    success: false,
...
exports.fixAppointmentIndexHandler = fixAppointmentIndexHandler;
