 ...
 */
exports.generateUploadToken = (0, https_1.onCall)({ cors: init_1.CORS_ORIGINS }, async (request) => {
 ...
 */
exports.confirmUpload = (0, https_1.onCall)({ cors: init_1.CORS_ORIGINS }, async (request) => {
    const { data, auth } = request;
    if (!auth) {
        throw new https_1.HttpsError('unauthenticated', 'User must be authenticated');
    }
 ...
 */
exports.deleteFile = (0, https_1.onCall)({ cors: init_1.CORS_ORIGINS }, async (request) => {
    const { data, auth } = request;
    if (!auth) {
        throw new https_1.HttpsError('unauthenticated', 'User must be authenticated');
    }
 ...
 */
exports.listUserFiles = (0, https_1.onCall)({ cors: init_1.CORS_ORIGINS }, async (request) => {
    const { data, auth } = request;
    if (!auth) {
        throw new https_1.HttpsError('unauthenticated', 'User must be authenticated');
    }
