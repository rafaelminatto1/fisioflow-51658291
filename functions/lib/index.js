...
exports.setupMonitoring = exports.runPerformanceIndexes = exports.createPerformanceIndexes = exports.runMigrationHttp = exports.runMigration = exports.createAdminUser = exports.translateExercise = exports.getSupportedLanguages = exports.detectLanguage = exports.translate = exports.transcribeLongAudio = exports.transcribeAudio = exports.synthesizeTTS = exports.listUserFiles = exports.deleteStorageFile = exports.confirmUpload = exports.generateUploadToken = exports.healthCheck = exports.apiEvaluate = exports.updateTreatmentSession = exports.createTreatmentSession = exports.listTreatmentSessions = exports.updateMedicalRecord = exports.createMedicalRecord = exports.savePainRecord = exports.getPainRecords = exports.getPatientRecords = exports.savePainRecordV2 = exports.getPainRecordsV2 = exports.createTreatmentSessionV2 = exports.listTreatmentSessionsV2 = exports.deleteMedicalRecordV2 = exports.updateMedicalRecordV2 = exports.createMedicalRecordV2 = exports.getPatientRecordsV2 = exports.getEventReport = exports.findTransactionByAppointmentId = exports.deleteTransaction = exports.updateTransaction = exports.createTransaction = exports.listTransactions = exports.getEventReportV2 = exports.findTransactionByAppointmentIdV2 = exports.deleteTransactionV2 = exports.updateTransactionV2 = exports.createTransactionV2 = exports.listTransactionsV2 = exports.createPayment = exports.listPayments = exports.getPatientStats = void 0;
exports.expiringVouchers = exports.weeklySummary = exports.dailyReports = exports.dailyReminders = exports.onAppointmentUpdated = exports.onAppointmentCreated = exports.onPatientCreated = exports.apiRouter = exports.realtimePublish = exports.scheduledWeeklyReport = exports.scheduledDailyReport = exports.downloadReport = exports.getReport = exports.listReports = exports.generateAIReport = exports.cleanupOldTraces = exports.performanceStream = exports.getPerformanceTrends = exports.getTraceTimeline = exports.getSlowRequests = exports.getPerformanceStats = exports.cleanupOldErrors = exports.getErrorTrends = exports.errorStream = exports.getErrorDetails = exports.resolveError = exports.getRecentErrors = exports.getErrorStats = exports.downloadExport = exports.importPatients = exports.exportPatients = exports.getWebhookEventTypes = exports.testWebhook = exports.listWebhooks = exports.unsubscribeWebhook = exports.subscribeWebhook = exports.analyzeProgress = exports.dailyPatientDigest = exports.migrateClinicalSchema = exports.scanMedicalReportHttp = exports.getClinicalInsightsHttp = exports.getPatientAISummaryHttp = exports.aiGetSuggestions = exports.aiSoapNoteChat = exports.aiExerciseRecommendationChat = exports.aiClinicalChat = exports.aiMovementAnalysis = exports.aiClinicalAnalysis = exports.aiSoapGeneration = exports.aiExerciseSuggestion = void 0;
exports.withPerformanceTracing = exports.startHttpTrace = exports.measureFirestore = exports.measureDatabase = exports.measureHttpCall = exports.measure = exports.startTrace = exports.createCrashlyticsLogger = exports.setCustomKeys = exports.setCustomKey = exports.clearUserId = exports.setUserId = exports.recordError = exports.initCrashlytics = exports.updateUserRole = exports.listUsers = exports.onUserCreated = exports.testWhatsAppTemplate = exports.testWhatsAppMessage = exports.patientReactivation = exports.onAppointmentUpdatedWorkflow = exports.onAppointmentCreatedWorkflow = exports.appointmentReminders = exports.emailWebhook = exports.processNotificationQueue = exports.sendNotificationBatch = exports.sendNotification = exports.dataIntegrity = exports.cleanup = exports.birthdays = void 0;
...
// ============================================================================
const tts_1 = require("./api/tts");
Object.defineProperty(exports, "synthesizeTTS", { enumerable: true, get: function () { return tts_1.synthesizeTTS; } });
const speech_1 = require("./api/speech");
Object.defineProperty(exports, "transcribeAudio", { enumerable: true, get: function () { return speech_1.transcribeAudio; } });
Object.defineProperty(exports, "transcribeLongAudio", { enumerable: true, get: function () { return speech_1.transcribeLongAudio; } });
...
Object.defineProperty(exports, "detectLanguage", { enumerable: true, get: function () { return translation_1.detectLanguage; } });
...
Object.defineProperty(exports, "translateExercise", { enumerable: true, get: function () { return translation_1.translateExercise; } });
// Admin Functions
...
const ai_assistant_1 = require("./api/ai-assistant");
Object.defineProperty(exports, "getPatientAISummaryHttp", { enumerable: true, get: function () { return ai_assistant_1.getPatientAISummaryHttp; } });
const clinical_insights_1 = require("./api/clinical-insights");
Object.defineProperty(exports, "getClinicalInsightsHttp", { enumerable: true, get: function () { return clinical_insights_1.getClinicalInsightsHttp; } });
const ocr_scanner_1 = require("./api/ocr-scanner");
Object.defineProperty(exports, "scanMedicalReportHttp", { enumerable: true, get: function () { return ocr_scanner_1.scanMedicalReportHttp; } });
const clinical_setup_1 = require("./migrations/clinical-setup");
Object.defineProperty(exports, "migrateClinicalSchema", { enumerable: true, get: function () { return clinical_setup_1.migrateClinicalSchema; } });
const scheduled_tasks_1 = require("./crons/scheduled-tasks");
...
const flows_1 = require("./ai/flows");
Object.defineProperty(exports, "analyzeProgress", { enumerable: true, get: function () { return flows_1.analyzeProgress; } });
// ============================================================================
// WEBHOOK MANAGEMENT
// ============================================================================
