...
exports.clinicalAnalysis = void 0;
...
exports.clinicalAnalysis = (0, https_1.onCall)({
    ...
    try {
        ...
        const caseData = {
            ...
            previousSessions: previousSessions.map((soap) => ({
        ...
        const aiResult = await generateClinicalAnalysis(caseData, data.useGrounding ?? false, data.redFlagCheckOnly ?? false);
        if (!aiResult.success) {
        ...
        throw new https_1.HttpsError('internal', error instanceof Error ? error.message : 'Failed to generate clinical analysis');
    }
});
// ============================================================================
// HELPER FUNCTIONS
 ...
 */
async function generateClinicalAnalysis(caseData, useGrounding, redFlagCheckOnly) {
    try {
...
Return ONLY valid JSON matching the provided schema.`;
        ...
        const estimatedCost = (promptTokens / 1000000) * costPerMillionInput +
...
//# sourceMappingURL=clinical-analysis.js.map