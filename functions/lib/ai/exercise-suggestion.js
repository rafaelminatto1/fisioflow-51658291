...
exports.exerciseSuggestion = void 0;
...
exports.exerciseSuggestion = (0, https_1.onCall)({
    ...
    try {
        ...
        throw new https_1.HttpsError('internal', error instanceof Error ? error.message : 'Failed to generate exercise suggestions');
    }
});
// ============================================================================
// HELPER FUNCTIONS
 ...
 */
async function generateExerciseSuggestions(context) {
    try {
...
Return ONLY valid JSON matching this structure:
{
  ...
  "estimatedDuration": minutes
        ...
        const estimatedCost = (promptTokens / 1000000) * 0.075 +
...
function buildExercisePrompt(context) {
    ...
    const recentSOAP = (soapHistory || []).slice(-3).map((soap) => `
...
//# sourceMappingURL=exercise-suggestion.js.map