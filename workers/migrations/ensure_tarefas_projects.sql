-- Migration: Ensure tarefas and projects tables exist
-- Run this against Neon database if getting 500 errors on /api/tarefas or /api/projects
...
-- ============================================
-- SATISFACTION SURVEYS TABLE (if not exists)
-- ============================================
...
-- ============================================
-- PROFILES TABLE (ensure exists for JOIN)
-- ============================================
...
-- Verification query - should return 0 if all tables exist
DO $$
BEGIN
  RAISE NOTICE 'Migration completed successfully!';
  RAISE NOTICE 'Tables created/verified: projects, tarefas, user_invitations, satisfaction_surveys, profiles';
END $$;