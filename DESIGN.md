...
- _Example:_ A card using `surface-container-highest` sits directly on a `surface` background. The change in luminance creates the edge, making the UI feel "carved" rather than "drawn."
