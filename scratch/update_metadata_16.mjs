...
const updates = [
  {
    id: "e6f47701-d572-4663-8a30-36b3db815413",
    progression: "Aumentar a amplitude lateral gradualmente conforme a tolerância.",
    sets: 3,
    reps: 15,
    rpe: 3,
  },
  {
    id: "e8a34241-d85c-4860-982c-3597c234a9b8",
    progression: "Realizar com bastão ou banda elástica para assistência/resistência.",
    sets: 3,
    reps: 12,
    rpe: 4,
  },
  {
    id: "016f443a-7a54-4a41-86f2-2b34a623704b",
    progression: "Inclinar o tronco mais à frente para alongar fibras posteriores do manguito.",
    sets: 3,
    reps: 30,
    rpe: 4,
  },
  {
    id: "f402ec3b-d421-4f1e-922e-33631587372b",
    progression: "Ponte unilateral ou com pés sobre superfície instável.",
    sets: 3,
    reps: 12,
    rpe: 5,
  },
