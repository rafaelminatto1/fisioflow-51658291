...
ALTER FUNCTION public.check_appointment_conflict(uuid, timestamp with time zone, timestamp with time zone, uuid) SET search_path = public, extensions;
ALTER FUNCTION public.publish_goal_profile(uuid) SET search_path = public, extensions;
ALTER FUNCTION public.update_schedule_capacity_config_updated_at() SET search_path = public, extensions;
ALTER FUNCTION public.get_available_time_slots(date, uuid) SET search_path = public, extensions;
...
ALTER FUNCTION public.calculate_patient_trends(uuid) SET search_path = public, extensions;
...
ALTER FUNCTION public.calculate_comprehensive_adherence(uuid) SET search_path = public, extensions;
...
ALTER FUNCTION public.add_to_email_queue(uuid, varchar, varchar, jsonb, int, timestamp) SET search_path = public, extensions;
ALTER FUNCTION public.get_email_stats(date, date) SET search_path = public, extensions;
ALTER FUNCTION public.process_email_queue(int) SET search_path = public, extensions;
ALTER FUNCTION public.update_patient_sessions_updated_at() SET search_path = public, extensions;
ALTER FUNCTION public.create_session_package(uuid, uuid, int, numeric, date) SET search_path = public, extensions;
ALTER FUNCTION public.update_appointments_updated_at() SET search_path = public, extensions;
ALTER FUNCTION public.should_send_notification(uuid, varchar) SET search_path = public, extensions;
ALTER FUNCTION public.log_notification(uuid, varchar, varchar, varchar) SET search_path = public, extensions;
ALTER FUNCTION public.update_notification_status(uuid, varchar) SET search_path = public, extensions;
ALTER FUNCTION public.get_notification_analytics(date, date) SET search_path = public, extensions;
...
ALTER FUNCTION public.use_session_from_package(uuid, uuid) SET search_path = public, extensions;
ALTER FUNCTION public.get_patient_financial_summary(uuid) SET search_path = public, extensions;
ALTER FUNCTION public.get_user_role(uuid) SET search_path = public, extensions;
...
ALTER FUNCTION public.get_user_permissions(uuid) SET search_path = public, extensions;
