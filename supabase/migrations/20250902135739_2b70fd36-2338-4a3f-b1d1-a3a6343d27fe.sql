...
BEGIN
    ...
    BEGIN
        ...
        IF has_gender AND has_main_condition AND has_status AND has_address AND has_medical_history THEN
            ...
            VALUES 
            (gen_random_uuid(), 'Maria Silva', 'maria.silva@email.com', '(11) 98888-1111', '1985-03-15', 'F', 'Lombalgia', 'Ativo', 'Rua das Flores, 123 - São Paulo/SP', 'Histórico de dor lombar há 2 anos. Trabalha em escritório.'),
            (gen_random_uuid(), 'João Santos', 'joao.santos@email.com', '(11) 98888-2222', '1978-07-22', 'M', 'Lesão no ombro', 'Ativo', 'Av. Principal, 456 - São Paulo/SP', 'Lesão durante atividade esportiva. Pratica tênis recreativo.'),
            (gen_random_uuid(), 'Ana Oliveira', 'ana.oliveira@email.com', '(11) 98888-3333', '1992-11-08', 'F', 'Dor cervical', 'Inicial', 'Rua da Esperança, 789 - São Paulo/SP', 'Dor cervical por postura inadequada no trabalho. Primeira consulta.'),
            (gen_random_uuid(), 'Carlos Pereira', 'carlos.pereira@email.com', '(11) 98888-4444', '1965-05-30', 'M', 'Artrose de joelho', 'Em tratamento', 'Rua do Comércio, 321 - São Paulo/SP', 'Artrose bilateral de joelhos. Aposentado, 65 anos.'),
            (gen_random_uuid(), 'Fernanda Costa', 'fernanda.costa@email.com', '(11) 98888-5555', '1988-12-03', 'F', 'Fibromialgia', 'Ativo', 'Av. das Palmeiras, 654 - São Paulo/SP', 'Diagnóstico de fibromialgia. Professora, 35 anos.')
