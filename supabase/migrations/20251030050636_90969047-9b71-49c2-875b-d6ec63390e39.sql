...
CREATE INDEX idx_ai_suggestions_patient ON public.ai_suggestions(patient_id);
CREATE INDEX idx_ai_suggestions_created ON public.ai_suggestions(created_at);
CREATE INDEX idx_gamification_patient ON public.patient_gamification(patient_id);
CREATE INDEX idx_achievements_patient ON public.achievements_log(patient_id);
CREATE INDEX idx_xp_transactions_patient ON public.xp_transactions(patient_id);
