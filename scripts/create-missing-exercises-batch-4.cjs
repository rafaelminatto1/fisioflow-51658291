...
const DATABASE_URL = 'postgresql://neondb_owner:npg_GDT83hbugqXf@ep-wandering-bonus-acj4zwvo-pooler.sa-east-1.aws.neon.tech/neondb?channel_binding=require&sslmode=require';
