...
const DB_URL = "postgresql://neondb_owner:npg_GDT83hbugqXf@ep-wandering-bonus-acj4zwvo.sa-east-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require";
