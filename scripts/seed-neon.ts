...
const EXERCISES = [
  // ── JOELHO ──────────────────────────────────────────────
  {
    ...
    description: 'Exercício isométrico para fortalecimento do quadríceps com apoio de parede. Ideal para as fases iniciais de reabilitação de joelho.',
    ...
    durationSeconds: 30,
    restSeconds: 45,
    pathologiesIndicated: ['Condromalácia patelar', 'Tendinopatia patelar', 'Pós-operatório LCA', 'Artrose de joelho'],
  ...
  },
  {
    ...
    categorySlug: 'joelho',
    difficulty: 'iniciante' as const,
    description: 'Exercício clássico de fortalecimento do quadríceps em cadeia aberta, indicado nas fases pós-operatórias precoces.',
    ...
    repsRecommended: 15,
    restSeconds: 30,
    pathologiesIndicated: ['Pós-operatório LCA fase 1', 'Condromalácia patelar', 'Síndrome patelofemoral'],
  ...
  },
  {
    ...
    categorySlug: 'joelho',
    difficulty: 'iniciante' as const,
    description: 'Fortalecimento do quadríceps em cadeia aberta com resistência progressiva. Use amplitude reduzida (90-40°) em casos patelofemoral.',
  ...
  },
  {
    ...
    description: 'Exercício funcional de subida de degrau para fortalecimento de quadríceps e glúteos em cadeia fechada. Excelente para retorno às AVDs.',
    ...
    repsRecommended: 10,
    restSeconds: 60,
    pathologiesIndicated: ['Pós-operatório LCA fase 3-4', 'Artrose leve', 'Fraqueza funcional de MMII'],
  ...
  },
  {
    ...
    categorySlug: 'joelho',
    difficulty: 'intermediario' as const,
    description: 'Ativação específica do VMO nos últimos 30° de extensão. Fundamental na reabilitação patelofemoral e pós-LCA.',
  ...
  // ── OMBRO ───────────────────────────────────────────────
  {
    ...
    categorySlug: 'ombro',
    difficulty: 'iniciante' as const,
    description: 'Exercício de mobilização passiva precoce do ombro pela gravidade. Indicado nas primeiras 24-48h pós-cirurgia ou trauma.',
    ...
    setsRecommended: 3,
    repsRecommended: 20,
    pathologiesIndicated: ['Pós-operatório de ombro precoce', 'Capsulite adesiva fase 1', 'Luxação glenoumeral'],
  ...
  },
  {
    ...
    categorySlug: 'ombro',
    difficulty: 'intermediario' as const,
    description: 'Fortalecimento do manguito rotador (infraespinhal e redondo menor). Essencial para estabilização dinâmica glenoumeral.',
    ...
    repsRecommended: 15,
    restSeconds: 45,
    pathologiesIndicated: ['Lesão de manguito rotador', 'Instabilidade glenoumeral', 'Pós-operatório de ombro fase 2'],
  ...
  },
  {
    ...
    categorySlug: 'ombro',
    difficulty: 'intermediario' as const,
    description: 'Fortalecimento do subescapular — principal rotador interno e estabilizador anterior do ombro.',
  ...
  // ── COLUNA ──────────────────────────────────────────────
  {
    ...
    categorySlug: 'coluna',
    difficulty: 'iniciante' as const,
    description: 'Exercício de estabilização da coluna com ativação de multífidos, transverso e extensores do quadril. Base de qualquer protocolo de lombalgia.',
    ...
    durationSeconds: 10,
    restSeconds: 30,
    pathologiesIndicated: ['Lombalgia crônica', 'Hérnia de disco lombar', 'Instabilidade lombar', 'Pós-operatório lombar'],
  ...
  },
  {
    ...
    categorySlug: 'coluna',
    difficulty: 'iniciante' as const,
    description: 'Ativação de glúteo máximo e isquiotibiais com estabilização lombar. Um dos exercícios mais versáteis da reabilitação.',
  ...
  },
  {
    ...
    categorySlug: 'coluna',
    difficulty: 'iniciante' as const,
    description: 'Mobilização em flexão-extensão da coluna para manutenção da hidratação discal e mobilidade segmentar.',
    ...
    repsRecommended: 10,
    restSeconds: 20,
    pathologiesIndicated: ['Lombalgia aguda', 'Rigidez matinal', 'Hérnia de disco (exceto extensão aguda)'],
  ...
  // ── QUADRIL ─────────────────────────────────────────────
  {
    ...
    difficulty: 'iniciante' as const,
    description: 'Isolamento do glúteo médio em rotação externa. Essencial para correção de valgo dinâmico e síndrome da dor femoropatelar.',
    ...
    repsRecommended: 15,
    restSeconds: 30,
    pathologiesIndicated: ['Síndrome patelofemoral', 'Tendinopatia glútea', 'Síndrome do piriforme', 'Dor femoropatelar'],
  ...
  },
  {
    ...
    categorySlug: 'quadril',
    difficulty: 'intermediario' as const,
    description: 'Fortalecimento funcional do glúteo médio em cadeia fechada. Fundamental para marcha e controle pélvico.',
  ...
  // ── TORNOZELO ───────────────────────────────────────────
  {
    ...
    difficulty: 'iniciante' as const,
    description: 'Fortalecimento do complexo sural (gastrocnêmio e sóleo) em cadeia fechada. Fundamental na reabilitação de tendinopatia de Aquiles.',
    ...
    repsRecommended: 15,
    restSeconds: 60,
    pathologiesIndicated: ['Tendinopatia de Aquiles', 'Fascite plantar', 'Pós-entorse de tornozelo fase 2-3'],
  ...
  // ── NEUROLOGIA ──────────────────────────────────────────
  {
    ...
    difficulty: 'iniciante' as const,
    description: 'Reeducação da marcha em ambiente seguro com suporte bilateral. Indicado para pacientes com déficit neuromotor.',
    ...
    durationSeconds: 120,
    restSeconds: 60,
    pathologiesIndicated: ['Hemiplegia pós-AVC', 'Parkinson estágio 2-3', 'Lesão medular incompleta', 'Pós-artroplastia'],
  ...
  // ── RESPIRATÓRIO ────────────────────────────────────────
  {
    ...
    difficulty: 'iniciante' as const,
    description: 'Técnica fundamental de controle respiratório com ativação do diafragma. Base de toda fisioterapia respiratória.',
    ...
    setsRecommended: 1,
    repsRecommended: 10,
    pathologiesIndicated: ['DPOC', 'Asma', 'Ansiedade', 'Pós-COVID', 'Dor lombar (respiração deficiente)'],
  ...
  // ── CORE ────────────────────────────────────────────────
  {
    ...
    categorySlug: 'core',
    difficulty: 'intermediario' as const,
    description: 'Exercício isométrico de alta ativação do core global. Progressão natural após estabilização básica.',
  ...
  // ── FUNCIONAL ───────────────────────────────────────────
  {
    ...
    difficulty: 'iniciante' as const,
    description: 'AVD fundamental que avalia e treina força funcional de MMII. Usado como teste (5-repetition STS test) e como exercício.',
    ...
    repsRecommended: 10,
    restSeconds: 45,
    pathologiesIndicated: ['Fraqueza funcional geral', 'Pós-artroplastia', 'Sarcopenia', 'Parkinson', 'Pós-AVC'],
...
const PROTOCOLS = [
  {
    ...
    weeksTotal: 24,
    description: 'Protocolo baseado em evidências para reabilitação após reconstrução do LCA com enxerto autólogo (tendão patelar ou isquiotibiais). Critérios de progressão baseados em função, não tempo.',
    objectives: 'Restaurar amplitude de movimento, força e função neuromuscular para retorno seguro ao esporte.',
    ...
    phases: [
      { name: 'Fase 1 — Inflamatória/Proteção', weekStart: 1, weekEnd: 2, goals: ['Controle da dor e edema', 'Extensão completa passiva', 'Ativação do quadríceps (SLR)', 'Marcha com auxílio'], precautions: ['Evitar flexão ativa de joelho acima de 90°', 'Gelo 20min 3-4x/dia', 'Elevação do membro'] },
      { name: 'Fase 2 — Fortalecimento Inicial', weekStart: 3, weekEnd: 6, goals: ['Flexão de 120°', 'Força de quadríceps ≥ 50% contra-lateral', 'Marcha sem auxílio'], precautions: ['Sem impacto', 'Sem pivô', 'Progressão gradual de carga'] },
      { name: 'Fase 3 — Fortalecimento Funcional', weekStart: 7, weekEnd: 12, goals: ['Flexão completa', 'Bicicleta ergométrica', 'Exercícios proprioceptivos avançados'], precautions: ['Sem corrida até semana 12', 'Avalie derrame articular antes de progredir'] },
      { name: 'Fase 4 — Retorno Progressivo ao Esporte', weekStart: 13, weekEnd: 20, goals: ['Corrida progressiva', 'Saltos e aterrissagens', 'Exercícios específicos da modalidade'], precautions: ['Limb Symmetry Index (LSI) ≥ 80% antes de iniciar corrida'] },
      { name: 'Fase 5 — Retorno ao Esporte', weekStart: 21, weekEnd: 24, goals: ['LSI ≥ 90%', 'Testes funcionais aprovados', 'Confiança psicológica'], precautions: ['Tampa Return to Sport Score ≥ 22 pontos'] },
    ],
    milestones: [
      { week: 2, title: 'Extensão Completa', criteria: ['0° de déficit de extensão', 'Controle ativo do quadríceps (SLR sem extensor lag)'], notes: 'Crítico — déficit de extensão preditivo de síndrome patelofemoral' },
      { week: 6, title: 'Marcha Normal sem Dispositivo', criteria: ['Padrão de marcha simétrico', 'Sem antálgica', 'Escada subindo sem apoio'] },
      { week: 12, title: 'Iniciando Corrida', criteria: ['Isocinético: 70% do contra-lateral', 'Sem derrame articular', 'Hop test unipodal ≥ 85%'] },
      { week: 20, title: 'Treino Específico', criteria: ['LSI ≥ 85%', 'Sem dor', 'Confiança subjetiva > 7/10'] },
      { week: 24, title: 'Alta para Esporte', criteria: ['LSI ≥ 90% em todos os testes', 'Tampa Scale < 17', 'ACL-RSI ≥ 56'] },
    ],
    restrictions: [
      { weekStart: 1, weekEnd: 6, description: 'Sem impacto de qualquer tipo', type: 'activity' as const },
      { weekStart: 1, weekEnd: 12, description: 'Sem corrida ou pivô', type: 'activity' as const },
      { weekStart: 1, weekEnd: 4, description: 'Peso parcial — progressão conforme tolerância', type: 'weight_bearing' as const },
    ],
    references: [
      { title: 'Criteria for return to sport after anterior cruciate ligament reconstruction', authors: 'Grindem H, Snyder-Mackler L, Moksnes H et al.', year: 2016, journal: 'British Journal of Sports Medicine', doi: '10.1136/bjsports-2016-096825' },
      { title: 'ACL Study Group Recommendations', authors: 'Wilk KE, Macrina LC, Cain EL et al.', year: 2012, journal: 'Journal of Orthopaedic & Sports Physical Therapy' },
    ],
    progressionCriteria: [
      { phase: 'Fase 1 → 2', criteria: ['Sem derrame articular', 'Extensão completa', 'Flexão ≥ 90°', 'Controle do quadríceps'] },
      { phase: 'Fase 2 → 3', criteria: ['Flexão ≥ 120°', 'Marcha normal', 'Força ≥ 50% contra-lateral'] },
      { phase: 'Fase 3 → 4', criteria: ['Flexão completa', 'Força ≥ 70% contra-lateral', 'Sem derrame'] },
    ],
  },
  {
    ...
    evidenceLevel: 'A' as const,
    weeksTotal: 8,
    description: 'Protocolo multimodal para lombalgia crônica (> 12 semanas) baseado em exercício ativo, educação em dor e ativação progressiva.',
    objectives: 'Redução da dor, melhora da funcionalidade e autoeficácia para manejo da dor crônica.',
    icd10Codes: ['M54.5'],
    tags: ['lombalgia', 'coluna', 'dor_cronica', 'core'],
    phases: [
      { name: 'Fase 1 — Ativação e Educação', weekStart: 1, weekEnd: 2, goals: ['Educação em neurociência da dor', 'Exercícios suaves de mobilidade', 'Redução do medo de movimento'], precautions: ['Evitar repouso prolongado', 'Manter nível de atividade'] },
      { name: 'Fase 2 — Estabilização', weekStart: 3, weekEnd: 5, goals: ['Ativação do transverso e multífidos', 'Bird Dog, Dead Bug, Ponte', 'Progressão de carga gradual'], precautions: ['Iniciar com carga mínima', 'Sem exercícios de alta carga se dor > 5/10'] },
      { name: 'Fase 3 — Fortalecimento e Funcionalidade', weekStart: 6, weekEnd: 8, goals: ['Exercícios funcionais (agachamento, step)', 'Retorno às atividades de vida diária', 'Plano de manutenção'], precautions: ['Monitorar flare-ups', 'Estratégia de retorno à atividade'] },
    ],
    milestones: [
      { week: 2, title: 'Mudança na Percepção da Dor', criteria: ['Compreensão do modelo biopsicossocial', 'Redução do medo de movimento (TSK < 37)'] },
      { week: 5, title: 'Estabilidade Core', criteria: ['Bird Dog 10s sem compensação', 'Ponte unipodal 10 reps'] },
      { week: 8, title: 'Alta com Plano de Manutenção', criteria: ['PSFS ≥ 6/10', 'Retorno ao trabalho/atividades', 'Plano de exercícios autônomo'] },
    ],
    references: [
      { title: 'Exercise therapy for chronic nonspecific low-back pain', authors: 'Hayden JA, van Tulder MW, Malmivaara A, Koes BW', year: 2005, journal: 'Cochrane Database of Systematic Reviews' },
    ],
    restrictions: [],
    progressionCriteria: [
      { phase: 'Fase 1 → 2', criteria: ['Compreensão da neurofisiologia da dor', 'Dor ≤ 4/10 no repouso', 'Engajamento ativo'] },
    ],
  },
  {
    ...
    weeksTotal: 16,
    description: 'Protocolo progressivo para as 3 fases da capsulite adesiva: dolorosa, rígida e de recuperação.',
    objectives: 'Recuperação gradual da amplitude de movimento glenoumeral e função do membro superior.',
    icd10Codes: ['M75.0'],
    tags: ['ombro', 'capsulite', 'mobilizacao', 'fase_dolorosa'],
    phases: [
      { name: 'Fase Dolorosa (Freezing)', weekStart: 1, weekEnd: 4, goals: ['Controle da dor', 'Manutenção da amplitude disponível', 'Pêndulo de Codman'], precautions: ['Não forçar amplitude', 'Evitar movimentos bruscos', 'Calor antes/gelo após'] },
      { name: 'Fase Rígida (Frozen)', weekStart: 5, weekEnd: 12, goals: ['Mobilização articular grau I-III', 'Deslizamentos capsulares', 'Alongamentos progressivos'], precautions: ['Mobilização abaixo do limiar de dor', 'Progredir amplitude semanalmente'] },
      { name: 'Fase de Recuperação (Thawing)', weekStart: 13, weekEnd: 16, goals: ['Fortalecimento do manguito rotador', 'Exercícios funcionais acima da cabeça', 'Retorno às atividades'], precautions: ['Monitorar dor nas amplitudes extremas'] },
    ],
    milestones: [
      { week: 4, title: 'Controle da Dor', criteria: ['Dor < 4/10 no repouso', 'Sono sem despertar álgico'] },
      { week: 8, title: 'Amplitude Mínima', criteria: ['Abdução ≥ 90°', 'Rotação externa ≥ 20°'] },
      { week: 16, title: 'Recuperação Funcional', criteria: ['Abdução ≥ 150°', 'Rotação externa ≥ 50°', 'Mão atrás das costas — L3'] },
    ],
    references: [
      { title: 'Adhesive capsulitis of the shoulder: review of pathophysiology and current clinical treatments', authors: 'Neviaser AS, Hannafin JA', year: 2010, journal: 'Sports Health' },
    ],
    restrictions: [
      { weekStart: 1, weekEnd: 4, description: 'Sem mobilização forçada ou passiva vigorosa', type: 'activity' as const },
    ],
    progressionCriteria: [],
  },
];
