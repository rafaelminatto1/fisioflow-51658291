  ...
  const newTemplates = [
    {
      ...
      description:
        "Protocolo baseado em evidências (2025) combinando exercícios resistidos e aeróbicos de baixo impacto.",
      category: "ortopedico",
      ...
      clinicalNotes:
        "Treino resistido mostrou maior relevância clínica a longo prazo (>30% melhora). Exercícios aquáticos recomendados para fase aguda de dor.",
      contraindications:
        "Exercícios de alta intensidade sem período de adaptação (risco de 'flare-ups').",
    ...
    },
    {
      ...
      description:
        "Foco em formação de hábito e micro-treinos para pacientes com baixo nível de atividade física.",
      category: "prevencao",
      ...
      clinicalNotes:
        "Uso de 'micro-workouts' (3-5 mins) durante o dia. Foco em movimentos funcionais básicos: sentar-levantar e caminhadas curtas.",
    ...
    },
    {
      ...
      description:
        "Fortalecimento dos flexores profundos do pescoço e estabilização escapulotorácica.",
      category: "ortopedico",
      ...
      clinicalNotes:
        "Exercício de 'chin-tuck' com biofeedback pressórico. Progressão para manutenção postural funcional.",
      contraindications:
        "Instabilidade cervical confirmada. Vertigem cervicogênica aguda não avaliada.",
    ...
    },
    {
      ...
      description:
        "Treino de Heavy Slow Resistance (HSR) e alongamento excêntrico para tendinopatia do cotovelo.",
      category: "ortopedico",
      ...
      clinicalNotes:
        "Protocolo Tyler Twist com barra flexível ou halteres. Carga excêntrica lenta (3-5 segundos).",
      contraindications:
        "Injeção de corticoide recente (< 2 semanas). Dor incapacitante ao repouso.",
      precautions:
        "Dor leve (2-3/10) durante o exercício é aceitável, desde que não piore após 24h.",
      evidenceLevel: "A",
    ...
    },
    {
      ...
      description:
        "Protocolo para Artroplastia Total de Quadril. Foco em independência funcional e segurança articular.",
      ...
      clinicalNotes:
        "Reforço de abdutores e treino de marcha. Educação sobre restrições de movimento.",
      contraindications:
        "Flexão de quadril > 90°, adução além da linha média ou rotação interna excessiva (conforme acesso cirúrgico).",
      precautions: "Monitorar sinais de TVP e integridade cicatricial.",
      evidenceLevel: "A",
      bibliographicReferences: [
        "Manske et al. Post-Surgical Rehab 2024",
        "AAOS Hip Arthroplasty Guidelines",
      ],
      templateType: "system",
    ...
    },
    {
      ...
      description:
        "Treino orientado a tarefas para pacientes em fase subaguda de recuperação neurológica.",
      category: "idosos",
      ...
      clinicalNotes:
        "Foco em descarga de peso no lado parético, simetria de tronco e transferências funcionais.",
      ...
      evidenceLevel: "A",
      bibliographicReferences: [
        "Winstein et al. AHA/ASA Guidelines",
        "Langhorne et al. Lancet Neurol",
      ],
      templateType: "system",
    ...
    },
    {
      ...
      estimatedDuration: 30,
      clinicalNotes:
        "Incentivo a padrões respiratórios diafragmáticos combinados com movimentos de MMSS e MMII.",
      ...
      evidenceLevel: "B",
      bibliographicReferences: [
        "Spruit et al. ATS/ERS Statement",
        "Cochrane Rehabilitation for COPD/Elderly",
      ],
      templateType: "system",
      patientProfile: "idosos",
      isActive: true,
