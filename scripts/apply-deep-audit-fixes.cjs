...
const fixes = [
    ...
    { slug: 'fortalecimento-de-gluteo', path: '/exercises/illustrations/fortalecimento-gluteo-lateral.avif' },
    ...
    { slug: 'alongamento-de-quadriceps-em-pe', path: '/exercises/illustrations/alongamento-quadriceps.avif' },
    { slug: 'ponte-de-gluteo-unilateral', path: '/exercises/illustrations/ponte-gluteo.avif' },
    { slug: 'deslizamento-de-calcanhar', path: '/exercises/illustrations/deslizamento-calcanhar.avif' },
    { slug: 'rotacao-externa-de-ombro', path: '/exercises/illustrations/rotacao-externa-ombro-elastico.avif' },
    { slug: 'deslizamento-de-nervo-mediano', path: '/exercises/illustrations/deslizamento-nervo-mediano.avif' },
    { slug: 'star-excursion-balance-test-sebt', path: '/exercises/illustrations/sebt.avif' },
    { slug: 'rotacao-externa-de-ombro-com-faixa', path: '/exercises/illustrations/rotacao-externa-ombro.avif' },
    { slug: 'mobilidade-de-ombro', path: '/exercises/illustrations/mobilidade-ombro.avif' },
    { slug: 'rotacao-interna-de-ombro-com-faixa', path: '/exercises/illustrations/rotacao-interna-ombro.avif' },
    ...
    { slug: 'mobilizacao-de-quadril-capsular', path: '/exercises/illustrations/mobilizacao-quadril-capsular.avif' },
    { slug: 'mobilizacao-de-ombro-com-bastao', path: '/exercises/illustrations/mobilizacao-ombro-bastao.avif' },
    { slug: 'deslizamento-do-nervo-mediano', path: '/exercises/illustrations/deslizamento-nervo-mediano.avif' },
    { slug: 'fortalecimento-de-preensao-bolinha', path: '/exercises/illustrations/fortalecimento-preensao-bolinha.avif' }
];
