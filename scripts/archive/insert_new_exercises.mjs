...
const newExercises = [
  {
    ...
    description:
      "Manobra de alongamento focada no músculo Iliopsoas. Desenvolvida para reduzir tensões na porção anterior do quadril, aliviar rigidez na região lombar e ampliar a flexibilidade articular da pelve.",
    instructions:
      "1. Ajoelhe-se com um joelho no chão (use um colchonete para conforto) e o outro pé à frente, formando um ângulo de 90 graus.\n2. Mantenha o tronco ereto e o core (abdômen) contraído.\n3. Projete o quadril levemente para a frente até sentir um alongamento na parte frontal da coxa e virilha da perna apoiada no chão.\n4. Mantenha a posição estática respirando profundamente durante todo o tempo estipulado.\n5. Troque de perna e repita.",
    ...
    precautions:
      "Interrompa imediatamente se sentir dor aguda no joelho apoiado ou pinçamento profundo no quadril.",
    benefits:
      "Diminuição do tônus muscular do flexor do quadril, alívio de dor lombar associada a tensão no psoas e melhora na marcha e corrida.",
  ...
  },
  {
    ...
    precautions:
      "Não coloque o rolo na região do pescoço (cervical) nem na parte inferior das costas (lombar). Apenas no meio das costas.",
    benefits:
      "Melhora da postura, aumento da expansibilidade da caixa torácica para respiração e alívio de dores em pescoço e ombros.",
  ...
  },
  {
    ...
    precautions:
      "Se tiver alguma lesão prévia no ombro ou sentir sensação de luxação, evite afundar muito o peito.",
    benefits:
      "Melhor flexibilidade de membros superiores, alívio de tensões de postura de escritório e aumento da eficiência em movimentos acima da cabeça (overhead).",
    equipment: [],
  ...
  },
  {
    ...
    precautions:
      "A coluna cervical é sensível. Interrompa imediatamente se sentir tontura, irradiação severa ou dor aguda no pescoço.",
    benefits:
      "Redução de cefaleias tensionais, alívio do estresse crônico cervical e melhora da mobilidade do pescoço.",
    equipment: [],
  ...
  },
  {
    ...
    precautions:
      "Pode ser desconfortável nos joelhos se houver histórico de menisco. Ajuste o ângulo fechando um pouco mais os joelhos se necessário.",
    benefits:
      "Aumento massivo do escopo de movimento do quadril, alívio de dores lombares secundárias a quadril rígido e melhor desempenho atlético.",
    equipment: ["Colchonete"],
