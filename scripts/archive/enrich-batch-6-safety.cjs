...
const enrichmentData = [
  ...
  },
  {
    ...
    benefits:
      "Melhora a rotação externa do ombro e alivia tensões na face anterior da articulação.",
  },
  {
  ...
  },
  {
    ...
    benefits:
      "Combina mobilidade de ombro com alongamento de tríceps, sendo útil para pós-operatórios tardios.",
  },
  {
    slug: "barra-fixa-pronada",
    precautions:
      "Exercício de alta intensidade; evitar em casos de lesões agudas nos ombros ou cotovelos.",
    benefits: "Fortalecimento global de dorsais, bíceps e estabilizadores da escápula.",
  },
  {
    slug: "avanco-com-salto",
    precautions:
      "Alto impacto articular; contraindicado para lesões agudas de menisco ou LCA sem reabilitação avançada.",
  ...
  },
  {
    ...
    benefits:
      "Fortalece glúteo máximo e quadríceps com menor estresse na patela que o avanço frontal.",
  },
  {
  ...
  },
  {
    ...
    benefits:
      "Fortalece o tibial posterior, essencial para sustentar o arco plantar e prevenir entorses.",
  },
  {
  ...
  },
  {
    ...
    benefits:
      "Aumenta a resistência muscular e a estabilidade articular sem o impacto do movimento.",
  },
];
