  ...
  const allTemplates = [
    {
      ...
      description:
        "Foco em controle de edema, extensão total e ativação de quadríceps pós-reconstrução de LCA.",
      ...
      clinicalNotes:
        "Meta: Extensão 0° passiva. Ativação de quadríceps sem lag. Marcha com descarga de peso conforme tolerado.",
      contraindications:
        "Cadeia cinética aberta (extensão) entre 30-0°. Rotação excessiva do joelho.",
      precautions: "Monitorar sinais inflamatórios e integridade da incisão.",
      evidenceLevel: "A",
      bibliographicReferences: [
        "Wright et al. JAAOS 2015",
        "MGB Sports Medicine ACL Protocol 2025",
      ],
      templateType: "system",
    ...
    },
    {
      ...
      description:
        "Protocolo focado em equilíbrio de força do manguito rotador e controle escapular.",
      category: "ortopedico",
      ...
      clinicalNotes:
        "Enfâse em infraespinal e redondo menor para centramento da cabeça umeral. Mobilidade da cápsula posterior.",
      contraindications:
        "Exercícios acima de 90° de flexão/abdução se houver dor aguda (arco doloroso).",
    ...
    },
    {
      ...
      description:
        "Treino pliométrico, agilidade e estabilidade dinâmica para entorses grau II/III.",
      category: "esportivo",
      ...
      clinicalNotes:
        "Pular corda, saltos em Y, mudanças de direção. Uso de tape funcional se necessário.",
      ...
      evidenceLevel: "A",
      bibliographicReferences: [
        "Doherty et al. Sports Med 2017",
        "JOSPT Ankle Sprain Guidelines 2021",
      ],
      templateType: "system",
    ...
    },
    {
      ...
      description:
        "Treino de força funcional e equilíbrio dinâmico para idosos frágeis ou pré-frágeis.",
      category: "geriatrico",
      ...
      clinicalNotes:
        "Sentar e levantar, marcha tandem, fortalecimento de tríceps sural e glúteos. SPPB como avaliação.",
      contraindications: "Instabilidade hemodinâmica severa. Vertigem aguda não diagnosticada.",
      precautions:
        "Sempre próximo a barras ou suporte. Monitorar saturação e frequência se DPOC/ICC associado.",
      evidenceLevel: "A",
      bibliographicReferences: [
        "Cruz-Jentoft et al. Age Ageing 2019",
        "Fragility Fracture Network Guidelines",
      ],
      templateType: "system",
    ...
    },
    {
      ...
      clinicalNotes:
        "Focar em fenômeno de centralização. Exercícios de extensão se preferência direcional confirmada.",
      ...
      bibliographicReferences: [
        "McKenzie & May 2003",
        "Danish Health Authority Clinical Guidelines",
      ],
      templateType: "system",
      patientProfile: "ortopedico",
      isActive: true,
