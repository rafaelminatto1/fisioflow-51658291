...
const finalMappings = [
  // Broken Path Fixes
  {
    ...
    path: "/exercises/illustrations/abducao-quadril-pe.avif",
  },
  ...
  { name: "Medicine Ball Slam", path: "/exercises/illustrations/agachamento-com-soco.avif" },
  {
    ...
    path: "/exercises/illustrations/barra-fixa-pronada.avif",
  },
  {
    name: "Rolling com Foam Roller",
    path: "/exercises/illustrations/mckenzie-extensao-lombar-deitado.avif",
  },
  ...
  { name: "Step Touch com Braços", path: "/exercises/illustrations/marcha-paralela.avif" },
  {
    ...
    path: "/exercises/illustrations/alongamento-de-piriforme-4-supino.avif",
  },
  { name: "Salto Unilateral na Caixa", path: "/exercises/illustrations/box-jump.avif" },
  {
    name: "Mobilização Cervical com Toalha",
    path: "/exercises/illustrations/alongamento-lateral-de-pescoco.avif",
  },
  {
  ...
  { name: "Mobilização Patelar", path: "/exercises/illustrations/quadriceps-arco-curto.avif" },
  {
    ...
    path: "/exercises/illustrations/desvio-radial-de-punho.avif",
  },
  {
    name: "Mergulho no Banco (Tríceps)",
    path: "/exercises/illustrations/alongamento-triceps-sentado.avif",
  },
  ...
  { name: "Face Pull", path: "/exercises/illustrations/rotacao-externa-ombro.avif" },
  {
    ...
    path: "/exercises/illustrations/salto-unipodal-aterrissagem.avif",
  },
  {
