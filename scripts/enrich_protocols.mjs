...
const sql = neon("postgresql://neondb_owner:npg_GDT83hbugqXf@ep-wandering-bonus-acj4zwvo-pooler.sa-east-1.aws.neon.tech/neondb?sslmode=require");
        ...
        phases: JSON.stringify([
          {
            ...
            weekStart: 0,
            weekEnd: 2,
            goals: ["Reduzir dor e edema", "Restaurar extensão completa (0°)", "Ativação do quadríceps"],
        ...
        milestones: JSON.stringify([
          {
            ...
            criteria: ["Extensão passiva igual ao lado contralateral", "Aviso: Sem dor em extensão"],
        ...
        phases: JSON.stringify([
          {
            ...
            weekStart: 0,
            weekEnd: 4,
            goals: ["Controle de dor matinal", "Diminuir inflamação com gelo", "Alongamento passivo plantar"],
          ...
          },
          {
            ...
            weekStart: 5,
            weekEnd: 12,
            goals: ["Fortalecimento intrínseco e extrínseco do pé", "Progressão de carga guiada (Heavy Slow Resistance)", "Treino Sensório-motor"],
        ...
        milestones: JSON.stringify([
          {
            ...
            criteria: ["Dor < 4 na EVA aos primeiros passos", "Mobilidade de tornozelo sem restrições graves"]
          },
          {
            week: 12,
            title: "Progressão Funcional",
            criteria: ["Caminhada sem dor por pelo menos 30 min", "Capaz de realizar elevação de panturrilha unilateral com carga"]
          }
        ]),
        restrictions: JSON.stringify([
          {
          ...
          },
          {
            weekStart: 0,
            weekEnd: 6,
            description: "Supressão de atividades de impacto agressivas (saltos/corrida intensa) até estar assintomático.",
            type: "activity"
          }
        ]),
        references: JSON.stringify([
          {
            title: "High-load strength training improves outcome in patients with plantar fasciitis: A randomized controlled trial",
      ...
      },
      {
        ...
        phases: JSON.stringify([
          {
            ...
            weekStart: 0,
            weekEnd: 4,
            goals: ["Proteger reparo cirúrgico", "Ganho de Amplitude Passiva", "Prevenir ombro rígido"],
          ...
          },
          {
            ...
            weekStart: 5,
            weekEnd: 8,
            goals: ["Transição para ADM ativa", "Treino de controle escapular", "Início de isometria suave"],
        ...
        milestones: JSON.stringify([
          {
            ...
            criteria: ["Conseguir elevação com ajuda até no mínimo 90°", "Sem dor em repouso intenso"]
          },
          {
            week: 8,
        ...
        restrictions: JSON.stringify([
          ...
          },
          {
            weekStart: 0,
            weekEnd: 8,
            description: "Evitar movimentos para além do plano escapular que forcem os rotadores sob estresse.",
            type: "activity"
          }
        ]),
        references: JSON.stringify([
          {
            title: "Rehabilitation following arthroscopic rotator cuff repair: a prospective, randomized, double-blind trial",
