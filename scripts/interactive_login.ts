...
async function main() {
  ...
  console.log("A janela está aberta no VNC. Por favor, faça o login normalmente com seu email e senha.");
  console.log("Se pedir CAPTCHA, resolva. Quando estiver logado com sucesso (você verá seu nome ou USP no site da ScienceDirect), pule de volta no chat e me avise escrevendo 'pronto'!");
