...
async function runOnce(
	...
	try {
		...
		const rootContent = [
			...
			"",
			"## Trilhas disponíveis",
			"- LCA e retorno ao esporte",
			"- Artroplastia de joelho e quadril",
			"- Ombro ortopédico e pós-operatório",
			"- Tornozelo, Aquiles e instabilidade",
			"",
			"## Como usar",
		...
		const lcaProtocolContent = [
			...
			protocolSection("Testes de Alta e Retorno", [
				"Testes de salto unilateral e comparação entre membros.",
				"Força de quadríceps e cadeia posterior com assimetria clinicamente aceitável.",
				"Qualidade de movimento em aterrissagem, desaceleração e corte.",
				"Prontidão psicológica e confiança para retorno ao esporte.",
			]),
			"",
		...
		const arthroplastyContent = [
			...
			"",
			"## Objetivo clínico",
			"Organizar condutas para pré-habilitação, mobilização precoce e progressão funcional após TKA, THA e fratura de quadril.",
			"",
			"## Perguntas que esta trilha responde",
			"- O que realmente deve entrar no protocolo pós-artroplastia?",
			"- Quando a pré-habilitação vale a pena?",
			"- Como equilibrar intensidade, segurança e ganho funcional em idosos ou pós-cirúrgicos?",
			"",
			articleSection("Artigos-base", arthroplastyArticles),
			"",
			"## Aplicação prática",
			"- Use esta trilha para avaliação pré-operatória, desenho de protocolos e educação de expectativa de recuperação.",
			"- Priorize marcha, treino motor, força, ROM funcional e metas mensuráveis.",
		].join("\n");
		...
		const arthroplastyProtocolContent = [
			...
			protocolSection("Testes de Alta e Função", [
				"Teste sentar-levantar e velocidade de marcha.",
				"Tolerância a escadas, transferências e marcha comunitária.",
				"Força funcional de quadríceps, glúteos e panturrilha.",
		...
		const ankleProtocolContent = [
			...
			protocolSection("Testes de Alta e Retorno", [
				...
				"Controle postural em apoio unipodal e tarefas dinâmicas.",
