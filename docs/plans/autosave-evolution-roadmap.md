...
- **Impacto:** Zero _re-renders_ desnecessários, digitação mais fluida (especialmente em textos longos) e menor risco de vazamento de memória.
...
- O Service Worker tenta um _Background Sync_ (API nativa dos navegadores modernos) assim que a conexão de internet é reestabelecida, mesmo se a aba do FisioFlow não estiver mais aberta.
