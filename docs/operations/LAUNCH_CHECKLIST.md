...
| Canal de incidentes definido | `RUNBOOK_INCIDENTS.md` → "Canal de incidentes" preenchido (não "definir") | ⬜ |
...
|---|---|---|---|
| Tech Lead | Backend / Infra | ⬜ | |
| Frontend Lead | Web / DS | ⬜ | |
| PM | Produto / Backlog | ⬜ | |
...
1. Criar uma cópia deste arquivo como `LAUNCH_CHECKLIST_vX.Y_YYYY-MM-DD.md` para cada release
2. Marcar cada item com ✅ conforme verificado, ou ❌ com nota de bloqueio
3. **Não liberar release enquanto houver ❌ em itens das seções 1–5**
4. Itens das seções 6–9 podem ter exceções documentadas com justificativa
5. Seção 10 — obrigatória para toda release de produção com usuários reais
