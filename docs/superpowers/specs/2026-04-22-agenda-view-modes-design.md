...
- Reaproveitar cobertura existente quando útil, especialmente o padrão já presente em [src/components/schedule/__tests__/CalendarWeekView.test.tsx](/home/rafael/Documents/fisioflow/fisioflow-51658291/src/components/schedule/__tests__/CalendarWeekView.test.tsx), que já valida troca de visualização em um componente relacionado.
